...
import kotlinx.android.synthetic.main.item_vega_ghana_cocoa_waiting_truck_list.view.*
...
class VegaGhanaCocoaWaitingTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaGateEntry>) {
        ...
        binding.rvWeighbridge.setUp(gateEntry1.asReversed(), R.layout.item_vega_ghana_cocoa_waiting_truck_list, { it, pos ->
