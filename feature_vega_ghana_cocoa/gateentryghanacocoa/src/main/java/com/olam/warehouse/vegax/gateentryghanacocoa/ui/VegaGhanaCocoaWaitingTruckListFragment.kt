...
import com.olam.warehouse.vegax.gateentryghanacocoa.databinding.FragmentVegaGhanaCocoaWaitingTruckListBinding
import com.olam.warehouse.vegax.gateentryghanacocoa.databinding.ItemVegaGhanaCocoaWaitingTruckListBinding
...
class VegaGhanaCocoaWaitingTruckListFragment : BaseFragment() {
    private lateinit var binding: FragmentVegaGhanaCocoaWaitingTruckListBinding
    ...
    override val layoutResourceId = R.layout.fragment_vega_ghana_cocoa_waiting_truck_list
    ...
    companion object {
        fun newInstance(gateEntryData: VegaGateEntry) = VegaGhanaCocoaWaitingTruckListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaGhanaCocoaWaitingTruckListBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun initUI() {
        ...
        binding.ivSortDownUp.visibility = View.GONE
    ...
    private fun setUpAdapter(data: List<VegaGateEntry>) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_ghana_cocoa_waiting_truck_list,
            ItemVegaGhanaCocoaWaitingTruckListBinding::inflate,
            { it, pos, bindItem ->
