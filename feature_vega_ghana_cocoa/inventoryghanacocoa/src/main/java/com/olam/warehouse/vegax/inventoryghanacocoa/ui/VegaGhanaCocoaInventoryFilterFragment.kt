...
import com.olam.warehouse.vegax.inventoryghanacocoa.data.domain.model.FilterList
import com.olam.warehouse.vegax.inventoryghanacocoa.databinding.FragmentVegaGhanaCocoaInventoryFilterBinding
import com.olam.warehouse.vegax.inventoryghanacocoa.utils.*
import kotlinx.android.synthetic.main.item_vega_ghana_cocoa_inventory_filter.view.*
 ...
 */
class VegaGhanaCocoaInventoryFilterFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_ghana_cocoa_inventory_filter
    private lateinit var binding: FragmentVegaGhanaCocoaInventoryFilterBinding
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaGhanaCocoaInventoryFilterFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaGhanaCocoaInventoryFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUp(listFilterMaterial, R.layout.item_vega_ghana_cocoa_inventory_filter, { it, pos ->
    ...
    private fun setUpHumidityAdapter(listFilterHumidity: ArrayList<FilterList>) {
        binding.rvAdmixture.setUp(listFilterHumidity, R.layout.item_vega_ghana_cocoa_inventory_filter, { it, pos ->
    ...
    private fun setUpImpurityAdapter(listFilterImpurity: ArrayList<FilterList>) {
        binding.rvTotalImpurity.setUp(listFilterImpurity, R.layout.item_vega_ghana_cocoa_inventory_filter, { it, pos ->
    ...
    private fun setUpMouldAdapter(listFilterMould: ArrayList<FilterList>) {
        binding.rvMould.setUp(listFilterMould, R.layout.item_vega_ghana_cocoa_inventory_filter, { it, pos ->
