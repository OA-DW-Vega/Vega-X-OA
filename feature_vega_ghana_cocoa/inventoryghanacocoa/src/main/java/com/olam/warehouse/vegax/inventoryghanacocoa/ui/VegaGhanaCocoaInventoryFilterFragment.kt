...
import com.olam.warehouse.vegax.inventoryghanacocoa.databinding.ItemVegaGhanaCocoaInventoryFilterBinding
...
class VegaGhanaCocoaInventoryFilterFragment : BaseFragment() {
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            listFilterMaterial,
            R.layout.item_vega_ghana_cocoa_inventory_filter,
            ItemVegaGhanaCocoaInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
