...
import kotlinx.android.synthetic.main.item_vega_ghana_cocoa_inventory_sync_details.view.*
import java.util.*
...
class VegaGhanaCocoaInventorySyncDetailsDailog : BottomSheetDialogFragment() {
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUp(syncStatusList, R.layout.item_vega_ghana_cocoa_inventory_sync_details, { it, pos ->
