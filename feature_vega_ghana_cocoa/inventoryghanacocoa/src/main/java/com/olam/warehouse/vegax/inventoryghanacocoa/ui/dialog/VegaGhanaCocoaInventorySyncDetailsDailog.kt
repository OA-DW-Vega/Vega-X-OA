package com.olam.warehouse.vegax.inventoryghanacocoa.ui.dialog
...
import com.olam.warehouse.vegax.inventoryghanacocoa.databinding.FragmentBottomSheetGhanaCocoaInventorySyncBinding
import com.olam.warehouse.vegax.inventoryghanacocoa.databinding.ItemVegaGhanaCocoaInventorySyncDetailsBinding
import com.olam.warehouse.vegax.inventoryghanacocoa.utils.SYNC_STATUS_DATA
import java.util.*

/**
 * Created by Keerthi Santhanam on 7/6/2020.
 */
class VegaGhanaCocoaInventorySyncDetailsDailog : BottomSheetDialogFragment() {

    private var syncStatusList = ArrayList<SyncStatus>()

    companion object {
        fun newInstance(syncStatusList: ArrayList<SyncStatus>) = VegaGhanaCocoaInventorySyncDetailsDailog().putArgs {
            putParcelableArrayList(SYNC_STATUS_DATA, syncStatusList)
        }
    }

    private lateinit var binding: FragmentBottomSheetGhanaCocoaInventorySyncBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBottomSheetGhanaCocoaInventorySyncBinding.inflate(layoutInflater)
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUpAdapter(
            syncStatusList,
            R.layout.item_vega_ghana_cocoa_inventory_sync_details,
            ItemVegaGhanaCocoaInventorySyncDetailsBinding::inflate,
            { it, pos, bindItem ->
