...
import kotlinx.android.synthetic.main.item_ghana_cocoa_weighscale_lot_card_layout.view.*
...
//        vm.saveLotDetails(vegaCocoaDispatchLots)
    ...
    private fun setUpMaterialAdapter() {
        binding.rvMaterialList.setUp(vm.materialModelList, R.layout.item_ghana_cocoa_material_layout, { it, pos ->
    ...
    private fun setUpAdapter(list: ArrayList<VegaGhanaCocoaDispatchLots>) {
        val lots = list
        binding.clLotSummary.rvList.setUp(lots, R.layout.item_ghana_cocoa_weighscale_lot_card_layout, { item, pos ->
