...
import com.olam.warehouse.vegax.mtntghanacocoa.databinding.ItemVegaGhanaCocoaMtntOfflineSummaryBinding
...
//        hideLoading()
    ...
    private fun setUpAdapter(dispatchItemsList: ArrayList<VegaCocoaDispatchWB>) {
        ...
        binding.rvDispatchOffline.setUpAdapter(
            ...
            ItemVegaGhanaCocoaMtntOfflineSummaryBinding::inflate,
            { it, pos, bindItem ->
//                val dispatch = it.dispatch
                //tvStoNo.text = it.purchaseDocNum
                bindItem.tvSDWaybillNo.text = it.sidingDepotwayBillNumber
                bindItem.tvDispatchQty.text = it.purchaseQuantity
                bindItem.DateValue.text=it.erdat
                bindItem.transportvendorvalue.text = it.fromVendorCode
                ...
                bindItem.tvDestinationWH.text = (it.destinationWH).plus(" - ")
