package com.olam.warehouse.vegax.mtntghanacocoa.data.api
...
interface VegaGhanaCocoaMtntApi {
...
//    @GET("x-dispatch/vega/dispatch/getPurchaseOrders")
    ...
    suspend fun postWeighScaleDeliveryDetails(
        @Body vegaDeliveryPost: VegaGhanaMtntDeliveryPost,
        @Query("whReceiptNum") wayBillNumber: String
    ): GenericReqAndResp<List<VegaGhanaMtntDeliveryDetail>>
