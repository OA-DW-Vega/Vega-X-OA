...
import kotlinx.android.synthetic.main.item_ghana_cocoa_mtnt_truck_layout.view.*
...
class VegaGhanaCocoaMtntWeighbridgeTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUp(dispatch1, R.layout.item_ghana_cocoa_mtnt_truck_layout, { it, pos ->
