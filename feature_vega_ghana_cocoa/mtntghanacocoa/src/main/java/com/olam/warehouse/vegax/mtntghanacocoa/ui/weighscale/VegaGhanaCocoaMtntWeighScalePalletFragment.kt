...
import com.olam.warehouse.vegax.mtntghanacocoa.databinding.ItemVegaGhanaCocoaMtntAddBagBinding
   ...
   /* private fun updatePalletUI(response: Resource<GenericReqAndResp<List<VegaGhanaMtntWeighScalePallet>>>?) {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(),
            R.layout.item_vega_ghana_cocoa_mtnt_add_bag,
            ItemVegaGhanaCocoaMtntAddBagBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
                    bindItem.clBagHead.setBackgroundResource(com.olam.warehouse.presentation.R.drawable.rectangle_grey_border)
                } else {
                    bindItem.clBagHead.setBackgroundResource(R.drawable.shape_ghana_rect_light_grey1)
                }
