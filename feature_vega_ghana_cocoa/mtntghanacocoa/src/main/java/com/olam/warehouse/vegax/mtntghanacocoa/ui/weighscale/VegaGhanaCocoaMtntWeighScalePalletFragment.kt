...
import com.olam.warehouse.vegax.mtntghanacocoa.databinding.FragmentGhanaCocoaMtntWeighscaleAddPalletBinding
...
import kotlinx.android.synthetic.main.item_vega_ghana_cocoa_mtnt_add_bag.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import kotlin.random.Random

class VegaGhanaCocoaMtntWeighScalePalletFragment : BaseFragment() {

    override val layoutResourceId: Int =
        R.layout.fragment_ghana_cocoa_mtnt_weighscale_add_pallet
    private lateinit var binding: FragmentGhanaCocoaMtntWeighscaleAddPalletBinding
    ...
    companion object {
        fun newInstance(item: VegaGhanaCocoaDispatchLots) = VegaGhanaCocoaMtntWeighScalePalletFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentGhanaCocoaMtntWeighscaleAddPalletBinding.inflate(inflater)
        initUI()
        return binding.root
    }
...
//        vm.pallet.observe(viewLifecycleOwner, Observer { updatePalletUI(it) })
   ...
   /* private fun updatePalletUI(response: Resource<GenericReqAndResp<List<VegaGhanaMtntWeighScalePallet>>>?) {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_vega_ghana_cocoa_mtnt_add_bag, { it, pos ->
            if (pos % 2 == 0) {
    ...
    fun clearTotalWeights() {
        binding.tvStockValue.text = UNIT_ZERO.plus(" ").plus(UNIT_KG)
        binding.tvStorageValue.text =  UNIT_ZERO.plus(" ").plus(UNIT_KG)
        binding.tvNetWtValue.text =  UNIT_ZERO.plus(" ").plus(UNIT_KG)
    }
