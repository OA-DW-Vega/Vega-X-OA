package com.olam.warehouse.vegax.mtntghanacocoa.data.domain.usecase
...
import com.olam.warehouse.vegax.mtntghanacocoa.data.domain.model.VegaGhanaMergedDeliveryPostResponse
import com.olam.warehouse.vegax.mtntghanacocoa.data.domain.model.VegaGhanaMtntDeliveryPost
import com.olam.warehouse.vegax.mtntghanacocoa.data.domain.model.VegaGhanaMtntMergedDeliveryPost
import com.olam.warehouse.vegax.mtntghanacocoa.data.repo.VegaGhanaCocoaMtntRepository


class VegaGhanaCocoaDispatchUseCase(private val repository: VegaGhanaCocoaMtntRepository) {
    ...
    suspend fun deleteGhanaLotList() = repository.deleteGhanaLotList()
    ...
    suspend fun getAllPlantRoute() = repository.getAllPlantRoute()
...
//        repository.postWeighScaleDeliveryDetail(vegaDeliveryPost)
    ...
    suspend fun postWeighScaleDeliveryDetail(
        ...
        repository.postWeighScaleDeliveryDetail(vegaDeliveryPost, wayBillNumber)
    ...
    suspend fun removeGhanaLotFromList(batchNumber: String, wbid: String) =
        repository.removeGhanaLotFromList(batchNumber, wbid)
    ...
    suspend fun getWeighBridgeStockCount(): LiveData<List<VegaGhanaCocoaMtntWithLots>> = repository.getWeighBridgeStockCount()
