...
import com.olam.warehouse.vegax.offloadinggrnghanacocoa.databinding.ItemGhanaCocoaMtnrWeighscaleLotCardLayoutBinding
...
import com.olam.warehouse.vegax.offloadinggrnghanacocoa.utils.OFFLINE_DATA
...
class VegaGhanaCocoaOfflineMtnrWeighScaleSummaryFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(data: VegaCoffeeReceivingMtnrWithLots) =
            VegaGhanaCocoaOfflineMtnrWeighScaleSummaryFragment().putArgs {
    ...
    private fun setUpAdapter(list: List<VegaCoffeeReceiveLots>) {
        ...
        binding.rvLots.setUpAdapter(
            lots, R.layout.item_ghana_cocoa_mtnr_weighscale_lot_card_layout,
            ItemGhanaCocoaMtnrWeighscaleLotCardLayoutBinding::inflate,
            { item, pos, bindItem ->
                ...
                if (dispatchWeight!! < receivingWeight!!) {
                    bindItem.tvTotalWeightLoss.text = "Weight Gain"
                }
                bindItem.tvTotalWeightLossValue.text =
                    abs(weightLoss!!).formatThreeDigits().plus(" ").plus("MT")
