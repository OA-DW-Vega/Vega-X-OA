...
import kotlinx.android.synthetic.main.item_ghana_cocoa_mtnr_weighscale_lot_card_layout.view.*
...
class VegaGhanaCocoaOfflineMtnrWeighScaleSummaryFragment : BaseFragment() {
    ...
    private fun setUpAdapter(list: List<VegaCoffeeReceiveLots>) {
        ...
        binding.rvLots.setUp(lots, R.layout.item_ghana_cocoa_mtnr_weighscale_lot_card_layout, { item, pos ->
