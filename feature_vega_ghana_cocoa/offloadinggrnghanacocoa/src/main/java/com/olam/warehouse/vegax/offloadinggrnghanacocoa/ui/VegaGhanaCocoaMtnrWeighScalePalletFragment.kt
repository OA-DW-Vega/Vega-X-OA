...
import kotlinx.android.synthetic.main.item_vega_ghana_cocoa_offload_add_bag.view.*
...
class VegaGhanaCocoaMtnrWeighScalePalletFragment : BaseFragment() {
   ...
   /* private fun updateConfigItems(configItems: List<VegaConfigDetails>?) {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCoffeeOffloadingBagMaterial>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_vega_ghana_cocoa_offload_add_bag, { it, pos ->
            if (pos % 2 == 0) {
