...
import com.olam.warehouse.vegax.offloadinggrnghanacocoa.databinding.ItemGhanaCocaLotSummaryDwGrnBinding
...
class VegaGhanaCocoaDWGRNLotAdapter(
    ...
    RecyclerView.Adapter<VegaGhanaCocoaDWGRNLotAdapter.LotViewHolder>() {

    class LotViewHolder(bind: ItemGhanaCocaLotSummaryDwGrnBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LotViewHolder {
        val viewHolder =
            ItemGhanaCocaLotSummaryDwGrnBinding.inflate(
    ...
    override fun onBindViewHolder(holder: LotViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.binding.ivClose.setImageDrawable(AppCompatResources.getDrawable(holder.binding.ivClose.context,
            if (isClose) com.olam.warehouse.vegax.mtntghanacocoa.R.drawable.ic_ghana_close_black else
                com.olam.warehouse.vegax.mtntghanacocoa.
                R.drawable.ic_ghana_edit_gray))
