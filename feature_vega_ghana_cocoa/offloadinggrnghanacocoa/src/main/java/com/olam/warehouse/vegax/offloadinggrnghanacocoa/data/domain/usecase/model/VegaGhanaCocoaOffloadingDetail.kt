...
data class VegaGhanaOffloadingPostRequest(
    var batchNumber: String? = "",
    var delFlag: String? = "",
    var deliveryDetails: List<VegaGhanaOffloadingDeliveryDetail>,
    var key: String? = "",
...
data class VegaGhanaOffloadingDeliveryDetail(
    var batchNumber: String? = "",
    var bltxt: String? = "",
...
data class VegaGhanaCocoaCostCenterModel(
    val COST_CENTRE_LIST: List<String>
)
data class VegaGhanaCostCenter(
