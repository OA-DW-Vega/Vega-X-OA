...
//            activity?.finish()
    ...
    private fun initExtra() {
        ...
        println("Roshna rejectList => $rejectList")
...
//        vm.getOBDDetails(vegaCoffeeReceivingData.delivery)
   ...
   /* private fun showRemarkDialog() {
    ...
    private fun generateAcceptBatchId(): String? {
        ...
        batchId =
            formattedYear.plus(formattedMonth).plus(formattedDate).plus(customLocationList.single().procureLocationCode)
        return batchId
    }
    ...
    private fun generateRejectBatchId(): String? {
        ...
        batchId =
            formattedYear.plus(formattedMonth).plus(formattedDate).plus(vegaCoffeeReceivingData.storageLocationCode)
        return batchId
    }
    ...
    private fun moveToSuccessPage(vegaMtntResponse: VegaMtntResponse) {
        ...
        intent.putExtra(
            ...
            getString(R.string.wb_id_is, vegaMtntResponse.wbId).plus("\n")
                .plus(getString(R.string.mtnr_number, vegaMtntResponse.mtnNumber))
        )
//        intent.putExtra(
