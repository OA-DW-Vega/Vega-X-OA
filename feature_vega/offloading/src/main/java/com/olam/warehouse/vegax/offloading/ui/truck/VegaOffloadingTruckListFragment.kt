...
import kotlinx.android.synthetic.main.item_vega_offloading_truck_list.view.*
...
class VegaOffloadingTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaOffloadingTrucks>?) {
        ...
        binding.rvWeighbridge.setUp(offloading1.asReversed(), R.layout.item_vega_offloading_truck_list, { it, pos ->
