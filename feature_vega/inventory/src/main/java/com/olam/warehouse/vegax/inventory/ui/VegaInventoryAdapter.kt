...
class VegaInventoryParentAdapter(
    ...
    override fun onBindViewHolder(holder: ParentViewHolder, position: Int) {
        ...
        holder.binding.rvChild.adapter =
            VegaInventoryChildAdapter(items[position].storageLoc, listener, colorCode)
    }
...
class VegaInventoryChildAdapter(
    ...
    override fun onBindViewHolder(holder: ChildViewHolder, position: Int) {
        holder.bindingChild.tvKorValue.text =
        ...
        holder.bindingChild.tvOriginValue.text = items[position].origin
        holder.bindingChild.tvWeightValue.text =
            if (!items[position].weight.isNullOrEmpty()) items[position].weight.toDouble()
                .formatThreeDigits().plus(" Kg") else ""
