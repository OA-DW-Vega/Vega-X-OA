...
import kotlinx.android.synthetic.main.item_vega_approve_quality_params.view.*
...
class VegaApproveQualityFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaApproveQuality>) {
        data.let {
            ...
            var i = 0
            binding.rvApproveQuality.setUp(approveQuality.first().qualityParameters as MutableList<VegaApproveQualityParams>,
