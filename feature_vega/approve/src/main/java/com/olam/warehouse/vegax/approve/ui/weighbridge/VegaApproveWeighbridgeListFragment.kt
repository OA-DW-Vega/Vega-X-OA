...
import kotlinx.android.synthetic.main.item_vega_weighbridge_approve.view.*
...
class VegaApproveWeighbridgeListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaApproveWeighBridgeId>?) {
        ...
        var count = 0
        binding.rvWeighBridgeId.setUp(weighBridgeList1, R.layout.item_vega_weighbridge_approve, { it, pos ->
