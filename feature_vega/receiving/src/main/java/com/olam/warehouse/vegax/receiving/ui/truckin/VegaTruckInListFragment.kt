...
import com.olam.warehouse.vegax.receiving.databinding.FragmentVegaTruckinWblistBinding
import com.olam.warehouse.vegax.receiving.databinding.ItemVegaTruckinWbListBinding
 ...
 */
class VegaTruckInListFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaTruckinWblistBinding
    override val layoutResourceId = R.layout.fragment_vega_truckin_wblist

    companion object {
        fun newInstance(receivingData: VegaReceiving) = VegaTruckInListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaTruckinWblistBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_truckin_wb_list,
            ItemVegaTruckinWbListBinding::inflate,
            { it, pos, bindingItem ->
