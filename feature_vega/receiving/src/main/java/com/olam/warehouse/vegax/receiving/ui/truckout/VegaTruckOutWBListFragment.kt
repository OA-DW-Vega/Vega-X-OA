...
import com.olam.warehouse.vegax.receiving.databinding.ItemVegaTruckoutWbListBinding
...
class VegaTruckOutWBListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_truckout_wb_list,
            ItemVegaTruckoutWbListBinding::inflate,
            { it, pos, bindItem ->
