package com.olam.warehouse.vegax.receiving.ui.truckin
...
import com.olam.warehouse.vegax.receiving.databinding.FragmentVegaTruckinSummaryBinding
import com.olam.warehouse.vegax.receiving.ui.VegaReceivingViewModel
import com.olam.warehouse.vegax.receiving.utils.DIRECTIONIN
import com.olam.warehouse.vegax.receiving.utils.PROCURE
import com.olam.warehouse.vegax.receiving.utils.RECEIVING_DATA
 ...
 */
class VegaTruckInSummaryFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaTruckinSummaryBinding
    override val layoutResourceId = R.layout.fragment_vega_truckin_summary

    companion object {
        fun newInstance(receivingData: VegaReceiving) = VegaTruckInSummaryFragment().putArgs {
            putParcelable(RECEIVING_DATA, receivingData)
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaTruckinSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
