...
import com.olam.warehouse.vegax.receiving.databinding.FragmentVegaTruckinMtntSummaryBinding
 ...
 */
class VegaTruckInMtntSummaryFragments : BaseFragment() {

    private var mtntData = VegaMtnt()
    private var mMtntList = mutableListOf<VegaMtnt>()

    private val vm: VegaMtntViewModel by viewModel()
    private lateinit var binding: FragmentVegaTruckinMtntSummaryBinding
    override val layoutResourceId = R.layout.fragment_vega_truckin_mtnt_summary

    companion object {
        fun newInstance(mtntData: VegaMtnt) = VegaTruckInMtntSummaryFragments().putArgs {
            putParcelable(MTNT_DATA, mtntData)
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaTruckinMtntSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
