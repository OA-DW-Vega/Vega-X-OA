...
import com.olam.warehouse.vegax.receiving.databinding.ItemVegaTruckoutMtntWbListBinding
...
class VegaTruckOutMtntWBListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaMtnt>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_truckout_mtnt_wb_list,
            ItemVegaTruckoutMtntWbListBinding::inflate,
            { it, pos, bindItem ->
