 ...
 */
class VegaGateEntryViewModel(private val useCase: VegaGateEntryUseCase, private val dispatchers: AppDispatchers) :
    BaseViewModel() {
    ...
    fun postGateEntryData(gateEntryPost: VegaGateEntryPost) = viewModelScope.launch(dispatchers.main) {
