...
import com.olam.warehouse.vegax.gateentry.databinding.FragmentVegaWaitingTruckListBinding
import com.olam.warehouse.vegax.gateentry.utils.*
import kotlinx.android.synthetic.main.item_vega_waiting_truck_list.view.*
 ...
 */
class VegaWaitingTruckListFragment : BaseFragment() {
    private lateinit var binding: FragmentVegaWaitingTruckListBinding
    ...
    override val layoutResourceId = R.layout.fragment_vega_waiting_truck_list
    ...
    companion object {
        fun newInstance(gateEntryData: VegaGateEntry) = VegaWaitingTruckListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaWaitingTruckListBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(data: List<VegaGateEntry>) {
        ...
        binding.rvWeighbridge.setUp(gateEntry1.asReversed(), R.layout.item_vega_waiting_truck_list, { it, pos ->
