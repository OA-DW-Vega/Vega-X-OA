...
import com.olam.warehouse.vegax.gateentry.databinding.ItemVegaWaitingTruckListBinding
...
class VegaWaitingTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaGateEntry>) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_waiting_truck_list,
            ItemVegaWaitingTruckListBinding::inflate,
            { it, pos, bindingItem ->
