package com.olam.warehouse.vegax.quality.ui.offline
...
import com.olam.warehouse.vegax.quality.databinding.FragmentVegaQualityOfflineBinding
import com.olam.warehouse.vegax.quality.ui.VegaQualityViewModel
import com.olam.warehouse.vegax.quality.utils.*
import com.olam.warehouse.vegax.quality.work.getQualityOneTimeRequestWorker
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaQualityOfflineFragment : BaseFragment() {
    ...
    private var mAdapter = VegaQualityOfflineAdapter({ moveQualityParms(it) }, { viewDetails(it) })
    private lateinit var mListener: OnOfflineListener

    companion object {
        fun newInstance() = VegaQualityOfflineFragment().putArgs {
        }
    }
    ...
    private lateinit var binding: FragmentVegaQualityOfflineBinding
    override val layoutResourceId = R.layout.fragment_vega_quality_offline

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaQualityOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
                        ...
                        if (workInfo != null) {
                            when (workInfo.state) {
                                WorkInfo.State.SUCCEEDED -> {
                                    ...
                                    showErrorDialogWithFAQLink(requireContext(), "Sync success $position")
                                ...
                                WorkInfo.State.FAILED -> {
                                    ...
                                    showErrorDialogWithFAQLink(requireContext(), "Sync failed $position")
