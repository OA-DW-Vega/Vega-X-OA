...
import com.olam.warehouse.vegax.quality.databinding.FragmentVegaQualityWeighBridgeListBinding
...
class VegaQualityWBListFragment : BaseFragment() {

    private var mAdapter = VegaWeighBridgeListAdapter { moveBagdetail(it) }
    private val vm: VegaQualityViewModel by viewModel()
    private lateinit var mListener: OnWeighBridgeListener
    private lateinit var binding: FragmentVegaQualityWeighBridgeListBinding
    override val layoutResourceId = R.layout.fragment_vega_quality_weigh_bridge_list
    ...
    companion object {
        fun newInstance() = VegaQualityWBListFragment().putArgs {
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaQualityWeighBridgeListBinding.inflate(layoutInflater)
        return binding.root
    }
