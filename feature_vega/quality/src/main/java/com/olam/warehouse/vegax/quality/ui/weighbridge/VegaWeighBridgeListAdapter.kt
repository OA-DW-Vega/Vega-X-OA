...
import kotlinx.android.synthetic.main.item_vega_quality_weigh_bridge_details.view.*
...
class VegaWeighBridgeListAdapter(private val onClick: (VegaQualityWBDetails?) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WeighBridgeViewHolder {
        val v =
            LayoutInflater.from(parent.context).inflate(R.layout.item_vega_quality_weigh_bridge_details, parent, false)
