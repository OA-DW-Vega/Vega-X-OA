...
import com.olam.warehouse.vegax.quality.databinding.ItemVegaQualityOfflineBinding

class VegaQualityOfflineAdapter(private val onClick: (VegaQualityWBDetails?) -> Unit, private val onClickView: (VegaQualityWBDetails?) -> Unit) :
    RecyclerView.Adapter<VegaQualityOfflineAdapter.ParamsViewHolder>() {
...
//        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_vega_quality_offline, parent, false)
        val v = ItemVegaQualityOfflineBinding.inflate(
    ...
    inner class ParamsViewHolder(itemView: ItemVegaQualityOfflineBinding) :
