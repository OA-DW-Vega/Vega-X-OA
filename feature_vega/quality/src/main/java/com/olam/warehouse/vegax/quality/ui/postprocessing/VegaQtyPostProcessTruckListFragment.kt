...
import com.olam.warehouse.vegax.quality.databinding.ItemVegaPostQualityDetailsBinding
...
class VegaQtyPostProcessTruckListFragment : BaseFragment() {
    ...
    private fun updateDetails(poList: List<VegaPostProcessQualityWBDetails>) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            data,
            R.layout.item_vega_post_quality_details,
            ItemVegaPostQualityDetailsBinding::inflate,
            { item, pos, bindingItem ->
                bindingItem.tvLotNo.text = item.batchNumber
                bindingItem.tvProcessOrderNo.text = item.batchNumber
                bindingItem.tvStroageLocation.text = item.bagWeight
                bindingItem.tvWeight.text = item.bagWeight
                bindingItem.tvDate.text = item.erdat
            },
            {
