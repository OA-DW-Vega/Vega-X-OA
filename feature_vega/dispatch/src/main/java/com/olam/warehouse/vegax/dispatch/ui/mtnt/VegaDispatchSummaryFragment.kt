...
import com.olam.warehouse.vegax.dispatch.databinding.ItemVegaDispatchSummaryDetailsListBinding
    ...
    private fun setUpAdapter(selectedStocks: List<VegaDispatchLots>) {
        ...
        binding.rvDispatchLots.setUpAdapter(
            ...
            { it, pos, bindingItem ->
                ...
                bindingItem.tvDispatchWeight.text = it.editedWeight.plus(" ").plus(it.unitOfMeasure)
                bindingItem.tvLocation.text = it.storageLocationCode
