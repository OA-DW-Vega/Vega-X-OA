...
class VegaDispatchLotsActivity : HomeBaseActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        try {
            ...
            searchView.setBackgroundColor(com.olam.warehouse.vegax.dispatch.utils.getColor(if(getCurrentOriginEntity().contains("OFI"))com.olam.warehouse.presentation.R.color.colorPrimaryOfi else com.olam.warehouse.presentation.R.color.green))
