...
import kotlinx.android.synthetic.main.item_vega_fgrn_po_details.view.*
...
class VegaFgrnPoDetailsFragment : BaseFragment() {
    ...
    private fun updateDetails(poList: List<VegaFgrnProcessingOrder>) {
        ...
        binding.rvFgrnPoselection.setUp(data, R.layout.item_vega_fgrn_po_details, { item, pos ->
            ...
            tvBatchNo.text = item.rminList!![0].batchNumber
        }, {
