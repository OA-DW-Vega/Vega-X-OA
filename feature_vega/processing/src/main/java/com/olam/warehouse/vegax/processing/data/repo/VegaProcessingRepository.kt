...
interface VegaProcessingRepository {
    ...
    suspend fun getFgrnPoDetailsList(): LiveData<Resource<GenericReqAndResp<List<VegaFgrnProcessingOrder>>>>
...
class VegaProcessingRepositoryImpl(
    ...
    override suspend fun getFgrnPoDetailsList(): LiveData<Resource<GenericReqAndResp<List<VegaFgrnProcessingOrder>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaFgrnProcessingOrder>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaFgrnProcessingOrder>> =
                api.getFgrnPoDetailsList(VegaProcessingOrderReq(getCurrentKey(), getPlantDetails()))
        }.build().asLiveData()
    }
