...
android {
   ...
   buildFeatures.viewBinding = true
    namespace = "com.olam.warehouse.odquality"
}
...
//      property("sonar.projectKey", "vegaxod123")
...
//    //property("sonar.kotlin.detekt.reportPaths", "$buildDir/reports/detekt.xml")
//     property("sonar.exclusions","**/BuildConfig.class,**/R.java,**/R\$*.java,src/main/gen/**/*,src/main/assets/**/*,src/androidTest/java"
//    )
//}
//}
