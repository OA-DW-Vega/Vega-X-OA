...
class DOQualityActivity : HomeBaseActivity(), DOQualityWBListFragment.OnWeighBridgeListener,
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        try {
            val fragmentSearch = supportFragmentManager.findFragmentById(R.id.flQuality) as DOQualityWBListFragment?
                ...
                override fun onQueryTextChange(newText: String?): Boolean {
                    newText.let {
                        if (newText?.isEmpty() == true) {
                            fragmentSearch?.updateAdapter(mQualityWBList)
                        } else {
                            mSearchList.clear()
                            ...
                            fragmentSearch?.updateAdapter(mSearchList)
                        }
                    }
                    return true
                }
