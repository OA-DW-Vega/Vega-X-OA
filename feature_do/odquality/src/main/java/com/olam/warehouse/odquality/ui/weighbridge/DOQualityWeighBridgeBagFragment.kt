...
import kotlinx.android.synthetic.main.fragment_do_quality_weigh_bridge_bag.*
import kotlinx.android.synthetic.main.item_do_quality_weigh_bridge_bag.view.*
...
//            map: MutableMap<String, MutableSet<String>>
    ...
    private fun initExtra() {
        ...
        if (selectedBagsStr != "default") {
            ...
            rvWeighbridge?.adapter?.notifyDataSetChanged()
        }
...
//            callBack?.replaceFragment(WEIGHBRIDGE_LIST, map)
            ...
            activity?.finish()
            val intent = Intent(activity!!, DOQualityActivity::class.java)
    ...
    private fun initRecyclerView() {
        var qrCode = ""
        binding.rvWeighbridge.setUp(bags, R.layout.item_do_quality_weigh_bridge_bag, { it, pos ->
            qrCode = it.bagQrCode
            tvQrCode.text = qrCode


            chkBox.isChecked = doQualityWBDetails?.missedQrCodes?.contains(qrCode)!!
            ...
            chkBox.setOnClickListener{
                ...
                it.isSelected=chkBox.isChecked
                if (chkBox.isChecked) {
