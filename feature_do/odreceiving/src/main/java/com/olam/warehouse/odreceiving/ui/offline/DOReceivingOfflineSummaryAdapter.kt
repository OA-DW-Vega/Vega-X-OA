...
import kotlinx.android.synthetic.main.item_do_receiving_offline_summary.view.*
...
class DOReceivingOfflineSummaryAdapter(
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        holder.bindItems(mData[position])
    }

    inner class ItemViewHolder(private val iv: View) : RecyclerView.ViewHolder(iv) {
        fun bindItems(data: DOReceivingWithLineItems) {
            ...
            when (receiving.status) {
                Status.RECEVING_COMPLETED -> {
                    iv.ivStatus.setImageDrawable(iv.context.getDrawable(com.olam.warehouse.presentation.R.drawable.do_icon_completed))
                    itemView.viewStatus.setBackgroundColor(
                ...
                Status.SYNC_ERROR -> {
                    ...
                    iv.ivStatus.setImageDrawable(iv.context.getDrawable(com.olam.warehouse.presentation.R.drawable.ic_do_icon_error))
                    itemView.viewStatus.setBackgroundColor(
                        ContextCompat.getColor(
                            itemView.context,
                    ...
                    iv.ivStatus.setImageDrawable(iv.context.getDrawable(com.olam.warehouse.presentation.R.drawable.icon_no_progresss))
                    itemView.viewStatus.setBackgroundColor(
                        ContextCompat.getColor(
                            itemView.context,
        ...
        private fun showDeleteDialog(receiving: DOReceivingWithLineItems, adapterPosition: Int) {
            MaterialDialog(iv.context).show {
                message(R.string.delete_msg)
                getMetirialCustomView(
                    this,
                    iv.context.getString(com.olam.warehouse.presentation.R.string.confirm),
                    iv.context.getString(com.olam.warehouse.presentation.R.string.cancel),
                    {
