package com.olam.warehouse.vegax.createmapar.ui.createmap
...
import com.olam.warehouse.vegax.createmapar.databinding.FragmentCreateMapBinding
...
import com.olam.warehouse.vegax.createmapar.utils.CREATE_MAP
import com.olam.warehouse.vegax.createmapar.utils.LOT
import com.olam.warehouse.vegax.createmapar.utils.LOT_ID
import com.olam.warehouse.vegax.createmapar.utils.MODE
 ...
 */
class CreateMapFragment : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_create_map
    private lateinit var binding: FragmentCreateMapBinding
    private val vm: ArViewModel by viewModel()
    private var lotList = arrayListOf<ArLotDetails>()

    companion object {
        fun newInstance() = CreateMapFragment().putArgs {
        }
    }
    ...
    override fun onCreateView(
        ...
        binding = FragmentCreateMapBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun initUI() {
        binding.tvStartAR.setOnClickListener {
            ...
            when (it.status) {
                Resource.Status.SUCCESS -> {
                    ...
                    if (it.data?.isNotEmpty() == true) {
                        val lotitems = it.data?.filter { it.anchorIds.isEmpty() }
