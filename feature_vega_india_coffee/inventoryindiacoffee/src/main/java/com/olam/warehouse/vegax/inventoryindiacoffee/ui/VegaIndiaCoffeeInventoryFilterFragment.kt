...
import com.olam.warehouse.vegax.inventoryindiacoffee.databinding.ItemVegaIndiaCoffeeInventoryFilterBinding
...
//        binding.tvAdmixture.text = "KOR"
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            listFilterMaterial,
            R.layout.item_vega_india_coffee_inventory_filter,
            ItemVegaIndiaCoffeeInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
