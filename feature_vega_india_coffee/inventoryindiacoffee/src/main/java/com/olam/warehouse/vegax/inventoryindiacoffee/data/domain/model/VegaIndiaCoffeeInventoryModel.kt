package com.olam.warehouse.vegax.inventoryindiacoffee.data.domain.model
...
data class IndiaCoffeeInventory(
...
data class IndiaCoffeeStorageLoc(
    val inventory: List<IndiaCoffeeInventory>,
    val kor: String? = "",
...
data class VegaIndiaCoffeeInventoryStocks(
