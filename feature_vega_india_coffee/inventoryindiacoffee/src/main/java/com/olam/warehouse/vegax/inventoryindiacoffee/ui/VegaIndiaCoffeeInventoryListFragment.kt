...
import com.olam.warehouse.vegax.inventoryindiacoffee.data.domain.model.SyncStatus
...
import com.olam.warehouse.vegax.inventoryindiacoffee.ui.dialog.VegaIndiaCoffeeInventorySyncDetailsDailog
import com.olam.warehouse.vegax.inventoryindiacoffee.utils.INVENTORY_CODE
import com.olam.warehouse.vegax.inventoryindiacoffee.utils.INVENTORY_DETAILS
import com.olam.warehouse.vegax.inventoryindiacoffee.utils.INVENTORY_LOTS
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper


class VegaIndiaCoffeeInventoryListFragment : BaseFragment(),
    VegaIndiaCoffeeInventoryNavigateToDetailsListener {
    ...
    companion object {
        fun newInstance() = VegaIndiaCoffeeInventoryListFragment().putArgs {
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("inventoryindiacoffee/ui/VegaIndiaCoffeeInventoryListFragment")
    ...
    private fun syncDetails() {
        val bottomDialog = VegaIndiaCoffeeInventorySyncDetailsDailog.newInstance(syncStatusList)
    ...
    private fun setAdapter(data: List<VegaInventoryWarehouseModel>) {
        ...
        binding.rvInventory.adapter = VegaIndiaCoffeeInventoryParentAdapter(data, materialList, this)
    }
