...
class VegaIndiaCoffeeInventoryViewModel(
    private val useCase: VegaIndiaCoffeeInventoryUseCase,
    ...
    private var qualityParamSource: LiveData<Resource<GenericReqAndResp<List<VegaIndiaCoffeeInventoryStocks>>>> =
        MutableLiveData()
    private val _qualityDetails = MediatorLiveData<Resource<GenericReqAndResp<List<VegaIndiaCoffeeInventoryStocks>>>>()
