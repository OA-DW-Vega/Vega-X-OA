...
import kotlinx.android.synthetic.main.item_vega_india_coffee_inventory_child.view.*
import kotlinx.android.synthetic.main.item_vega_india_coffee_inventory_parent.view.*
import kotlinx.android.synthetic.main.item_vega_india_coffee_material_details.view.*
...
//        }
        ...
        holder.itemView.rv_child.adapter =
                VegaIndiaCoffeeInventoryChildAdapter(items[position].storageLoc, listener, colorCode, materialList)
    }
...
class VegaIndiaCoffeeInventoryChildAdapter(
    ...
    override fun onBindViewHolder(holder: ChildViewHolder, position: Int) {
        ...
        holder.itemView.rv_material.setUp(materialsList, R.layout.item_vega_india_coffee_material_details, { it, pos ->
            /*if (getCurrentKey().split("_")[2].contains(KEY_SESAME)) {
            ...
            tvHumidityValue.text =
                    if (!it.averageKor.isNullOrEmpty()) it.averageKor.toDouble().formatThreeDigits() else ""
