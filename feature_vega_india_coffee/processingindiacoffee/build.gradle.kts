...
android {
   ...
   buildFeatures.viewBinding = true
    namespace = "com.olam.warehouse.vegax.processingindiacoffee"
}
...
sonarqube {
    properties {
        ...
        property(
            "sonar.exclusions",
            "**/BuildConfig.class,**/R.java,**/R\$*.java,src/main/gen/**/*,src/main/assets/**/*,src/androidTest/java,src/test/java"
        )
    }
}
...
dependencies {
    ...
    implementation(project(mapOf("path" to ":feature_vega_india_coffee:inventoryindiacoffee")))
}
