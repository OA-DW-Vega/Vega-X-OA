...
import com.olam.warehouse.vegax.processingindiacoffee.databinding.FragmentVegaIndiaCoffeeFgrnPendingBinding
import com.olam.warehouse.vegax.processingindiacoffee.databinding.ItemVegaIndiaCoffeeFgrnPendingBinding
import com.olam.warehouse.vegax.processingindiacoffee.utils.FRAG_GRADES
...
class VegaIndiaCoffeeFgrnPendingFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_india_coffee_fgrn_pending
    private lateinit var binding: FragmentVegaIndiaCoffeeFgrnPendingBinding
    ...
    companion object {
        fun newInstance(model: VegaCocoaFgrnItems) = VegaIndiaCoffeeFgrnPendingFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaIndiaCoffeeFgrnPendingBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun updateItems(pendingList: List<VegaCocoaFgrnItems>) {
        binding.rvPendingPoList.setUpAdapter(
            ...
            R.layout.item_vega_india_coffee_fgrn_pending,
            ItemVegaIndiaCoffeeFgrnPendingBinding::inflate,
            { item, pos, bindItem ->
            ...
            {
                var localFgrnItem= this
                localFgrnItem.rminList= fgrnItem.rminList
                callBack?.replaceFgrnFragment(FRAG_GRADES, localFgrnItem, this.fgrnId)
            })
    }
