...
import kotlinx.android.synthetic.main.item_vega_india_coffee_fgrn_grades.view.*
...
class VegaIndiaCoffeeFgrnGradesFragment : BaseFragment() {
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCocoaFgrnItemsGrades>) {
        binding.rvGrades.setUp(gradeList, R.layout.item_vega_india_coffee_fgrn_grades, { item, pos ->
