...
import kotlinx.android.synthetic.main.item_vega_india_coffee_fgrn_inventory_filter.view.*
import java.util.*
...
class VegaIndiaCoffeeFgrnFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<FilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_india_coffee_fgrn_inventory_filter, { it, pos ->
