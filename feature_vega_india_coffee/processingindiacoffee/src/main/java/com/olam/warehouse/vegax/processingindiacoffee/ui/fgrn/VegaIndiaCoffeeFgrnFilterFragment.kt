...
import com.olam.warehouse.vegax.processingindiacoffee.data.domain.model.FilterList
import com.olam.warehouse.vegax.processingindiacoffee.databinding.FragmentVegaIndiaCoffeeFgrnFilterBinding
import com.olam.warehouse.vegax.processingindiacoffee.databinding.ItemVegaIndiaCoffeeFgrnInventoryFilterBinding
import com.olam.warehouse.vegax.processingindiacoffee.utils.*
import java.util.*


class VegaIndiaCoffeeFgrnFilterFragment : BaseFragment() {

    private lateinit var binding: FragmentVegaIndiaCoffeeFgrnFilterBinding
    override val layoutResourceId = R.layout.fragment_vega_india_coffee_fgrn_filter
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaIndiaCoffeeFgrnFilterFragment().putArgs {
    ...
    override fun onCreateView(
        ...
        binding = FragmentVegaIndiaCoffeeFgrnFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<FilterList>) {
        binding.rvWhLocation.setUpAdapter(
            listFliterWhLoc,
            R.layout.item_vega_india_coffee_fgrn_inventory_filter,
            ItemVegaIndiaCoffeeFgrnInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
