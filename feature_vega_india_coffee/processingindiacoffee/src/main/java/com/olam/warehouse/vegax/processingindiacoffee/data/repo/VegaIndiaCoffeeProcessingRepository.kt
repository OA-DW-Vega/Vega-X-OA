package com.olam.warehouse.vegax.processingindiacoffee.data.repo
...
import com.olam.warehouse.vegax.processingindiacoffee.utils.prepareData

interface VegaIndiaCoffeeProcessingRepository {
    suspend fun getGrades(): LiveData<List<VegaMaterial>>
    suspend fun getStages(): LiveData<List<VegaProcessingStage>>
    suspend fun getBom(bomPostReq: VegaIndiaCoffeeProcessingRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>>

    suspend fun getStocks(material: String): LiveData<Resource<GenericReqAndResp<List<VegaCocoaRminLots>>>>
    suspend fun postCreatePo(bomPostReq: VegaIndiaCoffeeProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>>

    suspend fun getInventoryDetails(material: String): LiveData<Resource<GenericReqAndResp<VegaInventoryAndSyncModel>>>
    ...
    suspend fun postRminDetails(model: VegaIndiaCoffeeRminProcessingPost): LiveData<Resource<GenericReqAndResp<List<VegaIndiaCoffeeProcessingRminResponse>>>>
    ...
    suspend fun updateFgrnSequence(postData: NicaraguaUpdateFgrnSequencePost): LiveData<Resource<GenericReqAndResp<NicaraguaUpdateFgrnSequencePost>>>
...
class VegaIndiaCoffeeProcessingRepositoryImpl(
    ...
    override suspend fun getInventoryDetails(material: String): LiveData<Resource<GenericReqAndResp<VegaInventoryAndSyncModel>>> {
    ...
    override suspend fun getQualityParams(
        ...
        return object :
            NetworkOnlyBoundResource<GenericReqAndResp<List<VegaIndiaCoffeeInventoryStocks>>>() {
    ...
    override suspend fun postCreatePo(bomPostReq: VegaIndiaCoffeeProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>> {
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaFgrnProcessingOrder>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaFgrnProcessingOrder>> =
                api.getFgrnPoDetailsList(
                    VegaIndiaCoffeeProcessingOrderReq(
                        getCurrentKey(),
                        auart,
                        cfgNo,
                        fevor,
    ...
    override suspend fun getPoGrades(
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCocoaFgrnItemsGrades>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCocoaFgrnItemsGrades>> =
                api.getFgrnGrades(
                    VegaIndiaCoffeeProcessOrderDetailsPostReq(
                        getCurrentKey(),
                        getPlantDetails(),
                        poNo,
                        rmin
    ...
    override suspend fun postRminDetails(model: VegaIndiaCoffeeRminProcessingPost): LiveData<Resource<GenericReqAndResp<List<VegaIndiaCoffeeProcessingRminResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaIndiaCoffeeProcessingRminResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaIndiaCoffeeProcessingRminResponse>> =
    ...
    override suspend fun getRminWithLotList(
        ...
        bomNo: String,
        baseMaterialCode: String
    ) =  if(baseMaterialCode.isNotEmpty())dao.getRminWithLotList(cgfNo, poNo, bomNo, baseMaterialCode) else dao.getRminWithLotListWithoutMaterial(cgfNo, poNo, bomNo)
    ...
    override suspend fun updateFgrnSequence(postData: NicaraguaUpdateFgrnSequencePost): LiveData<Resource<GenericReqAndResp<NicaraguaUpdateFgrnSequencePost>>> {
            return object :
                NetworkOnlyBoundResource<GenericReqAndResp<NicaraguaUpdateFgrnSequencePost>>() {

                override suspend fun createCall(): GenericReqAndResp<NicaraguaUpdateFgrnSequencePost> =
    ...
    override suspend fun getSuppliers(purchaseOrgType: String?) =
        if (purchaseOrgType?.isNotEmpty() == true)  repo.getSuppliers(purchaseOrgType.toString()) else repo.getMaterials()
    ...
    override suspend fun getMaterialQualityGrades(materialCode: String) =
        if (materialCode.isNotEmpty()) repo.getMaterialQualityGrades(materialCode) else repo.getAllMaterialQualityGrades()

    override suspend fun getQualityGradesListWithDesc(): LiveData<List<QualitativeParams>> =
        repo.getQualityGradeDescList()

        override suspend fun getVendors() = repo.getMaterials()
