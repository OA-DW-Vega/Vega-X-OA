...
import com.olam.warehouse.vegax.weighment.databinding.FragmentVegaIndiaCoffeeTruckoutWblistBinding
import com.olam.warehouse.vegax.weighment.databinding.ItemVegaIndiaCoffeeTruckoutWbListBinding
...
class VegaIndiaCoffeeTruckOutWBListFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaIndiaCoffeeTruckoutWblistBinding
    override val layoutResourceId = R.layout.fragment_vega_india_coffee_truckout_wblist

    companion object {
        fun newInstance(receivingData: VegaReceiving) = VegaIndiaCoffeeTruckOutWBListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaIndiaCoffeeTruckoutWblistBinding.inflate(layoutInflater)
        return binding.root
    }
...
//                                        .filter { wb -> !wb.qcStatus.equals("") }
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_india_coffee_truckout_wb_list,
            ItemVegaIndiaCoffeeTruckoutWbListBinding::inflate,
            { it, pos, bindItem ->
                ...
                //item.bagType=receivingData.bagType
