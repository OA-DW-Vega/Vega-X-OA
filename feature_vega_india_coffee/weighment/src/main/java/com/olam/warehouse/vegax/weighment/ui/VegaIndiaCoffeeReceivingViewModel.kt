...
import com.olam.warehouse.vegax.weighment.utils.getLineItemFromReceiving
import kotlinx.coroutines.launch
import kotlinx.coroutines.withContext
import java.math.BigDecimal

class VegaIndiaCoffeeReceivingViewModel(
    private val useCaseIndiaCoffee: VegaIndiaCoffeeReceivingUseCase,
    private val dispatchers: AppDispatchers
) :
    BaseViewModel() {

    private var receiveSource: LiveData<Resource<GenericReqAndResp<VegaIndiaCoffeeReceivingResponse>>> =
        MutableLiveData()
    ...
    private val _receive = MediatorLiveData<Resource<GenericReqAndResp<VegaIndiaCoffeeReceivingResponse>>>()
    ...
    val receive: LiveData<Resource<GenericReqAndResp<VegaIndiaCoffeeReceivingResponse>>> get() = _receive
    ...
    private fun getWeighBridgeDetail() = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            weightBridgeSource = useCaseIndiaCoffee.getWeighBridgeDetailOnline()
        }
    ...
    fun getPreSamplingQualitydata(batchNo: String, materialId: String) = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            qualityPreSamplingSource = useCaseIndiaCoffee.getPreSamplingQualityList(batchNo, materialId)
        }
    ...
    fun getQualityParams(materialId: String, isValueExist: Boolean?, wbId: String?) =
            viewModelScope.launch(dispatchers.main) {
                ...
                withContext(dispatchers.io) {
                    qualityGetSource = useCaseIndiaCoffee.getQualityParams(materialId, isValueExist, wbId)
                }
    ...
    fun getLocations() = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            locationSource = useCaseIndiaCoffee.getLocations()
        }
    ...
    fun postReceivingData(
        indiaCoffeeReceivingData: VegaIndiaCoffeeReceivingPost
    ) = viewModelScope.launch(dispatchers.main) {
        _receive.removeSource(receiveSource) // We make sure there is only one source of livedata (allowing us properly refresh)
        withContext(dispatchers.io) {
            receiveSource = useCaseIndiaCoffee.postReceivingDetail(indiaCoffeeReceivingData)
        }
    ...
    fun postReceivingMtnData(indiaCoffeeReceivingData: VegaIndiaCoffeeReceivingPost) =
        viewModelScope.launch(dispatchers.main) {
            _receive.removeSource(receiveSource) // We make sure there is only one source of livedata (allowing us properly refresh)
            withContext(dispatchers.io) {
                receiveSource = useCaseIndiaCoffee.postReceivingMtnDetail(indiaCoffeeReceivingData)
            }
            _receive.addSource(receiveSource) {
                _receive.value = it
            }
    ...
    fun saveReceiving(receivingData: VegaReceiving) = viewModelScope.launch(dispatchers.main) {
        withContext(dispatchers.io) {
            useCaseIndiaCoffee.saveReceiving(receivingData)
        }
    }
    ...
    fun getReceiving() = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            receiveLocalSource = useCaseIndiaCoffee.getReceiving()
        }
    ...
    fun getReceivingWithLineItem() = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            receiveWithLineItemLocalSource = useCaseIndiaCoffee.getReceivingWithLineItem()
        }
    ...
    fun getWarehouses() = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            warehouseSourceLocal = useCaseIndiaCoffee.getWarehouses()
        }
    ...
    fun getWarehousesWithMtns(whID: String) = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            warehouseWithMtnsSource = useCaseIndiaCoffee.getWarehousesWithMtns(whID)
        }
    ...
    fun fetchWarehouseWithMtns() = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            warehouseSource = useCaseIndiaCoffee.fetchWarehouseWithMtns()
        }
    ...
    fun saveWarehouseWithMtns(it: VegaReceivingMtnWrapper) = viewModelScope.launch(dispatchers.main) {
        withContext(dispatchers.io) {
            useCaseIndiaCoffee.saveWarehouseWithMtns(it)
        }
    }
    ...
    fun saveReceivingLineItems(postData: MutableList<VegaReceiving>) = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            useCaseIndiaCoffee.saveReceivingLineItems(lineItems)
        }
    }

    fun updateDeletedItem(wbId: String?, txnId: String?) = viewModelScope.launch(dispatchers.main) {
        withContext(dispatchers.io) {
            wbId?.let { useCaseIndiaCoffee.updateDeletedItem(it, txnId) }
        }
    }
    ...
    fun updateReceivingFailMsg(msg: String, tmpWbId: String) = viewModelScope.launch(dispatchers.main) {
        withContext(dispatchers.io) {
            useCaseIndiaCoffee.updateReceivingFailMsg(msg, tmpWbId)
        }
    }
    ...
    fun getTruckInWeighBridgeDetail() = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            truckInWeightBridgeSource = useCaseIndiaCoffee.getTruckInWeighBridgeDetailOnline()
        }
    ...
    fun getWeighBridgeIdDetail(wbid: String) = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            weighBridgeIdSource = useCaseIndiaCoffee.getWeighBridgeIdDetail(wbid)
        }
