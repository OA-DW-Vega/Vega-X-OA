...
import com.olam.warehouse.vegax.weighment.databinding.ItemVegaIndiaCoffeeTruckinWbListBinding
...
class VegaIndiaCoffeeTruckInListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            receiving.asReversed(), R.layout.item_vega_india_coffee_truckin_wb_list,
            ItemVegaIndiaCoffeeTruckinWbListBinding::inflate,
            { it, pos, bindItem ->
