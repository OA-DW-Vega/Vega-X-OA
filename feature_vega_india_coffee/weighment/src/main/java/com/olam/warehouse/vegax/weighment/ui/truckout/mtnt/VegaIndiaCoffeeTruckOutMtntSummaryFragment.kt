...
import kotlinx.android.synthetic.main.item_vega_india_coffee_bag_summary_details.view.*
...
//        mtntData.tmpWbId = wbId ?: ""
    ...
    private fun setBagDetails(data: MutableList<VegaMtnt>?) {
        binding.rvBagDetailSummary.setUp(data!!, R.layout.item_vega_india_coffee_bag_summary_details, { it, pos ->
