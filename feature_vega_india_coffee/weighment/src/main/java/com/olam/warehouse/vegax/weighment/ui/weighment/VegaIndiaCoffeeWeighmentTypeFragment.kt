package com.olam.warehouse.vegax.weighment.ui.weighment
...
import com.olam.warehouse.vegax.weighment.databinding.FragmentVegaIndiaCoffeeWeighmentTypeBinding
import com.olam.warehouse.vegax.weighment.utils.*
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper


class VegaIndiaCoffeeWeighmentTypeFragment : BaseFragment() {

    private val mTAG = VegaIndiaCoffeeWeighmentTypeFragment::class.java.canonicalName
    private lateinit var binding: FragmentVegaIndiaCoffeeWeighmentTypeBinding
    ...
    override val layoutResourceId = R.layout.fragment_vega_india_coffee_weighment_type

    companion object {
        fun newInstance() = VegaIndiaCoffeeWeighmentTypeFragment().putArgs {
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaIndiaCoffeeWeighmentTypeBinding.inflate(layoutInflater)
        return binding.root
    }
