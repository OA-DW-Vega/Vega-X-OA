...
import com.olam.warehouse.vegax.weighment.databinding.FragmentVegaIndiaCoffeeTruckoutMtntWblistBinding
import com.olam.warehouse.vegax.weighment.databinding.ItemVegaIndiaCoffeeTruckoutMtntWbListBinding
...
import com.olam.warehouse.vegax.weighment.utils.TRUCKOUT_MTNT_ADD_WEIGHT_FRAG
import com.olam.warehouse.vegax.weighment.utils.getColor
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaIndiaCoffeeTruckOutMtntWBListFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaIndiaCoffeeTruckoutMtntWblistBinding
    override val layoutResourceId = R.layout.fragment_vega__india_coffee_truckout_mtnt_wblist

    companion object {
        fun newInstance(mtntData: VegaMtnt) = VegaIndiaCoffeeTruckOutMtntWBListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaIndiaCoffeeTruckoutMtntWblistBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(data: List<VegaMtnt>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_india_coffee_truckout_mtnt_wb_list,
            ItemVegaIndiaCoffeeTruckoutMtntWbListBinding::inflate,
            { it, pos, bindItem ->
