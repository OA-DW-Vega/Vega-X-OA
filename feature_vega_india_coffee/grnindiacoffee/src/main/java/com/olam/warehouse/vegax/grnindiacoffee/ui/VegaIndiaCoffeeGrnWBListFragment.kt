...
import com.olam.warehouse.vegax.grnindiacoffee.databinding.FragmentVegaIndiaCoffeeGrnWeighbridgeListBinding
import com.olam.warehouse.vegax.grnindiacoffee.databinding.ItemVegaIndiaCoffeeWeighbridgeGrnBinding
...
class VegaIndiaCoffeeGrnWBListFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaIndiaCoffeeGrnWeighbridgeListBinding
    private var callBack: CallBack? = null
    override val layoutResourceId = R.layout.fragment_vega_india_coffee_grn_weighbridge_list
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaIndiaCoffeeGrnWeighbridgeListBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(data: List<VegaGrnWeighBridgeId>?) {
        ...
        binding.rvWeighBridgeId.setUpAdapter(
            ...
            R.layout.item_vega_india_coffee_weighbridge_grn,
            ItemVegaIndiaCoffeeWeighbridgeGrnBinding::inflate,
            { it, pos, bindItem ->
