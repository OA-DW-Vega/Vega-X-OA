package com.olam.warehouse.vegax.grnindiacoffee.ui.offline
...
import com.olam.warehouse.vegax.grnindiacoffee.databinding.FragmentVegaIndiaCoffeeGrnOfflineBinding
import com.olam.warehouse.vegax.grnindiacoffee.databinding.ItemVegaIndiaCoffeeGrnOfflineBinding
...
class VegaIndiaCoffeeGrnOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_india_coffee_grn_offline
    private val vm: VegaIndiaCoffeeGrnViewModel by viewModel()
    private lateinit var binding: FragmentVegaIndiaCoffeeGrnOfflineBinding
    private var grnList = arrayListOf<VegaGrnWeighBridgeId>()
    private var callBack: CallBack? = null

    companion object {
        fun newInstance() = VegaIndiaCoffeeGrnOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaIndiaCoffeeGrnOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaGrnWeighBridgeId>) {
        ...
        binding.rvOfflineGrn.setUpAdapter(
            grnList,
            R.layout.item_vega_india_coffee_grn_offline,
            ItemVegaIndiaCoffeeGrnOfflineBinding::inflate,
            { it, pos, bindItem ->
