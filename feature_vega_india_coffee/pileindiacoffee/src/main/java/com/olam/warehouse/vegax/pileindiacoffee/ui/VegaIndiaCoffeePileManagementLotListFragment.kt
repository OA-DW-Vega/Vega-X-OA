...
import kotlinx.android.synthetic.main.item_india_coffee_pile_management_lot_list_card.view.*
...
class VegaIndiaCoffeePileManagementLotListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUp(data, R.layout.item_india_coffee_pile_management_lot_list_card, { it, pos ->
