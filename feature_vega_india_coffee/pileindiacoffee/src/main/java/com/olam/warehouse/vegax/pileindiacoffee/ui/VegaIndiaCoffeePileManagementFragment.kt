...
import com.olam.warehouse.vegax.pileindiacoffee.databinding.ItemIndiaCoffeePileManagementBinding
...
class VegaIndiaCoffeePileManagementFragment : BaseFragment(), VegaSingleSelectListener {
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUpAdapter(
            lots,
            R.layout.item_india_coffee_pile_management,
            ItemIndiaCoffeePileManagementBinding::inflate,
            { item, pos, bindItem ->
