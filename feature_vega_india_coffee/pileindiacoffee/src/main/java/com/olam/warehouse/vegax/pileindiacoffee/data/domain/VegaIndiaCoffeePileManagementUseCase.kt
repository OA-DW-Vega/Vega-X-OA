package com.olam.warehouse.vegax.pileindiacoffee.ui.data.domain
...
class VegaIndiaCoffeePileManagementUseCase(private val repository: VegaIndiaCoffeePileManagementRepository) {
