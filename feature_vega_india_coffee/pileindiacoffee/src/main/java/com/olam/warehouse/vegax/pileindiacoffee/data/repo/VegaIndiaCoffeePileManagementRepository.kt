package com.olam.warehouse.vegax.pileindiacoffee.ui.data.repo
...
import com.olam.warehouse.vegax.pileindiacoffee.ui.data.domain.model.*
import java.util.*

interface VegaIndiaCoffeePileManagementRepository {
...
class VegaIndiaCoffeePileManagementRepositoryImpl(
    private val api: VegaIndiaCoffeePileManagementApi,
    private val dao: VegaCoffeeDispatchDao

) : VegaIndiaCoffeePileManagementRepository {
