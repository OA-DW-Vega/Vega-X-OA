...
import kotlinx.android.synthetic.main.item_india_coffee_pile_management_summary.view.*
...
class VegaIndiaCoffeePileManagementSummaryFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLotList.setUp(data, R.layout.item_india_coffee_pile_management_summary, { it, pos ->
