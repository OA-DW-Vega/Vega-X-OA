...
import kotlinx.android.synthetic.main.item_vega_india_coffee_pile_filter_.view.*
import java.util.*
...
class VegaIndiaCoffeePileFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<CoffeeFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_india_coffee_pile_filter_, { it, pos ->
