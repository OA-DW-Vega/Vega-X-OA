package com.olam.warehouse.vegax.offloadingindiacoffee.data.domain.usecase
...
class VegaIndiaCoffeeOffloadingUseCase(private val repository: VegaOffloadingRepository) {
    ...
    suspend fun postQuality(qualityPost: VegaIndiaCoffeeOffloadingQualityPost) = repository.postQuality(qualityPost)
