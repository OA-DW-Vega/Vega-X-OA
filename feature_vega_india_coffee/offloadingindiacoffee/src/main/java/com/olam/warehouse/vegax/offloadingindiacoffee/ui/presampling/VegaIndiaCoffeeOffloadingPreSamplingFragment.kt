...
import kotlinx.android.synthetic.main.fragment_vega_india_coffee_offloading_presampling.*
        ...
        binding.tvAcceptedBags.onChange {
            try {
                if ((binding.tvAcceptedBags.text.toString().isEmpty()) && (binding.tvDamagedBags.text.toString().isEmpty()))
                {
                    ...
                    val acceptedBagsValue = tvAcceptedBags.text.toString()
                    val damagedBagsValue = tvDamagedBags.text.toString()
