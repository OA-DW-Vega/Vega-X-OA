...
@Parcelize
data class VegaIndiaCoffeePpqInspectionLots(
...
@Parcelize
data class VegaIndiaCoffeePpqInspectionLotDetails(
    var inspectionLotNum: String = "",
    var materialCode: String = "",
    var plantId: String = "",
    var inspectionOperationNum: String = "",
    var usageDecision: Boolean = false,
    var qualityParameters: List<VegaIndiaCoffeePpqInspectionLotParams> = emptyList()
) : Parcelable

@Parcelize
data class VegaIndiaCoffeePpqInspectionLotParams(
    var charDesc: String = "",
    var formula: String = "",
