...
import com.olam.warehouse.vegax.ppqindiacoffee.databinding.ItemVegaIndiaCoffeePpqLotDetailsBinding
...
//                materialIdList.addAll(list.map { "000000".plus(it.materialCode) })
    ...
    private fun setUpAdapter(lotList: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvInspectiontLots.setUpAdapter(
            lotList,
            R.layout.item_vega_india_coffee_ppq_lot_details,
            ItemVegaIndiaCoffeePpqLotDetailsBinding::inflate,
            { it, pos, bindItem ->
