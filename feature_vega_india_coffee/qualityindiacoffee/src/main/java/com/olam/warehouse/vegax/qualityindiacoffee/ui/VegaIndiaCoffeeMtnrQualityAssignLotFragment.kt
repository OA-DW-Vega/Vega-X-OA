...
import kotlinx.android.synthetic.main.item_vega_india_coffee_mtnr_lot.view.*
...
//                binding.tvBatchDefault.gone()
    ...
    private fun updateAdapter(stockList: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvInventoryLot.setUp(stockList, R.layout.item_vega_india_coffee_mtnr_lot, { it, pos ->
            ivDelete.gone()
            tvLotNoValue.text = it.batchNumber
//            tvWeightValue.text = it.weight.plus(" ").plus(it.unitOfMeasure)
            tvWeightValue.text = it.weight.plus(" ").plus("KG")
