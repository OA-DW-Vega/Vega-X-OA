...
import kotlinx.android.synthetic.main.item_vega_india_coffee_mtnr_inventory_filter.*
import java.util.*
...
class VegaIndiaCoffeeMtnrFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<IndiaCoffeeFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_india_coffee_mtnr_inventory_filter, { it, pos ->
