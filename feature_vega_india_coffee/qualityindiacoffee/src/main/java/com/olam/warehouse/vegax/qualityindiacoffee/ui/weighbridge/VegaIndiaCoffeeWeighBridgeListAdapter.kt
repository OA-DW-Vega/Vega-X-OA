...
import kotlinx.android.synthetic.main.item_vega_india_coffee_quality_weigh_bridge_details.view.*
        ...
        fun bindItems(weighbridge: VegaQualityWBDetails?) {
            weighbridge?.let {
                ...
                if (it.weighBridgeType == PROCURE) {
                    ...
                    itemView.tvSupplierName.text = it.supplierCode.plus("-").plus(it.supplierName)
                } else {
