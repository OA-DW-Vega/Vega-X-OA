package com.olam.warehouse.vegax.dispatchindiacoffee.ui.truck
...
import com.olam.warehouse.vegax.dispatchindiacoffee.databinding.FragmentVegaDispatchTruckListBinding
import com.olam.warehouse.vegax.dispatchindiacoffee.databinding.ItemVegaDispatchTruckListBinding
import com.olam.warehouse.vegax.dispatchindiacoffee.ui.VegaDispatchViewModel
import com.olam.warehouse.vegax.dispatchindiacoffee.utils.DIRECTION
import com.olam.warehouse.vegax.dispatchindiacoffee.utils.DISPATCH_PROCESS
import com.olam.warehouse.vegax.dispatchindiacoffee.utils.getColor
...
class VegaDispatchTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaDispatchTrucks>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            dispatch1.asReversed(),
            R.layout.item_vega_dispatch_truck_list,
            ItemVegaDispatchTruckListBinding::inflate,
            { it, pos, bindItem ->
