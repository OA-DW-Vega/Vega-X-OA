...
import com.olam.warehouse.vegax.dispatchindiacoffee.databinding.ItemVegaDispatchLotsDetailsBinding
    ...
    private fun setUpAdapter(selectedStocks: List<VegaDispatchLots>) {
        ...
        binding.rvLots.setUpAdapter(
            ...
            { it, pos, bindItem ->
                ...
                bindItem.etDispatchWeight.setText(it.editedWeight, TextView.BufferType.EDITABLE)
                bindItem.tvKor.text = it.kor
//            tvOrigin.text = it.region
                bindItem.tvOrigin.text = it.storageLocationCode
                bindItem.ivDeleteData.setOnClickListener { view -> showItemDeleteDialog(it) }
                bindItem.etDispatchWeight.onChange { text ->
                ...
                bindItem.etDispatchWeight.onRightDrawableClicked { item -> item.text.clear() }
            }, {
                val item = this
