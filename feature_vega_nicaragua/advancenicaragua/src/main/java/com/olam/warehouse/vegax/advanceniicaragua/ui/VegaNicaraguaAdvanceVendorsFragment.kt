...
import kotlinx.android.synthetic.main.item_vega_nicargua_advance_vendor.view.*
...
class VegaNicaraguaAdvanceVendorsFragment : BaseFragment() {
    ...
    private fun initUI() {
        ...
        vm.supplier.observe(this, Observer {
            supplierList =it.toMutableList().filter { it.vendorCode.startsWith("1") } as ArrayList<VegaVendor>
