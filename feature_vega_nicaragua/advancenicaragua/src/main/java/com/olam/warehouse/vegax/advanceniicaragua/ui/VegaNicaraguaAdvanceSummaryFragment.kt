        ...
        arguments?.let {
            ...
            if (it.getBoolean(UIUtils.FROM_TRANSACTION,false))
            {
                ...
                if(!receiveData.documentNumber.isNullOrEmpty())
                {
                    ...
                    binding.cashJournalNumberLayout.isVisible = receiveData.documentNumber!= receiveData.accountingNumber

                    binding.tvAccountingNumber.text = receiveData.accountingNumber
                    binding.tvCashJournalNumber.text= receiveData.documentNumber
                }
