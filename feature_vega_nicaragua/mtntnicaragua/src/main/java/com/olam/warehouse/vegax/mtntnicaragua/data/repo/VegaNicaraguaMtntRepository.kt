...
interface VegaNicaraguaMtntRepository {
    ...
    suspend fun postNicMtntWSDeliveryDetails(vegaNicMtntDeliveryPost: VegaNicMtntDeliveryPost): LiveData<Resource<GenericReqAndResp<List<VegaNicMtntDeliveryDetail>>>>
    ...
    suspend fun getGrnPrintDetails(): LiveData<Resource<GenericReqAndResp<List<VegaNicaraguaMtnt>>>>
    suspend fun getOfflineLotDetails(lotId: String, materialCode: String): List<VegaNicaraguaGRNInventoryDetails>
...
class VegaNicaraguaMtntRepositoryImpl(private val api: VegaNicaraguaMtntApi, private val dao: VegaNicaraguaMtntDao) :
    ...
    override suspend fun getGrnPrintDetails(): LiveData<Resource<GenericReqAndResp<List<VegaNicaraguaMtnt>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaNicaraguaMtnt>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaNicaraguaMtnt>> =
                api.getReprintDetailsForMtnt(true, getCurrentKey())
