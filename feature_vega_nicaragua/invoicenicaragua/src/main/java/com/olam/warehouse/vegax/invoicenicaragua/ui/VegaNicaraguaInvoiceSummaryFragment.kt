...
import com.olam.warehouse.vegax.invoicenicaragua.databinding.ItemVegaNicaraguaInvoiceAdvanceBinding
...
class VegaNicaraguaInvoiceSummaryFragment : BaseFragment(),
    ...
    private fun setPriceDetails() {
        ...
        binding.basePriceEt.text = formatString(grnData.basePrice!!)
    ...
    private fun setAdvanceLinesAdapter(data: List<VegaNicaraguaAdvanceLineItemGrn>) {
        ...
        binding.advanceLineItems.setUpAdapter(
            data.toMutableList(),
            R.layout.item_vega_nicaragua_invoice_advance,
            ItemVegaNicaraguaInvoiceAdvanceBinding::inflate,
            { it, pos, bindItem ->
                ...
                bindItem.tvTotalAmt.text = it.amount
