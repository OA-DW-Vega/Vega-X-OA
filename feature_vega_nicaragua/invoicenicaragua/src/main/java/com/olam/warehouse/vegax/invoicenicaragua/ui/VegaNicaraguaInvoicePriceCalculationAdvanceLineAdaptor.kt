...
import com.olam.warehouse.vegax.invoicenicaragua.databinding.ItemVegaNicaraguaInvoiceAdvanceLineBinding
import java.util.*
import kotlin.collections.ArrayList


class VegaNicaraguaInvoicePriceCalculationAdvanceLineAdaptor(var ctx: Context, var list: List<AdvanceLineItemDetails>) :
    RecyclerView.Adapter<VegaNicaraguaInvoicePriceCalculationAdvanceLineAdaptor.VegaNicaraguaInvoicePriceCalculationAdvanceLineViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): VegaNicaraguaInvoicePriceCalculationAdvanceLineViewHolder {
        return VegaNicaraguaInvoicePriceCalculationAdvanceLineViewHolder(
            ItemVegaNicaraguaInvoiceAdvanceLineBinding.inflate(
    ...
    override fun onBindViewHolder(holder: VegaNicaraguaInvoicePriceCalculationAdvanceLineViewHolder, position: Int) {
        ...
        holder.binding.tvAdvanceAmount.text = model.amount
        ...
        holder.binding.EtCurrecncyDevaluation.setText(model.legalExpenseAmount)
    ...
    inner class VegaNicaraguaInvoicePriceCalculationAdvanceLineViewHolder(bind: ItemVegaNicaraguaInvoiceAdvanceLineBinding) :
