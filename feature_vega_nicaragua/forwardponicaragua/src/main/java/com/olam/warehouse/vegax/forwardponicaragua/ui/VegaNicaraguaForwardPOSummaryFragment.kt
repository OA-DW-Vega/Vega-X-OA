...
import com.olam.warehouse.vegax.forwardponicaragua.databinding.ItemVegaNicaraguaForwardPoSummaryYieldBinding
import com.olam.warehouse.vegax.forwardponicaragua.work.getPOLotSequnceOneTimeRequestWorker
import com.olam.warehouse.vegax.forwardponicaragua.utils.covertToDouble
...
//            if(!UIUtils.FILTEREDPRICEDETAILS.isNullOrEmpty())
            filteredPriceDetails=it.getParcelableArrayList<VegaNicaraguaGrnPriceDetails>(UIUtils.FILTEREDPRICEDETAILS)?: ArrayList<VegaNicaraguaGrnPriceDetails>()
        }
    }
  ...
  fun  prepareofflinedata():VegaNicaraguaForwardPoPost
    ...
    private fun setYieldInformation()
    {
        binding.yieldDetails.setOnClickListener(View.OnClickListener {
            if (binding.yieldDetailsLayout.isVisible) {
                ...
                binding.yieldDetails.setCompoundDrawablesWithIntrinsicBounds(
                    0,
                    0,
                    R.drawable.ic_baseline_expand_more_24,
                    0
        ...
        binding.rvYield.setUpAdapter(filteredPriceDetails,
            R.layout.item_vega_nicaragua_forward_po_summary_yield,
            ItemVegaNicaraguaForwardPoSummaryYieldBinding::inflate,
            { it, pos, bindItem ->
                bindItem.description.text = it.description
                bindItem.value.text = it.price!!.trim()
            })
    ...
    private fun setTransactionInformation()
    {
        ...
        binding.tvQualityGrade.text =  receivingData.grade+ "-" + receivingData.qualityGradeDesc
    }
