...
import kotlinx.android.synthetic.main.fragment_vega_nicaragua_grn_weighment.view.clBagHead
import kotlinx.android.synthetic.main.fragment_vega_nicaragua_grn_weighment.view.ivEdit
import kotlinx.android.synthetic.main.item_vega_nicaragua_weighment_summary_bag.view.*
...
class VegaNicaraguaGrnSpotWeighment : BaseFragment() {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaNicaraguaWeighmentBagMaterial>) {
        if (bagList.size > 0) {
            ...
            binding.rvWeight.setUp(bagList, R.layout.item_vega_nicaragua_grn_supplier_bag, { it, pos ->
                if (pos % 2 == 0) {
