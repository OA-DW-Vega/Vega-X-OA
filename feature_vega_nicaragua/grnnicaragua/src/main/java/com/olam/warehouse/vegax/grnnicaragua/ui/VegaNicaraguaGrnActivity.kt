...
class VegaNicaraguaGrnActivity : HomeBaseActivity(), VegaNicaraguaGrnTypeFragment.CallBack,
    ...
    VegaNicaraguaGrnFixedTransactionDetails.CallBack, VegaTrackTraceListener {
    ...
    override fun replaceFragment(grnType: String) {
        when (grnType) {
            GRN_SPOT -> displayFragment(
                VegaNicaraguaGrnSpotTransactionDetails.newInstance(grnType, VegaReceiving(), procurementType, complaintType),
                true
            )
            ...
            GRN_FIXED -> displayFragment(
                VegaNicaraguaGrnFixedTransactionDetails.newInstance(grnType, VegaReceiving(), procurementType, complaintType),
                true
            )
        }
    }
