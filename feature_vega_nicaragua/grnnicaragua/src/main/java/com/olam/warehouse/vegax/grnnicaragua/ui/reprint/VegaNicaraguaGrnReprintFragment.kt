...
import kotlinx.android.synthetic.main.item_vega_nicaragua_grn_reprint.view.*
...
//            setupAdapter(grnList)
    ...
    private fun setupAdapter(itemList: MutableList<VegaReceiving>) {
        ...
        binding.rvTransaction.setUp(itemList, R.layout.item_vega_nicaragua_grn_reprint, { it, pos ->
