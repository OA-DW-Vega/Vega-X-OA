...
import com.olam.warehouse.vegax.inventorynicaragua.databinding.ItemVegaNicInventoryFilterLayoutBinding
...
class VegaNicInventoryFilterFragment : BaseFragment() {
    ...
    private fun setStLocationAdapter(data: MutableList<FilterList>) {
        binding.rvStorageLoc.setUpAdapter(
            data,
            R.layout.item_vega_nic_inventory_filter_layout,
            ItemVegaNicInventoryFilterLayoutBinding::inflate,
            { item, pos, bindItem ->
                bindItem.tvInventoryFilter.text = getMaterialName(item.value)
                bindItem.tvInventoryFilter.setOnClickListener {
                    item.isSelected = !item.isSelected
                    binding.rvStorageLoc.adapter?.notifyItemChanged(pos)
                }
                ViewCompat.setBackground(
                    bindItem.tvInventoryFilter,
                    ContextCompat.getDrawable(
                        bindItem.main.context,
    ...
    private fun setCertificationAdapter(data: MutableList<FilterList>) {
        binding.rvCertification.setUpAdapter(
            data,
            R.layout.item_vega_nic_inventory_filter_layout,
            ItemVegaNicInventoryFilterLayoutBinding::inflate,
            { item, pos, bindItem ->
                ...
                bindItem.tvInventoryFilter.setOnClickListener {
                    item.isSelected = !item.isSelected
                    binding.rvCertification.adapter?.notifyItemChanged(pos)
                }
                ViewCompat.setBackground(
                    bindItem.tvInventoryFilter,
                    ContextCompat.getDrawable(
    ...
    private fun setQualityGradeFilter(data: MutableList<FilterList>) {
        binding.rvQualityGrade.setUpAdapter(
            data,
            R.layout.item_vega_nic_inventory_filter_layout,
            ItemVegaNicInventoryFilterLayoutBinding::inflate,
            { item, pos, bindItem ->
                ...
                bindItem.tvInventoryFilter.setOnClickListener {
                    item.isSelected = !item.isSelected
                    binding.rvQualityGrade.adapter?.notifyItemChanged(pos)
                }
                ViewCompat.setBackground(
                    bindItem.tvInventoryFilter,
                    ContextCompat.getDrawable(
    ...
    private fun setMaterialFilter(data: MutableList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            ...
            { item, pos, bindItem ->
                ...
                bindItem.tvInventoryFilter.setOnClickListener {
                    item.isSelected = !item.isSelected
                    binding.rvMaterial.adapter?.notifyItemChanged(pos)
                }
                ViewCompat.setBackground(
                    bindItem.tvInventoryFilter,
                    ContextCompat.getDrawable(
