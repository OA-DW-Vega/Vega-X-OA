...
import kotlinx.android.synthetic.main.item_vega_nic_inventory_child.view.*
import kotlinx.android.synthetic.main.item_vega_nic_material_details.view.*
...
class VegaNicInventoryParentAdapter(
    ...
    override fun onBindViewHolder(holder: ParentViewHolder, position: Int) {
        ...
        holder.itemView.rv_material.setUp(materialsList, R.layout.item_vega_nic_material_details, { it, pos ->
            tvWeightValue.text =
                if (it.totalWeight.isNotEmpty()) it.totalWeight.toDouble().formatThreeDigits().plus(it.uom) else ""
            tvQualityValue.text = it.qualityGrade
