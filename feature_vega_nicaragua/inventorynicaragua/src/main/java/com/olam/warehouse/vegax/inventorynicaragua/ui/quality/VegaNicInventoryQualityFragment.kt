...
import kotlinx.android.synthetic.main.item_vega_nic_quality_details.view.*
...
class VegaNicInventoryQualityFragment : BaseFragment() {
    ...
    private fun setUpAdapter(qualityParameters: List<QualityParams>) {
        binding.rvQuality.setUp(qualityParameters as MutableList, R.layout.item_vega_nic_quality_details, { it, pos ->
            if (pos % 2 == 0) {
