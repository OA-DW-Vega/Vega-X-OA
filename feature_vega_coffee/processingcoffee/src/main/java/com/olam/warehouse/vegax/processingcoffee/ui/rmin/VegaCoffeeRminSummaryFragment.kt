...
import kotlinx.android.synthetic.main.item_rmin_material_summary.view.*
import kotlinx.android.synthetic.main.item_summary_lot.view.*
...
class VegaCoffeeRminSummaryFragment : BaseFragment() {
    ...
    private fun initGradeList() {
        ...
        binding.rvMaterialList.setUp(grade, R.layout.item_rmin_material_summary, { it, pos ->
    ...
    private fun setupAdapter() {
        ...
        binding.rvLotList.setUp(list, R.layout.item_summary_lot, { it, pos ->
            ...
            tvScaleWeightValue.text = weight.plus(" ").plus(it.unitOfMeasure)
