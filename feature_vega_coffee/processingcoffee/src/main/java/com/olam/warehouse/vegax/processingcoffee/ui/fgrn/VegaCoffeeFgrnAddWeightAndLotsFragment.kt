...
import com.olam.warehouse.vegax.processingcoffee.databinding.FragmentVegaCoffeeFgrnAddWeightAndLotsBinding
...
class VegaCoffeeFgrnAddWeightAndLotsFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_coffee_fgrn_add_weight_and_lots
    private lateinit var binding: FragmentVegaCoffeeFgrnAddWeightAndLotsBinding
    ...
    companion object {
        fun newInstance(
            ...
            id: String,
            isEdit: Boolean
        ) = VegaCoffeeFgrnAddWeightAndLotsFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCoffeeFgrnAddWeightAndLotsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcoffee/ui/fgrn/VegaCoffeeFgrnAddWeightAndLotsFragment")
            .title("IVC/Coffee/Processing/FGRN Add Weight and Lot")
            .with(tracker)
    }
