...
import com.olam.warehouse.vegax.processingcoffee.databinding.FragmentInventoryLotListBinding
import com.olam.warehouse.vegax.processingcoffee.databinding.ItemInventoryLotBinding
import com.olam.warehouse.vegax.processingcoffee.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.processingcoffee.utils.MULTIPLE_LOT
import com.olam.warehouse.vegax.processingcoffee.utils.getColor
import com.olam.warehouse.vegax.processingcoffee.utils.listOfField
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCoffeeRMINLotListFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_inventory_lot_list
    private lateinit var binding: FragmentInventoryLotListBinding
    ...
    private var listener: CoffeeAddLotsListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        listener = context as? CoffeeAddLotsListener
    }
    ...
    companion object {
        fun newInstance(
            ...
            VegaCoffeeRMINLotListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentInventoryLotListBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcoffee/ui/rmin/VegaCoffeeRMINAddLotFragment")
            .title("IVC/Coffee/Processing/RMIN Lot List")
            .with(tracker)
    }
    ...
    private fun setupAdapter(data: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_inventory_lot,
            ItemInventoryLotBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter =
            ArrayAdapter(requireContext(), R.layout.item_vega_coffee_processing_rmin_grade, wareHouseList)
