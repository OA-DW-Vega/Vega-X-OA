...
class VegaCoffeeFgrnGradesFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(model: VegaCoffeeFgrnItems, id: String) = VegaCoffeeFgrnGradesFragment().putArgs {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcocoa/ui/fgrn/VegaCocoaFgrnGradesFragment").title("IVC/Coffee/Processing/FGRN Grades")
            .with(tracker)
    }
