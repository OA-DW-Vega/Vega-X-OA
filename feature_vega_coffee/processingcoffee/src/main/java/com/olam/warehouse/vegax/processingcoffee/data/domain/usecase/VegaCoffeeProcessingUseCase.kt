package com.olam.warehouse.vegax.processingcoffee.data.domain.usecase
...
import com.olam.warehouse.vegax.processingcoffee.data.domain.model.VegaCoffeeProcessingRminBomPost
import com.olam.warehouse.vegax.processingcoffee.data.repo.VegaCoffeeProcessingRepository

class VegaCoffeeProcessingUseCase(val repository: VegaCoffeeProcessingRepository) {
    suspend fun getGrades() = repository.getGrades()
    suspend fun getStages() = repository.getStages()
    suspend fun getBom(bomPostReq: VegaCoffeeProcessingRminBomPost) =
    ...
    suspend fun postRminDetails(model: VegaCoffeeProcessingFgrnPost) = repository.postRminDetails(model)
    ...
    suspend fun postFgrnDetails(poReq: VegaCoffeeProcessingFgrnPost) = repository.postFgrnDetails(poReq)
    ...
    suspend fun postCreatePo(bomPostReq: VegaCoffeeProcessingCreatePoReq) = repository.postCreatePo(bomPostReq)
