...
import kotlinx.android.synthetic.main.item_vega_coffee_bag_consump_summary.view.*
import kotlinx.android.synthetic.main.item_vega_coffee_fgrn_summary.view.*
...
class VegaCoffeeFgrnSummaryFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcoffee/ui/fgrn/VegaCoffeeFgrnSummaryFragment").title("Processing Coffee")
            .with(tracker)
    }
    ...
    private fun updateAdapter(gradeItems: List<VegaCoffeeFgrnGradesWithBagItems>) {
        ...
        binding.rvFgrnSummary.setUp(gradeItems as MutableList, R.layout.item_vega_coffee_fgrn_summary, { it, pos ->
    ...
    private fun updateBagConsumptionAdapter(bagConsumpList: ArrayList<VegaCocoaFgrnBagCosumption>) {
        ...
        binding.rvBagConsumption.setUp(bagConsumpList, R.layout.item_vega_coffee_bag_consump_summary, { it, pos ->
