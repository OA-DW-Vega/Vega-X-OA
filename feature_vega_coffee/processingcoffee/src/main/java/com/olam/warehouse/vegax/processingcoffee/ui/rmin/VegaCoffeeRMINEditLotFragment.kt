...
import com.olam.warehouse.vegax.processingcoffee.utils.FRAG_ADD_WEIGHT
import com.olam.warehouse.vegax.processingcoffee.utils.Lot_List
...
class VegaCoffeeRMINEditLotFragment : BaseFragment(), CoffeeRminItemRemoveListener,
    ...
    companion object {
        fun newInstance(fgrnIdMaterialCode: String, model: VegaCoffeeRminProcessing) =
            VegaCoffeeRMINEditLotFragment().putArgs {
