...
import com.olam.warehouse.vegax.processingcoffee.data.domain.model.CoffeeFilterList
import com.olam.warehouse.vegax.processingcoffee.databinding.FragmentVegaCoffeeFgrnFilterBinding
import com.olam.warehouse.vegax.processingcoffee.databinding.ItemVegaCoffeeFgrnInventoryFilterBinding
import com.olam.warehouse.vegax.processingcoffee.utils.*
import java.util.*

class VegaCoffeeFgrnFilterFragment : BaseFragment() {

    private lateinit var binding: FragmentVegaCoffeeFgrnFilterBinding
    override val layoutResourceId = R.layout.fragment_vega_coffee_fgrn_filter
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaCoffeeFgrnFilterFragment().putArgs {
    ...
    override fun onCreateView(
        ...
        binding = FragmentVegaCoffeeFgrnFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<CoffeeFilterList>) {
        binding.rvWhLocation.setUpAdapter(
            listFliterWhLoc,
            R.layout.item_vega_coffee_fgrn_inventory_filter,
            ItemVegaCoffeeFgrnInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
