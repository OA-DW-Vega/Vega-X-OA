...
import kotlinx.android.synthetic.main.item_vega_coffee_fgrn_inventory_filter.view.*
import java.util.*
...
class VegaCoffeeFgrnFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<CoffeeFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_coffee_fgrn_inventory_filter, { it, pos ->
