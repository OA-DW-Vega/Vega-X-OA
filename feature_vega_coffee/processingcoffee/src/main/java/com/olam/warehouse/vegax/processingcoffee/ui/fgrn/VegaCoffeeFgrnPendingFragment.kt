...
import com.olam.warehouse.vegax.processingcoffee.databinding.FragmentVegaCoffeeFgrnPendingBinding
import com.olam.warehouse.vegax.processingcoffee.databinding.ItemVegaCoffeeFgrnPendingBinding
...
class VegaCoffeeFgrnPendingFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_coffee_fgrn_pending
    private lateinit var binding: FragmentVegaCoffeeFgrnPendingBinding
    ...
    companion object {
        fun newInstance(model: VegaCoffeeFgrnItems) = VegaCoffeeFgrnPendingFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCoffeeFgrnPendingBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcoffee/ui/fgrn/VegaCoffeeFgrnPendingFragment").title("IVC/Coffee/Processing/FGRN Pending")
            .with(tracker)
    }
    ...
    private fun updateItems(pendingList: List<VegaCoffeeFgrnItems>) {
        binding.rvPendingPoList.setUpAdapter(
            ...
            R.layout.item_vega_coffee_fgrn_pending,
            ItemVegaCoffeeFgrnPendingBinding::inflate,
            { item, pos, bindItem ->
