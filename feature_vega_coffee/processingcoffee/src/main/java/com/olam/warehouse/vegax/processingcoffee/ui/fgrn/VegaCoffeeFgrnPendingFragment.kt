...
import kotlinx.android.synthetic.main.item_vega_coffee_fgrn_pending.view.*
...
class VegaCoffeeFgrnPendingFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcoffee/ui/fgrn/VegaCoffeeFgrnPendingFragment").title("Processing Cocoa")
            .with(tracker)
    }
    ...
    private fun updateItems(pendingList: List<VegaCoffeeFgrnItems>) {
        binding.rvPendingPoList.setUp(pendingList as MutableList, R.layout.item_vega_coffee_fgrn_pending, { item, pos ->
