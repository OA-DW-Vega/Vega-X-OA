...
class VegaCoffeeFgrnViewModel(
    private val useCase: VegaCoffeeProcessingUseCase,
    ...
    private var postFgrnSource: LiveData<Resource<GenericReqAndResp<List<VegaCoffeeProcessingFgrnResponse>>>> =
        MutableLiveData()
    private val _postFgrn = MediatorLiveData<Resource<GenericReqAndResp<List<VegaCoffeeProcessingFgrnResponse>>>>()
    val postFgrn: LiveData<Resource<GenericReqAndResp<List<VegaCoffeeProcessingFgrnResponse>>>> get() = _postFgrn
    ...
    fun postFgrn(poReq: VegaCoffeeProcessingFgrnPost) = viewModelScope.launch(dispatchers.main) {
    ...
    fun createBatchFormat(vegaMaterial: VegaMaterial): String {
        val pile = "NP"
        var lotId = ""
