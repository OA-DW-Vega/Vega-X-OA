...
import kotlinx.android.synthetic.main.item_vega_coffee_fgrn_grades.view.*
...
class VegaCoffeeRMINGradesFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcoffee/ui/fgrn/VegaCoffeeRMINGradesFragment").title("Processing Coffee")
            .with(tracker)
    }
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCoffeeFgrnItemsGrades>) {
        ...
        binding.rvGrades.setUp(gradeList, R.layout.item_vega_coffee_fgrn_grades, { item, pos ->
