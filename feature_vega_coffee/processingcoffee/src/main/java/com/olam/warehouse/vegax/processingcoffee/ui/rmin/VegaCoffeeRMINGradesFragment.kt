...
import com.olam.warehouse.vegax.processingcoffee.databinding.FragmentVegaCoffeeFgrnGradesBinding
import com.olam.warehouse.vegax.processingcoffee.databinding.ItemVegaCoffeeFgrnGradesBinding
import com.olam.warehouse.vegax.processingcoffee.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCoffeeRMINGradesFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_coffee_fgrn_grades
    private lateinit var binding: FragmentVegaCoffeeFgrnGradesBinding
    ...
    companion object {
        fun newInstance(model: VegaCoffeeRminProcessing, id: String) = VegaCoffeeRMINGradesFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCoffeeFgrnGradesBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcoffee/ui/fgrn/VegaCoffeeRMINGradesFragment").title("IVC/Coffee/Processing/RMIN Grades")
            .with(tracker)
    }
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCoffeeFgrnItemsGrades>) {
        ...
        binding.rvGrades.setUpAdapter(
            gradeList,
            R.layout.item_vega_coffee_fgrn_grades,
            ItemVegaCoffeeFgrnGradesBinding::inflate,
            { item, pos, bindItem ->
    ...
    private fun View.updateGradeSelection(
        ...
        pos: Int,
        bindItem: ItemVegaCoffeeFgrnGradesBinding
    ) {
