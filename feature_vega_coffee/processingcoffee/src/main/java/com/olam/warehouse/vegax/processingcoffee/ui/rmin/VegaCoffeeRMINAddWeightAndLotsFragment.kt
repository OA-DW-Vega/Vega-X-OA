...
import com.olam.warehouse.vegax.processingcoffee.databinding.FragmentVegaCoffeeRminAddWeightBinding
...
class VegaCoffeeRMINAddWeightAndLotsFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_coffee_rmin_add_weight
    private lateinit var binding: FragmentVegaCoffeeRminAddWeightBinding
    ...
    companion object {
        ...
        ) = VegaCoffeeRMINAddWeightAndLotsFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCoffeeRminAddWeightBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcoffee/ui/fgrn/VegaCoffeeFgrnAddWeightAndLotsFragment")
            .title("IVC/Coffee/Processing/RMIN Add Weight and Lots")
            .with(tracker)
    }
