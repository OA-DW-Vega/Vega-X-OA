...
import com.olam.warehouse.vegax.processingcoffee.databinding.ItemLotCardLayoutBinding
import kotlinx.android.synthetic.main.item_lot_card_layout.view.*

class VegaCoffeeRminLotAdapter(
    var data: ArrayList<VegaCoffeeRminLots>,
    var listener: CoffeeRminItemRemoveListener,
    private var addWeightListener: CoffeeRminAddWeightListener? = null
) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    class ScaleViewHolder(bind: ItemLotCardLayoutBinding) : RecyclerView.ViewHolder(bind.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {

        val viewHolder =
            ItemLotCardLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
