package com.olam.warehouse.vegax.mtntcoffee.data.repo
...
interface VegaCoffeeMtntRepository {
    ...
    suspend fun getPurchaseOrder(receivingWerks: String): LiveData<Resource<GenericReqAndResp<List<VegaCoffeePurchaseOrder>>>>
    ...
    suspend fun postDeliveryDetail(vegaDeliveryPost: VegaCoffeeDeliveryPost): LiveData<Resource<GenericReqAndResp<VegaDeliveryPostResponse>>>
    suspend fun postWeighScaleDeliveryDetail(vegaDeliveryPost: VegaCoffeeDeliveryPost): LiveData<Resource<GenericReqAndResp<List<VegaCoffeeMtntDeliveryDetail>>>>
...
class VegaCoffeeMtntRepositoryImpl(
    ...
    override suspend fun getPurchaseOrder(receivingWerks: String): LiveData<Resource<GenericReqAndResp<List<VegaCoffeePurchaseOrder>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCoffeePurchaseOrder>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCoffeePurchaseOrder>> =
    ...
    override suspend fun postDeliveryDetail(vegaDeliveryPost: VegaCoffeeDeliveryPost): LiveData<Resource<GenericReqAndResp<VegaDeliveryPostResponse>>> {
    ...
    override suspend fun postWeighScaleDeliveryDetail(vegaDeliveryPost: VegaCoffeeDeliveryPost): LiveData<Resource<GenericReqAndResp<List<VegaCoffeeMtntDeliveryDetail>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCoffeeMtntDeliveryDetail>>>() {

            override suspend fun createCall(): GenericReqAndResp<List<VegaCoffeeMtntDeliveryDetail>> =
