...
import com.olam.warehouse.vegax.mtntcoffee.databinding.FragmentCoffeeMtntWeighbridgeAddLotLayoutBinding
import com.olam.warehouse.vegax.mtntcoffee.ui.ItemRemoveListener
import com.olam.warehouse.vegax.mtntcoffee.ui.VegaCoffeeMtntLotAdapter
...
import com.olam.warehouse.vegax.mtntcoffee.utils.LOT_LIST
import com.olam.warehouse.vegax.mtntcoffee.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.mtntcoffee.utils.WEIGHBRIDGE_SUMMARY
...
class VegaCoffeeMtntWeighBridgeAddLotFragment : BaseFragment(), ItemRemoveListener {
    override val layoutResourceId = R.layout.fragment_coffee_mtnt_weighbridge_add_lot_layout
    private lateinit var binding: FragmentCoffeeMtntWeighbridgeAddLotLayoutBinding
    ...
    companion object {
        fun newInstance(model: VegaCocoaDispatchWB) =
            VegaCoffeeMtntWeighBridgeAddLotFragment()
                .putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentCoffeeMtntWeighbridgeAddLotLayoutBinding.inflate(layoutInflater)
        initExtra()
        initAdapter()
        initUI()
        return binding.root
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("mtntcoffee.ui.weighbridge").title("IVC/Coffee/MTNT/Weighbridge Add Lot")
            .with(tracker)
    }
    ...
    private fun initExtra() {
        ...
        vm.dispatchWh.remarks.isNullOrEmpty()
