...
class VegaCoffeeMtntWeighScaleSummaryFragment : BaseFragment(), VegaCoffeeMtntLotRemoveListener {
    ...
    private fun setUpAdapter(list: List<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUpAdapter(
            lots,
            R.layout.item_coffee_lot_summary,
            ItemCoffeeLotSummaryBinding::inflate,
            { item, pos, bindItem ->
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("mtntcoffee.ui.weighbridge")
            .title("IVC/Coffee/MTNT/Weighscale Summary")
            .with(tracker)
    }
}
