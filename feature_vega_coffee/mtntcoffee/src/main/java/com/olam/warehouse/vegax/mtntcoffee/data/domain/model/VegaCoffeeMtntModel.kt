...
data class VegaCoffeeLotListModel(
...
data class VegaCoffeeMtntPostRequest(
    ...
    var delFlag: String? = "",
    var deliveryDetails: List<VegaCoffeeMtntDeliveryDetail>,
    var key: String? = "",
...
data class VegaCoffeeMtntDeliveryDetail(
    var batchNumber: String? = "",
...
data class VegaCoffeeMtntPallet(
    var weighbridgeID: String? = "",
