...
class VegaCoffeeMtntViewModel(private val useCase: VegaCoffeeDispatchUseCase, private val dispatchers: AppDispatchers) :
    BaseViewModel() {
    ...
    private var purchaseSource: LiveData<Resource<GenericReqAndResp<List<VegaCoffeePurchaseOrder>>>> = MutableLiveData()
    private val _purchaseOrder = MediatorLiveData<Resource<GenericReqAndResp<List<VegaCoffeePurchaseOrder>>>>()
    val purchaseOrder: LiveData<Resource<GenericReqAndResp<List<VegaCoffeePurchaseOrder>>>> get() = _purchaseOrder
    ...
    private var weighScaleDeliveryPostSource: LiveData<Resource<GenericReqAndResp<List<VegaCoffeeMtntDeliveryDetail>>>> =
        MutableLiveData()
    private val _weighScaleDeliveryPost =
        MediatorLiveData<Resource<GenericReqAndResp<List<VegaCoffeeMtntDeliveryDetail>>>>()
    val weighScaleDeliveryPost: LiveData<Resource<GenericReqAndResp<List<VegaCoffeeMtntDeliveryDetail>>>> get() = _weighScaleDeliveryPost
    ...
    fun postDeliveryDetail(vegaDeliveryPost: VegaCoffeeDeliveryPost) = viewModelScope.launch(dispatchers.main) {
    ...
    fun postWeighScaleDeliveryDetails(vegaDeliveryPost: VegaCoffeeDeliveryPost) =
