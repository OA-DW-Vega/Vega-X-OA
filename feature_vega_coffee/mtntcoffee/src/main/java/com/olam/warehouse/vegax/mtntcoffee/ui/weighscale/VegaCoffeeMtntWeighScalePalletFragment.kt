...
import kotlinx.android.synthetic.main.item_vega_coffee_mtnt_add_bag.view.*
...
class VegaCoffeeMtntWeighScalePalletFragment : BaseFragment() {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_vega_coffee_mtnt_add_bag, { it, pos ->
            if (pos % 2 == 0) {
                clBagHead.setBackgroundResource(com.olam.warehouse.presentation.R.drawable.rectangle_grey_border)
            } else {
                clBagHead.setBackgroundResource(R.drawable.shape_coffee_rect_light_grey1)
            }
