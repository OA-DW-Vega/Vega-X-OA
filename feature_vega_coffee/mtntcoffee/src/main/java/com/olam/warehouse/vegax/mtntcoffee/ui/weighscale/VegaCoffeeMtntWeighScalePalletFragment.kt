...
import com.olam.warehouse.vegax.mtntcoffee.databinding.FragmentMtntWeighscaleAddPalletBinding
import com.olam.warehouse.vegax.mtntcoffee.databinding.ItemVegaCoffeeMtntAddBagBinding
...
import com.olam.warehouse.vegax.mtntcoffee.utils.FRAG_ADD_BAG_WEIGHT
import com.olam.warehouse.vegax.mtntcoffee.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.mtntcoffee.utils.UPDATE_WEIGHT
...
class VegaCoffeeMtntWeighScalePalletFragment : BaseFragment() {

    override val layoutResourceId: Int =
        R.layout.fragment_mtnt_weighscale_add_pallet
    private lateinit var binding: FragmentMtntWeighscaleAddPalletBinding
    ...
    companion object {
        fun newInstance(item: VegaCocoaDispatchLots) = VegaCoffeeMtntWeighScalePalletFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentMtntWeighscaleAddPalletBinding.inflate(inflater)
        initUI()
        return binding.root
    }
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(),
            R.layout.item_vega_coffee_mtnt_add_bag,
            ItemVegaCoffeeMtntAddBagBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
                    bindItem.clBagHead.setBackgroundResource(com.olam.warehouse.presentation.R.drawable.rectangle_grey_border)
                } else {
                    bindItem.clBagHead.setBackgroundResource(R.drawable.shape_coffee_rect_light_grey1)
                }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("mtntcoffee.ui.weighbridge").title("IVC/Coffee/MTNT/Weighscale Pallet")
            .with(tracker)
    }
}
