...
import com.olam.warehouse.vegax.mtntcoffee.databinding.FragmentCoffeeTruckListLayoutBinding
import com.olam.warehouse.vegax.mtntcoffee.databinding.ItemCoffeeMtntTruckLayoutBinding
...
class VegaCoffeeMtntWeighbridgeTruckListFragment : BaseFragment() {
    override val layoutResourceId: Int = R.layout.fragment_coffee_truck_list_layout
    private lateinit var binding: FragmentCoffeeTruckListLayoutBinding
    ...
    companion object {
        fun newInstance() = VegaCoffeeMtntWeighbridgeTruckListFragment()
            .putArgs {
            }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentCoffeeTruckListLayoutBinding.inflate(inflater)
            ...
            Resource.Status.SUCCESS -> {
                ...
                response.data?.data?.let {
                    if (it.isNotEmpty()) {
                        vegaWbIds =
                            it.filter {
                                it.batchPicking.isNullOrEmpty() && it.direction.equals(
                                    DIRECTIONOUT
                                ) && it.weighMethod == WEIGHBRIDGE_METHOD
                            } as ArrayList
                        dispatch = vegaWbIds
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUpAdapter(
            dispatch1,
            R.layout.item_coffee_mtnt_truck_layout,
            ItemCoffeeMtntTruckLayoutBinding::inflate,
            { it, pos, bindItem ->
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("mtntcoffee.ui.weighbridge").title("IVC/Coffee/MTNT/Weighbridge Truck List")
            .with(tracker)
    }
}
