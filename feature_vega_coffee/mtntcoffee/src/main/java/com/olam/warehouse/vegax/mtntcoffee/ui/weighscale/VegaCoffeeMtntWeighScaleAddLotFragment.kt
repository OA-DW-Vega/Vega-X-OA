...
import com.olam.warehouse.vegax.mtntcoffee.databinding.FragmentCoffeeMtntWsAddLotLayoutBinding
import com.olam.warehouse.vegax.mtntcoffee.databinding.ItemMaterialLayoutBinding
import com.olam.warehouse.vegax.mtntcoffee.databinding.ItemWeighscaleLotCardLayoutBinding
...
class VegaCoffeeMtntWeighScaleAddLotFragment : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_coffee_mtnt_ws_add_lot_layout
    private lateinit var binding: FragmentCoffeeMtntWsAddLotLayoutBinding
    ...
    companion object {
        fun newInstance(model: VegaCocoaDispatchWB) =
            VegaCoffeeMtntWeighScaleAddLotFragment()
                .putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentCoffeeMtntWsAddLotLayoutBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("mtntcoffee.ui.weighbridge").title("IVC/Coffee/MTNT/Weighscale Add Lot")
            .with(tracker)
    }
    ...
    private fun initUI() {
        ...
        binding.clLotSummary.btnAddLot.setOnClickListener {
            callback.replaceFragment(
                LOT_LIST,
                VegaCoffeeLotListModel(selectedList = vm.lotList, isMultipleAdd = true, material = getMaterialList())
            )
        }
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        ...
        binding.clLotSummary.rvList.setUpAdapter(
            lots,
            R.layout.item_weighscale_lot_card_layout,
            ItemWeighscaleLotCardLayoutBinding::inflate,
            { item, pos, bindItem ->
