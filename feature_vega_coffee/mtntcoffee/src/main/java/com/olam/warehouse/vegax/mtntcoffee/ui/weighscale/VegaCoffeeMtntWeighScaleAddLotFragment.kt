...
import kotlinx.android.synthetic.main.item_weighscale_lot_card_layout.view.*
...
class VegaCoffeeMtntWeighScaleAddLotFragment : BaseFragment() {
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        val lots = list
        binding.clLotSummary.rvList.setUp(lots, R.layout.item_weighscale_lot_card_layout, { item, pos ->
