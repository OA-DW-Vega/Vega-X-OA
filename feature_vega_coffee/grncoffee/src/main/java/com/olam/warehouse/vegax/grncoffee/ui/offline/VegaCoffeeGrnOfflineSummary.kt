package com.olam.warehouse.vegax.grncoffee.ui.offline
...
import com.olam.warehouse.vegax.grncoffee.databinding.FragmentVegaCoffeeGrnOfflineBinding
import com.olam.warehouse.vegax.grncoffee.databinding.ItemVegaCoffeeGrnOfflineBinding
 ...
 */
class VegaCoffeeGrnOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_coffee_grn_offline
    private val vm: VegaCoffeeGrnViewModel by viewModel()
    private lateinit var binding: FragmentVegaCoffeeGrnOfflineBinding
    private var grnList = arrayListOf<VegaGrnWeighBridgeId>()
    private var callBack: CallBack? = null

    companion object {
        fun newInstance() = VegaCoffeeGrnOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaCoffeeGrnOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("grnCoffee/ui/offline/VegaCoffeeGrnOfflineSummary")
            .title("IVC/Coffee/GRN/Offline Summary")
            .with(tracker)
        initUI()
    }
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaGrnWeighBridgeId>) {
        ...
        binding.rvOfflineGrn.setUpAdapter(
            grnList,
            R.layout.item_vega_coffee_grn_offline,
            ItemVegaCoffeeGrnOfflineBinding::inflate,
            { it, pos, bindItem ->
