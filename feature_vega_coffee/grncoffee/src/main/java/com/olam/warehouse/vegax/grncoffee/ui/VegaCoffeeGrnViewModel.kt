 ...
 */
class VegaCoffeeGrnViewModel(
    private val useCase: VegaCoffeeGrnUseCase,
    ...
    private var grnSource: LiveData<Resource<GenericReqAndResp<VegaCoffeeGrnResponse>>> = MutableLiveData()
    private val _grn = MediatorLiveData<Resource<GenericReqAndResp<VegaCoffeeGrnResponse>>>()
    val grn: LiveData<Resource<GenericReqAndResp<VegaCoffeeGrnResponse>>> get() = _grn
    ...
    fun postGrn(grnPost: VegaCoffeeGrnPost) = viewModelScope.launch(dispatchers.main) {
