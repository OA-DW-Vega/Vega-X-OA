...
import com.olam.warehouse.vegax.grncoffee.databinding.ItemVegaCoffeeQualityDetailsBinding
...
class VegaCoffeeGRNLotQualityFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("inventorycocoa/ui/VegaCocoaInventoryQualityFragment").title("IVC/Coffee/GRN/Lot Quality")
            .with(tracker)
        initUI()
    }
    ...
    private fun setUpAdapter(qualityParameters: List<VegaQualityParams>?) {
      ...
      ///  var VegaQualityParams1=ArrayList<VegaQualityParams>()
        ...
        binding.rvQuality.setUpAdapter(
            ...
            ItemVegaCoffeeQualityDetailsBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
