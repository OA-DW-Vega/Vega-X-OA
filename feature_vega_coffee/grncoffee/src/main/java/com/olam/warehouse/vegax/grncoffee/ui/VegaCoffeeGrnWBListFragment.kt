...
import kotlinx.android.synthetic.main.item_vega_coffee_weighbridge_grn.view.*
...
class VegaCoffeeGrnWBListFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("grncoffee/ui/weighbridge/VegaCoffeeGrnWBListFragment").title("Coffee GRN")
            .with(tracker)
        initUI()
    }
        ...
        binding.rvWeighBridgeId.setUp(
            ...
            { it, pos ->
                ...
                tvProcurementType.text =
                    if (it.purchaseDocNum.isNullOrEmpty()) getString(R.string.fixed_purchase) else getString(R.string.fixed_purchase)
