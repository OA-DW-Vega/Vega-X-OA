...
import com.olam.warehouse.vegax.ppqcoffee.databinding.ItemVegaCoffeePpqLotDetailsBinding
...
class VegaCoffeePpqLotListFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("ppqcoffee/ui/ppq/VegaCoffeePpqLotListFragment")
            .title("IVC/Coffee/PPQ/Lot List").with(tracker)
    }
    ...
    private fun setUpAdapter(lotList: MutableList<VegaCoffeePpqInspectionLots>) {
        ...
        binding.rvInspectiontLots.setUpAdapter(
            lotList,
            R.layout.item_vega_coffee_ppq_lot_details,
            ItemVegaCoffeePpqLotDetailsBinding::inflate,
            { it, pos, bindItem ->
