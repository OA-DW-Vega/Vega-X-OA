...
import kotlinx.android.synthetic.main.item_vega_coffee_inventory_sync_details.view.*
...
class VegaCoffeeInventorySyncDetailsDailog : BottomSheetDialogFragment() {
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<CoffeeSyncStatus>) {
        binding.rvSyncDetails.setUp(syncStatusList, R.layout.item_vega_coffee_inventory_sync_details, { it, pos ->
