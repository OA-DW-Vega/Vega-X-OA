...
import com.olam.warehouse.vegax.gateentrycoffee.databinding.ItemVegaCoffeeWaitingTruckListBinding
...
class VegaCoffeeWaitingTruckListFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("gateentrycoffee/ui/VegaCoffeeWaitingTruckListFragment - $wType").title("IVC/Coffee/Gate Entry/Waiting Truck List")
            .with(tracker)
    }
    ...
    private fun setUpAdapter(data: List<VegaGateEntry>) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_coffee_waiting_truck_list,
            ItemVegaCoffeeWaitingTruckListBinding::inflate,
            { it, pos, bindItem ->
