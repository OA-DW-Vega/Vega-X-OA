...
import kotlinx.android.synthetic.main.item_coffee_sales_truck_layout.view.*
...
class VegaCoffeeSalesWeighbridgeTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUp(dispatch1, R.layout.item_coffee_sales_truck_layout, { it, pos ->
