...
import com.olam.warehouse.vegax.salescoffee.databinding.ItemCoffeeSalesLotBinding
...
class VegaCoffeeSalesAddLotFragment : BaseFragment(), RecyclerViewItemClickListener {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("thirdpartysalescoffee/ui/VegaThirdPartyTypeFragment").title("IVC/Coffee/Sales/Add Lot")
            .with(tracker)
    ...
    private fun showSingleSelectDialog(isWh: Boolean, title: String) {
        customDialog =
            CustomCoffeeSingleSelectDialog(title, isWh, soNumbers, requireActivity(), this)
        customDialog?.show()
    ...
    private fun setUpAdapter(lineItems: MutableList<VegaCoffeeSalesLotWithbags>) {
        ...
        binding.rvLots.setUpAdapter(
            ...
            ItemCoffeeSalesLotBinding::inflate,
            { it, pos, bindItem ->
                val lot = it.salesLot
