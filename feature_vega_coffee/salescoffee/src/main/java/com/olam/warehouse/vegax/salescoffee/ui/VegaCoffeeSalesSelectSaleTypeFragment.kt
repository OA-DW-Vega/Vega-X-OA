...
import com.olam.warehouse.vegax.salescoffee.databinding.FragmentCoffeeSalesTypesBinding
import com.olam.warehouse.vegax.salescoffee.utils.SALES_PENDING
import com.olam.warehouse.vegax.salescoffee.utils.SALES_TYPE_ANTICIPATED
...
class VegaCoffeeSalesSelectSaleTypeFragment : BaseFragment() {
    override val layoutResourceId: Int = R.layout.fragment_coffee_sales_types
    private var callBack: CallBack? = null
    private lateinit var binding: FragmentCoffeeSalesTypesBinding
    ...
    companion object {
        fun newInstance() = VegaCoffeeSalesSelectSaleTypeFragment().putArgs {
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentCoffeeSalesTypesBinding.inflate(layoutInflater)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("/salescoffee/ui/VegaCoffeeSalesSelectSaleTypeFragment").title("IVC/Coffee/Sales/Select Sale Type")
            .with(tracker)
    }
