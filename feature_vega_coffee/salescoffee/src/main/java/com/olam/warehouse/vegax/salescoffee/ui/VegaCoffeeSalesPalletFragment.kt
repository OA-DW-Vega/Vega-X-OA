...
import com.olam.warehouse.vegax.salescoffee.databinding.ItemCoffeeSalesPalletBagInfoBinding
...
class VegaCoffeeSalesPalletFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("thirdpartysalescoffee/ui/VegaThirdPartyTypeFragment").title("IVC/Coffee/Sales/Pallet")
            .with(tracker)
