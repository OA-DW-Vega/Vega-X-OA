...
import com.olam.warehouse.vegax.salescoffee.databinding.ItemCoffeeSalesPendingListBinding
...
class VegaCoffeeSalesPendingFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("thirdpartysalescoffee/ui/VegaThirdPartyTypeFragment").title("IVC/Coffee/Sales/Pending")
            .with(tracker)
