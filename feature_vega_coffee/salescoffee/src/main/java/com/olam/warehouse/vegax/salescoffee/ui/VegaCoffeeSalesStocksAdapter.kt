...
import kotlinx.android.synthetic.main.item_coffee_sales_lot_list_detail.view.*

class VegaCoffeeSalesStocksAdapter(
    private val items: List<VegaCoffeeSalesLots>
) :
    RecyclerView.Adapter<VegaCoffeeSalesStocksAdapter.DetailsViewHolder>() {

    class DetailsViewHolder(bind: ItemCoffeeSalesLotListDetailBinding) : RecyclerView.ViewHolder(bind.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DetailsViewHolder {
        val viewHolder =
            ItemCoffeeSalesLotListDetailBinding.inflate(LayoutInflater.from(parent.context), parent, false)
