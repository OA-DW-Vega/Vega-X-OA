...
import com.olam.warehouse.vegax.offloadingcoffee.databinding.FragmentVegaCoffeeOffloadAddWeightLayoutBinding
import com.olam.warehouse.vegax.offloadingcoffee.databinding.ItemVegaCoffeeOffloadAddBagBinding
...
class VegaCoffeeMtnrWeighScalePalletFragment : BaseFragment() {

    override val layoutResourceId: Int =
        R.layout.fragment_vega_coffee_offload_add_weight_layout
    private lateinit var binding: FragmentVegaCoffeeOffloadAddWeightLayoutBinding
    ...
    companion object {
        fun newInstance(item: VegaCoffeeReceiveLots) = VegaCoffeeMtnrWeighScalePalletFragment().putArgs {
            putParcelable("MODEL_BUNDLE", item)
        }

        fun newInstance(item: VegaCoffeeReceiveLots, receive: VegaCoffeeReceiving) =
            VegaCoffeeMtnrWeighScalePalletFragment().putArgs {
                putParcelable("MODEL_BUNDLE", item)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaCoffeeOffloadAddWeightLayoutBinding.inflate(inflater)
        initUI()
        return binding.root
    }
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("offloadingcoffee/ui/mtnr/VegaCoffeeMtnrTypeSelectFragment").title("IVC/Coffee/Offloading/MTNR Weighscale Pallet")
            .with(tracker)
    }
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCoffeeOffloadingBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(),
            R.layout.item_vega_coffee_offload_add_bag,
            ItemVegaCoffeeOffloadAddBagBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
                    bindItem.clBagHead.setBackgroundResource(com.olam.warehouse.presentation.R.drawable.rectangle_grey_border)
                } else {
                    bindItem.clBagHead.setBackgroundResource(R.drawable.shape_coffee_offload_rect_light_grey1)
                }
