...
class VegaCoffeeSupplierConsignmentFragment : BaseFragment(), VegaSingleSelectListener,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("offloadingcoffee/ui/mtnr/VegaCoffeeMtnrTypeSelectFragment").title("IVC/Coffee/Offloading/Supplier Consignment")
            .with(tracker)
    }
    ...
    private fun initUI() {
        ...
        if (offloadData.imageString.equals(WEIGHBRIDGE_WEIHSCALE)) {
            ...
            binding.llDeptLayout.visibility = View.GONE
            ...
            binding.llDeptLayout.visibility = View.VISIBLE
