package com.olam.warehouse.vegax.offloadingcoffee.ui.supplier
...
import com.olam.warehouse.vegax.offloadingcoffee.databinding.FragmentSupplierConsignmentLayoutBinding
...
import kotlinx.android.synthetic.main.fragment_supplier_consignment_layout.*
...
class VegaCoffeeSupplierConsignmentFragment : BaseFragment(), VegaSingleSelectListener,
    VegaCoffeeSingleSelectListener {

    override val layoutResourceId = R.layout.fragment_supplier_consignment_layout
    private lateinit var binding: FragmentSupplierConsignmentLayoutBinding
    ...
    companion object {
        fun newInstance(offload: VegaCoffeeReceiving) = VegaCoffeeSupplierConsignmentFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentSupplierConsignmentLayoutBinding.inflate(layoutInflater)
    ...
    private fun initUI() {
        ...
        if (offloadData.imageString.equals(WEIGHBRIDGE_WEIHSCALE)) {
            ...
            binding.tvYearValue.visibility = View.GONE
            binding.tvPo.visibility = View.GONE
            binding.tvPOValue.visibility = View.GONE
            ll_DeptLayout.visibility=View.GONE
            ll_OriginLayout.visibility=View.GONE
            binding.tvTransportCostLabel.visibility=View.GONE
        } else {
            binding.tvyear.visibility = View.VISIBLE
            binding.tvYearValue.visibility = View.VISIBLE
            ll_DeptLayout.visibility=View.VISIBLE
            ll_OriginLayout.visibility=View.VISIBLE
            binding.tvTransportCostLabel.visibility=View.VISIBLE
        }
        binding.tvPOValue.isEnabled=false
        ...
        vm.custonLocation.observe(viewLifecycleOwner, Observer {
            ...
            binding.etConnaissement.onChange { enableProceed() }
            ...
            vm.offloadingMtnr.observe(viewLifecycleOwner, Observer {
                if (it == null) {
                    ...
                    binding.etConnaissement.setText(it.receiving.challan)
                    binding.etCooperative.setText(it.receiving.remarks)
                    binding.tvReceivingValue.text =
    ...
    private fun moveToSummary() {
        ...
        vm.vegaCoffeeReceivingData.challan = binding.etConnaissement.text.toString()
        vm.vegaCoffeeReceivingData.remarks = binding.etCooperative.text.toString()
        validateInputs()
    }
    ...
    private fun setValueEmpty(fragment: Fragment?) {
        ...
        when (fragment) {
            is VegaCoffeeSupplierConsignmentFragment -> binding.tvstoValue.text = ""
        }
    }
    ...
    private fun validateProceed() {
        ...
        batchInfo.delivery = vm.vegaCoffeeReceivingData.materialCode.plus(vm.vegaCoffeeReceivingData.supplierCode)
            .plus(vm.vegaCoffeeReceivingData.weighBridgeType)
        vm.saveMtnrReceivingLots(vm.vegaCoffeeReceivingData, batchInfo)
    ...
    private fun validateInputs() {
        when {
            ...
            vm.vegaCoffeeReceivingData.vendorDeclaredWeight.isNullOrEmpty() -> showSnack(getString(R.string.error_valid_declared))
    ...
    private fun enableProceed() {
        ...
        if(offloadData.imageString.equals(WEIGHSCALE)){
             enable = (binding.tvWhValue.text.isNotEmpty() && binding.tvstoValue.text.isNotEmpty() && binding.tvDriverName.text.isNotEmpty()
                            && binding.tvTruckNoValue.text.toString().isNotEmpty()
                            && binding.tvReceivingValue.text.isNotEmpty()&&binding.etTruckBagcount.text.isNotEmpty()&&binding.etTruckDeclaredweight.text.isNotEmpty()&& !binding.tvOrigin.text.equals(" ")&&!binding.tvDestinationLabel.text.equals(" ")&&binding.etConnaissement.text.isNotEmpty())
        ...
        else if(offloadData.imageString.equals(WEIGHBRIDGE_WEIHSCALE))
        {
            enable = (binding.tvWhValue.text.isNotEmpty() && binding.tvstoValue.text.isNotEmpty() && binding.tvDriverName.text.isNotEmpty()
                    && binding.tvTruckNoValue.text.toString().isNotEmpty()
                    && binding.tvReceivingValue.text.isNotEmpty()&&binding.etTruckBagcount.text.isNotEmpty()&&binding.etTruckDeclaredweight.text.isNotEmpty()&&binding.etConnaissement.text.isNotEmpty())
        }
                    ...
                    when (it.data?.success) {
                        true -> {
                            response.data?.data?.let {
                                ...
                                binding.tvPOValue.isEnabled=true
                                for (drawable in binding.tvPOValue.compoundDrawables) {
                                    if (drawable != null) {
    ...
    override fun clickOnItem(data: String, isWh: Boolean, isVendor: Boolean, isGrade: Boolean, isSupplier: Boolean,isOrigin:Boolean,isDepartment:Boolean) {
        ...
        else if(isDepartment)
        {
            ...
            offloadData.storageLocationCode = split[0]
            offloadData.storageLocationName = split[1]
    ...
    private fun clearAllValues() {
        ...
        binding.etConnaissement.setText(" ")
        binding.etCooperative.setText(" ")
