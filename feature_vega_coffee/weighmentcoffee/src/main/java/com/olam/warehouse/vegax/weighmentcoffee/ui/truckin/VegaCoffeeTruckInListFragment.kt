...
import com.olam.warehouse.vegax.weighmentcoffee.databinding.ItemVegaCoffeeTruckinWbListBinding
...
class VegaCoffeeTruckInListFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("receiving/ui/truckin/VegaTruckInListFragment").title("IVC/Coffee/Weighment/Truck In List").with(tracker)
        initUI()
    }
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_coffee_truckin_wb_list,
            ItemVegaCoffeeTruckinWbListBinding::inflate,
            { it, pos, bindItem ->
                ...
                when (receivingData.weighBridgeType == PROCURE) {
                    true -> callBack?.replaceMtntFragment(
                        SUPPLIER_FRAG,
                        receivingData.direction ?: "",
                        item
                    )
                    else -> callBack?.replaceMtntFragment(
                        MTNR_FRAG,
                        receivingData.direction ?: "",
                        item
                    )
