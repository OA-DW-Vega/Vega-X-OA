...
import kotlinx.android.synthetic.main.fragment_vega_coffee_truckout_add_weight.*
        ...
        when {
            binding.etTruckTarWeight.text.isNullOrEmpty() -> showSnack(getString(R.string.error_valid_tar_weight))
                ...
                when {
                    ...
                    receivingData.weighBridgeType == PROCURE && tvOrigin.text.isNullOrEmpty()->showSnack(getString(R.string.error_valid_origin))
                    receivingData.weighBridgeType == PROCURE  && tvDestinationLocation.text.isNullOrEmpty()->showSnack(getString(R.string.error_valid_department))
