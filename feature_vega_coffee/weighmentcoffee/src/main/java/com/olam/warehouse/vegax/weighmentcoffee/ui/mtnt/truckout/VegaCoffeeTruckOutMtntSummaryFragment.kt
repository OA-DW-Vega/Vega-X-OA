...
import com.olam.warehouse.vegax.weighmentcoffee.utils.MTNTDATA
import com.olam.warehouse.vegax.weighmentcoffee.utils.MTNT_POST_DATA
import com.olam.warehouse.vegax.weighmentcoffee.utils.getTmpId
import kotlinx.android.synthetic.main.item_vega_coffee_bag_summary_details.view.*
 ...
 */
class VegaCoffeeTruckOutMtntSummaryFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(mtntData: VegaMtnt, mMtntList: ArrayList<VegaMtnt>) =
            VegaCoffeeTruckOutMtntSummaryFragment().putArgs {
    ...
    private fun initUI() {
        ...
        binding.tvGross.text = mtntData.grossWeight.plus(" ")
            .plus(mtntData.unitsOfMeasure)

        binding.tvTarWeight.text = mtntData.tareWeight.plus(" ")
            .plus(mtntData.unitsOfMeasure)

        binding.tvBagTare.text = mBagsTarWeight?.formatThreeDigits().toString().plus(" ")
            .plus(mtntData.unitsOfMeasure)
...
//        mtntData.tmpWbId = wbId ?: ""
    ...
    private fun setBagDetails(data: MutableList<VegaMtnt>?) {
        binding.rvBagDetailSummary.setUp(data!!, R.layout.item_vega_coffee_bag_summary_details, { it, pos ->
