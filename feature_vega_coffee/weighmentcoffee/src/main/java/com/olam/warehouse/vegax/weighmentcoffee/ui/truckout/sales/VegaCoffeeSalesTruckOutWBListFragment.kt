...
import kotlinx.android.synthetic.main.item_vega_coffee_truckout_mtnt_wb_list.view.*
    ...
    private fun setUpAdapter(data: List<VegaMtnt>?) {
        ...
        binding.rvWeighbridge.setUp(
            ...
            { it, pos ->
                ...
                tvDeliveryLable.visibility = if (isThirdPartySale) View.GONE else View.VISIBLE
                tvDelivery.visibility = if (isThirdPartySale) View.GONE else View.VISIBLE
            ...
            },
            {
                ...
                callBack?.replaceSalesFragment("", TRUCK_OUT_SALES_ADD_WEIGHT, item, isThirdPartySale)
