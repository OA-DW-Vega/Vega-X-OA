...
import com.olam.warehouse.vegax.weighmentcoffee.databinding.FragmentVegaCoffeeTruckoutMtntAddWeightBinding
 ...
 */
class VegaCoffeeTruckOutMtntAddWeightFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaCoffeeTruckoutMtntAddWeightBinding

    override val layoutResourceId = R.layout.fragment_vega_coffee_truckout_mtnt_add_weight

    companion object {
        fun newInstance(mtntData: VegaMtnt, mMtntList: ArrayList<VegaMtnt>) =
            VegaCoffeeTruckOutMtntAddWeightFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaCoffeeTruckoutMtntAddWeightBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("receiving/ui/truckout/mtnt/VegaTruckOutMtntAddWeightFragment").title("IVC/Coffee/Weighment/Truck Out MTNT Add Weight")
            .with(tracker)
        initUI()
    }
