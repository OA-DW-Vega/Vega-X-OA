...
class VegaCoffeeSalesTruckInSummaryFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(receivingData: VegaReceiving) = VegaCoffeeSalesTruckInSummaryFragment()
            .putArgs {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("receiving/ui/truckin/VegaTruckInSummaryFragment").title("IVC/Coffee/Weighment/Sales Truck In Summary").with(tracker)
        initUI()
    }
    ...
    private fun initUI() {
        ...
        binding.tvTruckWeight.text = receivingData.tareWeight.plus(" ").plus(receivingData.unitsOfMeasure)
    ...
    private fun postReceiving() {
        ...
        if (AppUtils.isOnline()) {
            vm.postSalesTruckInData(VegaReceivingPost(getCurrentKey(), getPlantDetails(), postData))
        } else {
