...
import com.olam.warehouse.vegax.weighmentcoffee.databinding.FragmentVegaCoffeeTruckoutWblistBinding
import com.olam.warehouse.vegax.weighmentcoffee.databinding.ItemVegaCoffeeTruckoutWbListBinding
...
class VegaCoffeeTruckOutWBListFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaCoffeeTruckoutWblistBinding
    override val layoutResourceId = R.layout.fragment_vega_coffee_truckout_wblist

    companion object {
        fun newInstance(receivingData: VegaReceiving) = VegaCoffeeTruckOutWBListFragment()
            .putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCoffeeTruckoutWblistBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track()
            ...
            .title("IVC/Coffee/Weighment/Truck Out WBList").with(tracker)
    }

    private fun initUI() {
        receivingData = arguments?.getParcelable(RECEIVING_DATA)!!
        vm.weighBridgeTruckOut.observe(viewLifecycleOwner, Observer { updateUIWithOnlineData(it) })
        vm.getWeighBridgeTruckOutDetail()
                            ...
                            if (receivingData.weighBridgeType == PROCURE)
                                vegaWbIds =
                                    it1.filter { wb -> wb.direction == DIRECTIONIN }
                                        ...
                                        .filter { wb -> wb.weighMethod.equals("WB") }
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_coffee_truckout_wb_list,
            ItemVegaCoffeeTruckoutWbListBinding::inflate,
            { it, pos, bindItem ->
            ...
            tvDriverPhone.text = it.phoneNo*/
                ...
                callBack?.replaceMtntFragment(
                    TRUCKOUT_ADD_WEIGHT_FRAG,
                    receivingData.truckDirection ?: "",
                    item
                )
