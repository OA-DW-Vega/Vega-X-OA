...
class VegaCoffeeTruckOutWBListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUp(receiving.asReversed(), R.layout.item_vega_coffee_truckout_wb_list, { it, pos ->
            ...
            callBack?.replaceMtntFragment(TRUCKOUT_ADD_WEIGHT_FRAG, receivingData.truckDirection ?: "", item)
