...
import com.olam.warehouse.vegax.coffeepile.databinding.FragmentPileManagementFilterBinding
import com.olam.warehouse.vegax.coffeepile.databinding.ItemVegaCoffeePileFilterBinding
import com.olam.warehouse.vegax.coffeepile.ui.data.domain.model.CoffeeFilterList
import com.olam.warehouse.vegax.coffeepile.ui.utils.*
import java.util.*

class VegaCoffeePileFilterFragment : BaseFragment() {

    private lateinit var binding: FragmentPileManagementFilterBinding
    override val layoutResourceId = R.layout.fragment_pile_management_filter
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaCoffeePileFilterFragment().putArgs {
    ...
    override fun onCreateView(
        ...
        binding = FragmentPileManagementFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<CoffeeFilterList>) {
        binding.rvWhLocation.setUpAdapter(
            listFliterWhLoc,
            R.layout.item_vega_coffee_pile_filter_,
            ItemVegaCoffeePileFilterBinding::inflate,
            { it, pos, bindItem ->
