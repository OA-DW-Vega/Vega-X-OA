...
import kotlinx.android.synthetic.main.item_pile_management.view.*
            ...
            else
{
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        val lots = list
        binding.rvLots.setUp(lots, R.layout.item_pile_management, { item, pos ->
                ...
                if (it.isNotEmpty()) {
                    ...
                    if (come ?: 0 <= 0) {
                        ...
                        vm.lots.forEach { item1 ->
                            if (item1.batchNumber.equals(item.batchNumber) && item1.materialCode.equals(item.materialCode)) item.editedWeight =
                                editVal
                        }
                    } else {
