...
import com.olam.warehouse.vegax.coffeepile.databinding.FragmentPileManagementLotListBinding
import com.olam.warehouse.vegax.coffeepile.databinding.ItemPileManagementLotListCardBinding
import com.olam.warehouse.vegax.coffeepile.ui.data.domain.model.VegaCoffeeThirdPartyPileLotListModel
import com.olam.warehouse.vegax.coffeepile.ui.utils.getColor
import com.olam.warehouse.vegax.coffeepile.ui.utils.listOfField
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCoffeePileManagementLotListFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_pile_management_lot_list
    private lateinit var binding: FragmentPileManagementLotListBinding
    private val vm: VegaCoffeePileManagementViewModel by viewModel()
    ...
    private var listener: VegaCoffeePileManagementAddLotListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        listener = context as? VegaCoffeePileManagementAddLotListener
    }
    ...
    companion object {
        fun newInstance(
            ...
            VegaCoffeePileManagementLotListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        setHasOptionsMenu(true)
        binding = FragmentPileManagementLotListBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("pilemanagement/ui//VegaCoffeePileManagementFragment").title("IVC/Coffee/Pile Management/Lot List")
            .with(tracker)
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_pile_management_lot_list_card,
            ItemPileManagementLotListCardBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter = ArrayAdapter(requireContext(), R.layout.item_vega_coffee_pile_management_wh, wareHouseList)
