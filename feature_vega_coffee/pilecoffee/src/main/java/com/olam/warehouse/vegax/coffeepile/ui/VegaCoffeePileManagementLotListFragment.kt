...
import kotlinx.android.synthetic.main.item_pile_management_lot_list_card.view.*
...
class VegaCoffeePileManagementLotListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUp(data, R.layout.item_pile_management_lot_list_card, { it, pos ->
