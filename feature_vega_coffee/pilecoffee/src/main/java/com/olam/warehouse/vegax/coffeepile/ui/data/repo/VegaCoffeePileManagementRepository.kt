package com.olam.warehouse.vegax.coffeepile.ui.data.repo
...
import com.olam.warehouse.vegax.coffeepile.ui.data.domain.model.*
import java.util.*

interface VegaCoffeePileManagementRepository {
...
class VegaCoffeePileManagementRepositoryImpl(
    private val api: VegaCoffeePileManagementApi,
    private val dao: VegaCoffeeDispatchDao

) : VegaCoffeePileManagementRepository {
    ...
    override suspend fun getCustomLocations() = dao.getPCustomLocations()
