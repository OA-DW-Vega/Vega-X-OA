...
import com.olam.warehouse.vegax.coffeepile.databinding.FragmentPileManagementSummaryBinding
import com.olam.warehouse.vegax.coffeepile.databinding.ItemPileManagementSummaryBinding
...
import com.olam.warehouse.vegax.coffeepile.ui.utils.MATERIAL_LIST
import com.olam.warehouse.vegax.coffeepile.ui.utils.PILE_LIST
import com.olam.warehouse.vegax.coffeepile.ui.utils.PILE_MANAGEMENT_SUMMARY
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCoffeePileManagementSummaryFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_pile_management_summary
    private lateinit var binding: FragmentPileManagementSummaryBinding
    ...
    companion object {
        fun newInstance(
            ...
            VegaCoffeePileManagementSummaryFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentPileManagementSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("pilemanagement/ui//VegaCoffeePileManagementSummaryFragment").title("IVC/Coffee/Pile Management/Summary")
            .with(tracker)
        initUI()
    }
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLotList.setUpAdapter(
            data,
            R.layout.item_pile_management_summary,
            ItemPileManagementSummaryBinding::inflate,
            { it, pos, bindItem ->
