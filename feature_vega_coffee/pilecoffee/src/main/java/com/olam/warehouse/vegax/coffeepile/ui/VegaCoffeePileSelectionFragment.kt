...
import com.olam.warehouse.vegax.coffeepile.databinding.FragmentPileManagementPileSelectionBinding
import com.olam.warehouse.vegax.coffeepile.databinding.ItemPileManagmentSelectionBinding
...
class VegaCoffeePileSelectionFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_pile_management_pile_selection
    private lateinit var binding: FragmentPileManagementPileSelectionBinding
    ...
    companion object {
        fun newInstance(
            ...
            VegaCoffeePileSelectionFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentPileManagementPileSelectionBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("pilemanagement/ui//VegaCoffeePileManagementFragment").title("IVC/Coffee/Pile Management/Pile Selection")
            .with(tracker)
        initUI()
    }
...
//                    binding.tvInventory.setBackgroundResource(com.olam.warehouse.presentation.R.drawable.ic_arrow_up)
    ...
    private fun updateAdapter(stockList: MutableList<VegaPileSelectionModel>) {
        ...
        binding.rvInventoryLot.setUpAdapter(
            stockList,
            R.layout.item_pile_managment_selection,
            ItemPileManagmentSelectionBinding::inflate,
            { it, pos, bindItem ->
                ...
                bindItem.checkbox.setOnClickListener { view ->
                    stockList.forEach { it.isChecked = false }
                    stockList[pos].isChecked = !it.isChecked!!
                    if (it.isChecked!!) pileSelection = it
                    binding.rvInventoryLot.adapter?.notifyDataSetChanged()
