...
import com.olam.warehouse.vegax.thirdpartysalescoffee.databinding.ItemCoffeeThirdpartyInventoryLotBinding
...
class VegaCoffeeThirdPartyLotListFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("pilemanagement/ui//VegaCoffeePileManagementFragment").title("IVC/Coffee/Third Party Sales/Lot List")
            .with(tracker)
    }
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_coffee_thirdparty_inventory_lot,
            ItemCoffeeThirdpartyInventoryLotBinding::inflate,
            { it, pos, bindItem ->
