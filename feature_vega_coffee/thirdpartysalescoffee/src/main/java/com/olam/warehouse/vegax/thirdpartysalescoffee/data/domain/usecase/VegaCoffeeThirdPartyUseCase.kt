...
class VegaCoffeeThirdPartyUseCase(private val repository: VegaCoffeeThirdPartyRepository) {
    ...
    suspend fun getTTFeatureMaster(module: String) = repository.getTTFeatureMaster(module)
    ...
    suspend fun postNicDeliveryDetailForWeighScale(vegaDeliveryPost: VegaNicaraguaCoffeeTPDeliveryPost, type: String) =
        repository.postNicDeliveryDetailForWeighScale(vegaDeliveryPost, type)
