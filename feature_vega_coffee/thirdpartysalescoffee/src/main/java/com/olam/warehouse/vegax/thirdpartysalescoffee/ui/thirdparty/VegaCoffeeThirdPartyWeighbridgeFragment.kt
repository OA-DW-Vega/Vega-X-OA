...
import com.olam.warehouse.vegax.thirdpartysalescoffee.databinding.FragmentThirdPartyWeighbridgeLotSelectionBinding
import com.olam.warehouse.vegax.thirdpartysalescoffee.databinding.ItemThirdPartyWeighbridgeBinding
...
import com.olam.warehouse.vegax.thirdpartysalescoffee.utils.WEIGHBRIDGE
import com.olam.warehouse.vegax.thirdpartysalescoffee.utils.WEIGHBRIDGE_ADD_LOT
import com.olam.warehouse.vegax.thirdpartysalescoffee.utils.getColor
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCoffeeThirdPartyWeighbridgeFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_third_party_weighbridge_lot_selection
    private lateinit var binding: FragmentThirdPartyWeighbridgeLotSelectionBinding
    ...
    companion object {
        fun newInstance(type: String) = VegaCoffeeThirdPartyWeighbridgeFragment()
            .putArgs {
                putString("type", type)
            }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentThirdPartyWeighbridgeLotSelectionBinding.inflate(inflater)
            ...
            Resource.Status.SUCCESS -> {
                ...
                response.data?.data?.let {
                    if (it.isNotEmpty()) {
                        vegaWbIds =
                            it.filter {
                                it.batchPicking.isNullOrEmpty() && it.direction.equals(com.olam.warehouse.vegax.thirdpartysalescoffee.utils.DIRECTIONOUT) &&
                                        (it.netWeight == null || it.netWeight == "0" || it.netWeight == "0.000" || it.netWeight == "")
                            } as ArrayList
                        dispatch = vegaWbIds
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUpAdapter(
            dispatch1,
            R.layout.item_third_party_weighbridge,
            ItemThirdPartyWeighbridgeBinding::inflate,
            { it, pos, bindItem ->
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("pilemanagement/ui//VegaCoffeePileManagementFragment").title("IVC/Coffee/Third Party Sales/Weighbridge")
            .with(tracker)
        initUI()
    }
