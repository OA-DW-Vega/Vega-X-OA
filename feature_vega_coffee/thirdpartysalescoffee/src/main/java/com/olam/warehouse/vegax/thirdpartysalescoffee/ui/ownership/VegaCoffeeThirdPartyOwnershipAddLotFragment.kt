...
import com.olam.warehouse.vegax.thirdpartysalescoffee.databinding.FragmentThirdPartyOwnershipAddLotBinding
...
class VegaCoffeeThirdPartyOwnershipAddLotFragment : BaseFragment(), VegaSingleSelectListener {

    private lateinit var saleType: String
    override val layoutResourceId = R.layout.fragment_third_party_ownership_add_lot
    private lateinit var binding: FragmentThirdPartyOwnershipAddLotBinding
    ...
    companion object {
        fun newInstance(type: String) = VegaCoffeeThirdPartyOwnershipAddLotFragment()
            .putArgs {
                putString("type", type)
            }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentThirdPartyOwnershipAddLotBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("thirdpartysalescoffee/ui/VegaThirdPartyOwnershipAddLotFragment")
            .title("IVC/Coffee/Third Party Sales/Ownership Add Lot").with(tracker)
    }
