...
import com.olam.warehouse.vegax.exportsalescoffee.databinding.FragmentExportSalesAddLotBinding
import com.olam.warehouse.vegax.exportsalescoffee.databinding.ItemExportSalesAddLotBinding
import com.olam.warehouse.vegax.exportsalescoffee.utils.CONTAINER_DATA
 ...
 */
class VegaCoffeeExportAddLotFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_export_sales_add_lot
    private val vm: VegaCoffeeExportSalesViewModel by viewModel()
    private var callback: CallBack? = null
    private lateinit var binding: FragmentExportSalesAddLotBinding
    ...
    companion object {
        fun newInstance(container: VegaCoffeeExportSalesContainer, materialList: ArrayList<String>) =
            VegaCoffeeExportAddLotFragment().putArgs {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("exportsalescoffee/ui/VegaCoffeeExportAddLotFragment").title("IVC/Coffee/Export Sales/AddLot")
            .with(tracker)
        initExtra()
        initUI()
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentExportSalesAddLotBinding.inflate(layoutInflater)
    ...
    private fun updateLotAdapter(lots: List<VegaCoffeeExportSalesLots>) {
        ...
        binding.rvLots.setUpAdapter(
            ...
            R.layout.item_export_sales_add_lot,
            ItemExportSalesAddLotBinding::inflate,
            { it, pos, bindItem ->
                val lot = it
