...
import com.olam.warehouse.vegax.exportsalescoffee.databinding.FragmentVegaExportSalesLotsBinding
import com.olam.warehouse.vegax.exportsalescoffee.databinding.ItemVegaCoffeeExportLotsBinding
import com.olam.warehouse.vegax.exportsalescoffee.utils.MATERIAL_LIST
import com.olam.warehouse.vegax.exportsalescoffee.utils.SELECTED_MATERIAL_LIST
import com.olam.warehouse.vegax.exportsalescoffee.utils.getColor
 ...
 */
class VegaCoffeeExportStocksFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_export_sales_lots
    private val vm: VegaCoffeeExportSalesViewModel by viewModel()
    private var callback: CallBack? = null
    private lateinit var binding: FragmentVegaExportSalesLotsBinding
    ...
    companion object {
        fun newInstance(materialList: ArrayList<String>, selectedList: ArrayList<String>) =
            VegaCoffeeExportStocksFragment().putArgs {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("exportsalescoffee/ui/VegaCoffeeExportStocksFragment").title("IVC/Coffee/Export Sales/ExportStocks")
            .with(tracker)
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        setHasOptionsMenu(true)
        binding = FragmentVegaExportSalesLotsBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter = ArrayAdapter(requireContext(), R.layout.item_vega_coffee_export_sales, wareHouseList)
    ...
    private fun setupAdapter(data: MutableList<VegaCoffeeExportSalesLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_vega_coffee_export_lots,
            ItemVegaCoffeeExportLotsBinding::inflate,
            { it, pos, bindItem ->
