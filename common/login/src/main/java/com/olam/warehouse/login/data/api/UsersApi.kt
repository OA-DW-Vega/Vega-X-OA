...
interface UsersApi {
    ...
    suspend fun getUserDetail(
        ...
        @Query("deviceManufacturer") deviceManufacturer: String,
        @Query("avlStorage") availableStorage : String,
    ...
    @GET("x-master/faq/getall")
    suspend fun getFaqAll(): GenericReqAndResp<List<FaqModel>>
}
