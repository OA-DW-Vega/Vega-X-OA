...
class VegaGhanaCocoaDispatchPostWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params),
    KoinComponent {
...
//        val inputDeliveryDetails = inputResponseObj?.deliveryDetails ?: emptyList()
        ...
        var mtntPlantName: String? = ""
        var mtntPlantList = Gson().fromJson<List<Plant>>(PreferenceHelper.get(Constants.MTNT_PLANT_LIST, ""))
...
//            deliveryDetail.batchNumber = item.batchNumber
        deliveryDetail.batchNumber = ""
        deliveryDetail.materialCode = dispatchData.dispatch.materialCode
        deliveryDetail.materialName = dispatchData.dispatch.materialName
            deliveryDetail.plantId = dispatchData.dispatch.plantId
            //deliveryDetail.recPlantId = dispatchData.dispatch.recPlantId
        mtntPlantName = dispatchData.dispatch.destinationWH
        ...
        val departurePointCodeValue = dispatchData.dispatch.departurePoint.toString().split("-")
...
//            deliveryDetail.netWeight = item.editedWeight
        ...
        deliveryDetail.driverLicenseNumber = dispatchData.dispatch.driverLicenseNumber
        val transportVendorCodeValue = dispatchData.dispatch.fromVendorCode.toString().split("-")
...
//            deliveryDetail.endLotFlag = item.isEndLot ?: false
        ...
        val routeCodeValue = dispatchData.dispatch.routeLocCode.toString().split("-")
        deliveryDetail.routeLocCode = routeCodeValue[0]
        deliveryDetail.textId = dispatchData.dispatch.textId
        deliveryDetail.textValue = dispatchData.dispatch.textValue
        deliveryDetail.purchaseQuantity = dispatchData.dispatch.purchaseQuantity
...
//            }
        ...
        deliveryDetail.recStorageLocationCode = dispatchData.dispatch.storageLocationCode
        deliveryDetail.storageLocationCode = dispatchData.dispatch.storageLocationCode
        /*deliveryDetail.recStorageLocationCode = dispatchData.dispatch.storageLocationCode
        deliveryDetail.storageLocationCode = dispatchData.dispatch.recStorageLocationCode*/
        deliveryDetail.netWeight = dispatchData.dispatch.purchaseQuantity
        deliveryDetail.grossWeight = dispatchData.dispatch.purchaseQuantity
...
//                deliveryDetail.grossWeight = grossWeight.toString().trim()
                ...
                bag.bagMaterialCode = dispatchData.dispatch.bagMaterialCode.toString()
                bag.bagType = dispatchData.dispatch.bagType.toString()
                bag.bagCount = dispatchData.dispatch.purchaseQuantity.toString()
                bag.grossWeight = dispatchData.dispatch.grossWeight.toString()
                bag.netWeight = dispatchData.dispatch.netWeight.toString()
                bag.noOfPallet = "0"
                bag.palletAverage = "0"
                bag.palletWeight = "0"
                bag.tareWeight = dispatchData.dispatch.tareWeight.toString()
                bag.unitsOfMeasure = dispatchData.dispatch.unitsOfMeasure.toString()
                val bagSort = arrayListOf<VegaCocoaSweepingBagMaterial>()
                bagSort.add(bag)
                bagItems = bagSort
                deliveryDetail.bagList = bagItems
            ...
            if(it.toString().isNotEmpty()) {
                ...
                if (textValue[1].trim().equals("Z003")) {
                    ...
                    textNavListValues.textValue =
                        dispatchData.dispatch.driverLicenseNumber.toString().plus("/")
                            .plus(dispatchData.dispatch.driverName.toString()).plus("/")
                            .plus(dispatchData.dispatch.driverPhoneNumber.toString())
                    ...
                    textNavListValues.textId = textValue[1].trim()
                    textNavListValues.textValue =
                        dispatchData.dispatch.evacuationCertificateNumber.toString().trim()
                } else if (textValue[1].trim().equals("Z011")) {
                    textNavListValues.textId = textValue[1].trim()
                    textNavListValues.textValue =
                        dispatchData.dispatch.sidingDepotwayBillNumber.toString().trim()
                } else {
                    textNavListValues.textId = textValue[1].trim()
            ...
            val response =
                api.postWeighScaleDeliveryDetails(
                    VegaGhanaMtntDeliveryPost(
                        ...
                        list,
                        "WEIGHSCALE",
                        dispatchData.dispatch.vehicleNumber,
                        dispatchData.dispatch.driverLicenseNumber,
                        "",
                        dispatchData.dispatch.driverPhoneNumber.toString(),
                        dispatchData.dispatch.driverName.toString(),
