 ...
 */
@Dao
abstract class VegaCoCoaQualityDao {
    ...
    @Query("SELECT * FROM VegaCoCoaQualityWBDetail WHERE weighBridgeId = :wbid")
    abstract fun isQualityWBExist(wbid: String): List<VegaCoCoaQualityWBDetail>
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    abstract suspend fun insertWeighBridge(storageLocation: VegaCoCoaQualityWBDetail)
