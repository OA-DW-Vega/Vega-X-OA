...
abstract class VegaCocoaRMinDao {
    ...
    @Query("UPDATE VegaCocoaFgrnItemsGrades SET startTime = :startTime, isRoundOff = :roundOff WHERE fgrnIdMaterialCode = :fgrnIdMaterialCode")
    abstract fun updateFgrnGradeStartTime(
        startTime: String,
        fgrnIdMaterialCode: String,
        roundOff: Boolean?
    )

    @Query("UPDATE VegaCocoaFgrnItemsGrades SET endTime = :endTime, isRoundOff = :roundOff WHERE fgrnIdMaterialCode = :fgrnIdMaterialCode")
    abstract fun updateFgrnGradeEndTime(
        endTime: String,
        fgrnIdMaterialCode: String,
        roundOff: Boolean?
    )
    ...
    @Query("SELECT * FROM VegaCocoaRminProcessing where cgfNo = :cgfNo and poNumber = :poNo and bom = :bomNo")
    abstract fun getRminWithLotListWithoutMaterial(
        cgfNo: String,
        poNo: String,
        bomNo: String
    ): LiveData<VegaCocoaRminItemWithLots>
