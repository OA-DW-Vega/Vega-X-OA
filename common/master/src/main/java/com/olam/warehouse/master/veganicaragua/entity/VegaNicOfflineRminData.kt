...
@Parcelize
@Entity
data class VegaNicOfflineRminData(
//    @ColumnInfo(index = true)
    ...
    @Ignore
    var processingLotDtls: List<VegaNicOfflineRminProcessLotDetails> = emptyList(),
...
data class VegaNicOfflineRminProcessLotDetails(
//    @ColumnInfo(index = true)
    var rminTempId: String = "",
    var bagCount: String? = "",
