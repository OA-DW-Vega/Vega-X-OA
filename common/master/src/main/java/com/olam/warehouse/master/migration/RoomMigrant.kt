...
val MIGRATION_25_26: Migration = object : Migration(25, 26) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE  VegaOffloadingTrucks ADD COLUMN weighMethod TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE  VegaVendor ADD COLUMN werks TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE  VegaReceiving ADD COLUMN postDate TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE  VegaGhanaProcessingOrder ADD COLUMN materialType TEXT DEFAULT ''")
        database.execSQL("CREATE TABLE TempVegaGhanaProcessingOrder (processOrderNo TEXT NOT NULL,plant TEXT,netWeight TEXT,unitsOfMeasure TEXT,materialName TEXT, auart TEXT, materialCode TEXT NOT NULL, rminTotal TEXT, rfgrnTotal TEXT, startDate TEXT, vendor TEXT, storageLocationCode TEXT, materialType TEXT DEFAULT '', PRIMARY KEY(processOrderNo, materialCode) )")
        database.execSQL("INSERT INTO TempVegaGhanaProcessingOrder SELECT * FROM VegaGhanaProcessingOrder")
        database.execSQL("DROP TABLE VegaGhanaProcessingOrder")
        database.execSQL("ALTER TABLE TempVegaGhanaProcessingOrder RENAME TO VegaGhanaProcessingOrder")
        database.execSQL("ALTER TABLE  VegaNicaraguaInvoiceDetails ADD COLUMN postDate TEXT DEFAULT ''")
    }
}
val MIGRATION_26_27: Migration = object : Migration(26, 27) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaNicOfflineRminLots ADD COLUMN warehouseId TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaNicOfflineRminLots ADD COLUMN vendorCode TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCocoaFgrnItems ADD COLUMN vendor TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCocoaSweepingBagMaterial ADD COLUMN isRoundOff INTEGER")
        database.execSQL("ALTER TABLE  VegaCocoaRminProcessing ADD COLUMN atSourceVal TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE  VegaCoffeeRminProcessing ADD COLUMN atSourceVal TEXT DEFAULT ''")
        database.execSQL("CREATE TABLE VegaGhanaCocoaGRNHistoryTransactions (id INTEGER NOT NULL,username TEXT,plantId TEXT,storageLocationCode TEXT,wbId TEXT,grnNumber TEXT,postingDate TEXT,whReceiptNumber TEXT,quantity TEXT,uom TEXT,vendorCode TEXT, PRIMARY KEY(id))")
        database.execSQL("CREATE INDEX IF NOT EXISTS index_VegaGhanaCocoaGRNHistoryTransactions_id ON VegaGhanaCocoaGRNHistoryTransactions(id)")
        database.execSQL("CREATE TABLE VegaGhanaCocoaMtntHistoryTransactions (id INTEGER NOT NULL,username TEXT,plantId TEXT,storageLocCode TEXT,deliveryNumber TEXT,deliveryType TEXT,wbId TEXT,postingDate TEXT,quantity TEXT,uom TEXT,wayBillNumber TEXT,materialCode TEXT,evacuationCertificate TEXT,driverName TEXT,driverContactNumber TEXT,driverLicenseNumber TEXT,truckNumber TEXT,transporterName TEXT,destinationLocation TEXT,grnNumber TEXT,sendingLocation TEXT,transactionStatus TEXT, PRIMARY KEY(id))")
        database.execSQL("CREATE INDEX IF NOT EXISTS index_VegaGhanaCocoaMtntHistoryTransactions_id ON VegaGhanaCocoaMtntHistoryTransactions(id)")
        database.execSQL("CREATE TABLE VegaGhanaCocoaMtnrHistoryTransactions (id INTEGER NOT NULL,username TEXT,plantId TEXT,storageLocCode TEXT,deliveryNumber TEXT,deliveryType TEXT,wbId TEXT,postingDate TEXT,quantity TEXT,uom TEXT,wayBillNumber TEXT,materialCode TEXT,evacuationCertificate TEXT,driverName TEXT,driverContactNumber TEXT,driverLicenseNumber TEXT,truckNumber TEXT,transporterName TEXT,sendingLocation TEXT,destinationLocation TEXT,grnNumber TEXT,transactionStatus TEXT, PRIMARY KEY(id))")
        database.execSQL("CREATE INDEX IF NOT EXISTS index_VegaGhanaCocoaMtnrHistoryTransactions_id ON VegaGhanaCocoaMtnrHistoryTransactions(id)")
    }
}

val MIGRATION_27_28: Migration = object : Migration(27, 28) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaVendor ADD COLUMN storagelocationcodeName TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaNicaraguaMtnt ADD COLUMN mtntDocSequence TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaReceiving ADD COLUMN mtnrDocSequence TEXT DEFAULT ''")
    }
}

val MIGRATION_28_29: Migration = object : Migration(28, 29) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaNicaraguaMtnt ADD COLUMN obdnumber TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaNicDispatchLots ADD COLUMN vendorCode TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaNicDispatchLots ADD COLUMN vendorName TEXT DEFAULT ''")
    }
}

val MIGRATION_29_30: Migration = object : Migration(29, 30) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaReceiving ADD COLUMN tollingVendorCode TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaReceiving ADD COLUMN tollingVendorName TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeReceiving ADD COLUMN tollingVendorCode TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeReceiving ADD COLUMN tollingVendorName TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCameroonOffloadingBagMaterial ADD COLUMN bagType1 TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCameroonOffloadingBagMaterial ADD COLUMN bagCount1 TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCameroonOffloadingBagMaterial ADD COLUMN tareWeight1 TEXT DEFAULT ''")
    }
}
val MIGRATION_30_31: Migration = object : Migration(30, 31) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaNicaraguaGRNInventoryDetails ADD COLUMN availablebagCount TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaNicDispatchLots ADD COLUMN availbagCount TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaNicDispatchLots ADD COLUMN isPartially INTEGER")
    }
}

val MIGRATION_31_32: Migration = object : Migration(31, 32) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaCoffeeRminLots ADD COLUMN palletCount TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeRminLots ADD COLUMN palletWeight TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeFgrnItems ADD COLUMN palletWeight TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeFgrnItems ADD COLUMN palletCount TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCocoaDispatchLots ADD COLUMN palletWeight TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCocoaDispatchLots ADD COLUMN palletCount TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeSalesLots ADD COLUMN palletWeight TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeSalesLots ADD COLUMN palletCount TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeSalesLots ADD COLUMN palletAvg TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeExportSalesLots ADD COLUMN palletWeight TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeExportSalesLots ADD COLUMN palletCount TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoffeeExportSalesLots ADD COLUMN palletAvg TEXT DEFAULT ''")
    }
}

val MIGRATION_32_33: Migration = object : Migration(32, 33) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE  VegaReceiving ADD COLUMN deleteFlag INTEGER")
        database.execSQL("ALTER TABLE VegaCocoaRminProcessing ADD COLUMN operatorName TEXT DEFAULT ''")
    }
}

val MIGRATION_33_34: Migration = object : Migration(33, 34) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("CREATE TABLE VegaWorkflowProcess (processId TEXT NOT NULL,processName TEXT,PRIMARY KEY(processId) )")
        /*adding werks as a primary key into vega vendor table*/
        database.execSQL("CREATE TABLE TempVegaVendor (vendorCode TEXT NOT NULL ,purchaseOrgType TEXT NOT NULL,werks TEXT  NOT NULL DEFAULT '123', vendorAddress TEXT,vendorCity TEXT,countryCode TEXT,vendorName TEXT, vendorType TEXT, vendorAdvLimit TEXT, bcApprover TEXT, vendorCustomerCode TEXT, taxNumber TEXT,  storagelocationcodeName TEXT,  PRIMARY KEY(vendorCode, purchaseOrgType, werks) )")
        database.execSQL("INSERT INTO TempVegaVendor(vendorCode,purchaseOrgType,vendorAddress,vendorCity,countryCode,vendorType,vendorName,vendorAdvLimit,bcApprover,vendorCustomerCode,taxNumber,storagelocationcodeName) SELECT vendorCode,purchaseOrgType,vendorAddress,vendorCity,countryCode,vendorType,vendorName,vendorAdvLimit,bcApprover,vendorCustomerCode,taxNumber,storagelocationcodeName FROM VegaVendor")
        database.execSQL("DROP TABLE VegaVendor")
        database.execSQL("ALTER TABLE TempVegaVendor RENAME TO VegaVendor")
    }
...
val MIGRATION_34_35: Migration = object : Migration(34, 35) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaCocoaDispatchLots ADD COLUMN oldBatchNumber TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCocoaDispatchLots ADD COLUMN binMergedBatchNumber TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaEcuadorDispatchLots ADD COLUMN mergedBatchNumber TEXT DEFAULT ''")
    }
}

val MIGRATION_35_36: Migration = object : Migration(35, 36) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaDispatchLots ADD COLUMN bagType TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaDispatchLots ADD COLUMN totalBagWeight TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaDispatchLots ADD COLUMN totalNoOfBags TEXT DEFAULT ''")

        database.execSQL("ALTER TABLE VegaEcuadorDispatchStocks ADD COLUMN bagType TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaEcuadorDispatchStocks ADD COLUMN totalBagWeight TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaEcuadorDispatchStocks ADD COLUMN totalNoOfBags TEXT DEFAULT ''")
       // database.execSQL("ALTER TABLE VegaNicDispatchLots RENAME COLUMN isPartially TO Partially")
    }
}

val MIGRATION_36_37: Migration = object : Migration(36, 37) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE  VegaPackageMaterial ADD COLUMN isDefault INTEGER")
    }
}

val MIGRATION_38_39: Migration = object : Migration(36, 37) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("CREATE TABLE VegaFeatureMaster (featureName TEXT NOT NULL ,moduleName TEXT NOT NULL,subModuleName TEXT  NOT NULL, screenName TEXT,dataType TEXT,featureDesc TEXT,fieldType TEXT, fieldValue TEXT, featureValue TEXT, mandatory INTEGER, visible INTEGER, maxLength TEXT,  minLength TEXT, moduleDesc TEXT, screenDesc TEXT,  subModuleDesc TEXT,  PRIMARY KEY(featureName, moduleName, subModuleName) )")
        database.execSQL("CREATE TABLE VegaTrackTraceFarmerData (autoId INTEGER NOT NULL ,id INTEGER, countryId TEXT,farmerId TEXT,farmerName TEXT, isComplaint INTEGER, active INTEGER,productId TEXT, createdAt TEXT,  createdBy TEXT, updatedAt TEXT, updatedBy TEXT, PRIMARY KEY(autoId) )")
        database.execSQL("CREATE TABLE TrackTraceFarmerModel (tmpWbId INTEGER NOT NULL ,id INTEGER, supplier TEXT, farmer TEXT,farmerWeight TEXT,uom TEXT, countryId TEXT, countryName TEXT,farmerId TEXT,farmerName TEXT,productName TEXT, isComplaint INTEGER, isActive INTEGER, createdAt TEXT,  createdBy TEXT, updatedAt TEXT, updatedBy TEXT, productId TEXT, PRIMARY KEY(tmpWbId) )")
        database.execSQL("CREATE TABLE TrackTraceSourceLotDetails (autoId INTEGER NOT NULL, id INTEGER ,plant TEXT, countryId TEXT, productCode TEXT,sourceLotId TEXT, vendorCode TEXT, vendorName TEXT,farmerId TEXT,isEudrComplaintFlag INTEGER, createdAt TEXT, updatedAt TEXT,  PRIMARY KEY(autoId) )")
        database.execSQL("ALTER TABLE VegaMaterial ADD COLUMN complainceFlag TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaGateEntry ADD COLUMN sourceLotId TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaGateEntry ADD COLUMN eudrStatus TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaReceiving ADD COLUMN sourceLotId TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaReceiving ADD COLUMN eudrStatus TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoCoaReceiving ADD COLUMN sourceLotId TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaCoCoaReceiving ADD COLUMN eudrStatus TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaMaterial ADD COLUMN eudrEquivalentMap TEXT DEFAULT ''")
    }
}

val MIGRATION_38_40: Migration = object : Migration(38, 40) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE VegaMaterial ADD COLUMN productGroup TEXT DEFAULT ''")
    }
}
...
val MIGRATION_40_41: Migration = object : Migration(40, 41) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("CREATE TABLE TrackTraceTransactionIdDetails (autoId INTEGER NOT NULL ,dwTransactionId TEXT, vendorCode TEXT,vendorName TEXT,country TEXT, product TEXT, totalProductionInMetricTon TEXT,dateGeoLocationCaptured TEXT, compliantFlag INTEGER, PRIMARY KEY(autoId) )")
        database.execSQL("CREATE TABLE TrackTraceFarmerTransDetails (id INTEGER NOT NULL ,tmpWbId TEXT,countryId TEXT, productId TEXT,countryName TEXT,createdAt TEXT, createdBy TEXT, netWeight TEXT,uom TEXT, updatedAt TEXT, updatedBy TEXT, supplierCode TEXT,supplierName TEXT, PRIMARY KEY(id) )")
        database.execSQL("ALTER TABLE TrackTraceFarmerModel ADD COLUMN farmerGroupName TEXT NOT NULL DEFAULT ''")
        database.execSQL("ALTER TABLE TrackTraceFarmerModel ADD COLUMN farmerGroupId TEXT NOT NULL DEFAULT ''")
        database.execSQL("ALTER TABLE VegaTrackTraceFarmerData ADD COLUMN farmerGroupName TEXT NOT NULL DEFAULT ''")
        database.execSQL("ALTER TABLE VegaTrackTraceFarmerData ADD COLUMN farmerGroupId TEXT NOT NULL DEFAULT ''")
        database.execSQL("ALTER TABLE VegaReceiving ADD COLUMN farmerLessTransactionId TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaReceiving ADD COLUMN DESMR TEXT DEFAULT ''")
    }
}

val MIGRATION_41_42: Migration = object : Migration(41, 42) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("ALTER TABLE TrackTraceFarmerModel ADD COLUMN cropLimit REAL DEFAULT 0.0")
        database.execSQL("ALTER TABLE TrackTraceFarmerModel ADD COLUMN uomFromOfis TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaTrackTraceFarmerData ADD COLUMN cropLimit REAL DEFAULT 0.0")
        database.execSQL("ALTER TABLE VegaTrackTraceFarmerData ADD COLUMN uom TEXT DEFAULT ''")
        database.execSQL("ALTER TABLE VegaMaterial ADD COLUMN cropLimit REAL DEFAULT 0.0")
    }

    val MIGRATION_42_43: Migration = object : Migration(42, 43) {
        override fun migrate(database: SupportSQLiteDatabase) {
            database.execSQL("ALTER TABLE VegaCoCoaReceiving ADD COLUMN farmerLessTransactionId TEXT DEFAULT ''")
        }
    }
}
