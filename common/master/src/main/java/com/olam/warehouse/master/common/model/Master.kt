...
data class MasterWrapper(
    ...
    var notificationsModuleList: List<NotifyModuleList>? = emptyList(),
...
//    var wsitemDetails: List<DOQualityWBDetails>? = emptyList(),
    ...
    var fgrnSequence: String? = "",
    var pileSequence: String? = "",
    var fgrnTicketSequence:String?="",
    var workflowProcessList: List<VegaWorkflowProcess>? = emptyList(),
    var workflowDetails: List<VegaWorkflowDetails>? = emptyList(),
    var configFeaturesList: List<VegaFeatureMaster>? = emptyList(),
    var ftdcList: List<ftdcItem>? = emptyList()
    )
