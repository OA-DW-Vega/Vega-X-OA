...
abstract class VegaCoffeeRminDao {
    ...
    abstract fun getMaterialtypelist(): LiveData<List<VegaCocoaMiscellaneous>>
    ...
    @Query("SELECT * FROM VegaCoffeeFgrnGradesMatrialWeights where fgrnId = :fgrnId and materialCode=:materialCode")
    abstract fun getAllFGRNItems(fgrnId: String, materialCode: String): LiveData<VegaCoffeeFgrnGradesMatrialWeights>
    ...
    @Query("SELECT * FROM VegaGhanaProcessingOrder where materialType = :type")
    abstract fun getProcessOrders(type: String): LiveData<List<VegaGhanaProcessingOrder>>
    ...
    @Query("SELECT * FROM VegaCoffeeFgrnItemsGrades where fgrnId = :fgrnId ")
    abstract  fun getRminGradeWithBags(
        fgrnId: String
    ): LiveData<VegaCoffeeFgrnGradesWithBagMatrialWeights>
