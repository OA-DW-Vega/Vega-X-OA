...
interface PortReceivingDao {
    ...
    @Query("UPDATE PortMtnBales SET isOfflineData =1, isVerified = 1, toSloc =:storageId, baleStatus = 'Good' WHERE mtnNumber=:mtnNumber")
    fun updateMtnBalesStatus(mtnNumber: String,storageId:String)
