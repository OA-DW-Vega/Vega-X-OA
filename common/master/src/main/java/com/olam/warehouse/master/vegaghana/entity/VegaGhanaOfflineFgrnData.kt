...
@Parcelize
@Entity
data class VegaGhanaOfflineFgrnData(
//    @ColumnInfo(index = true)
    @PrimaryKey
    var fgrnTempId: String = "",
    var rminTempId: String? = "",
    var processingStage: String? = "",
    var outputMaterialCode: String? = "",
    var plant: String? = null,
    @Ignore
    var processingLotDtls: List<VegaGhanaOfflineFgrnProcessLotDetails> = emptyList(),
...
@Parcelize
@Entity(primaryKeys = ["fgrnTempId"])
data class VegaGhanaOfflineFgrnProcessLotDetails(
//    @ColumnInfo(index = true)
    var fgrnTempId: String = "",
    var rminTempId: String? = "",
    var bagCount: String? = "",
