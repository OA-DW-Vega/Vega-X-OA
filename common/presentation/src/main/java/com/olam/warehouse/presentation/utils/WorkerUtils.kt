...
const val UNIQUE_ONE_TIME_DO_WB_QUALITY_WORKER = "DO_WB_QUALITY_WORKER"
...
const val DO_WB_QUALITY_OUTPUT_DATA = "do_wb_quality_data"
const val SESSION_OUT_DATA = "SESSION_OUT_DATA"
const val UNIQUE_ONE_TIME_FARMER_DATA_WORKER = "TT_Farmer_Data_Worker"
const val FARMER_OUTPUT_DATA = "farmer output data"
const val UNIQUE_ONE_TIME_SOURCE_LOT_WORKER = "TT_Source_Lot_Data_Worker"
const val UNIQUE_ONE_TIME_TRANS_ID_WORKER = "TT_Trans_Id_Data_Worker"
const val SOURCE_LOT_OUTPUT_DATA = "source lot output data"
const val TRANS_ID_OUTPUT_DATA = "transaction id output data"
