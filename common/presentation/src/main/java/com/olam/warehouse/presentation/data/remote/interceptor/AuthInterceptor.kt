...
import com.olam.warehouse.presentation.utils.Constants.CL_Fetch_Origin
...
class AuthInterceptor(context: Context) : Interceptor, KoinComponent {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val request = chain.request()
            ...
            .addHeader(CL_Fetch_Origin, origin)
...
//                            uri = redirectUri,
                            ...
                            if (authResponse?.isSuccessful == true) {
                                ...
                                //context?.sendBroadcast(Intent(SESSION_EXPIRED))
                                context?.sendBroadcast(
                                    Intent(SESSION_EXPIRED).apply {
...
fun getHeader(bearerToken: String): String {
