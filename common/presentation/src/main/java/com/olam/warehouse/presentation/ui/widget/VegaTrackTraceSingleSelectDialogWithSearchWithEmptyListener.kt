...
import com.olam.warehouse.presentation.databinding.CustomTrackTraceSingleSelectDialogLayoutBinding
...
class VegaTrackTraceSingleSelectDialogWithSearchWithEmptyListener(
    private var title: String,
    private var currentFalg: String,
    private var items: List<String>,
    private var activity: Context,
    private var listener: VegaSingleSelectCommonListener,
    private var searchListEmptyListener: String
) :
    Dialog(activity),
    ...
    private lateinit var binding: CustomTrackTraceSingleSelectDialogLayoutBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        requestWindowFeature(Window.FEATURE_NO_TITLE)
        binding = CustomTrackTraceSingleSelectDialogLayoutBinding.inflate(layoutInflater)
    ...
    private fun setAdapter(
        ...
        if(item.isNotEmpty()) {
            ...
            if(searchListEmptyListener.isNotEmpty()){
                setEmptyMsg("")
            }
        }
    }

    private fun setEmptyMsg(data: String){
        binding.llEmptyMsg.visible()
        binding.tvEmptyMsgTitle.setText(searchListEmptyListener)
        binding.tvYes.setOnClickListener { listener.clickOnItem(data,currentFalg) }
