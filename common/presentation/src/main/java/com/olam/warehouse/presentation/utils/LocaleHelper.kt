...
/**
 * Created by SangiliPandian C on 14-11-2019.
 */
object LocaleHelper {
    ...
    private fun load(context: Context): Locale {
        ...
        val language = preferences.getString(SELECTED_LANGUAGE, Locale.getDefault().language) ?: "en"
        val country = preferences.getString(SELECTED_COUNTRY, Locale.getDefault().country) ?: "US"
