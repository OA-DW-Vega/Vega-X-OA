...
import com.olam.warehouse.vegax.bcapproveecuador.databinding.ItemEcuadorBcapproveListBinding
...
class VegaEcuadorBcApproveListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaEcuadorBcApproveWBDetails>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_ecuador_bcapprove_list,
            ItemEcuadorBcapproveListBinding::inflate,
            { it, pos, bindItem ->
                bindItem.tvLotId.text = it.poNumber
                bindItem.tvsupplierid.text = it.supplierName
                bindItem.tvGradeValue.text = it.batchNumber
                bindItem.tvWeightValue.text =
                    it.grnQty.toString().trim().plus(" ").plus(it.unitsOfMeasure)
                bindItem.tvStLocationValue.text = it.wbid
