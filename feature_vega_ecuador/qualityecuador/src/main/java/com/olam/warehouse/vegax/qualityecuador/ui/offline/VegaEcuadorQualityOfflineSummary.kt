package com.olam.warehouse.vegax.qualityecuador.ui.offline
...
import com.olam.warehouse.vegax.qualityecuador.databinding.FragmentVegaEcuadorQualityOfflineBinding
import com.olam.warehouse.vegax.qualityecuador.databinding.ItemVegaEcuadorQtyOfflineBinding
 ...
 */
class VegaEcuadorQualityOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_ecuador_quality_offline
    private val vm: VegaEcuadorQualityViewModel by viewModel()
    private lateinit var binding: FragmentVegaEcuadorQualityOfflineBinding
    private var qualityList = arrayListOf<VegaWeighBridgeWithQualityParams>()
    private var callBack: CallBack? = null

    companion object {
        fun newInstance() = VegaEcuadorQualityOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaEcuadorQualityOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaWeighBridgeWithQualityParams>) {
        ...
        binding.rvOfflineQuality.setUpAdapter(
            qualityList,
            R.layout.item_vega_ecuador_qty_offline,
            ItemVegaEcuadorQtyOfflineBinding::inflate,
            { it, pos, bindItem ->
