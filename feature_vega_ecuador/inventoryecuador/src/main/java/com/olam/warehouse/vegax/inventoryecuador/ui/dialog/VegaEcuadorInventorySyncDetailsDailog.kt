package com.olam.warehouse.vegax.inventoryecuador.ui.dialog
...
import com.olam.warehouse.vegax.inventoryecuador.data.domain.model.SyncStatus
import com.olam.warehouse.vegax.inventoryecuador.databinding.FragmentBottomSheetEcuadorInventorySyncBinding
import com.olam.warehouse.vegax.inventoryecuador.databinding.ItemVegaEcuadorInventorySyncDetailsBinding
import com.olam.warehouse.vegax.inventoryecuador.utils.SYNC_STATUS_DATA
import java.util.*

/**
 * Created by Keerthi Santhanam on 7/6/2020.
 */
class VegaEcuadorInventorySyncDetailsDailog : BottomSheetDialogFragment() {

    private var syncStatusList = ArrayList<SyncStatus>()

    companion object {
        fun newInstance(syncStatusList: ArrayList<SyncStatus>) = VegaEcuadorInventorySyncDetailsDailog().putArgs {
            putParcelableArrayList(SYNC_STATUS_DATA, syncStatusList)
        }
    }

    private lateinit var binding: FragmentBottomSheetEcuadorInventorySyncBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBottomSheetEcuadorInventorySyncBinding.inflate(layoutInflater)
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUpAdapter(
            syncStatusList,
            R.layout.item_vega_ecuador_inventory_sync_details,
            ItemVegaEcuadorInventorySyncDetailsBinding::inflate,
            { it, pos, bindItem ->
