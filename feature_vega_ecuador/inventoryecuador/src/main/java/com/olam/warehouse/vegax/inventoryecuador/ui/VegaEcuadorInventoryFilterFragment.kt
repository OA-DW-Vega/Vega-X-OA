...
import com.olam.warehouse.vegax.inventoryecuador.databinding.ItemVegaEcuadorInventoryFilterBinding
...
class VegaEcuadorInventoryFilterFragment : BaseFragment() {
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            listFilterMaterial,
            R.layout.item_vega_ecuador_inventory_filter,
            ItemVegaEcuadorInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
