...
import com.olam.warehouse.vegax.inventoryecuador.data.domain.model.FilterList
import com.olam.warehouse.vegax.inventoryecuador.databinding.FragmentVegaEcuadorInventoryFilterBinding
import com.olam.warehouse.vegax.inventoryecuador.utils.*
import kotlinx.android.synthetic.main.item_vega_ecuador_inventory_filter.view.*
 ...
 */
class VegaEcuadorInventoryFilterFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_ecuador_inventory_filter
    private lateinit var binding: FragmentVegaEcuadorInventoryFilterBinding
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaEcuadorInventoryFilterFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaEcuadorInventoryFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("inventoryecuador/ui/VegaEcuadorInventoryFilterFragment").title("Inventory Ecuador")
            .with(tracker)
        initUI()
    }
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUp(listFilterMaterial, R.layout.item_vega_ecuador_inventory_filter, { it, pos ->
    ...
    private fun setUpHumidityAdapter(listFilterHumidity: ArrayList<FilterList>) {
        binding.rvHumidity.setUp(listFilterHumidity, R.layout.item_vega_ecuador_inventory_filter, { it, pos ->
    ...
    private fun setUpImpurityAdapter(listFilterImpurity: ArrayList<FilterList>) {
        binding.rvTotalImpurity.setUp(listFilterImpurity, R.layout.item_vega_ecuador_inventory_filter, { it, pos ->
    ...
    private fun setUpMouldAdapter(listFilterMould: ArrayList<FilterList>) {
        binding.rvMould.setUp(listFilterMould, R.layout.item_vega_ecuador_inventory_filter, { it, pos ->
