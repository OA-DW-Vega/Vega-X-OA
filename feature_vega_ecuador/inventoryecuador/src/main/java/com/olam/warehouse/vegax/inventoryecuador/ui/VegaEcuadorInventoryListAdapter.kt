...
import com.olam.warehouse.vegax.inventoryecuador.databinding.ItemVegaEcuadorMaterialDetailsBinding
...
class VegaEcuadorInventoryChildAdapter(
    ...
    override fun onBindViewHolder(holder: ChildViewHolder, position: Int) {
        ...
        holder.bindChild.rvMaterial.setUpAdapter(
            materialsList,
            R.layout.item_vega_ecuador_material_details,
            ItemVegaEcuadorMaterialDetailsBinding::inflate,
            { it, pos, bindItem ->
                bindItem.tvHumidityValue.text = it.averageHumidity.toDouble().formatThreeDigits()
                bindItem.tvWeightValue.text = it.totalWeight.plus(" QE")
