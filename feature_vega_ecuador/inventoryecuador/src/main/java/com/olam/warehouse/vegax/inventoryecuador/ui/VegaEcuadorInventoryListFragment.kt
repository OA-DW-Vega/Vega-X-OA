...
import com.olam.warehouse.vegax.inventoryecuador.ui.dialog.VegaEcuadorInventorySyncDetailsDailog
import com.olam.warehouse.vegax.inventoryecuador.utils.INVENTORY_CODE
import com.olam.warehouse.vegax.inventoryecuador.utils.INVENTORY_DETAILS
import com.olam.warehouse.vegax.inventoryecuador.utils.INVENTORY_LOTS
 ...
 */
class VegaEcuadorInventoryListFragment : BaseFragment(),
    VegaEcuadorInventoryNavigateToDetailsListener {
    ...
    companion object {
        fun newInstance() = VegaEcuadorInventoryListFragment().putArgs {
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("inventoryecuador/ui/VegaEcuadorInventoryListFragment").title("Ecuador Inventory").with(tracker)
    ...
    private fun syncDetails() {
        val bottomDialog = VegaEcuadorInventorySyncDetailsDailog.newInstance(syncStatusList)
    ...
    private fun setAdapter(data: List<VegaInventoryWarehouseModel>) {
        ...
        binding.rvInventory.adapter = VegaEcuadorInventoryParentAdapter(data, materialList, this)
    }
