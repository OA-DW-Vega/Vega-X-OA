...
import com.olam.warehouse.vegax.exportsalesecuador.databinding.FragmentEcuadorCocoaExportSalesAddLotBinding
import com.olam.warehouse.vegax.exportsalesecuador.databinding.ItemEcuadorCocoaExportSalesAddLotBinding
import com.olam.warehouse.vegax.exportsalesecuador.utils.CONTAINER_DATA
 ...
 */
class VegaEcuadorCocoaExportAddLotFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_ecuador_cocoa_export_sales_add_lot
    private val vm: VegaEcuadorCocoaExportSalesViewModel by viewModel()
    private var callback: CallBack? = null
    private lateinit var binding: FragmentEcuadorCocoaExportSalesAddLotBinding
    ...
    companion object {
        fun newInstance(container: VegaCoffeeExportSalesContainer, materialList: ArrayList<String>) =
            VegaEcuadorCocoaExportAddLotFragment().putArgs {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("exportsalesecuador/ui/VegaCoffeeExportAddLotFragment").title("Export Sales")
            .with(tracker)
        initExtra()
        initUI()
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentEcuadorCocoaExportSalesAddLotBinding.inflate(layoutInflater)
    ...
    private fun updateLotAdapter(lots: List<VegaCoffeeExportSalesLots>) {
        ...
        binding.rvLots.setUpAdapter(
            ...
            R.layout.item_ecuador_cocoa_export_sales_add_lot,
            ItemEcuadorCocoaExportSalesAddLotBinding::inflate,
            { it, pos, bindItem ->
                val lot = it
