...
import com.olam.warehouse.vegax.exportsalesecuador.databinding.FragmentVegaEcuadorCocoaExportSalesLotsBinding
import com.olam.warehouse.vegax.exportsalesecuador.databinding.ItemVegaEcuadorCocoaExportLotsBinding
import com.olam.warehouse.vegax.exportsalesecuador.utils.MATERIAL_LIST
import com.olam.warehouse.vegax.exportsalesecuador.utils.SELECTED_MATERIAL_LIST
import com.olam.warehouse.vegax.exportsalesecuador.utils.getColor
 ...
 */
class VegaEcuadorCocoaExportStocksFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_ecuador_cocoa_export_sales_lots
    private val vm: VegaEcuadorCocoaExportSalesViewModel by viewModel()
    private var callback: CallBack? = null
    private lateinit var binding: FragmentVegaEcuadorCocoaExportSalesLotsBinding
    ...
    companion object {
        fun newInstance(materialList: ArrayList<String>, selectedList: ArrayList<String>) =
            VegaEcuadorCocoaExportStocksFragment().putArgs {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("exportsalesecuador/ui/VegaCoffeeExportStocksFragment").title("Export Sales")
            .with(tracker)
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        setHasOptionsMenu(true)
        binding = FragmentVegaEcuadorCocoaExportSalesLotsBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter = ArrayAdapter(requireContext(), R.layout.item_vega_ecuador_cocoa_export_sales, wareHouseList)
    ...
    private fun setupAdapter(data: MutableList<VegaCoffeeExportSalesLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_vega_ecuador_cocoa_export_lots,
            ItemVegaEcuadorCocoaExportLotsBinding::inflate,
            { it, pos, bindItem ->
