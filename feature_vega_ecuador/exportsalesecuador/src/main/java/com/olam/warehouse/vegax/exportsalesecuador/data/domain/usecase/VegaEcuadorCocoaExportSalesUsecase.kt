package com.olam.warehouse.vegax.exportsalesecuador.data.domain.usecase
 ...
 */
class VegaEcuadorCocoaExportSalesUsecase(val repo: VegaCoffeeExportSalesRepository) {
