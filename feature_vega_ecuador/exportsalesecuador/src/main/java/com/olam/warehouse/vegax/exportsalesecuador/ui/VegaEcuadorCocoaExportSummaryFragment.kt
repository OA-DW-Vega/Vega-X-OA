...
import com.olam.warehouse.vegax.exportsalesecuador.data.domain.model.VegaCoffeeExportSalesDeliveryDetail
...
import com.olam.warehouse.vegax.exportsalesecuador.databinding.FragmentExportEcuadorCocoaSummaryBinding
import com.olam.warehouse.vegax.exportsalesecuador.databinding.ItemExportEcuadorCocoaSummaryBinding
import com.olam.warehouse.vegax.exportsalesecuador.utils.*
 ...
 */
class VegaEcuadorCocoaExportSummaryFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_export_ecuador_cocoa_summary
    private val vm: VegaEcuadorCocoaExportSalesViewModel by viewModel()
    private var callback: CallBack? = null
    private lateinit var binding: FragmentExportEcuadorCocoaSummaryBinding
    ...
    companion object {
        ...
        ) = VegaEcuadorCocoaExportSummaryFragment().putArgs {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("exportsalesecuador/ui/VegaCoffeeExportSummaryFragment").title("Export Sales")
            .with(tracker)
        initExtra()
        initUI()
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentExportEcuadorCocoaSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun updateContainerAdapter(data: VegaCoffeeExportOTWithContainer) {
        ...
        binding.rvLots.setUpAdapter(
            containerList,
            R.layout.item_export_ecuador_cocoa_summary,
            ItemExportEcuadorCocoaSummaryBinding::inflate,
            { it, pos, bindItem ->
