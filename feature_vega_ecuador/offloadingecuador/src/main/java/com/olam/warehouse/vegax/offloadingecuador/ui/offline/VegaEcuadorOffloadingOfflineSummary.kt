package com.olam.warehouse.vegax.offloadingecuador.ui.offline
...
import com.olam.warehouse.vegax.offloadingecuador.databinding.ActivityVegaEcuaOffloadingOfflineSummaryBinding
import com.olam.warehouse.vegax.offloadingecuador.databinding.ItemVagaEcuaOffloadingOfflineSummaryBinding
 ...
 */
class VegaEcuadorOffloadingOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.activity_vega_ecua_offloading_offline_summary
    private val vm: VegaEcuadorOffloadingViewModel by viewModel()
    private lateinit var binding: ActivityVegaEcuaOffloadingOfflineSummaryBinding
    ...
    companion object {
        fun newInstance() = VegaEcuadorOffloadingOfflineSummary().putArgs {
        }
    }
   ...
   /* interface CallBack {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = ActivityVegaEcuaOffloadingOfflineSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(offloadingItems1: ArrayList<VegaEcuaOffloadingWithLineItems>) {
        ...
        binding.rvReceivingOffline.setUpAdapter(
            offloadingItems,
            R.layout.item_vaga_ecua_offloading_offline_summary,
            ItemVagaEcuaOffloadingOfflineSummaryBinding::inflate,
            { it, pos, bindItem ->
