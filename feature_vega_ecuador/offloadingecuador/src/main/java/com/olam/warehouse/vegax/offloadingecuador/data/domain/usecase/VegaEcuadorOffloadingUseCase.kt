package com.olam.warehouse.vegax.offloadingecuador.data.domain.usecase
 ...
 */
class VegaEcuadorOffloadingUseCase(private val repository: VegaEcuadorOffloadingRepository) {
