...
import com.olam.warehouse.vegax.localsalesecuador.databinding.FragmentEcuadorCocoaSalesAddPalletBinding
import com.olam.warehouse.vegax.localsalesecuador.databinding.ItemCoffeeSalesPalletBagInfoBinding
import com.olam.warehouse.vegax.localsalesecuador.utils.ADD_WEIGHT
import com.olam.warehouse.vegax.localsalesecuador.utils.LOT_DETAIL
import com.olam.warehouse.vegax.localsalesecuador.utils.getColor
import com.olam.warehouse.vegax.localsalesecuador.utils.prepareCocoaBagMaterial
 ...
 */
class VegaEcuadorCocoaSalesPalletFragment : BaseFragment() {

    override val layoutResourceId: Int = R.layout.fragment_ecuador_cocoa_sales_add_pallet
    private lateinit var binding: FragmentEcuadorCocoaSalesAddPalletBinding
    ...
    companion object {
        fun newInstance(item: VegaCoffeeSalesLots) = VegaEcuadorCocoaSalesPalletFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentEcuadorCocoaSalesAddPalletBinding.inflate(inflater)
        initUI()
        return binding.root
    }
...
//        callBack?.replaceFragment(UPDATE_WEIGHT, binding.tvNetWtValue.text.toString())
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCoffeeSalesBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(),
            R.layout.item_coffee_sales_pallet_bag_info,
            ItemCoffeeSalesPalletBagInfoBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
