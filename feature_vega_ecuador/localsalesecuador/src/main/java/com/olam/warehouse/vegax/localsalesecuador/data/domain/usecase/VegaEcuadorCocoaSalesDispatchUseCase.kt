package com.olam.warehouse.vegax.localsalesecuador.data.domain.usecase
...
class VegaEcuadorCocoaSalesDispatchUseCase(private val repo: VegaCoffeeSalesRepository) {
