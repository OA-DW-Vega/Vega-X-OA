...
import com.olam.warehouse.vegax.localsalesecuador.databinding.FragmentEcuadorCocoaSalesAddLotBinding
...
class VegaEcuadorCocoaSalesAddLotFragment : BaseFragment(), RecyclerViewItemClickListener {
    ...
    override val layoutResourceId: Int = R.layout.fragment_ecuador_cocoa_sales_add_lot
    private lateinit var binding: FragmentEcuadorCocoaSalesAddLotBinding

    companion object {
        fun newInstance(dispatch: VegaCoffeeSalesOrder, dispatchType: String) =
            VegaEcuadorCocoaSalesAddLotFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentEcuadorCocoaSalesAddLotBinding.inflate(inflater)
        initExtra()
        initUI()
        /*listener = this*/
        return binding.root
