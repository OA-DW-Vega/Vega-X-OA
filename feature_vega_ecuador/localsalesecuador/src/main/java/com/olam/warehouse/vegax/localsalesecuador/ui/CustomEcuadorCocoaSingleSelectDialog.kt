...
import com.olam.warehouse.vegax.localsalesecuador.databinding.CustomEcuadorCocoaDialogLayoutSalesBinding
import com.olam.warehouse.vegax.localsalesecuador.databinding.FilterEcuadorCocoaItemsSalesBinding

class CustomEcuadorCocoaSingleSelectDialog(
    ...
    private lateinit var binding: CustomEcuadorCocoaDialogLayoutSalesBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        requestWindowFeature(Window.FEATURE_NO_TITLE)
        binding = CustomEcuadorCocoaDialogLayoutSalesBinding.inflate(layoutInflater)
    ...
    private fun setAdapter(
        ...
        binding.recyclerView.setUpAdapter(
            item,
            R.layout.filter_ecuador_cocoa_items_sales,
            FilterEcuadorCocoaItemsSalesBinding::inflate,
            { it, pos, bindItem ->
