...
import com.olam.warehouse.vegax.localsalesecuador.databinding.FragmentEcuadorCocoaSalesWbAddLotBinding
import com.olam.warehouse.vegax.localsalesecuador.databinding.ItemEcuadorCocoaSalesLotBinding
import com.olam.warehouse.vegax.localsalesecuador.ui.CustomEcuadorCocoaSingleSelectDialog
import com.olam.warehouse.vegax.localsalesecuador.ui.RecyclerViewItemClickListener
...
class VegaEcuadorCocoaSalesWeighbridgeAddLotFragment : BaseFragment(), RecyclerViewItemClickListener {
    ...
    private var customDialog: CustomEcuadorCocoaSingleSelectDialog? = null
    private var editLotId: String = ""
    private var editLotMaterial: String = ""


    override val layoutResourceId: Int = R.layout.fragment_ecuador_cocoa_sales_wb_add_lot
    private lateinit var binding: FragmentEcuadorCocoaSalesWbAddLotBinding

    companion object {
        fun newInstance(dispatch: VegaCoffeeSalesOrder, dispatchType: String) =
            VegaEcuadorCocoaSalesWeighbridgeAddLotFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentEcuadorCocoaSalesWbAddLotBinding.inflate(inflater)
        initExtra()
        initUI()
        /*listener = this*/
        return binding.root
    ...
    private fun showSingleSelectDialog(isWh: Boolean, title: String) {
        customDialog =
            CustomEcuadorCocoaSingleSelectDialog(title, isWh, soNumbers, requireActivity(), this)
        customDialog?.show()
    ...
    private fun setUpAdapter(lineItems: MutableList<VegaCoffeeSalesLotWithbags>) {
        ...
        binding.rvLots.setUpAdapter(
            ...
            R.layout.item_ecuador_cocoa_sales_lot,
            ItemEcuadorCocoaSalesLotBinding::inflate,
            { it, pos, bindItem ->
                val lot = it.salesLot
