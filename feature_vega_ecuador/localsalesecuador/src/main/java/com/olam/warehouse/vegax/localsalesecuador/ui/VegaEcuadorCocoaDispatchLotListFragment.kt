...
import com.olam.warehouse.vegax.localsalesecuador.databinding.FragmentEcuadorCocoaSalesLotListBinding
import com.olam.warehouse.vegax.localsalesecuador.databinding.ItemCoffeeSalesLotListDetailBinding
import com.olam.warehouse.vegax.localsalesecuador.utils.MATERIAL_LIST
import com.olam.warehouse.vegax.localsalesecuador.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.localsalesecuador.utils.getColor
import com.olam.warehouse.vegax.localsalesecuador.utils.listOfField
import org.koin.androidx.viewmodel.ext.android.viewModel

/**
 * Created by Baskaran Kannan on 8/22/2020.
 */
class VegaEcuadorCocoaDispatchLotListFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_ecuador_cocoa_sales_lot_list
    private lateinit var binding: FragmentEcuadorCocoaSalesLotListBinding
    ...
    companion object {
        fun newInstance(model: VegaCoffeeSalesOrder, materialList: ArrayList<String>, isMultipleAdd: Boolean = true) =
            VegaEcuadorCocoaDispatchLotListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        setHasOptionsMenu(true)
        binding = FragmentEcuadorCocoaSalesLotListBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
...
//        setupAdapter(dispatchLotsList)
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter = ArrayAdapter(requireContext(), R.layout.item_vega_ecuador_cocoa_dispatch_wh, wareHouseList)
