package com.olam.warehouse.vegax.pileecuador.ui.data.domain.model
...
data class EcuadorFilterList(val value: String, var isSelected: Boolean = false)

data class VegaEcuadorThirdPartyPileLotListModel(
...
data class VegaCoffeeRminProcessingPost(
    ...
    var processingLotDtls: List<VegaEcuadorProcessingRMINLotDetails> = emptyList(),
...
data class VegaCoffeeProcessingFgrnPost(
    ...
    var outputMaterialCode: String? = "",
    var plant: Plant? = null,
    var processingLotDtls: List<EcuadorProcessingFgrnLotDetails> = emptyList(),
    var rmin: Boolean? = false,
    var shiftType: String? = "",
...
data class EcuadorProcessingFgrnLotDetails(
    var bagCount: String? = "",
    var batchNumber: String? = "",
    var confText: String? = "",
    var deliveryItem: String? = "",
