...
import com.olam.warehouse.vegax.pileecuador.databinding.FragmentEcuadorPileManagementPileSelectionBinding
import com.olam.warehouse.vegax.pileecuador.databinding.ItemEcuadorPileManagmentSelectionBinding
import com.olam.warehouse.vegax.pileecuador.ui.data.domain.model.VegaPileSelectionModel
import com.olam.warehouse.vegax.pileecuador.ui.data.domain.model.VegaPileSequence
import com.olam.warehouse.vegax.pileecuador.ui.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaEcuadorPileSelectionFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_ecuador_pile_management_pile_selection
    private lateinit var binding: FragmentEcuadorPileManagementPileSelectionBinding
    ...
    companion object {
        fun newInstance(
            ...
            VegaEcuadorPileSelectionFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentEcuadorPileManagementPileSelectionBinding.inflate(layoutInflater)
        return binding.root
    }
...
//                    binding.tvInventory.setBackgroundResource(com.olam.warehouse.presentation.R.drawable.ic_arrow_up)
    ...
    private fun updateAdapter(stockList: MutableList<VegaPileSelectionModel>) {
        ...
        binding.rvInventoryLot.setUpAdapter(
            stockList,
            R.layout.item_ecuador_pile_managment_selection,
            ItemEcuadorPileManagmentSelectionBinding::inflate,
            { it, pos, bindItem ->
