...
import com.olam.warehouse.vegax.pileecuador.databinding.FragmentEcuadorPileManagementLotListBinding
import com.olam.warehouse.vegax.pileecuador.databinding.ItemEcuadorPileManagementLotListCardBinding
import com.olam.warehouse.vegax.pileecuador.ui.data.domain.model.VegaEcuadorThirdPartyPileLotListModel
import com.olam.warehouse.vegax.pileecuador.ui.utils.getColor
import com.olam.warehouse.vegax.pileecuador.ui.utils.listOfField
import org.koin.androidx.viewmodel.ext.android.viewModel

class VegaEcuadorPileManagementLotListFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_ecuador_pile_management_lot_list
    private lateinit var binding: FragmentEcuadorPileManagementLotListBinding
    private val vm: VegaEcuadorPileManagementViewModel by viewModel()
    ...
    private var listener: VegaEcuadorPileManagementAddLotListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        listener = context as? VegaEcuadorPileManagementAddLotListener
    }

    companion object {
        fun newInstance(
            vegaLotModel: VegaEcuadorThirdPartyPileLotListModel
        ) =
            VegaEcuadorPileManagementLotListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        setHasOptionsMenu(true)
        binding = FragmentEcuadorPileManagementLotListBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_ecuador_pile_management_lot_list_card,
            ItemEcuadorPileManagementLotListCardBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter = ArrayAdapter(requireContext(), R.layout.item_vega_ecuador_pile_management_wh, wareHouseList)
