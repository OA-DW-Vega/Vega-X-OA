...
import com.olam.warehouse.vegax.pileecuador.databinding.FragmentEcuadorPileManagementSummaryBinding
import com.olam.warehouse.vegax.pileecuador.databinding.ItemEcuadorPileManagementSummaryBinding
import com.olam.warehouse.vegax.pileecuador.ui.data.domain.model.VegaCoffeePilePostRequest
import com.olam.warehouse.vegax.pileecuador.ui.data.domain.model.VegaCoffeePileResponse
import com.olam.warehouse.vegax.pileecuador.ui.data.domain.model.VegaPileSelectionModel
import com.olam.warehouse.vegax.pileecuador.ui.utils.MATERIAL_LIST
import com.olam.warehouse.vegax.pileecuador.ui.utils.PILE_LIST
import com.olam.warehouse.vegax.pileecuador.ui.utils.PILE_MANAGEMENT_SUMMARY
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaEcuadorPileManagementSummaryFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_ecuador_pile_management_summary
    private lateinit var binding: FragmentEcuadorPileManagementSummaryBinding
    ...
    companion object {
        fun newInstance(
            ...
            VegaEcuadorPileManagementSummaryFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentEcuadorPileManagementSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLotList.setUpAdapter(
            data,
            R.layout.item_ecuador_pile_management_summary,
            ItemEcuadorPileManagementSummaryBinding::inflate,
            { it, pos, bindItem ->
