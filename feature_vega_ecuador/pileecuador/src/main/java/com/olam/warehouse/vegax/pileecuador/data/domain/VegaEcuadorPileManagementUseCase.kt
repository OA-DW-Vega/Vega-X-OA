package com.olam.warehouse.vegax.pileecuador.ui.data.domain
...
class VegaEcuadorPileManagementUseCase(private val repository: VegaEcuadorPileManagementRepository) {
