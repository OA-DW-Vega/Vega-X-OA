...
import com.olam.warehouse.vegax.dispatchecuador.databinding.ItemEcuadorDispatchLotListDetailBinding
...
class VegaEcuadorDispatchLotListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaEcuadorDispatchLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_ecuador_dispatch_lot_list_detail,
            ItemEcuadorDispatchLotListDetailBinding::inflate,
            { it, pos, bindItem ->
