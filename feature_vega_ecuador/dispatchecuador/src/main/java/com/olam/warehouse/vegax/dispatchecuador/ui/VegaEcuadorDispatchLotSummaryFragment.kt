...
import kotlinx.android.synthetic.main.fragment_ecuador_dispatch_summary.view.ivEdit
import kotlinx.android.synthetic.main.item_lot_dispatch_summary.*
import kotlinx.android.synthetic.main.item_lot_dispatch_summary.view.*
import kotlinx.android.synthetic.main.item_vega_ecuador_dispatch_material_details.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel

/**
 * Created by Keerthi Santhanam on 7/25/2020.
 */
class VegaEcuadorDispatchLotSummaryFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(model: VegaEcuadorDispatch, dispatchLotList: ArrayList<VegaEcuadorDispatchLots>) =
            VegaEcuadorDispatchLotSummaryFragment().putArgs {
    ...
    private fun setUpMaterialAdapter(list: MutableList<VegaEcuadorDispatchPurchaseOrders>) {
        ...
        binding.rvMaterial.setUp(list, R.layout.item_vega_ecuador_dispatch_material_details, { it, pos ->
    ...
    private fun setupAdapter() {
        ...
        binding.rvLotList.setUp(dispatchLotsList, R.layout.item_lot_dispatch_summary, { it, pos ->
