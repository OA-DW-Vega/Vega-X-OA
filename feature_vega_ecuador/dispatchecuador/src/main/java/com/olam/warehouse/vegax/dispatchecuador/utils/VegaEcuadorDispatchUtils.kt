package com.olam.warehouse.vegax.dispatchecuador.utils
...
const val WEIGHBRIDGE_METHOD = "WB"
const val WEIGHSCALE_METHOD = "WS"
var FRAG_TYPE = "WS"
var weighBridgeId = "123"

fun getTmpId() = "TMP_".plus(Random.nextLong().toString())
var ttFeatureListDisPatch = java.util.ArrayList<VegaFeatureMaster>()
