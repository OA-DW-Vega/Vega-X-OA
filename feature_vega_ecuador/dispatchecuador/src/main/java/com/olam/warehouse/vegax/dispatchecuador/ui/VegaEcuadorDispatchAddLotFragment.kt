...
import kotlinx.android.synthetic.main.item_ecuador_dispatch_layout_lot_summary.view.*
...
class VegaEcuadorDispatchAddLotFragment : BaseFragment(), VegaEcuadorRecyclerViewItemClickListener {
    ...
    private fun setUpLotsAdapter(list: MutableList<VegaEcuadorDispatchLots>) {
        binding.rvLots.setUp(list, R.layout.item_ecuador_dispatch_layout_lot_summary, { item, pos ->
