...
import com.olam.warehouse.vegax.dispatchecuador.databinding.ItemEcuadorDispatchMergeLotListDetailBinding
...
class VegaEcuadorDispatchMergeFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaEcuadorDispatchLots>) {
        binding.rvSelectLots.setUpAdapter(
            data,
            R.layout.item_ecuador_dispatch_merge_lot_list_detail,
            ItemEcuadorDispatchMergeLotListDetailBinding::inflate,
            { it, pos, bindItem ->
