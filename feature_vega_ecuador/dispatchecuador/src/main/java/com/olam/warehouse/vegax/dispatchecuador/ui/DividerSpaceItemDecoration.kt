...
import com.olam.warehouse.master.vegaecuador.model.VegaEcuadorWbDispatchLots
...
class DividerSpaceItemDecorationWb(
    private val verticalSpaceHeight: Int,
    private val dispatchLotsList: MutableList<VegaEcuadorWbDispatchLots>
) :
    RecyclerView.ItemDecoration() {
