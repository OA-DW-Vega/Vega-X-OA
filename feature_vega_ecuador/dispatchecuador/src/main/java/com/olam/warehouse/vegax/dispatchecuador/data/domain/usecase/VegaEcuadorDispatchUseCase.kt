...
import com.olam.warehouse.master.vegaecuador.model.VegaEcuadorWbDeliveryPost
...
class VegaEcuadorDispatchUseCase(private val repository: VegaEcuadorDispatchRepository) {
    ...
    suspend fun postWbDeliveryDetail(vegaDeliveryPost: VegaEcuadorWbDeliveryPost) =
        repository.postWbDeliveryDetail(vegaDeliveryPost)
    ...
    suspend fun getTruckLists() = repository.getTrucks()
}
