 ...
 */
class VegaEcuadorCocoaRminViewModel(private val useCase: VegaEcuadorProcessingUseCase, private val dispatchers: AppDispatchers) :
    BaseViewModel() {
    ...
    private var postRminSource: LiveData<Resource<GenericReqAndResp<List<VegaEcuadorProcessingRminResponse>>>> =
        MutableLiveData()
    private val _postRmin = MediatorLiveData<Resource<GenericReqAndResp<List<VegaEcuadorProcessingRminResponse>>>>()
    val postRmin: LiveData<Resource<GenericReqAndResp<List<VegaEcuadorProcessingRminResponse>>>> get() = _postRmin
    ...
    fun fetchBomList(bomPostReq: VegaEcuadorProcessingRminBomPost) =
        viewModelScope.launch(dispatchers.main) {
    ...
    fun postRmin(poReq: VegaEcuadorRminProcessingPost) = viewModelScope.launch(dispatchers.main) {
    ...
    fun createPoRequest(poReq: VegaEcuadorProcessingCreatePoReq) = viewModelScope.launch(dispatchers.main) {
