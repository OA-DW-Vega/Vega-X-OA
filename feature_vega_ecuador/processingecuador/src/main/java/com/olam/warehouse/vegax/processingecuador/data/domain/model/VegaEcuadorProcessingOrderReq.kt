...
class VegaEcuadorProcessingOrderReq(
    var key: String? = "",
    var auart: String? = "",
    var cfgNo: String? = "",
    var fevor: String? = "",
...
data class VegaEcuadorRminProcessingPost(
...
data class VegaEcuadorProcessingRminResponse(
...
data class VegaEcuadorProcessingCreatePoReq(
    var cfgNo: String = "",
    var processingStage: String? = "",
    var batchNumber: String = "",
    var key: String? = "",
