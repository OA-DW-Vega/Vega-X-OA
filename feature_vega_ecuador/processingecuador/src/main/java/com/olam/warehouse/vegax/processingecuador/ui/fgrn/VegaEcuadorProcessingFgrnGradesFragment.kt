...
import com.olam.warehouse.vegax.processingecuador.databinding.FragmentVegaEcuadorProcessingFgrnGradesBinding
import com.olam.warehouse.vegax.processingecuador.databinding.ItemVegaEcuadorProcessingFgrnGradesBinding
...
class VegaEcuadorProcessingFgrnGradesFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_ecuador_processing_fgrn_grades
    private lateinit var binding: FragmentVegaEcuadorProcessingFgrnGradesBinding
    ...
    companion object {
        fun newInstance(model: VegaCocoaFgrnItems, id: String) = VegaEcuadorProcessingFgrnGradesFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaEcuadorProcessingFgrnGradesBinding.inflate(layoutInflater)
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCocoaFgrnItemsGrades>) {
        binding.rvGrades.setUpAdapter(
            gradeList,
            R.layout.item_vega_ecuador_processing_fgrn_grades,
            ItemVegaEcuadorProcessingFgrnGradesBinding::inflate,
            { item, pos, bindItem ->
