...
data class VegaEcuadorProcessingInventoryWarehouseModel(
...
data class VegaEcuadorProcessingInventoryAndSyncModel(
    var inventories: List<VegaEcuadorProcessingInventoryWarehouseModel>,
...
data class EcuadorProcessingInventory(
...
data class IndiaCoffeeStorageLoc(
    val inventory: List<EcuadorProcessingInventory>,
    val kor: String? = "",
...
data class VegaEcuadorProcessingInventoryStocks(
