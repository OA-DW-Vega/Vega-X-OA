...
import com.olam.warehouse.vegax.processingecuador.databinding.FragmentVegaEcuadorProcessingQualityParamsBinding
import com.olam.warehouse.vegax.processingecuador.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaEcuadorProcessingQualityFragment : BaseFragment() {

    private var qualityParameterList = arrayListOf<VegaQualityParameter?>()
    private var mAdapter = VegaEcuadorProcessingQualityAdapter { enableProceedBtn(it) }
    ...
    private var callBack: VegaEcuadorProcessingQualityFragment.CallBack? = null
    ...
    companion object {
        fun newInstance(model: VegaCocoaFgrnItems, id: String) =
            VegaEcuadorProcessingQualityFragment().putArgs {
                putParcelable(FRAG_LOTS, model)
                putString(FRAG_ID, id)
            }
    }

    private lateinit var binding: FragmentVegaEcuadorProcessingQualityParamsBinding
    override val layoutResourceId = R.layout.fragment_vega_ecuador_processing_quality_params
    ...
    override fun onCreateView(
        ...
        binding = FragmentVegaEcuadorProcessingQualityParamsBinding.inflate(layoutInflater)
        return binding.root
    }
