...
import com.olam.warehouse.vegax.processingecuador.databinding.FragmentAddLotRminEcuadorCocoaBinding
import com.olam.warehouse.vegax.processingecuador.databinding.ItemLotInfoEcuadorCocoaBinding
import com.olam.warehouse.vegax.processingecuador.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaEcuadorCocoaRminAddLotFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_add_lot_rmin_ecuador_cocoa
    private lateinit var binding: FragmentAddLotRminEcuadorCocoaBinding
    ...
    companion object {
        fun newInstance(fromSummary: Boolean, model: VegaCocoaRminProcessing) =
            VegaEcuadorCocoaRminAddLotFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentAddLotRminEcuadorCocoaBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
...
//        vm.getLotList(model?.cgfNo ?: "", model?.poNumber ?: "", model?.bom ?: "", model?.materialName ?: "")
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingecuador/ui/rmin/VegaCocoaRminAddLotFragment")
            .title("Rmin Cocoa")
            .with(tracker)
    }
    ...
    private fun setUpAdapter(list: MutableList<VegaCocoaRminLots>) {
        binding.rvList.setUpAdapter(
            list,
            R.layout.item_lot_info_ecuador_cocoa,
            ItemLotInfoEcuadorCocoaBinding::inflate,
            { item, pos, bindItem ->
