...
import kotlinx.android.synthetic.main.item_cocoa_third_party_add_lot.view.*
...
class VegaCocoaThirdPartyOwnershipSummaryFragment : BaseFragment() {
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        binding.rvLotList.setUp(list, R.layout.item_cocoa_third_party_add_lot, { item, pos ->
            ...
            ivClose.setImageDrawable(ivClose.context.getDrawable(R.drawable.ic_cocoa_tp_edit_gray))
