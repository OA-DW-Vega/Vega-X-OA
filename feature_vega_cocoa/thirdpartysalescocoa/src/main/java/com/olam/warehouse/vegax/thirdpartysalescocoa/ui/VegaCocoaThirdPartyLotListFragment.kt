...
import kotlinx.android.synthetic.main.item_cocoa_thirdparty_inventory_lot.view.*
...
class VegaCocoaThirdPartyLotListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUp(data, R.layout.item_cocoa_thirdparty_inventory_lot, { it, pos ->
