...
import kotlinx.android.synthetic.main.item_vega_cocoa_inventory_sync_details.view.*
import java.util.*
...
class VegaCocoaInventorySyncDetailsDailog : BottomSheetDialogFragment() {
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUp(syncStatusList, R.layout.item_vega_cocoa_inventory_sync_details, { it, pos ->
