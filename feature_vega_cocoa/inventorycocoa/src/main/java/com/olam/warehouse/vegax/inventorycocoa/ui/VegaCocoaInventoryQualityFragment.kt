...
import com.olam.warehouse.vegax.inventorycocoa.databinding.ItemVegaCocoaQualityDetailsBinding
...
class VegaCocoaInventoryQualityFragment : BaseFragment() {
    ...
    private fun setUpAdapter(qualityParameters: List<QualityParams>) {
        binding.rvQuality.setUpAdapter(
            ...
            R.layout.item_vega_cocoa_quality_details,
            ItemVegaCocoaQualityDetailsBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
