...
import com.olam.warehouse.vegax.inventorycocoa.databinding.ItemVegaCocoaInventoryFilterBinding
...
class VegaCocoaInventoryFilterFragment : BaseFragment() {
    ...
    private fun setUpMaterialAdapter(listFliterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            listFliterMaterial,
            R.layout.item_vega_cocoa_inventory_filter,
            ItemVegaCocoaInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
