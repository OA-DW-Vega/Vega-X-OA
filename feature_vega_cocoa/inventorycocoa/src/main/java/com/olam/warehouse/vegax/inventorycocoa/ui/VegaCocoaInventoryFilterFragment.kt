...
import com.olam.warehouse.vegax.inventorycocoa.data.domain.model.FilterList
import com.olam.warehouse.vegax.inventorycocoa.databinding.FragmentVegaCocoaInventoryFilterBinding
import com.olam.warehouse.vegax.inventorycocoa.utils.*
import kotlinx.android.synthetic.main.item_vega_cocoa_inventory_filter.view.*
 ...
 */
class VegaCocoaInventoryFilterFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cocoa_inventory_filter
    private lateinit var binding: FragmentVegaCocoaInventoryFilterBinding
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaCocoaInventoryFilterFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaCocoaInventoryFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpMaterialAdapter(listFliterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUp(listFliterMaterial, R.layout.item_vega_cocoa_inventory_filter, { it, pos ->
    ...
    private fun setUpLocationAdapter(listFliterLocation: ArrayList<FilterList>) {
        binding.rvLocation.setUp(listFliterLocation, R.layout.item_vega_cocoa_inventory_filter, { it, pos ->
    ...
    private fun setUpBeanAdapter(listFliterBean: ArrayList<FilterList>) {
        binding.rvBeanCount.setUp(listFliterBean, R.layout.item_vega_cocoa_inventory_filter, { it, pos ->
    ...
    private fun setUpMoistAdapter(listFliterMoist: ArrayList<FilterList>) {
        binding.rvMoisture.setUp(listFliterMoist, R.layout.item_vega_cocoa_inventory_filter, { it, pos ->
    ...
    private fun setUpFFAAdapter(listFliterFfa: ArrayList<FilterList>) {
        binding.rvFFA.setUp(listFliterFfa, R.layout.item_vega_cocoa_inventory_filter, { it, pos ->
    ...
    private fun setUpFATAdapter(listFliterFat: ArrayList<FilterList>) {
        binding.rvFAT.setUp(listFliterFat, R.layout.item_vega_cocoa_inventory_filter, { it, pos ->
