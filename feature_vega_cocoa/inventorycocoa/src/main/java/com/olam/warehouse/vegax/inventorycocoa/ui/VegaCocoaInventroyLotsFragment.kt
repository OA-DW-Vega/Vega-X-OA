...
import com.olam.warehouse.vegax.inventorycocoa.databinding.ItemVegaCocoaInventoryLotBinding
...
class VegaCocoaInventroyLotsFragment : BaseFragment() {
    ...
    private fun setUpAdapter(lotList: ArrayList<VegaCocoaInventoryLots>) {
        ...
        binding.rvLotList.setUpAdapter(
            lotList,
            R.layout.item_vega_cocoa_inventory_lot,
            ItemVegaCocoaInventoryLotBinding::inflate,
            { it, pos, bindItem ->
                when (it.materialQuality) {
                    null -> {
                        ...
                        bindItem.tvMoisture.text = it.materialQuality.qualityParams.B_MOIST
                        bindItem.tvBeanCount.text = it.materialQuality.qualityParams.B_BEANCOUNT
                        bindItem.tvFFA.text = it.materialQuality.qualityParams.B_FFA1
                        bindItem.tvFAT.text = it.materialQuality.qualityParams.B_FAT1
                    }
                }
