...
interface VegaCoCoaOffloadingRepository {
    ...
    suspend fun getWeighBridgeDetailOnline(): LiveData<Resource<GenericReqAndResp<List<VegaCoCoaReceiving>>>>
    ...
    suspend fun getBagItems(batchNumber: String?, mtnNumber: String, weighBridgeId: String): LiveData<List<VegaCoCoaOffloadingBagMaterial>>
    ...
    suspend fun postOffloadingSupplierDetail(vegaOffloadingPost: VegaCocoOffloadingSupplierPostRequest): LiveData<Resource<GenericReqAndResp<VegaMtntResponse>>>

    suspend fun getProductByName(materialName:String): LiveData<List<VegaMaterial>>
...
class VegaCoCoaOffloadingRepositoryImpl(
    ...
    override suspend fun getWeighBridgeDetailOnline(): LiveData<Resource<GenericReqAndResp<List<VegaCoCoaReceiving>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCoCoaReceiving>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCoCoaReceiving>> =
    ...
    override suspend fun getBagItems(
        ...
        return if (batchNumber.isNullOrEmpty()) {
            if(weighBridgeId.isNotEmpty())
                dao.getBagItems(weighBridgeId)
            else
                dao.getBagItems()
        } else {
            dao.getBagItems(batchNumber, mtnNumber)
        }
    }
    ...
    override suspend fun postOffloadingSupplierDetail(vegaOffloadingPost: VegaCocoOffloadingSupplierPostRequest): LiveData<Resource<GenericReqAndResp<VegaMtntResponse>>> {
    ...
    override suspend fun getProductByName(materialName: String) = dao.getProductByName(materialName)
}
