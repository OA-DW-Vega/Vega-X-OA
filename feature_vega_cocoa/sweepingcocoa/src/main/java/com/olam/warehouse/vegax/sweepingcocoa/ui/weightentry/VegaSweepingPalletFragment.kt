...
import com.olam.warehouse.vegax.sweepingcocoa.databinding.ItemVegaCocoaSweepingsBagBinding
...
class VegaSweepingPalletFragment : BaseFragment() {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList,
            R.layout.item_vega_cocoa_sweepings_bag,
            ItemVegaCocoaSweepingsBagBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
