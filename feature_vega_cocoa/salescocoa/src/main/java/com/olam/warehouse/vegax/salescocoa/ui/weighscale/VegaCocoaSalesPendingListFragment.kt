...
import kotlinx.android.synthetic.main.item_sales_pending_list.view.*
import kotlinx.android.synthetic.main.item_sales_truck_layout.view.tvMaterialName
import kotlinx.android.synthetic.main.item_sales_truck_layout.view.tvWbId
import kotlinx.android.synthetic.main.item_sales_truck_layout.view.tv_truck_no
...
class VegaCocoaSalesPendingListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaCocoaSalesWB>?) {
        ...
        binding.rvLots.setUp(dispatch1, R.layout.item_sales_pending_list, { it, pos ->
            tv_truck_no.text = it.saleOrderId
            tvMaterialName.text = it.materialName
            tvWbId.text = it.soWeight
            tvDateValue.text = it.ertim
            tvCustomerValue.text = it.customerName
