...
import com.olam.warehouse.vegax.salescocoa.databinding.ItemCocoaPalletBagInfoBinding
...
class VegaCocoaSalesPalletFragment : BaseFragment() {
    ...
    private fun initUI() {
        ...
        binding.tvRoundoff.setOnClickListener { showConformationRoundOFfDialog() }
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(),
            R.layout.item_cocoa_pallet_bag_info,
            ItemCocoaPalletBagInfoBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
