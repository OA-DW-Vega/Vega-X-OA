...
import com.olam.warehouse.vegax.processingcocoa.databinding.FragmentVegaCocoaFgrnSummaryBinding
import com.olam.warehouse.vegax.processingcocoa.databinding.ItemVegaCocoaBagConsumpSummaryBinding
import com.olam.warehouse.vegax.processingcocoa.databinding.ItemVegaCocoaFgrnSummaryBinding
import com.olam.warehouse.vegax.processingcocoa.utils.FRAG_ADD_WEIGHT_EDIT
import com.olam.warehouse.vegax.processingcocoa.utils.FRAG_ITEM
import com.olam.warehouse.vegax.processingcocoa.utils.prepareFgrnPostRequest
 ...
 */
class VegaCocoaFgrnSummaryFragment : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_cocoa_fgrn_summary
    private lateinit var binding: FragmentVegaCocoaFgrnSummaryBinding
    ...
    companion object {
        fun newInstance(model: VegaCocoaFgrnItems) = VegaCocoaFgrnSummaryFragment().putArgs {
            putParcelable(FRAG_ITEM, model)
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaCocoaFgrnSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcocoa/ui/fgrn/VegaCocoaFgrnSummaryFragment")
            .title("Fgrn Cocoa")
            .with(tracker)
    }
    ...
    private fun updateAdapter(gradeItems: List<VegaCocoaFgrnGradesWithBagItems>) {
        ...
        binding.rvFgrnSummary.setUpAdapter(
            ...
            R.layout.item_vega_cocoa_fgrn_summary,
            ItemVegaCocoaFgrnSummaryBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun updateBagConsumptionAdapter(bagConsumpList: ArrayList<VegaCocoaFgrnBagCosumption>) {
        ...
        binding.rvBagConsumption.setUpAdapter(
            bagConsumpList,
            R.layout.item_vega_cocoa_bag_consump_summary,
            ItemVegaCocoaBagConsumpSummaryBinding::inflate,
            { it, pos, bindItem ->
