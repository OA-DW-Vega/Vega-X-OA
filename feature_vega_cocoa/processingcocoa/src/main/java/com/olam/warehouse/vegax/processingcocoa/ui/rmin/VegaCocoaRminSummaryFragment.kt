...
import com.olam.warehouse.vegax.processingcocoa.databinding.ItemLotRminSummaryBinding
...
class VegaCocoaRminSummaryFragment : BaseFragment() {
    ...
    private fun initUI() {
        ...
        binding.tvOperatorName.text = model?.operatorName
    ...
    private fun preparePostData(): VegaCocoaRminProcessingPost {
        ...
        postModel.operatorName = model?.operatorName
        ...
        lots?.forEach {
            ...
            processLot.operatorName = model?.operatorName
