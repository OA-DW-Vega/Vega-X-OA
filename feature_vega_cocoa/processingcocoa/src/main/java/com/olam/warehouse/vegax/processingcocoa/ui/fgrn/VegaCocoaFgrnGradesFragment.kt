...
import com.olam.warehouse.vegax.processingcocoa.databinding.FragmentVegaCocoaFgrnGradesBinding
import com.olam.warehouse.vegax.processingcocoa.databinding.ItemVegaCocoaFgrnGradesBinding
 ...
 */
class VegaCocoaFgrnGradesFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cocoa_fgrn_grades
    private lateinit var binding: FragmentVegaCocoaFgrnGradesBinding
    ...
    companion object {
        fun newInstance(model: VegaCocoaFgrnItems, id: String) = VegaCocoaFgrnGradesFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCocoaFgrnGradesBinding.inflate(layoutInflater)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcocoa/ui/fgrn/VegaCocoaFgrnGradesFragment")
            .title("Fgrn Cocoa")
            .with(tracker)
    }
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCocoaFgrnItemsGrades>) {
        binding.rvGrades.setUpAdapter(
            gradeList,
            R.layout.item_vega_cocoa_fgrn_grades,
            ItemVegaCocoaFgrnGradesBinding::inflate,
            { item, pos, bindItem ->
