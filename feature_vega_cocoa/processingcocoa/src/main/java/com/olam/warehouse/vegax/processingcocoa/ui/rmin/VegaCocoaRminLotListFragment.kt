...
import com.olam.warehouse.vegax.processingcocoa.databinding.FragmentRminSelectWhBinding
import com.olam.warehouse.vegax.processingcocoa.databinding.ItemLotSummaryCocoBinding
import com.olam.warehouse.vegax.processingcocoa.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.processingcocoa.utils.MULTIPLE_LOT
import com.olam.warehouse.vegax.processingcocoa.utils.getColor
import com.olam.warehouse.vegax.processingcocoa.utils.listOfField
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCocoaRminLotListFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(model: VegaCocoaRminProcessing, isMultipleAdd: Boolean) =
            VegaCocoaRminLotListFragment().putArgs {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcocoa/ui/rmin/VegaCocoaRminLotListFragment")
            .title("Rmin Cocoa")
            .with(tracker)
    }
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaRminLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_lot_summary_coco,
            ItemLotSummaryCocoBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter = ArrayAdapter(requireContext(), R.layout.item_vega_cocoa_processing_rmin_grade, wareHouseList)
