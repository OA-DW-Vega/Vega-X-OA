...
import kotlinx.android.synthetic.main.item_vega_cocoa_fgrn_inventory_filter.view.*
...
class VegaCocoaFgrnFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<FilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_cocoa_fgrn_inventory_filter, { it, pos ->
