...
import com.olam.warehouse.vegax.processingcocoa.data.domain.model.FilterList
import com.olam.warehouse.vegax.processingcocoa.databinding.FragmentVegaCocoaFgrnFilterBinding
import com.olam.warehouse.vegax.processingcocoa.databinding.ItemVegaCocoaFgrnInventoryFilterBinding
 ...
 */
class VegaCocoaFgrnFilterFragment : BaseFragment() {

    private lateinit var binding: FragmentVegaCocoaFgrnFilterBinding
    override val layoutResourceId = R.layout.fragment_vega_cocoa_fgrn_filter
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaCocoaFgrnFilterFragment().putArgs {
    ...
    override fun onCreateView(
        ...
        binding = FragmentVegaCocoaFgrnFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcocoa/ui/fgrn/VegaCocoaFgrnFilterFragment")
            .title("Fgrn Cocoa")
            .with(tracker)
    }
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<FilterList>) {
        binding.rvWhLocation.setUpAdapter(
            listFliterWhLoc,
            R.layout.item_vega_cocoa_fgrn_inventory_filter,
            ItemVegaCocoaFgrnInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
