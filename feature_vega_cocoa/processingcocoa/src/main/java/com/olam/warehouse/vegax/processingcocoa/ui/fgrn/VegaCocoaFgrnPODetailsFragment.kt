...
import com.olam.warehouse.vegax.processingcocoa.databinding.FragmentVegaCocoaFgrnPoDetailsBinding
import com.olam.warehouse.vegax.processingcocoa.databinding.ItemVegaCocoaFgrnPoDetailsBinding
import com.olam.warehouse.vegax.processingcocoa.utils.FRAG_GRADES
import com.olam.warehouse.vegax.processingcocoa.utils.FRAG_PENDING
import com.olam.warehouse.vegax.processingcocoa.utils.getColor
import com.olam.warehouse.vegax.processingcocoa.utils.weightToProcess
 ...
 */
class VegaCocoaFgrnPODetailsFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cocoa_fgrn_po_details
    private lateinit var binding: FragmentVegaCocoaFgrnPoDetailsBinding
    ...
    companion object {
        fun newInstance() = VegaCocoaFgrnPODetailsFragment().putArgs {
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCocoaFgrnPoDetailsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcocoa/ui/fgrn/VegaCocoaFgrnPODetailsFragment")
            .title("Fgrn Cocoa")
            .with(tracker)
    }
    ...
    private fun moveToNext(offlineFgrnList: List<VegaCocoaFgrnItems>) {
        when (getCurrentFragment()) {
            is VegaCocoaFgrnPODetailsFragment -> when (offlineFgrnList.size > 0) {
    ...
    private fun updageStageUI(stageList: List<VegaProcessingStage>) {
        ...
        binding.spStage.setSelection(0,false)
        ...
        binding.spStage.setOnTouchListener(object : View.OnTouchListener {
    ...
    private fun updateAdapter(poList: MutableList<VegaCocoaFgrnItems>) {
        ...
        binding.rvPoList.setUpAdapter(
            poList,
            R.layout.item_vega_cocoa_fgrn_po_details,
            ItemVegaCocoaFgrnPoDetailsBinding::inflate,
            { item, pos, bindItem ->
