...
import kotlinx.android.synthetic.main.item_vega_cocoa_fgrn_po_details.view.*
...
class VegaCocoaFgrnPODetailsFragment : BaseFragment() {
    ...
    private fun updateAdapter(poList: MutableList<VegaCocoaFgrnItems>) {
        ...
        binding.tvToatalNo.text = getString(R.string.total_pos_0).plus(" ").plus(poList.size)
        binding.rvPoList.setUp(poList, R.layout.item_vega_cocoa_fgrn_po_details, { item, pos ->
