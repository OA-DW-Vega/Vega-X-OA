...
import com.olam.warehouse.vegax.processingcocoa.databinding.FragmentVegaCocoaFgrnPendingBinding
...
import kotlinx.android.synthetic.main.item_vega_cocoa_fgrn_pending.view.*
 ...
 */
class VegaCocoaFgrnPendingFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cocoa_fgrn_pending
    private lateinit var binding: FragmentVegaCocoaFgrnPendingBinding
    ...
    companion object {
        fun newInstance(model: VegaCocoaFgrnItems) = VegaCocoaFgrnPendingFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCocoaFgrnPendingBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcocoa/ui/fgrn/VegaCocoaFgrnPendingFragment")
            .title("Fgrn Cocoa")
            .with(tracker)
    }
    ...
    private fun updateItems(pendingList: List<VegaCocoaFgrnItems>) {
        binding.rvPendingPoList.setUp(pendingList as MutableList, R.layout.item_vega_cocoa_fgrn_pending, { item, pos ->
