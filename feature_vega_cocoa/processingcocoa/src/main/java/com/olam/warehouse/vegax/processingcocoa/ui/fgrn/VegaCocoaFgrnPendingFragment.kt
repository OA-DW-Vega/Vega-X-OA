...
import com.olam.warehouse.vegax.processingcocoa.databinding.ItemVegaCocoaFgrnPendingBinding
...
class VegaCocoaFgrnPendingFragment : BaseFragment() {
    ...
    private fun updateItems(pendingList: List<VegaCocoaFgrnItems>) {
        binding.rvPendingPoList.setUpAdapter(
            ...
            R.layout.item_vega_cocoa_fgrn_pending,
            ItemVegaCocoaFgrnPendingBinding::inflate,
            { item, pos, bindItem ->
