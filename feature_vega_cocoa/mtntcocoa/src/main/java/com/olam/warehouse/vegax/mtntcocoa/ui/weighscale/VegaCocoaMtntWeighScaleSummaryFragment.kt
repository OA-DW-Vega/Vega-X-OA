...
import kotlinx.android.synthetic.main.item_cocoa_lot_summary.view.*
...
class VegaCocoaMtntWeighScaleSummaryFragment : BaseFragment(), ItemRemoveListener {
    ...
    private fun setUpMaterialAdapter() {
        binding.header.rvMaterialList.setUp(vm.materialModelList, R.layout.item_material_layout, { it, pos ->
    ...
    private fun setUpAdapter(list: List<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUp(lots, R.layout.item_cocoa_lot_summary, { item, pos ->
            ...
            ivClose.setImageDrawable(ivClose.context.getDrawable(R.drawable.ic_edit_gray))
