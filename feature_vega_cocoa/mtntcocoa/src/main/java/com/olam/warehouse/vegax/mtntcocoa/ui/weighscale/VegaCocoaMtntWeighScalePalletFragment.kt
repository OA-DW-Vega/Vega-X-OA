...
import kotlinx.android.synthetic.main.fragment_cocoa_mtnt_weighscale_add_pallet.view.clBagHead
import kotlinx.android.synthetic.main.fragment_cocoa_mtnt_weighscale_add_pallet.view.ivEdit
import kotlinx.android.synthetic.main.item_vega_cocoa_no_weighment_add_bag.view.*
...
class VegaCocoaMtntWeighScalePalletFragment : BaseFragment() {
    ...
    private fun moveToSummary() {
        ...
        callBack?.replaceFragment(UPDATE_WEIGHT_WEIGHSCALE, VegaCocoaWSBagModel(binding.tvNetWtValue.text.toString(), true))
    }
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_vega_cocoa_no_weighment_add_bag, { it, pos ->
            if (pos % 2 == 0) {
                clBagHead.setBackgroundResource(com.olam.warehouse.presentation.R.drawable.rectangle_grey_border)
            } else {
                clBagHead.setBackgroundResource(R.drawable.shape_cocoa_rect_light_grey1)
            }
