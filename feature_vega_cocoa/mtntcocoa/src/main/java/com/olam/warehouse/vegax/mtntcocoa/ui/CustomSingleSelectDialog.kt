...
import com.olam.warehouse.vegax.mtntcocoa.databinding.CustomDialogLayoutBinding
import com.olam.warehouse.vegax.mtntcocoa.databinding.FilterItemsBinding
        ...
        binding.recyclerView.setUpAdapter(
            ...
            { it, pos, bindItem ->
                ...
                bindItem.fruitCardView.setOnClickListener { v ->
                    listener.clickOnItem(it, isWh, pos)
