...
import kotlinx.android.synthetic.main.item_vega_cameroon_secretid_details.view.*
...
//                            secretIdList = secretIdList.sortByDescending { getFormated(it.erdat) }
    ...
    private fun setUpAdapter(lotList: MutableList<VegaCameroonSecretId>) {
        ...
        binding.rvInspectiontLots.setUp(lotList, R.layout.item_vega_cameroon_secretid_details, { it, pos ->
            tvWbId.text = it.weighBridgeId
            tvBatchNo.text = it.vehNo
            tvMaterialName.text = it.tempBagCount
//            tvMaterialName.text = it.bagCount
//            tvWeight.text = it.weight.plus(" ").plus(it.unitOfMeasure)
            tvDateTxt.text = getFormatedDate(it.erdat)
