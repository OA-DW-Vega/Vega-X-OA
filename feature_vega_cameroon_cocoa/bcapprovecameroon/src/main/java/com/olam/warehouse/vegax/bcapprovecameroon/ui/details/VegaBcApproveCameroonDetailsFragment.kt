package com.olam.warehouse.vegax.bcapprovecameroon.ui.details
...
import com.olam.warehouse.vegax.bcapprovecameroon.data.domain.model.VegaBcApproveCameroonResponse
import com.olam.warehouse.vegax.bcapprovecameroon.data.domain.model.VegaQualityApproveCameroon
import com.olam.warehouse.vegax.bcapprovecameroon.data.domain.model.VegaQualityApproveCameroonGrnPost
import com.olam.warehouse.vegax.bcapprovecameroon.data.domain.model.VegaQualityApproveCameroonWeighBridgeId
import com.olam.warehouse.vegax.bcapprovecameroon.databinding.CutsomDialogBcApproveCameroonLayoutBinding
import com.olam.warehouse.vegax.bcapprovecameroon.databinding.FragmentVegaBcApproveCameroonDetailsBinding
...
import com.olam.warehouse.vegax.bcapprovecameroon.utils.preparePostGrnData
 ...
 */
class VegaBcApproveCameroonDetailsFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaBcApproveCameroonDetailsBinding

    override val layoutResourceId = R.layout.fragment_vega_bc_approve_cameroon_details
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaBcApproveCameroonDetailsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track()
            .screen("bcapprovecameroon/ui/details/VegaBcApproveCameroonDetailsFragment")
...
//        val mDialogView = LayoutInflater.from(activity?.applicationContext).inflate(R.layout.cutsom_dialog_bc_approve_cameroon_layout, null)
        val mDialogView =
            CutsomDialogBcApproveCameroonLayoutBinding.inflate(LayoutInflater.from(activity?.applicationContext))
