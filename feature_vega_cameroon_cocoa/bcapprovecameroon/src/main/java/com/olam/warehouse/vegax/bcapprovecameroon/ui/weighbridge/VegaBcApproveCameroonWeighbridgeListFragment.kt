...
import com.olam.warehouse.vegax.bcapprovecameroon.databinding.ItemVegaWeighbridgeBcApproveCameroonBinding
...
class VegaBcApproveCameroonWeighbridgeListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaQualityApproveCameroonWeighBridge>?) {
        ...
        binding.rvWeighBridgeId.setUpAdapter(
            ...
            ItemVegaWeighbridgeBcApproveCameroonBinding::inflate,
            { it, pos, bindItem ->
