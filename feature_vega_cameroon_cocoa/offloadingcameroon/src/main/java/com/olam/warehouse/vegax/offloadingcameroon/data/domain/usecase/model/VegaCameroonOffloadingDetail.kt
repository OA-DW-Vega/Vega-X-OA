...
data class VegaCameroonOffloadingPostRequest(
    var batchNumber: String? = "",
    var delFlag: String? = "",
    var deliveryDetails: List<VegaCameroonOffloadingDeliveryDetail>,
    var key: String? = "",
...
data class VegaCameroonOffloadingDeliveryDetail(
    var batchNumber: String? = "",
    var bltxt: String? = "",
...
data class VegaCameroonMtntDetails(
    var appoximateWeight : String? ="",
    var driverName : String? ="",
    var vehicleNumber : String? ="",
    var weighBridgeId : String? ="",
    var tempBagCount : String? ="",
    var autoBatchNumber : String? ="",
    var delivery:String?=""
)
