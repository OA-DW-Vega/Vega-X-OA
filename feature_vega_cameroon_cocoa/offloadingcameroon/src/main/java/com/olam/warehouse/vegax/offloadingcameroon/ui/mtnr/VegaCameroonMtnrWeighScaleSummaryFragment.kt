...
import kotlinx.android.synthetic.main.item_cameroon_mtnr_weighscale_lot_card_layout.view.*
import kotlinx.android.synthetic.main.offloading_cameroon_custom_edit_text.view.*
...
class VegaCameroonMtnrWeighScaleSummaryFragment : BaseFragment() {
    ...
    private fun setUpAdapter(list: List<VegaCoffeeReceiveLots>) {
        ...
        binding.rvLots.setUp(lots, R.layout.item_cameroon_mtnr_weighscale_lot_card_layout, { item, pos ->
