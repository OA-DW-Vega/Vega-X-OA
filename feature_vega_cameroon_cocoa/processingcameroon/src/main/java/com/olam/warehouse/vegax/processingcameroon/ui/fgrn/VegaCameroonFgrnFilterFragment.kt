...
import kotlinx.android.synthetic.main.item_vega_cameroon_fgrn_inventory_filter.*
import java.util.*
...
class VegaCameroonFgrnFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<CameroonFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_cameroon_fgrn_inventory_filter, { it, pos ->
