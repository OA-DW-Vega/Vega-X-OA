...
class VegaCameroonFgrnGradesFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(model: VegaCoffeeFgrnItems, id: String) = VegaCameroonFgrnGradesFragment().putArgs {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcameroon/ui/fgrn/VegaCameroonFgrnGradesFragment")
