...
import com.olam.warehouse.vegax.processingcameroon.databinding.FragmentVegaCameroonFgrnSiftSelectionBinding
...
class VegaCameroonFgrnShiftSelectionFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cameroon_fgrn_sift_selection
    private lateinit var binding: FragmentVegaCameroonFgrnSiftSelectionBinding
    ...
    companion object {
        fun newInstance(model: VegaCoffeeFgrnItems) = VegaCameroonFgrnShiftSelectionFragment().putArgs {
            putParcelable(FRAG_ITEM, model)
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaCameroonFgrnSiftSelectionBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcameroon/ui/fgrn/VegaCameroonFgrnShiftSelectionFragment").title("Vega_Cameroon/Processing")
            .with(tracker)
    }
    private fun initUI() {
        context?.let {
