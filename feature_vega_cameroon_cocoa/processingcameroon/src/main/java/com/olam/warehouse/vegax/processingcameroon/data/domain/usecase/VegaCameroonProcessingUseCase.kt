package com.olam.warehouse.vegax.processingcameroon.data.domain.usecase
...
import com.olam.warehouse.vegax.processingcameroon.data.domain.model.VegaCameroonProcessingRminBomPost
import com.olam.warehouse.vegax.processingcameroon.data.repo.VegaCameroonProcessingRepository

class VegaCameroonProcessingUseCase(val repository: VegaCameroonProcessingRepository) {
    suspend fun getGrades() = repository.getGrades()
    suspend fun getStages() = repository.getStages()
    suspend fun getBom(bomPostReq: VegaCameroonProcessingRminBomPost) =
    ...
    suspend fun saveFgrnItemPallet(fgrnItem: VegaCoffeeFgrnItems)= repository.saveFgrnItemPallet(fgrnItem)
    ...
    suspend fun postRminDetails(model: VegaCameroonProcessingFgrnPost) = repository.postRminDetails(model)
    ...
    suspend fun postFgrnDetails(poReq: VegaCameroonProcessingFgrnPost) = repository.postFgrnDetails(poReq)
    ...
    suspend fun postCreatePo(bomPostReq: VegaCameroonProcessingCreatePoReq) = repository.postCreatePo(bomPostReq)
    ...
    suspend fun getRminGradeWithBags(
        fgrnId: String,
        batchNo: String
    ): LiveData<VegaCoffeeFgrnGradesWithBagMatrialWeights>  = repository.getRminGradeWithBags(fgrnId, batchNo)
