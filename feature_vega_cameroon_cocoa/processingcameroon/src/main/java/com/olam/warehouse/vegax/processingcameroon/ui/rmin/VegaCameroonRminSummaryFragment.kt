...
import com.olam.warehouse.vegax.processingcameroon.databinding.ItemCameroonRminMaterialSummaryBinding
import com.olam.warehouse.vegax.processingcameroon.databinding.ItemCameroonSummaryLotBinding
...
class VegaCameroonRminSummaryFragment : BaseFragment() {
    ...
    private fun initGradeList() {
        ...
        binding.rvMaterialList.setUpAdapter(
            grade,
            R.layout.item_cameroon_rmin_material_summary,
            ItemCameroonRminMaterialSummaryBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun setupAdapter() {
        ...
        binding.rvLotList.setUpAdapter(
            list,
            R.layout.item_cameroon_summary_lot,
            ItemCameroonSummaryLotBinding::inflate,
            { it, pos, bindItem ->
                ...
                bindItem.tvScaleWeightValue.text = weight?.formatThreeDigits().plus(" ").plus("KG")
