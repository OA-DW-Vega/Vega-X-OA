...
import kotlinx.android.synthetic.main.item_vega_cameroon_fgrn_lot.view.*
...
class VegaCameroonFgrnAssignLotFragment : BaseFragment() {
    ...
    private fun updateAdapter(stockList: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvInventoryLot.setUp(stockList, R.layout.item_vega_cameroon_fgrn_lot, { it, pos ->
            ivDelete.gone()
