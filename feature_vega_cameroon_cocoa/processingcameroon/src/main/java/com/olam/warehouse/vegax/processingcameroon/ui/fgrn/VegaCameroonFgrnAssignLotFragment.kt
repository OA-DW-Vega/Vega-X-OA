...
import com.olam.warehouse.vegax.processingcameroon.databinding.FragmentVegaCameroonFgrnAssignLotBinding
import com.olam.warehouse.vegax.processingcameroon.databinding.ItemVegaCameroonFgrnLotBinding
import com.olam.warehouse.vegax.processingcameroon.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCameroonFgrnAssignLotFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cameroon_fgrn_assign_lot
    private lateinit var binding: FragmentVegaCameroonFgrnAssignLotBinding
    ...
    companion object {
        fun newInstance(
            ...
            VegaCameroonFgrnAssignLotFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCameroonFgrnAssignLotBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcameroon/ui/fgrn/VegaCameroonFgrnAssignLotFragment")
    ...
    private fun updateStorageLoc(customLocationList: MutableList<VegaCustomStLocation>) {
        customLocationList.let {
            ...
            val stageAdapter =
                ArrayAdapter(requireContext(), R.layout.item_vega_cameroon_processing_rmin_grade, storageLoc)
    ...
    private fun updateAdapter(stockList: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvInventoryLot.setUpAdapter(
            stockList,
            R.layout.item_vega_cameroon_fgrn_lot,
            ItemVegaCameroonFgrnLotBinding::inflate,
            { it, pos, bindItem ->
