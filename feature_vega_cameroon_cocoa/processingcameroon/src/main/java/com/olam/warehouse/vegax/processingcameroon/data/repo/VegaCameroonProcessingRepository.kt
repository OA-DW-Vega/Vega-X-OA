package com.olam.warehouse.vegax.processingcameroon.data.repo
...
interface VegaCameroonProcessingRepository {
    suspend fun getGrades(): LiveData<List<VegaMaterial>>
    suspend fun getStages(): LiveData<List<VegaProcessingStage>>
    suspend fun getBom(bomPostReq: VegaCameroonProcessingRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>>

    suspend fun getStocks(material: String): LiveData<Resource<GenericReqAndResp<List<VegaCoffeeRminLots>>>>
    suspend fun postCreatePo(bomPostReq: VegaCameroonProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>>
    ...
    suspend fun saveFgrnItemPallet( fgrnItem: VegaCoffeeFgrnItems)
    ...
    suspend fun savePalletDetails( material: VegaCoffeeFgrnGradesMatrialWeights)
    ...
    suspend fun postRminDetails(model: VegaCameroonProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaCameroonProcessingRminResponse>>>>
    ...
    suspend fun postFgrnDetails(poReq: VegaCameroonProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaCameroonProcessingFgrnResponse>>>>
    ...
    suspend fun getPalletDetails(
        batchNumber: String,
        material: String
    ): LiveData<Resource<GenericReqAndResp<List<VegaCameroonRminWeighScalePallet>>>>

    suspend fun getRminGradeWithBags(fgrnId: String, batchNo: String): LiveData<VegaCoffeeFgrnGradesWithBagMatrialWeights>
    suspend fun getFeatureMaster(module: String): LiveData<List<VegaFeatureMaster>>
}

class VegaCameroonProcessingRepoImpl(
    private val api: VegaCameroonProcessingApi,
    private val dao: VegaCoffeeRminDao,
    private val masterDao: MasterDao
) : VegaCameroonProcessingRepository {

    val currentKey = PreferenceHelper.get(Constants.CURRENT_KEY, "")
    override suspend fun getGrades() = dao.getProducts()
    override suspend fun getStages() = dao.getProcessingStage()
    override suspend fun getBom(bomPostReq: VegaCameroonProcessingRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>> {
    ...
    override suspend fun postCreatePo(bomPostReq: VegaCameroonProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>> {
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaFgrnProcessingOrder>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaFgrnProcessingOrder>> =
                api.getFgrnPoDetailsList(
                    VegaCameroonProcessingOrderReq(
                        getCurrentKey(),
                        auart,
                        cfgNo,
                        fevor,
    ...
    override suspend fun getPoGrades(
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>> =
                api.getFgrnGrades(VegaCameroonProcessOrderDetailsPostReq(getCurrentKey(), getPlantDetails(), poNo, rmin))
        }.build().asLiveData()
    }
    ...
    override suspend fun saveFgrnItemPallet(fgrnItem: VegaCoffeeFgrnItems){
        dao.saveFgrnItem(fgrnItem)
    }
    ...
    override suspend fun saveBagDetails(
        ...
        if(material.fgrnIdMaterialCode.isNotEmpty()) {
            dao.saveBagDetails(material)
        }
    }

    override suspend fun savePalletDetails(material: VegaCoffeeFgrnGradesMatrialWeights) = dao.saveBagDetails(material)
    ...
    override suspend fun postRminDetails(model: VegaCameroonProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaCameroonProcessingRminResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCameroonProcessingRminResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCameroonProcessingRminResponse>> =
    ...
    override suspend fun postFgrnDetails(poReq: VegaCameroonProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaCameroonProcessingFgrnResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCameroonProcessingFgrnResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCameroonProcessingFgrnResponse>> =
    ...
    override suspend fun getPalletDetails(
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCameroonRminWeighScalePallet>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCameroonRminWeighScalePallet>> =
                api.getPalletDetails(batchNumber, currentKey, material)
        }.build().asLiveData()
    }

    override suspend fun getRminGradeWithBags(
        fgrnId: String,
        batchNo: String
    ): LiveData<VegaCoffeeFgrnGradesWithBagMatrialWeights> = dao.getRminGradeWithBags(fgrnId)
