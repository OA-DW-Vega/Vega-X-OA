...
import kotlinx.android.synthetic.main.item_cameroon_lot_card_layout.view.*
...
class VegaCameroonRminLotAdapter(
    ...
    class ScaleViewHolder(bind: ItemCameroonLotCardLayoutBinding) : RecyclerView.ViewHolder(bind.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {

        val viewHolder =
            ItemCameroonLotCardLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
