...
import com.olam.warehouse.vegax.processingcameroon.databinding.FragmentVegaCameroonFgrnGradesBinding
import com.olam.warehouse.vegax.processingcameroon.databinding.ItemVegaCameroonFgrnGradesBinding
import com.olam.warehouse.vegax.processingcameroon.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCameroonRMINGradesFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cameroon_fgrn_grades
    private lateinit var binding: FragmentVegaCameroonFgrnGradesBinding
    ...
    companion object {
        fun newInstance(model: VegaCoffeeRminProcessing, id: String) = VegaCameroonRMINGradesFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCameroonFgrnGradesBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcameroon/ui/rmin/VegaCameroonRMINGradesFragment")
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCoffeeFgrnItemsGrades>) {
        ...
        binding.rvGrades.setUpAdapter(
            gradeList,
            R.layout.item_vega_cameroon_fgrn_grades,
            ItemVegaCameroonFgrnGradesBinding::inflate,
            { item, pos, bindItem ->
                bindItem.cbGrades.text = item.materialName
                if (item.materialCode.startsWith("0000002")) {
                    bindItem.cbGrades.isEnabled = false
                }
                ...
                bindItem.grades.setOnClickListener {
                    if (item.materialCode.startsWith("0000002")) {
                        bindItem.cbGrades.isChecked = false
                    } else {
    ...
    private fun View.updateGradeSelection(
        ...
        pos: Int,
        bindItem: ItemVegaCameroonFgrnGradesBinding
    ) {
