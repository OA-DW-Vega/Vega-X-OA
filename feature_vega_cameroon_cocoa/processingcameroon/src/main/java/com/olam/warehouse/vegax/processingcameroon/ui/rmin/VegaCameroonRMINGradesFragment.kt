...
import kotlinx.android.synthetic.main.item_vega_cameroon_fgrn_grades.view.*
...
class VegaCameroonRMINGradesFragment : BaseFragment() {
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCoffeeFgrnItemsGrades>) {
        ...
        binding.rvGrades.setUp(gradeList, R.layout.item_vega_cameroon_fgrn_grades, { item, pos ->
