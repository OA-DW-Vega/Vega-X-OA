...
import com.olam.warehouse.vegax.processingcameroon.databinding.ItemVegaCameroonFgrnPendingBinding
...
class VegaCameroonFgrnPendingFragment : BaseFragment() {
    ...
    private fun updateItems(pendingList: List<VegaCoffeeFgrnItems>) {
        binding.rvPendingPoList.setUpAdapter(
            ...
            R.layout.item_vega_cameroon_fgrn_pending,
            ItemVegaCameroonFgrnPendingBinding::inflate,
            { item, pos, bindItem ->
