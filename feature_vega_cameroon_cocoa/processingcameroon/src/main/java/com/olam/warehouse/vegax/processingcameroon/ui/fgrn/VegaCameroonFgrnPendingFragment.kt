...
import com.olam.warehouse.vegax.processingcameroon.databinding.FragmentVegaCameroonFgrnPendingBinding
...
import kotlinx.android.synthetic.main.fragment_vega_cameroon_fgrn_pending.view.*
import kotlinx.android.synthetic.main.item_vega_cameroon_fgrn_lot.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCameroonFgrnPendingFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cameroon_fgrn_pending
    private lateinit var binding: FragmentVegaCameroonFgrnPendingBinding
    ...
    companion object {
        fun newInstance(model: VegaCoffeeFgrnItems) = VegaCameroonFgrnPendingFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCameroonFgrnPendingBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcameroon/ui/fgrn/VegaCameroonFgrnPendingFragment")
    ...
    private fun updateItems(pendingList: List<VegaCoffeeFgrnItems>) {
        binding.rvPendingPoList.setUp(pendingList as MutableList, R.layout.item_vega_cameroon_fgrn_pending, { item, pos ->
