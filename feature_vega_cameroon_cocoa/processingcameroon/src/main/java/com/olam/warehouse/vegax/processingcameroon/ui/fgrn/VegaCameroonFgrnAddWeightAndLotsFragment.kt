...
import com.olam.warehouse.vegax.processingcameroon.databinding.FragmentVegaCameroonFgrnAddWeightAndLotsBinding
...
class VegaCameroonFgrnAddWeightAndLotsFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_cameroon_fgrn_add_weight_and_lots
    private lateinit var binding: FragmentVegaCameroonFgrnAddWeightAndLotsBinding
    ...
    companion object {
        fun newInstance(
            ...
            id: String,
            isEdit: Boolean
        ) = VegaCameroonFgrnAddWeightAndLotsFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCameroonFgrnAddWeightAndLotsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingcameroon/ui/fgrn/VegaCameroonFgrnAddWeightAndLotsFragment").title("Vega_Cameroon/Processing")
            .with(tracker)
    }
    ...
    private fun updateGradesWithBagItems(items: VegaCoffeeFgrnGradesWithBagItems?) {
        ...
        items.let {
           ...
           fgrnItem= it.lots.find { it.fgrnId.equals(fgrnItem.fgrnId) && it.processOrderNo.equals(fgrnItem.processOrderNo) }?:VegaCoffeeFgrnItems()

            palletWeight= fgrnItem.palletWeight?:"0"
            palletCount= fgrnItem.palletCount?:"0"
    ...
    fun updateBagWeight(bagMaterial: VegaCoffeeFgrnGradesMatrialWeights) {
        ...
        if (currentGrade.startTime?.isEmpty()!! && !palletCount.equals("0")) currentGrade.startTime = getCurrentTimeInMills().toString()
    ...
    private fun savePallet(){
        fgrnItem.palletWeight=palletWeight
        fgrnItem.palletCount=palletCount
        vm.saveFgrnItemPallet(fgrnItem)
    }
