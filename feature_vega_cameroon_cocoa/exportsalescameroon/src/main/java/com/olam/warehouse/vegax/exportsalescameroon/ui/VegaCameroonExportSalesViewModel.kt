...
import com.olam.warehouse.vegax.exportsalescameroon.data.domain.model.VegaCameroonExportSalesOrderModel
 ...
 */
class VegaCameroonExportSalesViewModel(
    private val useCase: VegaCameroonExportSalesUsecase,
    ...
    private var dispatchSalesOrder: LiveData<Resource<GenericReqAndResp<List<VegaCameroonExportSalesOrderModel>>>> =
        MutableLiveData()
    private val _dispatchSalesOrder =
        MediatorLiveData<Resource<GenericReqAndResp<List<VegaCameroonExportSalesOrderModel>>>>()
    val dispatchSalesOrderModel: LiveData<Resource<GenericReqAndResp<List<VegaCameroonExportSalesOrderModel>>>> get() = _dispatchSalesOrder
    ...
    private var inventorySource: LiveData<Resource<GenericReqAndResp<VegaCameroonInventoryModel>>> =
        MutableLiveData()
    private val _inventory = MediatorLiveData<Resource<GenericReqAndResp<VegaCameroonInventoryModel>>>()
    val inventory: LiveData<Resource<GenericReqAndResp<VegaCameroonInventoryModel>>> get() = _inventory

    private var palletResource: LiveData<Resource<GenericReqAndResp<List<VegaCameroonExportSalesWeighScalePallet>>>> =
        MutableLiveData()
    private val _pallet =
        MediatorLiveData<Resource<GenericReqAndResp<List<VegaCameroonExportSalesWeighScalePallet>>>>()
    val pallet: LiveData<Resource<GenericReqAndResp<List<VegaCameroonExportSalesWeighScalePallet>>>> get() = _pallet


    private var deliveryPostSource: LiveData<Resource<GenericReqAndResp<VegaCameroonExportSalesPostRequest>>> =
        MutableLiveData()
    private val _deliveryPost =
        MediatorLiveData<Resource<GenericReqAndResp<VegaCameroonExportSalesPostRequest>>>()
    val deliveryPost: LiveData<Resource<GenericReqAndResp<VegaCameroonExportSalesPostRequest>>> get() = _deliveryPost
    ...
    private var salesBagWithMaterialSource: LiveData<VegaCameroonExportSalesWithBagItems> =
        MutableLiveData()
    private val _salesBagWithMaterial = MediatorLiveData<VegaCameroonExportSalesWithBagItems>()
    val salesBagWithMaterial: LiveData<VegaCameroonExportSalesWithBagItems> get() = _salesBagWithMaterial
    ...
    fun getSalesPalletBag(batchNo: String) = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            salesBagWithMaterialSource = useCase.getExportSalesPalletBags(batchNo)
        }
    ...
    fun postDeliveryDetail(vegaDeliveryPost: VegaCameroonExportSalesPostRequest) =
        viewModelScope.launch(dispatchers.main) {
    ...
    fun updateContainerStatus(status: String, containerNumber: String) =
        viewModelScope.launch(dispatchers.main) {
            withContext(dispatchers.io) {
    ...
    fun saveExportLot(vegaCoffeeSalesLots: VegaCoffeeExportSalesLots) =
        viewModelScope.launch(dispatchers.io) {
            withContext(dispatchers.io) {
                useCase.saveExportLot(vegaCoffeeSalesLots)
            }
        }
