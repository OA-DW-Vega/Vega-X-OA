...
import com.olam.warehouse.vegax.exportsalescameroon.databinding.ItemVegaCameroonExportLotsBinding
...
class VegaCameroonExportStocksFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCoffeeExportSalesLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_vega_cameroon_export_lots,
            ItemVegaCameroonExportLotsBinding::inflate,
            { it, pos, bindItem ->
                ...
                bindItem.tvWeightValue.text =
                    weightValue.toDouble().formatThreeDigits().plus(" ").plus("KG")
