...
class VegaCameroonMtntWeighScaleSummaryFragment : BaseFragment(),
    ...
    private fun setUpMaterialAdapter() {
        binding.header.rvMaterialList.setUp(vm.materialModelList, R.layout.item_cameroon_material_layout, { it, pos ->
                ...
                "KG" ->
                    tvStoWeightValue.text =
                        it.soWeight?.toDouble()?.formatThreeDigits()?.replace(",", "").plus(" ")
                            .plus(it.uom)
                "MT" ->
                    tvStoWeightValue.text = convertMtToKg(it.soWeight.toString()).toDouble()
                        .formatThreeDigits()
                        .replace(",", "")
                        .plus(" ")
                        .plus("KG")
    ...
    private fun setUpAdapter(list: List<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUp(lots, R.layout.item_cameroon_lot_summary, { item, pos ->
            ...
            ivClose.setImageDrawable(ivClose.context.getDrawable(R.drawable.ic_cameroon_edit_gray))
