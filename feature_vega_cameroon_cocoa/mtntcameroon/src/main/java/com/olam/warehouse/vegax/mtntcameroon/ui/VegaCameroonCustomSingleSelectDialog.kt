...
import com.olam.warehouse.vegax.mtntcameroon.databinding.CameroonCustomDialogLayoutBinding
import com.olam.warehouse.vegax.mtntcameroon.databinding.CameroonFilterItemBinding
...
class VegaCameroonCustomSingleSelectDialog(
    ...
    private lateinit var binding: CameroonCustomDialogLayoutBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        requestWindowFeature(Window.FEATURE_NO_TITLE)
        binding = CameroonCustomDialogLayoutBinding.inflate(layoutInflater)
    ...
    private fun setAdapter(
        ...
        binding.recyclerView.setUpAdapter(
            ...
            CameroonFilterItemBinding::inflate,
            { it, pos, bindItem ->
