...
import com.olam.warehouse.vegax.mtntcameroon.databinding.FragmentCameroonMtntWeighbridgeAddLotLayoutBinding
import com.olam.warehouse.vegax.mtntcameroon.ui.ItemRemoveListenerCameroon
import com.olam.warehouse.vegax.mtntcameroon.ui.VegaCameroonMtntLotAdapter
...
import com.olam.warehouse.vegax.mtntcameroon.utils.LOT_LIST
import com.olam.warehouse.vegax.mtntcameroon.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.mtntcameroon.utils.WEIGHBRIDGE_SUMMARY
...
class VegaCameroonMtntWeighBridgeAddLotFragment : BaseFragment(), ItemRemoveListenerCameroon {
    override val layoutResourceId = R.layout.fragment_cameroon_mtnt_weighbridge_add_lot_layout
    private lateinit var binding: FragmentCameroonMtntWeighbridgeAddLotLayoutBinding
    ...
    private lateinit var adapter: VegaCameroonMtntLotAdapter
    ...
    companion object {
        fun newInstance(model: VegaCocoaDispatchWB) =
            VegaCameroonMtntWeighBridgeAddLotFragment()
                .putArgs {
    ...
    override fun onCreateView(
        ...
        binding = FragmentCameroonMtntWeighbridgeAddLotLayoutBinding.inflate(layoutInflater)
        initExtra()
        initAdapter()
        initUI()
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track()
            .screen("mtntcameroon/ui/weighbridge/VegaCameroonMtntWeighBridgeAddLotFragment")
