...
import kotlinx.android.synthetic.main.item_cameroon_mtnt_truck_layout.view.*
...
class VegaCameroonMtntWeighbridgeTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUp(dispatch1, R.layout.item_cameroon_mtnt_truck_layout, { it, pos ->
