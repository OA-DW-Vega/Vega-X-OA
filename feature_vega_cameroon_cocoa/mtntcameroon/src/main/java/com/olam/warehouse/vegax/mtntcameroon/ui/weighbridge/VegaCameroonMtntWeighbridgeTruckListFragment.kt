...
import com.olam.warehouse.vegax.mtntcameroon.databinding.FragmentCameroonTruckListLayoutBinding
import com.olam.warehouse.vegax.mtntcameroon.databinding.ItemCameroonMtntTruckLayoutBinding
...
import com.olam.warehouse.vegax.mtntcameroon.utils.DIRECTIONOUT
import com.olam.warehouse.vegax.mtntcameroon.utils.WEIGHBRIDGE
import com.olam.warehouse.vegax.mtntcameroon.utils.WEIGHBRIDGE_ADD_LOT
import com.olam.warehouse.vegax.mtntcameroon.utils.getColor
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaCameroonMtntWeighbridgeTruckListFragment : BaseFragment() {
    override val layoutResourceId: Int = R.layout.fragment_cameroon_truck_list_layout
    private lateinit var binding: FragmentCameroonTruckListLayoutBinding
    ...
    companion object {
        fun newInstance() = VegaCameroonMtntWeighbridgeTruckListFragment()
            .putArgs {
            }
    ...
    override fun onCreateView(
        ...
        binding = FragmentCameroonTruckListLayoutBinding.inflate(inflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track()
            .screen("mtntcameroon/ui/weighbridge/VegaCameroonMtntWeighbridgeTruckListFragment")
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUpAdapter(
            dispatch1,
            R.layout.item_cameroon_mtnt_truck_layout,
            ItemCameroonMtntTruckLayoutBinding::inflate,
            { it, pos, bindItem ->
