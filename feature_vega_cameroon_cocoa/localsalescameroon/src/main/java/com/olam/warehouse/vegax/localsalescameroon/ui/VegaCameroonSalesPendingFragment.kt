...
import com.olam.warehouse.vegax.localsalescameroon.databinding.FragmentCameroonSalesPendingListBinding
import com.olam.warehouse.vegax.localsalescameroon.databinding.ItemCameroonSalesPendingListBinding
import com.olam.warehouse.vegax.localsalescameroon.utils.ADD_LOT
import com.olam.warehouse.vegax.localsalescameroon.utils.SALES_TYPE_WEIGHSCALE
import com.olam.warehouse.vegax.localsalescameroon.utils.SEARCH_HINT
 ...
 */
class VegaCameroonSalesPendingFragment : BaseFragment() {

    override val layoutResourceId: Int = R.layout.fragment_cameroon_sales_pending_list
    private lateinit var binding: FragmentCameroonSalesPendingListBinding
    ...
    companion object {
        fun newInstance(salesTypeWeighscale: String) = VegaCameroonSalesPendingFragment().putArgs {
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentCameroonSalesPendingListBinding.inflate(inflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("localsalescameroon/ui/VegaCameroonSalesPendingFragment")
    ...
    private fun setUpAdapter(data: List<VegaCoffeePendingSalesOrderWithLots>?) {
        ...
        binding.rvLots.setUpAdapter(
            dispatch1,
            R.layout.item_cameroon_sales_pending_list,
            ItemCameroonSalesPendingListBinding::inflate,
            { it, pos, bindItem ->
