...
import kotlinx.android.synthetic.main.item_cameroon_sales_pending_list.view.*
...
class VegaCameroonSalesPendingFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaCoffeePendingSalesOrderWithLots>?) {
        ...
        binding.rvLots.setUp(dispatch1, R.layout.item_cameroon_sales_pending_list, { it, pos ->
