...
interface VegaCoffeeSalesRepository {
    ...
    suspend fun getOfflineSalesPalletBags(batchNumber: String): LiveData<VegaCameroonSalesWithBagItems>
    suspend fun saveSalesLot(salesLots: VegaCoffeeSalesLots)
...
class VegaCoffeeSalesRepositoryImpl(
    ...
    private val dao2 : VegaNicaraguaMtntDao
    ...
    override suspend fun getGrades(
        materialCode: String
    ) = dao2.getQualityGrades(materialCode, "NIPOSITI")

    override suspend fun getMaterialQualityGrades(
        materialCode: String
    ) = dao2.getMaterialQualityGrades(materialCode)

    override suspend fun getCertification(
        materialCode: String
    ) = dao2.getCertification(materialCode, "NIFG0014")

    override suspend fun getOfflineSalesPalletBags(batchNumber: String)= dao.getOfflineSalesPalletBags(batchNumber)

    override suspend fun saveSalesLot(salesLots: VegaCoffeeSalesLots) = dao.saveLot(salesLots)
