package com.olam.warehouse.vegax.localsalescameroon.utils
...
const val SALE_ORDER_DATA = "sale_order_data"
...
var certificate: String? = "certificate"
...
fun convertKgToLB1(weight: String): String {
    return weight.toDouble().formatThreeDigits()
}

fun convertLB1ToKg(weight: String): String {
    val converted = weight.toDouble()
    return converted.formatThreeDigits()
}
