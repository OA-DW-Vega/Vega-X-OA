...
import kotlinx.android.synthetic.main.item_cameroon_sales_pallet_bag_info.view.*
...
class VegaCameroonSalesPalletFragment : BaseFragment() {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCoffeeSalesBagMaterial>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_cameroon_sales_pallet_bag_info, { it, pos ->
            if (pos % 2 == 0) {
