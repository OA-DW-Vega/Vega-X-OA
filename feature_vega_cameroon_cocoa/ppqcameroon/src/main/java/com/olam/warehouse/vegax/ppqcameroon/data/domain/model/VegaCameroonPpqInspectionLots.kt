package com.olam.warehouse.vegax.ppqcameroon.data.domain.model
 ...
 */
@Parcelize
data class VegaCameroonPpqInspectionLots(
...
@Parcelize
data class VegaCameroonPpqInspectionLotDetails(
    var inspectionLotNum: String = "",
    var inspectionOperationNum: String = "",
    var usageDecision: Boolean = false,
    var qualityParameters: List<VegaCameroonPpqInspectionLotParams> = emptyList()
) : Parcelable

@Parcelize
data class VegaCameroonPpqInspectionLotParams(
    var charDesc: String = "",
    var formula: String = "",
