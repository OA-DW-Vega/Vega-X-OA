...
import com.olam.warehouse.vegax.ppqcameroon.databinding.ItemVegaCameroonPpqLotDetailsBinding
...
class VegaCameroonPpqLotListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(lotList: MutableList<VegaCameroonPpqInspectionLots>) {
        ...
        binding.rvInspectiontLots.setUpAdapter(
            lotList,
            R.layout.item_vega_cameroon_ppq_lot_details,
            ItemVegaCameroonPpqLotDetailsBinding::inflate,
            { it, pos, bindItem ->
