...
import com.olam.warehouse.vegax.ppqcameroon.databinding.ItemVegaCameroonPpqParamsBinding
...
class VegaCameroonPpqQualityParamsFragment : BaseFragment() {
    ...
    private fun setUpFormulaAdapter(items: MutableList<VegaCameroonPpqInspectionLotParams>) {
        ...
        binding.rvPpqParamsFormula.setUpAdapter(
            formulaParamList,
            R.layout.item_vega_cameroon_ppq_params,
            ItemVegaCameroonPpqParamsBinding::inflate,
            { it, pos, bindItem ->
                ...
                bindItem.edQualityValue.setText(result.toString())
