package com.olam.warehouse.vegax.qualitycameroon.ui.offline
...
import com.olam.warehouse.vegax.qualitycameroon.databinding.FragmentVegaCameroonQualityOfflineBinding
import com.olam.warehouse.vegax.qualitycameroon.databinding.ItemVegaCameroonQtyOfflineBinding
 ...
 */
class VegaCameroonQualityOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_cameroon_quality_offline
    private val vm: VegaCameroonQualityViewModel by viewModel()
    private lateinit var binding: FragmentVegaCameroonQualityOfflineBinding
    private var qualityList = arrayListOf<VegaWeighBridgeWithQualityParams>()
    private var callBack: CallBack? = null

    companion object {
        fun newInstance() = VegaCameroonQualityOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaCameroonQualityOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("qualitycameroon/ui/offline/VegaCameroonQualityOfflineSummary")
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaWeighBridgeWithQualityParams>) {
        ...
        binding.rvOfflineQuality.setUpAdapter(
            qualityList,
            R.layout.item_vega_cameroon_qty_offline,
            ItemVegaCameroonQtyOfflineBinding::inflate,
            { it, pos, bindItem ->
