...
import kotlinx.android.synthetic.main.item_vega_cameroon_quality_summary_params.view.*
            ...
            binding.rvApproveQuality.setUp(data,
                ...
                { item, pos ->
                    ...
                    if (item?.qualitative?.size!! > 0) {
                        tvUnitApprove.text = item.qualityParameterValue
                    } else
                        tvUnitApprove.text = item.qualityParameterValue
                    if (slectedItem.size > 0) {
                        ...
                        tvUnitApprove.text = i?.get(0)?.descValue
                    }
