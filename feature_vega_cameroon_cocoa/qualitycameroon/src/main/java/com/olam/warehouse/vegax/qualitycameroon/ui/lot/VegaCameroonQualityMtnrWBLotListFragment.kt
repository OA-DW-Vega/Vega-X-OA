package com.olam.warehouse.vegax.qualitycameroon.ui.lot
...
import com.olam.warehouse.vegax.qualitycameroon.databinding.FragmentVegaCameroonWeighbridgeLotBinding
...
import kotlinx.android.synthetic.main.item_vega_cameroon_lot_card_layout.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper


class VegaCameroonQualityMtnrWBLotListFragment : BaseFragment() {

    private val vm: VegaCameroonQualityViewModel by viewModel()
    private lateinit var mListener: OnLotListener
    private lateinit var binding: FragmentVegaCameroonWeighbridgeLotBinding
    override val layoutResourceId = R.layout.fragment_vega_cameroon_weighbridge_lot
    ...
    companion object {
        fun newInstance() = VegaCameroonQualityMtnrWBLotListFragment().putArgs {
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCameroonWeighbridgeLotBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("qualitycameroon/ui/lot/VegaCameroonQualityMtnrWBLotListFragment - $weightmentType")
    ...
    private fun initUI() {
        context?.let {
            ...
            getActionBtnChangedView(binding.btCreateGrn, it, true)
        }
        if (isOnline()) {
    ...
    private fun setAdapter(mQualityLotList1: MutableList<VegaCoffeeLot>) {
        ...
        binding.rvLots.setUp(mQualityLotList1, R.layout.item_vega_cameroon_lot_card_layout, { it, pos ->
            ...
            when(it.unitsOfMeasure){
                ...
                "MT" -> {
                    tvScaleWeightValue.text =
                        convertMtToKg(it.netWeight.toString()).toDouble().formatThreeDigits()
                            .plus(" ").plus("KG")
                }
            }
            ...
            if (it.qcStatus.isNullOrEmpty()) {
                tvQcStatusValue.text = getString(R.string.qc_not_done)
                tvQcStatusValue.setTextColor(
                    ContextCompat.getColor(
                        tvQcStatusValue.context,
                        com.olam.warehouse.presentation.R.color.black
                    )
                )
            } else {
                tvQcStatusValue.text = getString(R.string.qc_done)
                tvQcStatusValue.setTextColor(
                    ContextCompat.getColor(
                        tvQcStatusValue.context,
