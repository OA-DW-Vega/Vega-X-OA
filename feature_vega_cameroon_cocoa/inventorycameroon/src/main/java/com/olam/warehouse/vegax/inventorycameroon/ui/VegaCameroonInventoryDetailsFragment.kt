...
import com.olam.warehouse.vegax.inventorycameroon.databinding.ItemVegaCameroonInventoryDetailsBinding
...
class VegaCameroonInventoryDetailsFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<InventoryLots>) {
        ...
        binding.rvInventory.setUpAdapter(
            lotList,
            R.layout.item_vega_cameroon_inventory_details,
            ItemVegaCameroonInventoryDetailsBinding::inflate,
            { it, pos, bindItem ->
                when (it.smoky) {
                    "IR-AB/PR 003" -> bindItem.tvSmokyValue.text = "Absence"
                    "IR-AB/PR 004" -> bindItem.tvSmokyValue.text = "Presence"
                }
                bindItem.tvHumidityValue.text = it.beanMoisture
                bindItem.tvMouldValue.text = it.mould
                bindItem.tvWasteValue.text = it.waste
