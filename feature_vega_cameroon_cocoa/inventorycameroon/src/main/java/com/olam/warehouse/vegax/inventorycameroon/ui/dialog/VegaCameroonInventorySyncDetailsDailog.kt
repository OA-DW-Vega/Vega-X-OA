...
import com.olam.warehouse.vegax.inventorycameroon.databinding.ItemVegaCameroonInventorySyncDetailsBinding
...
class VegaCameroonInventorySyncDetailsDailog : BottomSheetDialogFragment() {
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUpAdapter(
            syncStatusList,
            R.layout.item_vega_cameroon_inventory_sync_details,
            ItemVegaCameroonInventorySyncDetailsBinding::inflate,
            { it, pos, bindItem ->
