...
import com.olam.warehouse.vegax.inventorycameroon.databinding.ItemVegaCameroonInventoryFilterBinding
...
class VegaCameroonInventoryFilterFragment : BaseFragment() {
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            listFilterMaterial,
            R.layout.item_vega_cameroon_inventory_filter,
            ItemVegaCameroonInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun setUpHumidityAdapter(listFilterHumidity: ArrayList<FilterList>) {
        binding.rvHumidity.setUpAdapter(
            listFilterHumidity,
            R.layout.item_vega_cameroon_inventory_filter,
            ItemVegaCameroonInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun setUpImpurityAdapter(listFilterImpurity: ArrayList<FilterList>) {
        binding.rvTotalImpurity.setUpAdapter(
            listFilterImpurity,
            R.layout.item_vega_cameroon_inventory_filter,
            ItemVegaCameroonInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
