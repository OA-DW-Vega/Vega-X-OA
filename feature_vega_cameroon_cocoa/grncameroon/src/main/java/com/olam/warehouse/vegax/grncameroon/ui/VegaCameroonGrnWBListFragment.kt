...
import com.olam.warehouse.vegax.grncameroon.databinding.FragmentVegaCameroonGrnWeighbridgeListBinding
import com.olam.warehouse.vegax.grncameroon.databinding.ItemVegaCameroonWeighbridgeGrnBinding
 ...
 */
class VegaCameroonGrnWBListFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaCameroonGrnWeighbridgeListBinding
    private var callBack: CallBack? = null
    override val layoutResourceId = R.layout.fragment_vega_cameroon_grn_weighbridge_list
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaCameroonGrnWeighbridgeListBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("grncameroon/ui/VegaCameroonGrnWBListFragment")
    ...
    private fun setUpAdapter(data: List<VegaGrnWeighBridgeId>?) {
        ...
        binding.rvWeighBridgeId.setUpAdapter(
            ...
            R.layout.item_vega_cameroon_weighbridge_grn,
            ItemVegaCameroonWeighbridgeGrnBinding::inflate,
            { it, pos, bindItem ->
