...
import com.olam.warehouse.vegax.grncameroon.databinding.FragmentVegaCameroonGrnDetailsBinding
import com.olam.warehouse.vegax.grncameroon.utils.*
import kotlinx.android.synthetic.main.fragment_vega_cameroon_grn_details.*
 ...
 */
class VegaCameroonGrnDetailsFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaCameroonGrnDetailsBinding
    override val layoutResourceId = R.layout.fragment_vega_cameroon_grn_details
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaCameroonGrnDetailsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("grncameroon/ui/VegaCameroonGrnDetailsFragment")
    ...
    companion object {
        fun newInstance(grnData: VegaGrnWeighBridgeId) = VegaCameroonGrnDetailsFragment().putArgs {
