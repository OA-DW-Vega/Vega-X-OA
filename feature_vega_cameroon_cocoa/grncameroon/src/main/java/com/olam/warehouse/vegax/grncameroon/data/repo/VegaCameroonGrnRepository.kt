package com.olam.warehouse.vegax.grncameroon.data.repo
...
import com.olam.warehouse.vegax.grncameroon.utils.prepareWeighBridgeData

/**
 * Created by Keerthi Santhanam on 6/29/2020.
 */
interface VegaCameroonGrnRepository {
...
class VegaCameroonGrnRepositoryImpl(private val api: VegaCameroonGrnApi, private val dao: VegaEcuadorGrnDao) : VegaCameroonGrnRepository {
