...
class VegaGhanaRminViewModel(
    ...
    fun getProcessOrders() = viewModelScope.launch(dispatchers.main) {
        ...
        withContext(dispatchers.io) {
            processOrderSource = useCase.getProcessOrders("IP")
        }
    ...
    fun getMaterialtypelist() = viewModelScope.launch(dispatchers.main) {
        _miscellaneousItems.removeSource(miscellaneousSource)
        withContext(dispatchers.io) {
            miscellaneousSource = useCase.getMaterialtypelist()
        }
        _miscellaneousItems.addSource(miscellaneousSource) {
            _miscellaneousItems.value = it
        }
