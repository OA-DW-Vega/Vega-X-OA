...
import com.olam.warehouse.vegax.processingghana.databinding.ItemVagaGhanaProcessingFgrnOfflineSummaryBinding
...
class VegaGhanaProcessingFgrnOfflineSummary : BaseFragment() {
    ...
    private fun initUI() {
        ...
        vm.offlineFgrnItemLocal.observe(viewLifecycleOwner, Observer {
            if (it != null) {
                updateUI(it)
            }
        })
        ...
        vm.fgrnItemLocal.observe(viewLifecycleOwner, Observer {
...
//                activity?.onBackPressed()
    ...
    private fun setUpAdapter(offloadingItems1: ArrayList<VegaGhanaOfflineFgrnProcessLotDetails>) {
        ...
        binding.rvReceivingOffline.setUpAdapter(
            ...
            ItemVagaGhanaProcessingFgrnOfflineSummaryBinding::inflate,
            { it, pos, bindItem ->
                val receiving = it
                ...
                bindItem.tvProductType.text = receiving.rminTempId
                bindItem.tvWbId.text = receiving.fgrnTempId
                ...
                if (receiving.successMessage?.isNotEmpty() == true) {
                    bindItem.llMsg.visible()
                    bindItem.tvSuccessMsg.text = receiving.successMessage
                } else {
                    bindItem.llMsg.gone()
                }
