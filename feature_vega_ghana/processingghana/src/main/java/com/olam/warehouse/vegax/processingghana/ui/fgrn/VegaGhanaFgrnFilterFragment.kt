...
import kotlinx.android.synthetic.main.item_vega_ghana_fgrn_inventory_filter.*
import java.util.*
...
class VegaGhanaFgrnFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<GhanaFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_ghana_fgrn_inventory_filter, { it, pos ->
