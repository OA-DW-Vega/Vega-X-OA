package com.olam.warehouse.vegax.processingghana.data.api
...
interface VegaGhanaProcessingApi {
    ...
    suspend fun fetchBomList(@Body bomPostReq: VegaGhanaProcessingRminBomPost): GenericReqAndResp<VegaProcessingRminBom>


    @POST("x-processing/vega/processing/createProcessOrder")
    suspend fun postCreatePo(@Body bomPostReq: VegaGhanaProcessingCreatePoReq): GenericReqAndResp<VegaProcessingRminPo>
    ...
    ): GenericReqAndResp<List<VegaGhanaProcessingQualityDetails>>
    ...
    fun getQualityParams(
        ...
        @Query("charg") charge: String,
        @Query("material") material: String
    ): Call<GenericReqAndResp<List<VegaGhanaProcessingQualityDetails>>>
    ...
    suspend fun getFgrnGrades(@Body poReq: VegaGhanaProcessOrderDetailsPostReq): GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>>

    @POST("x-processing/vega/processing/processOrders")
    suspend fun getFgrnPoDetailsList(@Body vegaProcessingOrderReq: VegaGhanaProcessingOrderReq): GenericReqAndResp<List<VegaFgrnProcessingOrder>>

    @POST("x-processing/vega/processing/processOrders")
    suspend fun fetchFgrnPoDetailsList(@Body vegaProcessingOrderReq: VegaGhanaProcessingOrderReq): GenericReqAndResp<List<VegaCoffeeFgrnItems>>

    @POST("x-processing/vega/processing/rmin_fgrn")
    suspend fun postRminDetails(@Body bomPostReq: VegaGhanaProcessingFgrnPost): GenericReqAndResp<List<VegaGhanaProcessingRminResponse>>

    @POST("x-processing/vega/processing/rmin_fgrn")
    suspend fun postFgrnDetails(@Body bomPostReq: VegaGhanaProcessingFgrnPost): GenericReqAndResp<List<VegaGhanaProcessingFgrnResponse>>
