...
import com.olam.warehouse.vegax.processingghana.databinding.ItemVegaGhanaFgrnPendingBinding
...
class VegaGhanaFgrnPendingFragment : BaseFragment() {
    ...
    private fun updateItems(pendingList: List<VegaCoffeeFgrnItems>) {
        binding.rvPendingPoList.setUpAdapter(
            ...
            R.layout.item_vega_ghana_fgrn_pending,
            ItemVegaGhanaFgrnPendingBinding::inflate,
            { item, pos, bindItem ->
