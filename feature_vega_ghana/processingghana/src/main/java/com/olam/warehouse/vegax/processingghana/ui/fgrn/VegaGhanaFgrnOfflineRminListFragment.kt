...
import com.olam.warehouse.vegax.processingghana.databinding.ItemGhanaRminBinding
...
class VegaGhanaFgrnOfflineRminListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(offloadingItems1: ArrayList<VegaGhanaOfflineRminProcessLotDetails>) {
        ...
        binding.rvPoList.setUpAdapter(
            ...
            ItemGhanaRminBinding::inflate,
            { it, pos, bindItem ->
                val receiving = it
                bindItem.tvScaleDispatchValue.text = receiving.netWeight.plus(" ").plus("MT")
                bindItem.tvScaleGradeValue.text = receiving.materialName
                bindItem.tvScaleLotValue.text = receiving.rminTempId
