...
import com.olam.warehouse.vegax.processingghana.databinding.ItemGhanaProcessingInventoryLotBinding
...
class VegaGhanaRMINLotListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_ghana_processing_inventory_lot,
            ItemGhanaProcessingInventoryLotBinding::inflate,
            { it, pos, bindItem ->
                ...
                bindItem.tvWeightValue.text =
                    it.weight?.toDouble()?.formatThreeDigits().plus(" ").plus("MT")
