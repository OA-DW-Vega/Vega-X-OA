...
const val JSON_MATERIAL_TYPE_LIST = "MATERIAL_TYPE_LIST"
...
fun prepareRminPostRequest(
    ...
    poReq.rmin = true
    poReq.notificationFlag = notificationFlag
    poReq.nextWorkFlowRole = nextWorkFlowRole
    poReq.navId = navId
    poReq.currentWorkFlowRole = currentWorkFlowRole
    ...
    lotDetails.gradeWithLotsAndBags?.forEach {
        ...
        it.lotItems?.forEach {
            ...
            processLot.grossWeight = it.rminLots.editedWeight
            processLot.netWeight = it.rminLots.editedWeight
            processLot.menge = it.rminLots.editedWeight
...
fun prepareFgrnPostRequest(
    ...
    lotDetails: List<VegaCoffeeFgrnGradesWithBagItems>?,dryloss:String?,
    notificationFlag: Boolean = false,
    nextWorkFlowRole: String? = "",
    navId: String? = "",
    currentWorkFlowRole: String? = ""
...
fun prepareRminCreatePoRequest(
    ...
    lotDetails: ArrayList<VegaCoffeeRminLots>, notificationFlag: Boolean = false,
    nextWorkFlowRole: String? = "",
    navId: String? = "",
    currentWorkFlowRole: String? = ""
    ...
    poReq.plant = getPlantDetails()
    poReq.rmin = true
    poReq.atSourceVal = model.atSourceVal
