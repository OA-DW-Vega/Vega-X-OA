...
interface VegaGhanaProcessingRepository {
    ...
    suspend fun getAllFGRNItems(): LiveData<VegaCoffeeFgrnGradesMatrialWeights>
...
class VegaGhanaProcessingRepoImpl(
    ...
    override suspend fun getProcessOrders(): LiveData<List<VegaGhanaProcessingOrder>> =
        dao.getProcessOrders()
    ...
    override suspend fun getAllFGRNItems() = dao.getAllFGRNItems()
