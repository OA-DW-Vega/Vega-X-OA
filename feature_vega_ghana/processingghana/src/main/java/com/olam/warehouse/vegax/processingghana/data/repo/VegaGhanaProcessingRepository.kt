package com.olam.warehouse.vegax.processingghana.data.repo
...
import com.olam.warehouse.vegax.processingghana.data.domain.model.*

interface VegaGhanaProcessingRepository {
    ...
    suspend fun getMaterialtypelist(): LiveData<List<VegaCocoaMiscellaneous>>
    suspend fun getBom(bomPostReq: VegaGhanaProcessingRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>>

    suspend fun getStocks(material: String): LiveData<Resource<GenericReqAndResp<List<VegaCoffeeRminLots>>>>
    suspend fun postCreatePo(bomPostReq: VegaGhanaProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>>
    suspend fun getBomoffline(wbId: String): LiveData<List<VegaProcessingRminBoms>>
    ...
    suspend fun saveOfflineRminLotDetails(rminData: VegaGhanaOfflineRminProcessLotDetails)

    suspend fun saveOfflineFgrnDetails(rminData: VegaGhanaOfflineFgrnData)

    suspend fun saveOfflineFgrnLotDetails(rminData: VegaGhanaOfflineFgrnProcessLotDetails)

    suspend fun saveOfflineRminSelectedLots(rminData: VegaGhanaOfflineRminLots)

    suspend fun saveOfflineRminItem(rminData: VegaGhanaOfflineRminItems)
    ...
    suspend fun getofflineRmindata(
        RminTempId: String
    ...
    suspend fun getProcessOrders(type: String): LiveData<List<VegaGhanaProcessingOrder>>
    ...
    suspend fun deleteAllRminItems()
    suspend fun deleteAllRminLots()
    suspend fun deleteAllFgrnItems()
    suspend fun updateFgrnStatus(status: Boolean, rminId: String)
    suspend fun getAllFGRNItems(fgrnItem: VegaCoffeeFgrnItems): LiveData<VegaCoffeeFgrnGradesMatrialWeights>
    ...
    suspend fun postRminDetails(model: VegaGhanaProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaGhanaProcessingRminResponse>>>>
    ...
    suspend fun updateFgrnDeletedItem(tmpWbId: String)
    suspend fun updateSyncedFgrnDeletedItem(status: Int)
    ...
    suspend fun postFgrnDetails(poReq: VegaGhanaProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaGhanaProcessingFgrnResponse>>>>
    ...
    suspend fun getStockDetailsByBatchNo(batchNo: String): LiveData<VegaEcuadorDispatchStocks>
...
class VegaGhanaProcessingRepoImpl(
    private val api: VegaGhanaProcessingApi,
    private val dao: VegaCoffeeRminDao,
    private val masterDao: MasterDao,
    private val vegaMtntDao: VegaMtntDao
) : VegaGhanaProcessingRepository {

    val currentKey = PreferenceHelper.get(Constants.CURRENT_KEY, "")
    override suspend fun getGrades() = dao.getProducts()
    override suspend fun getMaterials() = vegaMtntDao.getMaterials()
    override suspend fun getStages() = dao.getProcessingStage()
    override suspend fun getMaterialtypelist() = dao.getMaterialtypelist()
    override suspend fun getBom(bomPostReq: VegaGhanaProcessingRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>> {
    ...
    override suspend fun updateDeletedItem(tmpWbId: String) {
        dao.deleteOfflineRminData(tmpWbId)
        dao.deleteOfflineRminLotDetails(tmpWbId)
    }

    override suspend fun updateFgrnDeletedItem(tmpWbId: String) {
        dao.deleteOfflineFgrnData(tmpWbId)
        dao.deleteOfflineFgrnLotDetails(tmpWbId)
    }

    override suspend fun updateSyncedFgrnDeletedItem(status: Int) {
        dao.deleteSyncedOfflineFgrnLotDetails(status)
        dao.deleteSyncedOfflineFgrnData(status)
    }
    ...
    override suspend fun getOfflineRminItem(): LiveData<List<VegaGhanaOfflineRmin>> =
        dao.getofflineRminItem()

    override suspend fun getofflineFgrnItem(): LiveData<List<VegaGhanaOfflineFgrn>> =
            dao.getofflineFgrnItem()

    override suspend fun getofflineFgrnPostItem(): LiveData<List<VegaGhanaOfflineFgrnData>> =
            dao.getofflineFgrnPostItem()

    override suspend fun getofflineRminPostItem(rmin: String): LiveData<List<VegaGhanaOfflineRminProcessLotDetails>> =
            dao.getofflineRminPostItem(rmin)

    override suspend fun getProcessOrders(type: String): LiveData<List<VegaGhanaProcessingOrder>> =
            dao.getProcessOrders(type)

    override suspend fun getProcessOrderDetails(poNumber: String): LiveData<List<VegaGhanaProcessingOrderDetails>> =
            dao.getProcessOrderDetails(poNumber)

    override suspend fun getStockDetails(material: String): LiveData<List<VegaEcuadorDispatchStocks>> =
            dao.getStockDetails(material)

    override suspend fun getOfflineRminLots(): LiveData<List<VegaGhanaOfflineRminLots>> =
            dao.getOfflineRminLots()

    override suspend fun getOfflineRminItems(): LiveData<List<VegaGhanaOfflineRminItems>> =
        dao.getOfflineRminItems()

    override suspend fun postCreatePo(bomPostReq: VegaGhanaProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>> {
    ...
    override suspend fun getPoGrades(
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>> =
                api.getFgrnGrades(VegaGhanaProcessOrderDetailsPostReq(getCurrentKey(), getPlantDetails(), poNo, rmin))
        }.build().asLiveData()
    }
    ...
    override suspend fun deleteAllRminItems() = dao.deleteAllRminItems()
    override suspend fun deleteAllRminLots() = dao.deleteAllRminLots()
    override suspend fun deleteAllFgrnItems() = dao.deleteAllFgrnItems()
    override suspend fun updateFgrnStatus(status: Boolean, rminId: String) = dao.updateFgrnStatus(status, rminId)
    override suspend fun updateStockDetails(weight: String, batchNo: String) = dao.updateStockDetails(weight, batchNo)
    override suspend fun updateFgrnTotal(total: String, poNo: String) = dao.updateFgrnTotal(total, poNo)
    override suspend fun getStockDetailsByBatchNo(batchNo: String) = dao.getStockDetailsByBatchNo(batchNo)
    override suspend fun getAllFGRNItems(fgrnItem: VegaCoffeeFgrnItems) = dao.getAllFGRNItems(fgrnItem.fgrnId, fgrnItem.materialCode?:"")
    ...
    override suspend fun saveOfflineRminDetails(rminData: VegaGhanaOfflineRminData) {
        dao.saveOfflineRminDetails(rminData)
    }

    override suspend fun saveOfflineRminLotDetails(rminLotData: VegaGhanaOfflineRminProcessLotDetails) {
        dao.saveOfflineRminLotDetails(rminLotData)
    }

    override suspend fun saveOfflineFgrnDetails(rminData: VegaGhanaOfflineFgrnData) {
        dao.saveOfflineFgrnDetails(rminData)
    }

    override suspend fun saveOfflineFgrnLotDetails(rminLotData: VegaGhanaOfflineFgrnProcessLotDetails) {
        dao.saveOfflineFgrnLotDetails(rminLotData)
    }

    override suspend fun saveOfflineRminSelectedLots(rminLotData: VegaGhanaOfflineRminLots) {
        dao.saveOfflineRminSelectedLots(rminLotData)
    }

    override suspend fun saveOfflineRminItem(rminLotData: VegaGhanaOfflineRminItems) {
        dao.saveOfflineRminItem(rminLotData)
    }
    ...
    override suspend fun getofflineRmindata(
        RminTempId: String
    ): LiveData<List<VegaGhanaOfflineRminData>> =
        dao.getofflineRminData(RminTempId)
    ...
    override suspend fun postRminDetails(model: VegaGhanaProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaGhanaProcessingRminResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaGhanaProcessingRminResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaGhanaProcessingRminResponse>> =
    ...
    override suspend fun postFgrnDetails(poReq: VegaGhanaProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaGhanaProcessingFgrnResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaGhanaProcessingFgrnResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaGhanaProcessingFgrnResponse>> =
    ...
    override suspend fun getBomoffline(wbId: String) = dao.getRminBomDetails(wbId)
}
