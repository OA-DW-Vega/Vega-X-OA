...
import com.olam.warehouse.vegax.processingghana.databinding.ItemVagaGhanaProcessingRminOfflineSummaryBinding
...
class VegaGhanaProcessingRminOfflineSummary : BaseFragment() {
    ...
    private fun initUI() {
        ...
        vm.offlineRminItemsLocal.observe(viewLifecycleOwner, Observer {
    ...
    private fun setUpAdapter(offloadingItems1: ArrayList<VegaGhanaOfflineRminProcessLotDetails>) {
        ...
        binding.rvReceivingOffline.setUpAdapter(
            ...
            ItemVagaGhanaProcessingRminOfflineSummaryBinding::inflate,
            { it, pos, bindItem ->
                val receiving = it
                bindItem.tvNoOfBags.text = receiving.poNo
                bindItem.tvWeight.text = receiving.netWeight.plus(" ").plus("MT")
                bindItem.tvProductType.text = receiving.materialName
                bindItem.tvWbId.text = receiving.rminTempId
                receiving.status = 2
