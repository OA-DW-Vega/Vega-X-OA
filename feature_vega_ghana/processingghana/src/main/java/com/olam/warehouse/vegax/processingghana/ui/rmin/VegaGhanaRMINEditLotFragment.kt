...
import com.olam.warehouse.vegax.processingghana.utils.FRAG_ADD_WEIGHT
import com.olam.warehouse.vegax.processingghana.utils.Lot_List
...
class VegaGhanaRMINEditLotFragment : BaseFragment(), GhanaRminItemRemoveListener,
    ...
    companion object {
        fun newInstance(fgrnIdMaterialCode: String, model: VegaCoffeeRminProcessing) =
            VegaGhanaRMINEditLotFragment().putArgs {
    ...
    override fun updateAddWeightCal(weight: String) {
        var come : Int?
