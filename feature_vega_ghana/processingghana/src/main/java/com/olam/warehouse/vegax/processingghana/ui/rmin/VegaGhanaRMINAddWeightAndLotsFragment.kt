...
import com.olam.warehouse.vegax.processingghana.databinding.FragmentVegaGhanaRminAddWeightBinding
...
class VegaGhanaRMINAddWeightAndLotsFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_ghana_rmin_add_weight
    private lateinit var binding: FragmentVegaGhanaRminAddWeightBinding
    ...
    companion object {
        ...
        ) = VegaGhanaRMINAddWeightAndLotsFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaGhanaRminAddWeightBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun initUI() {
        ...
        gradeList = Gson().fromJson<List<VegaCoffeeFgrnItemsGrades>>(fgrnItem.gradeListDetails ?: "")
    ...
    fun onBackPressed() {
        val weight =
            if (binding.clNet.tvNetWeightValue.text.toString().length < 3) "0.0 MT" else binding.clNet.tvNetWeightValue.text.toString()
