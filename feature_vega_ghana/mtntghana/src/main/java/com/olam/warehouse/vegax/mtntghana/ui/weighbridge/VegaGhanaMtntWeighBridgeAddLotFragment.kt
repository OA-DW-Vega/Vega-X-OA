...
import com.olam.warehouse.vegax.mtntghana.databinding.FragmentGhanaMtntWeighbridgeAddLotLayoutBinding
import com.olam.warehouse.vegax.mtntghana.ui.GhanaMTNTItemRemoveListener
import com.olam.warehouse.vegax.mtntghana.ui.VegaGhanaMtntLotAdapter
...
import com.olam.warehouse.vegax.mtntghana.utils.WEIGHBRIDGE_SUMMARY
import com.olam.warehouse.vegax.mtntghana.utils.getColor
import org.koin.androidx.viewmodel.ext.android.viewModel
import java.util.concurrent.TimeUnit

class VegaGhanaMtntWeighBridgeAddLotFragment : BaseFragment(), GhanaMTNTItemRemoveListener {
    override val layoutResourceId = R.layout.fragment_ghana_mtnt_weighbridge_add_lot_layout
    private lateinit var binding: FragmentGhanaMtntWeighbridgeAddLotLayoutBinding
    ...
    private lateinit var adapter: VegaGhanaMtntLotAdapter
    ...
    companion object {
        fun newInstance(model: VegaCocoaDispatchWB) =
            VegaGhanaMtntWeighBridgeAddLotFragment()
                .putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentGhanaMtntWeighbridgeAddLotLayoutBinding.inflate(layoutInflater)
        initExtra()
        initAdapter()
        initUI()
        return binding.root
    ...
    private fun saveLotList(list: ArrayList<VegaGhanaCocoaDispatchLots>) {
        vm.addLoTInDB(list)
    }
