package com.olam.warehouse.vegax.mtntghana.ui.offline
...
import com.olam.warehouse.master.work.getGhanaMTNTDispatchOneTimeRequestWorker
...
import com.olam.warehouse.vegax.mtntghana.databinding.FragmentGhanaMtntOfflineSummaryBinding
import com.olam.warehouse.vegax.mtntghana.databinding.ItemVegaGhanaMtntOfflineSummaryBinding
import com.olam.warehouse.vegax.mtntghana.ui.VegaGhanaMtntViewModel
import com.olam.warehouse.vegax.mtntghana.utils.ADD_LOT
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaGhanaCashewMtntOfflineSummaryFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_ghana_mtnt_offline_summary
    private val vm: VegaGhanaMtntViewModel by viewModel()

    private lateinit var binding: FragmentGhanaMtntOfflineSummaryBinding
    ...
    companion object {
        fun newInstance() = VegaGhanaCashewMtntOfflineSummaryFragment().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentGhanaMtntOfflineSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
...
//        hideLoading()
    ...
    private fun setUpAdapter(dispatchItemsList: ArrayList<VegaCocoaDispatchWB>) {
        ...
        binding.rvDispatchOffline.setUpAdapter(
            dispatchItems,
            R.layout.item_vega_ghana_mtnt_offline_summary,
            ItemVegaGhanaMtntOfflineSummaryBinding::inflate,
            { it, pos, bindItem ->
//                val dispatch = it.dispatch
                bindItem.tvStoNo.text = it.purchaseDocNum
                ...
                bindItem.tvDeliveryId.text = it.weighBridgeId

                if (it.delivery == "")
                    bindItem.tvDeliveryId.text = it.weighBridgeId
                else
                    bindItem.tvDeliveryId.text = it.delivery
                when (it.status) {
                    4 -> {
                    ...
                    3 -> {
                        ...
                        bindItem.tvError.text = it.message
...
//                vm.updateDeletedItem(item.weighBridgeId)
    ...
    private fun startSync(item: ArrayList<VegaCocoaDispatchWB>, _index: Int) {
        ...
        val worker = getGhanaMTNTDispatchOneTimeRequestWorker(input, _index)
