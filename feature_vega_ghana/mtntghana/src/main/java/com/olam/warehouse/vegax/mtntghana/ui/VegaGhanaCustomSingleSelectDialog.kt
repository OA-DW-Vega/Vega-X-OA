...
import com.olam.warehouse.vegax.mtntghana.databinding.GhanaCustomDialogLayoutBinding
import com.olam.warehouse.vegax.mtntghana.databinding.GhanaFilterItemBinding

class VegaGhanaCustomSingleSelectDialog(
...
//    private var isMaterial: Boolean = false,
    ...
    private var listener: VegaGhanaSingleSelectListener
) :
    Dialog(activity),
    ...
    private lateinit var binding: GhanaCustomDialogLayoutBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        requestWindowFeature(Window.FEATURE_NO_TITLE)
        binding = GhanaCustomDialogLayoutBinding.inflate(layoutInflater)
    ...
    private fun setAdapter(
        ...
        listener: VegaGhanaSingleSelectListener
    ) {
        binding.recyclerView.setUpAdapter(
            item,
            R.layout.ghana_filter_item,
            GhanaFilterItemBinding::inflate,
            { it, pos, bindItem ->
                bindItem.textView.text = it
                bindItem.fruitCardView.setOnClickListener { v ->
                    listener.clickOnItem(it, isWh, isSendingWH)
