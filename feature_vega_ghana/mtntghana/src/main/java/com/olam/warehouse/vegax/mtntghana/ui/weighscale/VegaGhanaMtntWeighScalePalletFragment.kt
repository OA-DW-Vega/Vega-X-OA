...
import com.olam.warehouse.vegax.mtntghana.databinding.ItemVegaGhanaMtntAddBagBinding
...
//        vm.pallet.observe(viewLifecycleOwner, Observer { updatePalletUI(it) })
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(),
            R.layout.item_vega_ghana_mtnt_add_bag,
            ItemVegaGhanaMtntAddBagBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
