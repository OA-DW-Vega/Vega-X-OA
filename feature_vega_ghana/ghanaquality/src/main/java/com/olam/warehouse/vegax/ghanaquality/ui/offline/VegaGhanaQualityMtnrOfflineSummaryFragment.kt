...
//                activity?.finish()
        ...
        vm.mtnrLotList.observe(viewLifecycleOwner, Observer {
            lotDetails = it
            viewDetails()
        })
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaWeighBridgeWithQualityParams>) {
        ...
        binding.rvOfflineQuality.setUpAdapter(
            ...
            { it, pos, bindItem ->
                ...
                bindItem.tvReceivedWeight.text = quality.paidWeight.plus(" ").plus("MT")
                ...
                bindItem.tvViewWeighBridge.setOnClickListener { view ->
