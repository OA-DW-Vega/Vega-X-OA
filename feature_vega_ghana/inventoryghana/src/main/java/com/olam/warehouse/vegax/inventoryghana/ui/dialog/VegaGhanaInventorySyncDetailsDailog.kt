package com.olam.warehouse.vegax.inventoryghana.ui.dialog
...
import com.olam.warehouse.vegax.inventoryghana.databinding.FragmentBottomSheetGhanaInventorySyncBinding
import com.olam.warehouse.vegax.inventoryghana.databinding.ItemVegaGhanaInventorySyncDetailsBinding
import com.olam.warehouse.vegax.inventoryghana.utils.SYNC_STATUS_DATA
import java.util.*

/**
 * Created by Keerthi Santhanam on 7/6/2020.
 */
class VegaGhanaInventorySyncDetailsDailog : BottomSheetDialogFragment() {

    private var syncStatusList = ArrayList<SyncStatus>()

    companion object {
        fun newInstance(syncStatusList: ArrayList<SyncStatus>) = VegaGhanaInventorySyncDetailsDailog().putArgs {
            putParcelableArrayList(SYNC_STATUS_DATA, syncStatusList)
        }
    }

    private lateinit var binding: FragmentBottomSheetGhanaInventorySyncBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBottomSheetGhanaInventorySyncBinding.inflate(layoutInflater)
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUpAdapter(
            syncStatusList,
            R.layout.item_vega_ghana_inventory_sync_details,
            ItemVegaGhanaInventorySyncDetailsBinding::inflate,
            { it, pos, bindItem ->
