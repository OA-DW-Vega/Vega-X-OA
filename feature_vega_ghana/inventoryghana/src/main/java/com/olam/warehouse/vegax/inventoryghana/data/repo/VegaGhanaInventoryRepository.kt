...
interface VegaGhanaInventoryRepository {
    ...
    suspend fun getInventoryReports(paramPost: VegaGhanaInventoryPost): LiveData<Resource<GenericReqAndResp<List<VegaGhanaInventoryReportResponse>>>>
}
...
class VegaGhanaInventoryRepositoryImpl(
    ...
    override suspend fun getInventoryReports(paramPost: VegaGhanaInventoryPost):LiveData<Resource<GenericReqAndResp<List<VegaGhanaInventoryReportResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaGhanaInventoryReportResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaGhanaInventoryReportResponse>> =
                api.getReports(paramPost)
        }.build().asLiveData()
    }
