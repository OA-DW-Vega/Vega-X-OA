...
data class VegaGhanaInventoryReportResponse(
    var storageLocationCode: String = "",
    var isExpanded: Boolean = false,
    var totalweight: String = "",
    var reportsList: List<ReportsList> = emptyList()
  )


data class ReportsList(
    var storageLocationCode: String = "",
    var totalDryingLossQty: String = "",
    var totalGrnQty: String = "",
    var totalRminQty: String = "",
    var totalMtntQty: String = "",
    var totalFgrnQty: String = ""
)
