...
import com.olam.warehouse.vegax.inventoryghana.databinding.ItemVegaGhanaInventoryFilterBinding
...
class VegaGhanaInventoryFilterFragment : BaseFragment() {
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            listFilterMaterial,
            R.layout.item_vega_ghana_inventory_filter,
            ItemVegaGhanaInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
