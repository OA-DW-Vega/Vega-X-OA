...
import com.olam.warehouse.vegax.inventoryghana.data.domain.model.FilterList
import com.olam.warehouse.vegax.inventoryghana.databinding.FragmentVegaGhanaInventoryFilterBinding
import com.olam.warehouse.vegax.inventoryghana.utils.*
import kotlinx.android.synthetic.main.item_vega_ghana_inventory_filter.view.*
 ...
 */
class VegaGhanaInventoryFilterFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_ghana_inventory_filter
    private lateinit var binding: FragmentVegaGhanaInventoryFilterBinding
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaGhanaInventoryFilterFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaGhanaInventoryFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUp(listFilterMaterial, R.layout.item_vega_ghana_inventory_filter, { it, pos ->
    ...
    private fun setUpHumidityAdapter(listFilterHumidity: ArrayList<FilterList>) {
        binding.rvAdmixture.setUp(listFilterHumidity, R.layout.item_vega_ghana_inventory_filter, { it, pos ->
    ...
    private fun setUpImpurityAdapter(listFilterImpurity: ArrayList<FilterList>) {
        binding.rvTotalImpurity.setUp(listFilterImpurity, R.layout.item_vega_ghana_inventory_filter, { it, pos ->
    ...
    private fun setUpMouldAdapter(listFilterMould: ArrayList<FilterList>) {
        binding.rvMould.setUp(listFilterMould, R.layout.item_vega_ghana_inventory_filter, { it, pos ->
