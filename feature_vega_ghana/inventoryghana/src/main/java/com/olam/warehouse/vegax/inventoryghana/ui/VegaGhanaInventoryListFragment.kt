...
import com.olam.warehouse.vegax.inventoryghana.data.domain.model.SyncStatus
...
import com.olam.warehouse.vegax.inventoryghana.ui.dialog.VegaGhanaInventorySyncDetailsDailog
import com.olam.warehouse.vegax.inventoryghana.utils.INVENTORY_CODE
import com.olam.warehouse.vegax.inventoryghana.utils.INVENTORY_DETAILS
import com.olam.warehouse.vegax.inventoryghana.utils.INVENTORY_LOTS
 ...
 */
class VegaGhanaInventoryListFragment : BaseFragment(), VegaGhanaInventoryNavigateToDetailsListener {
    private lateinit var binding: FragmentVegaGhanaInventoryListBinding
    override val layoutResourceId = R.layout.fragment_vega_ghana_inventory_list
    ...
    companion object {
        fun newInstance() = VegaGhanaInventoryListFragment().putArgs {
        }
    }
    ...
    private fun syncDetails() {
        val bottomDialog = VegaGhanaInventorySyncDetailsDailog.newInstance(syncStatusList)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        setHasOptionsMenu(true)
        binding = FragmentVegaGhanaInventoryListBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setAdapter(data: List<VegaInventoryWarehouseModel>) {
        ...
        binding.rvInventory.adapter = VegaGhanaInventoryParentAdapter(data, materialList, this)
    }
