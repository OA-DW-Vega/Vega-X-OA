...
import com.olam.warehouse.vegax.inventoryghana.databinding.ItemVegaGhanaInventoryDetailsBinding
...
class VegaGhanaInventoryDetailsFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<InventoryLots>) {
        ...
        binding.rvInventory.setUpAdapter(
            lotList,
            R.layout.item_vega_ghana_inventory_details,
            ItemVegaGhanaInventoryDetailsBinding::inflate,
            { it, pos, bindItem ->
