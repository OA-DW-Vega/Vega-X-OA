...
import kotlinx.android.synthetic.main.fragment_vega_ghana_inventory_list.*
import kotlinx.android.synthetic.main.item_vega_ghana_inventory_details.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaGhanaInventoryDetailsFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(bundle: Bundle) = VegaGhanaInventoryDetailsFragment().putArgs {
    ...
    private fun setUpAdapter(data: List<InventoryLots>) {
        ...
        binding.rvInventory.setUp(lotList, R.layout.item_vega_ghana_inventory_details, { it, pos ->
