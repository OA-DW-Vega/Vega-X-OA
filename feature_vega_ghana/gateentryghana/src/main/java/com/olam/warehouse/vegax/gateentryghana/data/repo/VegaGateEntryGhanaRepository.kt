package com.olam.warehouse.vegax.gateentryghana.data.repo
 ...
 */
interface VegaGateEntryGhanaRepository {
    suspend fun getWaitingTrucks(): LiveData<Resource<List<VegaGateEntry>>>
    suspend fun postGateEntryData(gateEntryPost: VegaGateEntryGhanaPost): LiveData<Resource<GenericReqAndResp<VegaGateEntryGhanaResponse>>>
...
class VegaGateEntryGhanaRepositoryImpl(
    private val api: VegaGateEntryGhanaApi,
    private val dao: VegaGateEntryDao,
    private val masterDao: MasterDao
) : VegaGateEntryGhanaRepository {
    ...
    override suspend fun postGateEntryData(gateEntryPost: VegaGateEntryGhanaPost): LiveData<Resource<GenericReqAndResp<VegaGateEntryGhanaResponse>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<VegaGateEntryGhanaResponse>>() {
            override suspend fun createCall(): GenericReqAndResp<VegaGateEntryGhanaResponse> =
