...
import com.olam.warehouse.vegax.gateentryghana.databinding.ItemVegaGhanaWaitingTruckListBinding
...
class VegaGhanaWaitingTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaGateEntry>) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_ghana_waiting_truck_list,
            ItemVegaGhanaWaitingTruckListBinding::inflate,
            { it, pos, bindItem ->
