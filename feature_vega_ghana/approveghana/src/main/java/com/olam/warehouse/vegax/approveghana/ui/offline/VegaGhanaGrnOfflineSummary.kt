package com.olam.warehouse.vegax.approveghana.ui.offline
...
import com.olam.warehouse.vegax.approveghana.databinding.FragmentVegaGhanaGrnOfflineBinding
import com.olam.warehouse.vegax.approveghana.databinding.ItemVegaGhanaGrnOfflineBinding
 ...
 */
class VegaGhanaGrnOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_ghana_grn_offline
    private val vm: VegaGhanaGrnViewModel by viewModel()
    private lateinit var binding: FragmentVegaGhanaGrnOfflineBinding
    private var grnList = arrayListOf<VegaGrnWeighBridgeId>()
    private var callBack: CallBack? = null

    companion object {
        fun newInstance() = VegaGhanaGrnOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaGhanaGrnOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaGrnWeighBridgeId>) {
        ...
        binding.rvOfflineGrn.setUpAdapter(
            grnList,
            R.layout.item_vega_ghana_grn_offline,
            ItemVegaGhanaGrnOfflineBinding::inflate,
            { it, pos, bindItem ->
