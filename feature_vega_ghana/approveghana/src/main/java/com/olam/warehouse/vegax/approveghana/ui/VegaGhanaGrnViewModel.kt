 ...
 */
class VegaGhanaGrnViewModel(
    private val useCase: VegaGhanaGrnUseCase,
    ...
    private var qualitySource: LiveData<Resource<GenericReqAndResp<List<VegaGRNGhanaQuality>>>> =
        MutableLiveData()
    private val _qualityDetails =
        MediatorLiveData<Resource<GenericReqAndResp<List<VegaGRNGhanaQuality>>>>()
    val qualityDetails: LiveData<Resource<GenericReqAndResp<List<VegaGRNGhanaQuality>>>> get() = _qualityDetails
    ...
    fun postGrn(grnPost: VegaGhanaGrnPost) = viewModelScope.launch(dispatchers.main) {
