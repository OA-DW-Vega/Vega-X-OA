...
import com.olam.warehouse.vegax.offloadingghana.databinding.FragmentVegaGhanaOffloadAddWeightLayoutBinding
import com.olam.warehouse.vegax.offloadingghana.utils.FRAG_ADD_BAG_WEIGHT
import com.olam.warehouse.vegax.offloadingghana.utils.UPDATE_WEIGHT
import com.olam.warehouse.vegax.offloadingghana.utils.getColor
import com.olam.warehouse.vegax.offloadingghana.utils.prepareSesameBagMaterial
import kotlinx.android.synthetic.main.item_vega_ghana_offload_add_bag.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import kotlin.random.Random

class VegaGhanaMtnrWeighScalePalletFragment : BaseFragment() {

    override val layoutResourceId: Int =
        R.layout.fragment_vega_ghana_offload_add_weight_layout
    private lateinit var binding: FragmentVegaGhanaOffloadAddWeightLayoutBinding
    ...
    companion object {
        fun newInstance(item: VegaCoffeeReceiveLots) = VegaGhanaMtnrWeighScalePalletFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaGhanaOffloadAddWeightLayoutBinding.inflate(inflater)
        initUI()
        return binding.root
    }
    ...
    fun onBackPressed() {
        val weight =
            if (binding.tvNetWtValue.text.toString().length < 3) "0.0 MT" else binding.tvNetWtValue.text.toString()
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCoffeeOffloadingBagMaterial>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_vega_ghana_offload_add_bag, { it, pos ->
            if (pos % 2 == 0) {
                clBagHead.setBackgroundResource(com.olam.warehouse.presentation.R.drawable.rectangle_grey_border)
            } else {
                clBagHead.setBackgroundResource(R.drawable.shape_ghana_offload_rect_light_grey1)
            }
