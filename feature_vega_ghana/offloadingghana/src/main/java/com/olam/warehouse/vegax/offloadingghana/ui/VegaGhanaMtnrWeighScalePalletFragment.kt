...
import com.olam.warehouse.vegax.offloadingghana.databinding.ItemVegaGhanaOffloadAddBagBinding
...
class VegaGhanaMtnrWeighScalePalletFragment : BaseFragment() {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCoffeeOffloadingBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(),
            R.layout.item_vega_ghana_offload_add_bag,
            ItemVegaGhanaOffloadAddBagBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
