...
class VegaGhanaMtnrPostWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params),
    KoinComponent {
    var mtnNo = ""
    var id = "SYNC_".plus(Random.nextLong().toString())
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        val dao: VegaEcuadorOffloadingDao by inject()
        val api: VegaGhanaOffloadingApi by inject()
