package com.olam.warehouse.vegax.offloadingghana.data.repo
...
import com.olam.warehouse.vegax.offloadingghana.utils.prepareData
import java.util.*

/**
 * Created by Keerthi Santhanam on 23/6/2020.
 */
interface VegaGhanaOffloadingRepository {
...
class VegaGhanaOffloadingRepositoryImpl(
    ...
    override suspend fun saveMtnrReceivingLots(
        ...
        if (vegaCoffeeReceivingData.tempWBId?.startsWith("TMP", false)!!) {
            dao.saveMtnrQualityList(prepareData(vegaCoffeeReceivingData, lot))
        }
