package com.olam.warehouse.vegax.offloadingghana.data.domain.usecase
 ...
 */
class VegaGhanaOffloadingUseCase(private val repository: VegaGhanaOffloadingRepository) {
