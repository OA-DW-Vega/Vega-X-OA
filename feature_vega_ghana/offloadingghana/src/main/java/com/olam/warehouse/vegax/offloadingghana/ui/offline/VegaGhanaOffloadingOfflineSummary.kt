...
import com.olam.warehouse.vegax.offloadingghana.utils.OFFLOADING_SUMMARY_FRAG
 ...
 */
class VegaGhanaOffloadingOfflineSummary : BaseFragment() {
    ...
    companion object {
        fun newInstance() = VegaGhanaOffloadingOfflineSummary().putArgs {
        }
    }
