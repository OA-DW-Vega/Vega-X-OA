package com.olam.wharhouse.vegax.transhistoryghanacashew.ui.grn
...
import com.olam.wharhouse.vegax.transhistoryghanacashew.databinding.FragmentGhanaCashewQualityBinding
import com.olam.wharhouse.vegax.transhistoryghanacashew.databinding.ItemGhanaCashewQualityDetailsGrnBinding
 ...
 */
class VegaGhanaCashewGRNQualityFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_ghana_cashew_quality
    private lateinit var binding: FragmentGhanaCashewQualityBinding
    private val vm: VegaGhanaCashewTransHisViewModel by viewModel()
    private var callBack: CallBack? = null
    private var inventoryLots = VegaGhanaCashewGRNHistoryTransactions()
    ...
    companion object {
        fun newInstance(inventoryQuality: VegaGhanaCashewGRNHistoryTransactions) = VegaGhanaCashewGRNQualityFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentGhanaCashewQualityBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(qualityParameters: List<VegaQualityParams>?) {
        ...
        binding.rvQuality.setUpAdapter(
            qualityParameters,
            R.layout.item_ghana_cashew_quality_details_grn,
            ItemGhanaCashewQualityDetailsGrnBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
