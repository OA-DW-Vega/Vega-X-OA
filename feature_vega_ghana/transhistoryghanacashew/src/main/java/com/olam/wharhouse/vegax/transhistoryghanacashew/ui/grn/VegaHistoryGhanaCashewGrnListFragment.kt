...
import com.olam.wharhouse.vegax.transhistoryghanacashew.databinding.FragmentHistoryTransactionsGhanaCashewGrnListBinding
import com.olam.wharhouse.vegax.transhistoryghanacashew.databinding.ItemHistoryTransactionsGhanaCashewGrnBinding
...
class VegaHistoryGhanaCashewGrnListFragment : BaseFragment() {

    override val layoutResourceId: Int = R.layout.fragment_history_transactions_ghana_cashew_grn_list
    private lateinit var binding: FragmentHistoryTransactionsGhanaCashewGrnListBinding
    ...
    private var history = mutableListOf<VegaGhanaCashewGRNHistoryTransactions>()
    private var filteredHistory = mutableListOf<VegaGhanaCashewGRNHistoryTransactions>()
    private var historyData = VegaGhanaCashewGRNHistoryTransactions()
    private val mSearchList = mutableListOf<VegaGhanaCashewGRNHistoryTransactions>()
    private var vegaWbIds = listOf<VegaGhanaCashewGRNHistoryTransactions>()
    private var vegaWbsortedIds = listOf<VegaGhanaCashewGRNHistoryTransactions>()
    ...
    companion object {
        fun newInstance(
            historyTransactions: VegaGhanaCashewGRNHistoryTransactions
        ) = VegaHistoryGhanaCashewGrnListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentHistoryTransactionsGhanaCashewGrnListBinding.inflate(inflater)
        return binding.root
    }
    ...
    private fun updateUIWithOnlineData(response: Resource<GenericReqAndResp<VegaGhanaCashewGRNHistoryTranxResponse>>) {
        response.let {
            when (it.status) {
                        ...
                        if (it1?.isNotEmpty() == true) {
                          //  history.clear()
                            ...
                            if (vegaWbsortedIds.size>0) {
                                ...
                                vegaWbIds =
                                    vegaWbsortedIds.sortedWith(compareBy({ it.grnNumber })) as MutableList<VegaGhanaCashewGRNHistoryTransactions>
                            ...
                            history = vegaWbIds as MutableList<VegaGhanaCashewGRNHistoryTransactions>
                            //getWarehouseList()
    ...
    private fun setUpAdapter(data: List<VegaGhanaCashewGRNHistoryTransactions>) {
        val history1 = data as MutableList<VegaGhanaCashewGRNHistoryTransactions>
        binding.rvLots.setUpAdapter(
            history1,
            R.layout.item_history_transactions_ghana_cashew_grn,
            ItemHistoryTransactionsGhanaCashewGrnBinding::inflate,
            { it1, pos, bindItem ->
