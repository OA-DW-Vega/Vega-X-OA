package com.olam.wharhouse.vegax.transhistoryghanacashew.utils
...
const val HISTORY_TRANSACTIONS_FGRN = "history_transactions_fgrn"
const val HISTORY_TRANSACTIONS_LOT_FGRN = "history_transactions_lot_fgrn"

const val HISTORY_TRANSACTIONS_RMIN = "history_transactions_rmin"
const val HISTORY_TRANSACTIONS_LOT_RMIN = "history_transactions_lot_rmin"
const val HISTORY_DATA_FGRN = "history_intent_data_fgrn"
const val HISTORY_DATA_RMIN = "history_intent_data_rmin"
const val HISTORY_TRANSACTIONS_QUALITY_PARAM="history_transactions_grn_quality_param"
...
//    val materialCode = if(materialsCode.startsWith("1")) MATERIAL_CODE.plus(materialsCode)  else materialsCode
    val uom = uomDetails.filter { it.materialCode == materialsCode }.single()
    netWeight =
        uom.value2?.toInt()?.toDouble()?.div(uom.value1?.toInt()?.toDouble()!!)!!
