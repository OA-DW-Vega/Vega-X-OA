...
import com.olam.warehouse.master.vegaghana.entity.VegaGhanaCashewHistoryTranxMtnr
...
import com.olam.wharhouse.vegax.transhistoryghanacashew.databinding.FragmentHistoryTransactionsGhanaCashewMtnrListBinding
import com.olam.wharhouse.vegax.transhistoryghanacashew.databinding.ItemHistoryTransactionsGhanaCashewMtnrBinding
...
class VegaHistoryGhanaCashewMtnrListFragment : BaseFragment() {

    override val layoutResourceId: Int = R.layout.fragment_history_transactions_ghana_cashew_mtnr_list
    private lateinit var binding: FragmentHistoryTransactionsGhanaCashewMtnrListBinding
    ...
    private var history = mutableListOf<VegaGhanaCashewMtnrHistoryTransactions>()
    private var historyData = VegaGhanaCashewMtnrHistoryTransactions()
    private val mSearchList = mutableListOf<VegaGhanaCashewMtnrHistoryTransactions>()
    private var filteredHistory = mutableListOf<VegaGhanaCashewMtnrHistoryTransactions>()
    private var vegaWbIds = listOf<VegaGhanaCashewMtnrHistoryTransactions>()
    private var vegaWbsortedIds = listOf<VegaGhanaCashewMtnrHistoryTransactions>()
    private var sortList = VegaGhanaCashewMtnrHistoryTransactions()
    ...
    companion object{
        fun newInstance(
            historyTransactions: VegaGhanaCashewMtnrHistoryTransactions
        ) = VegaHistoryGhanaCashewMtnrListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentHistoryTransactionsGhanaCashewMtnrListBinding.inflate(inflater)
        return binding.root
    }
    ...
    private fun updateUIWithOnlineData(response: Resource<GenericReqAndResp<VegaGhanaCashewHistoryTranxMtnr>>) {
        response.let {
            when (it.status) {
                Resource.Status.SUCCESS -> {
                    ...
                    response.data?.data?.mtnrTxnDetails.let { it1 ->
                        if (it1?.isNotEmpty() == true) {
                            ...
                            history = vegaWbIds as MutableList<VegaGhanaCashewMtnrHistoryTransactions>
                            //getWarehouseList()
    ...
    private fun setUpAdapter(data: List<VegaGhanaCashewMtnrHistoryTransactions>) {
        val history1 = data as MutableList<VegaGhanaCashewMtnrHistoryTransactions>
        binding.rvLots.setUpAdapter(
            history1.asReversed(),
            R.layout.item_history_transactions_ghana_cashew_mtnr,
            ItemHistoryTransactionsGhanaCashewMtnrBinding::inflate,
            { it1, pos, bindItem ->
