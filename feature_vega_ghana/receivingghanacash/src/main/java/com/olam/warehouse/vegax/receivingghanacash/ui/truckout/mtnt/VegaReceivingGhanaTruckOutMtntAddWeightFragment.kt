...
import com.olam.warehouse.vegax.receivingghanacash.databinding.FragmentVegaReceivingGhanaTruckoutMtntAddWeightBinding
 ...
 */
class VegaReceivingGhanaTruckOutMtntAddWeightFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaReceivingGhanaTruckoutMtntAddWeightBinding

    override val layoutResourceId = R.layout.fragment_vega_receiving_ghana_truckout_mtnt_add_weight

    companion object {
        fun newInstance(mtntData: VegaMtnt, mMtntList: ArrayList<VegaMtnt>) =
            VegaReceivingGhanaTruckOutMtntAddWeightFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaReceivingGhanaTruckoutMtntAddWeightBinding.inflate(layoutInflater)
        return binding.root
    }
