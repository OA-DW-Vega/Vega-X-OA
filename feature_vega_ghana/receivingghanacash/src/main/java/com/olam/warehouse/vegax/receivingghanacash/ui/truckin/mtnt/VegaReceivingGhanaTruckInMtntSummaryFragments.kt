...
import com.olam.warehouse.vegax.receivingghanacash.databinding.FragmentVegaReceivingGhanaTruckinMtntSummaryBinding
...
/**
 * Created by Baskaran Kannan on 2/17/2020.
 */
class VegaReceivingGhanaTruckInMtntSummaryFragments : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaReceivingGhanaTruckinMtntSummaryBinding
    override val layoutResourceId = R.layout.fragment_vega_receiving_ghana_truckin_mtnt_summary

    companion object {
        fun newInstance(mtntData: VegaMtnt) =
            VegaReceivingGhanaTruckInMtntSummaryFragments().putArgs {
                putParcelable(MTNT_DATA, mtntData)
            }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaReceivingGhanaTruckinMtntSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
