...
import kotlinx.android.synthetic.main.item_vega_receiving_ghana_truckin_wb_list.view.*
...
class VegaReceivingGhanaTruckInListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUp(receiving.asReversed(), R.layout.item_vega_receiving_ghana_truckin_wb_list, { it, pos ->
