package com.olam.warehouse.vegax.receivingghanacash.ui.weighment
...
import com.olam.warehouse.vegax.receivingghanacash.databinding.FragmentVegaReceivingGhanaWeighmentTypeBinding
 ...
 */
class VegaReceivingGhanaWeighmentTypeFragment : BaseFragment() {

    private val mTAG = VegaReceivingGhanaWeighmentTypeFragment::class.java.canonicalName
    private lateinit var binding: FragmentVegaReceivingGhanaWeighmentTypeBinding
    ...
    override val layoutResourceId = R.layout.fragment_vega_receiving_ghana_weighment_type

    companion object {
        fun newInstance() = VegaReceivingGhanaWeighmentTypeFragment().putArgs {
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaReceivingGhanaWeighmentTypeBinding.inflate(layoutInflater)
        return binding.root
    }
