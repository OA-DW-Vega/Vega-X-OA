...
import com.olam.warehouse.vegax.receivingghanacash.databinding.FragmentVegaReceivingGhanaTruckoutMtntWblistBinding
...
import com.olam.warehouse.vegax.receivingghanacash.utils.MTNT_DATA
import com.olam.warehouse.vegax.receivingghanacash.utils.TRUCKOUT_MTNT_ADD_WEIGHT_FRAG
import com.olam.warehouse.vegax.receivingghanacash.utils.getColor
import kotlinx.android.synthetic.main.item_vega_receiving_ghana_truckout_mtnt_wb_list.*
 ...
 */
class VegaReceivingGhanaTruckOutMtntWBListFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaReceivingGhanaTruckoutMtntWblistBinding
    override val layoutResourceId = R.layout.fragment_vega_receiving_ghana_truckout_mtnt_wblist

    companion object {
        fun newInstance(mtntData: VegaMtnt) = VegaReceivingGhanaTruckOutMtntWBListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaReceivingGhanaTruckoutMtntWblistBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(data: List<VegaMtnt>?) {
        ...
        binding.rvWeighbridge.setUp(receiving.asReversed(), R.layout.item_vega_receiving_ghana_truckout_mtnt_wb_list, { it, pos ->
            ...
            tvWarehouseLoc.text = it.storageLocationCode
            if ("null" != it.erdat) {
