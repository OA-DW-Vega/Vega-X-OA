...
import com.olam.warehouse.vegax.receivingghanacash.databinding.ItemVegaReceivingGhanaTruckoutMtntWbListBinding
...
class VegaReceivingGhanaTruckOutMtntWBListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaMtnt>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_receiving_ghana_truckout_mtnt_wb_list,
            ItemVegaReceivingGhanaTruckoutMtntWbListBinding::inflate,
            { it, pos, bindItem ->
