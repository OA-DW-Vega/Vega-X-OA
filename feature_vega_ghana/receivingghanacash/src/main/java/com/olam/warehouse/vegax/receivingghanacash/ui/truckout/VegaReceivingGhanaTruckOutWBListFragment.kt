...
import kotlinx.android.synthetic.main.item_vega_receiving_ghana_truckout_wb_list.*
...
class VegaReceivingGhanaTruckOutWBListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaReceiving>?) {
        ...
        binding.rvWeighbridge.setUp(receiving.asReversed(), R.layout.item_vega_receiving_ghana_truckout_wb_list, { it, pos ->
