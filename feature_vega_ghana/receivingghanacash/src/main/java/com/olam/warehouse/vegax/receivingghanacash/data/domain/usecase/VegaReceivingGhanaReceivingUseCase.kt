 ...
 */
class VegaReceivingGhanaReceivingUseCase(private val repository: VegaReceivingGhanaRepository) {
    ...
    suspend fun postReceivingDetail(receivingData: VegaReceivingGhanaPost) = repository.postReceivingDetail(receivingData)
    suspend fun postReceivingMtnDetail(receivingData: VegaReceivingGhanaPost) =
