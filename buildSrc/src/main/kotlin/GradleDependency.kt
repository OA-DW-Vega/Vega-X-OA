...
object GradlePluginVersion {
    ...
    const val PARCELIZE = "1.6.20-RC2"
}
...
object GradleOldWayPlugins {
    ...
    const val CRASHLYTICS =
        "com.google.firebase:firebase-crashlytics-gradle:${GradlePluginVersion.CRASHLYTICS}"

    const val DYNATRACE =
        "com.dynatrace.tools.android:gradle-plugin:${GradlePluginVersion.DYNATRACE}"
    const val SONAR =
