...
private object LibraryVersion {
    ...
    const val LIFECYCLE_VIEW_MODEL_KTX = "2.2.0-rc01"
    ...
    const val LEAK_CANARY = "2.0-beta-5"
    const val PREFERENCE = "1.1.0"
    const val FLIPTABS = "v1.0"
    const val APPCENTER_SDK = "3.3.0"
    const val MOTOMO_SDK = "4.1.2"
...
object LibraryDependency {
    ...
    const val MOTOMO_SDK = "org.matomo.sdk:tracker:${LibraryVersion.MOTOMO_SDK}"
