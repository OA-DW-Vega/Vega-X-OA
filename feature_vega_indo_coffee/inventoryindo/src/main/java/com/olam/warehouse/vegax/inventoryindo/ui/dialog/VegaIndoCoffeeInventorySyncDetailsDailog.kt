...
import com.olam.warehouse.vegax.inventoryindo.databinding.ItemIndoCoffeeInventorySyncDetailsBinding
...
class VegaIndoCoffeeInventorySyncDetailsDailog : BottomSheetDialogFragment() {
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUpAdapter(
            syncStatusList,
            R.layout.item_indo_coffee_inventory_sync_details,
            ItemIndoCoffeeInventorySyncDetailsBinding::inflate,
            { it, pos, bindItem ->
