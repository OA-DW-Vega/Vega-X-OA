...
import kotlinx.android.synthetic.main.item_indo_coffee_inventory_filter.view.*
...
class VegaIndoCoffeeInventoryFilterFragment : BaseFragment() {
    ...
    private fun setUpMaterialAdapter(listFliterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUp(listFliterMaterial, R.layout.item_indo_coffee_inventory_filter, { it, pos ->
    ...
    private fun setUpLocationAdapter(listFliterLocation: ArrayList<FilterList>) {
        binding.rvLocation.setUp(listFliterLocation, R.layout.item_indo_coffee_inventory_filter, { it, pos ->
    ...
    private fun setUpBeanAdapter(listFliterBean: ArrayList<FilterList>) {
        binding.rvBeanCount.setUp(listFliterBean, R.layout.item_indo_coffee_inventory_filter, { it, pos ->
    ...
    private fun setUpMoistAdapter(listFliterMoist: ArrayList<FilterList>) {
        binding.rvMoisture.setUp(listFliterMoist, R.layout.item_indo_coffee_inventory_filter, { it, pos ->
    ...
    private fun setUpFFAAdapter(listFliterFfa: ArrayList<FilterList>) {
        binding.rvFFA.setUp(listFliterFfa, R.layout.item_indo_coffee_inventory_filter, { it, pos ->
    ...
    private fun setUpFATAdapter(listFliterFat: ArrayList<FilterList>) {
        binding.rvFAT.setUp(listFliterFat, R.layout.item_indo_coffee_inventory_filter, { it, pos ->
