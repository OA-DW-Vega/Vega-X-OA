 ...
 */
class VegaIndoCoffeeInventoryViewModel(
    private val useCase: VegaIndoCoffeeInventoryUsecase,
    private val dispatchers: AppDispatchers
) :
    BaseViewModel() {

    private var scanLotSource: LiveData<Resource<GenericReqAndResp<List<VegaIndoCoffeeInventoryLots>>>> =
        MutableLiveData()
    private val _scanLots = MediatorLiveData<Resource<GenericReqAndResp<List<VegaIndoCoffeeInventoryLots>>>>()
    val scanLot: LiveData<Resource<GenericReqAndResp<List<VegaIndoCoffeeInventoryLots>>>> get() = _scanLots

    private var lotListSource: LiveData<Resource<GenericReqAndResp<VegaIndoCoffeeInventoryLotHead>>> = MutableLiveData()
    private val _lotList = MediatorLiveData<Resource<GenericReqAndResp<VegaIndoCoffeeInventoryLotHead>>>()
    val lotList: LiveData<Resource<GenericReqAndResp<VegaIndoCoffeeInventoryLotHead>>> get() = _lotList
