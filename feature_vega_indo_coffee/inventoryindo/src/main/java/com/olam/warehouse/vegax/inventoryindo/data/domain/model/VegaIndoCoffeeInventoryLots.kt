package com.olam.warehouse.vegax.inventoryindo.data.domain.model
 ...
 */
@Parcelize
class VegaIndoCoffeeInventoryLots(
    var grnDate: String = "",
    var id: Int = 0,
    var kor: String? = "",
...
data class VegaIndoCoffeeInventoryLotHead(
    //var inventories: List<VegaIndoCoffeeInventoryLots>,
    var syncStatus: List<SyncStatus> = emptyList(),
    var stocks: List<VegaIndoCoffeeInventoryLots> = emptyList()
)
