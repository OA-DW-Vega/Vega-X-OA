...
data class VegaIndoCoffeeOffloadingPostRequest(
    var batchNumber: String? = "",
    var delFlag: String? = "",
    var deliveryDetails: List<VegaIndoCoffeeOffloadingDeliveryDetail>,
    var key: String? = "",
...
data class VegaIndoCoffeeOffloadingDeliveryDetail(
    var batchNumber: String? = "",
    var bltxt: String? = "",
