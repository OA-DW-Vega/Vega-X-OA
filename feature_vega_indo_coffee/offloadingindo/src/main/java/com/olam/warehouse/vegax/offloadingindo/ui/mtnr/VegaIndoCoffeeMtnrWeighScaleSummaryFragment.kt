...
import com.olam.warehouse.vegax.offloadingindo.databinding.ItemIndoCoffeeMtnrWeighscaleLotCardLayoutBinding
...
//            binding.tvDepartmentValue.visibility = View.VISIBLE
    ...
    private fun setUpBagAdapter(list: ArrayList<VegaCoffeeOffloadingBagMaterial>) {
        ...
        binding.rvLots.setUpAdapter(lots, R.layout.item_indo_coffee_mtnr_weighscale_lot_card_layout,
            ItemIndoCoffeeMtnrWeighscaleLotCardLayoutBinding::inflate,
            { item, pos, bindItem ->
    ...
    private fun setUpAdapter(list: List<VegaCoffeeReceiveLots>) {
        ...
        binding.rvLots.setUpAdapter(
            lots, R.layout.item_indo_coffee_mtnr_weighscale_lot_card_layout,
            ItemIndoCoffeeMtnrWeighscaleLotCardLayoutBinding::inflate,
            { item, pos, bindItem ->
                ...
                //ivEdit.visible()
                bindItem.tvAddWeight.visibility = View.GONE
                if (vegaCoffeeReceivingData.remarks?.isNotEmpty() == true) bindItem.ivEdit.gone() else bindItem.ivEdit.visible()
