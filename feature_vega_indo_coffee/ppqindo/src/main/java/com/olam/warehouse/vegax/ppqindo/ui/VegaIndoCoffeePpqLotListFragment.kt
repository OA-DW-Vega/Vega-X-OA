...
import kotlinx.android.synthetic.main.item_indo_coffee_ppq_lot_details.view.*
...
class VegaIndoCoffeePpqLotListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(lotList: MutableList<VegaIndoCoffeePpqInspectionLots>) {
        ...
        binding.rvInspectiontLots.setUp(lotList, R.layout.item_indo_coffee_ppq_lot_details, { it, pos ->
