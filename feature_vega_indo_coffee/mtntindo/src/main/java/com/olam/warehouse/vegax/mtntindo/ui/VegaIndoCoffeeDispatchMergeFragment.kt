...
import com.olam.warehouse.vegax.mtntindo.databinding.ItemIndoCoffeeDispatchMergeLotListDetailBinding
...
class VegaIndoCoffeeDispatchMergeFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaEcuadorDispatchLots>) {
        binding.rvSelectLots.setUpAdapter(
            data,
            R.layout.item_indo_coffee_dispatch_merge_lot_list_detail,
            ItemIndoCoffeeDispatchMergeLotListDetailBinding::inflate,
            { it, pos, bindItem ->
