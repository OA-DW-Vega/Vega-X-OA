...
import kotlinx.android.synthetic.main.item_indo_coffee_lot_dispatch_summary.*
import kotlinx.android.synthetic.main.item_indo_coffee_lot_dispatch_summary.view.*
...
class VegaIndoCoffeeDispatchLotSummaryFragment : BaseFragment() {
    ...
    private fun setupAdapter() {
        binding.rvLotList.addItemDecoration(DividerSpaceItemDecorationIndoCoffee(16, dispatchLotsList))
        binding.rvLotList.setUp(dispatchLotsList, R.layout.item_indo_coffee_lot_dispatch_summary, { it, pos ->
            ...
            if (model.isView == true) ivEdit.gone() else ivEdit.visible()
