...
import com.olam.warehouse.vegax.mtntindo.databinding.ItemIndoCoffeeDispatchMergePreviewLotListDetailBinding
...
class VegaIndoCoffeeDispatchMergePreviewFragment : BaseFragment() {
    ...
    private fun setupAdapter() {
        binding.rvSelectLots.addItemDecoration(
        ...
        binding.rvSelectLots.setUpAdapter(
            ...
            ItemIndoCoffeeDispatchMergePreviewLotListDetailBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun unMergeLots(
        ...
        itemClickedPos: Int,
        bindItem: ItemIndoCoffeeDispatchMergePreviewLotListDetailBinding
    ) {
