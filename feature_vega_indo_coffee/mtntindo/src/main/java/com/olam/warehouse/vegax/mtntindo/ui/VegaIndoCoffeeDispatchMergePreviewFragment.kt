...
import kotlinx.android.synthetic.main.item_indo_coffee_dispatch_merge_preview_lot_list_detail.*
import kotlinx.android.synthetic.main.item_indo_coffee_dispatch_merge_preview_lot_list_detail.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel

/**
 * Created by Baskaran Kannan on 4/8/2021.
 */
class VegaIndoCoffeeDispatchMergePreviewFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(model: VegaEcuadorDispatch) =
            VegaIndoCoffeeDispatchMergePreviewFragment().putArgs {
    ...
    private fun setupAdapter() {
        binding.rvSelectLots.addItemDecoration(DividerSpaceItemDecorationIndoCoffee(16, dispatchLotsList))
        binding.rvSelectLots.setUp(
            dispatchLotsList,
            R.layout.item_indo_coffee_dispatch_merge_preview_lot_list_detail,
            { it, pos ->
