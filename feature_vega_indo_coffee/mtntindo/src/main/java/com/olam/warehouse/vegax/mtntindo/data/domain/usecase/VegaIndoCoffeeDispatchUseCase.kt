package com.olam.warehouse.vegax.mtntindo.data.domain.usecase
 ...
 */
class VegaIndoCoffeeDispatchUseCase(private val repository: VegaIndoCoffeeDispatchRepository) {
    ...
    suspend fun validateLot(batchNumber: String, tmpId: String): VegaEcuadorDispatchLots =
        repository.validateLot(batchNumber, tmpId)
