...
import kotlinx.android.synthetic.main.item_indo_coffee_dispatch_lot_list_detail.view.*
...
class VegaIndoCoffeeDispatchLotListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaEcuadorDispatchLots>) {
        ...
        binding.rvLots.setUp(data, R.layout.item_indo_coffee_dispatch_lot_list_detail, { it, pos ->
