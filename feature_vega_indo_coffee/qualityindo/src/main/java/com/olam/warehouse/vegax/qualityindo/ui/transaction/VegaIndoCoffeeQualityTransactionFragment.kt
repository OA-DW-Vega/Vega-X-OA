...
import kotlinx.android.synthetic.main.item_vega_indo_quality_transaction.view.*
...
class VegaIndoCoffeeQualityTransactionFragment : BaseFragment() {
    ...
    private fun setupAdapter(itemList: List<VegaQualityWBDetails>) {
        ...
        binding.rvTransaction.setUp(itemList as ArrayList, R.layout.item_vega_indo_quality_transaction, { it, pos ->
            tvOffloadTempIdValue.text = it.weighBridgeId
            ...
            tvBatchNoValue.text = it.vehicleNumber
