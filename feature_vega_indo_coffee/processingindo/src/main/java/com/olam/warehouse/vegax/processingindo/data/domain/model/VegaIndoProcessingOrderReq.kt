...
class VegaIndoProcessingOrderReq(
    var key: String? = "",
    var auart: String? = "",
    var cfgNo: String? = "",
    var fevor: String? = "",
...
data class VegaProcessingIndoRminProcessingPost(
    var processingStage: String? = "",
    var key: String? = "",
    var outputMaterialCode: String? = "",
    var plant: Plant? = null,
    var processingLotDtls: List<VegaProcessingIndoRMINLotDetails> = emptyList(),
...
data class VegaProcessingIndoRminResponse(
...
data class VegaProcessingIndoCreatePoReq(
    var cfgNo: String = "",
    var processingStage: String? = "",
    var batchNumber: String = "",
    var key: String? = "",
