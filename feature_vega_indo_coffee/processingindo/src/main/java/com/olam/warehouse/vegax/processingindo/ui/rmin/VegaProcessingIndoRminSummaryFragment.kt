...
import kotlinx.android.synthetic.main.item_processing_indo_lot_rmin_summary.view.*
...
class VegaProcessingIndoRminSummaryFragment : BaseFragment() {
    ...
    private fun setupAdapter() {
        ...
        binding.rvLotList.setUp(list, R.layout.item_processing_indo_lot_rmin_summary, { it, _ ->
