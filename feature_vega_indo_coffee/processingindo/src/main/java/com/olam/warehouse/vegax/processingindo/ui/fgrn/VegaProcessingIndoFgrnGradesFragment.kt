...
import kotlinx.android.synthetic.main.item_vega_processing_indo_fgrn_grades.view.*
...
class VegaProcessingIndoFgrnGradesFragment : BaseFragment() {
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCocoaFgrnItemsGrades>) {
        binding.rvGrades.setUp(gradeList, R.layout.item_vega_processing_indo_fgrn_grades, { item, pos ->
