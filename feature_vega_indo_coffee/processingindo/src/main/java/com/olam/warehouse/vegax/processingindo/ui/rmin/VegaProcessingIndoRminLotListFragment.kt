...
import com.olam.warehouse.vegax.processingindo.databinding.ItemProcessingIndoLotSummaryBinding
...
class VegaProcessingIndoRminLotListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaRminLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_processing_indo_lot_summary,
            ItemProcessingIndoLotSummaryBinding::inflate,
            { it, pos, bindItem ->
