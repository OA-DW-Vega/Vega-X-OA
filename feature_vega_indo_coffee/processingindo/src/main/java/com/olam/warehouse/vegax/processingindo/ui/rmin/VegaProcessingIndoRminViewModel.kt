 ...
 */
class VegaProcessingIndoRminViewModel(private val useCase: VegaProcessingIndoUseCase, private val dispatchers: AppDispatchers) :
    BaseViewModel() {
    ...
    private var postRminSource: LiveData<Resource<GenericReqAndResp<List<VegaProcessingIndoRminResponse>>>> =
        MutableLiveData()
    private val _postRmin = MediatorLiveData<Resource<GenericReqAndResp<List<VegaProcessingIndoRminResponse>>>>()
    val postRmin: LiveData<Resource<GenericReqAndResp<List<VegaProcessingIndoRminResponse>>>> get() = _postRmin
    ...
    fun fetchBomList(bomPostReq: VegaProcessingIndoRminBomPost) =
        viewModelScope.launch(dispatchers.main) {
    ...
    fun postRmin(poReq: VegaProcessingIndoRminProcessingPost) = viewModelScope.launch(dispatchers.main) {
    ...
    fun createPoRequest(poReq: VegaProcessingIndoCreatePoReq) = viewModelScope.launch(dispatchers.main) {
