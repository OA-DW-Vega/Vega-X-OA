...
import com.olam.warehouse.vegax.processingindo.databinding.ItemVegaProcessingIndoFgrnPendingBinding
...
class VegaProcessingIndoFgrnPendingFragment : BaseFragment() {
    ...
    private fun updateItems(pendingList: List<VegaCocoaFgrnItems>) {
        binding.rvPendingPoList.setUpAdapter(
            ...
            R.layout.item_vega_processing_indo_fgrn_pending,
            ItemVegaProcessingIndoFgrnPendingBinding::inflate,
            { item, pos, bindItem ->
