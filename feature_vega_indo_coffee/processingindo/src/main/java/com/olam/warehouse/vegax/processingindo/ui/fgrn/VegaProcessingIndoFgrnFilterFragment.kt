...
import kotlinx.android.synthetic.main.item_vega_processing_indo_fgrn_inventory_filter.view.*
import java.util.*
...
class VegaProcessingIndoFgrnFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<vegaProcessingIndoFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_processing_indo_fgrn_inventory_filter, { it, pos ->
