...
import kotlinx.android.synthetic.main.item_vega_processing_indo_bag_consump_summary.view.*
import kotlinx.android.synthetic.main.item_vega_processing_indo_fgrn_summary.view.*
...
class VegaProcessingIndoFgrnSummaryFragment : BaseFragment() {
    ...
    private fun updateAdapter(gradeItems: List<VegaCocoaFgrnGradesWithBagItems>) {
        ...
        binding.rvFgrnSummary.setUp(gradeItems as MutableList, R.layout.item_vega_processing_indo_fgrn_summary, { it, pos ->
    ...
    private fun updateBagConsumptionAdapter(bagConsumpList: ArrayList<VegaCocoaFgrnBagCosumption>) {
        ...
        binding.rvBagConsumption.setUp(bagConsumpList, R.layout.item_vega_processing_indo_bag_consump_summary, { it, pos ->
