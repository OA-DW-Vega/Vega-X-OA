...
import com.olam.warehouse.vegax.grnindo.databinding.ItemIndoCoffeeGrnOfflineBinding
...
class VegaIndoCoffeeGrnOfflineSummary : BaseFragment() {
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaGrnWeighBridgeId>) {
        ...
        binding.rvOfflineGrn.setUpAdapter(
            ...
            ItemIndoCoffeeGrnOfflineBinding::inflate,
            { it, pos, bindItem ->
                ...
                bindItem.tvViewWeighBridge.setOnClickListener { _ -> viewDetails(it) }
                bindItem.ivDeleteData.setOnClickListener { _ -> showDeleteDialog(it) }
