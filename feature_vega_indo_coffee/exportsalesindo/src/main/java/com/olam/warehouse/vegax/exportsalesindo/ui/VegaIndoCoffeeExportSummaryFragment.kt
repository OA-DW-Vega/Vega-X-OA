...
import com.olam.warehouse.vegax.exportsalesindo.databinding.ItemExportIndoCoffeeSummaryBinding
...
class VegaIndoCoffeeExportSummaryFragment : BaseFragment() {
    ...
    private fun updateContainerAdapter(data: VegaIndoCoffeeExportOTWithContainer) {
        ...
        binding.rvLots.setUpAdapter(
            ...
            ItemExportIndoCoffeeSummaryBinding::inflate,
            { it, pos, bindItem ->
                ...
                if (isView) bindItem.ivSelect.gone() else bindItem.ivSelect.visible()
            })
    }
