package com.olam.warehouse.vegax.mtntghanacashew.ui
...
import com.olam.warehouse.vegax.mtntghanacashew.R
import com.olam.warehouse.vegax.mtntghanacashew.databinding.FragmentVegaGhanaMtntLotListBinding
import com.olam.warehouse.vegax.mtntghanacashew.utils.*
import kotlinx.android.synthetic.main.item_ghana_mtnt_lot_list_detail.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel

/**
 * Created by Keerthi Santhanam on 7/21/2020.
 */
class VegaGhanaMtntLotListFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_ghana_mtnt_lot_list
    private lateinit var binding: FragmentVegaGhanaMtntLotListBinding
    ...
    private var listener: VegaGhanaMtntAddLotsListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        listener = context as? VegaGhanaMtntAddLotsListener
    }

    companion object {
        fun newInstance(model: VegaEcuadorDispatch, materialList: ArrayList<String>) =
            VegaGhanaMtntLotListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaGhanaMtntLotListBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    ...
    private fun setupAdapter(data: MutableList<VegaEcuadorDispatchLots>) {
        ...
        binding.rvLots.setUp(data, R.layout.item_ghana_mtnt_lot_list_detail, { it, pos ->
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter = ArrayAdapter(requireContext(), R.layout.item_vega_ghana_mtnt_dispatch_wh, wareHouseList)
