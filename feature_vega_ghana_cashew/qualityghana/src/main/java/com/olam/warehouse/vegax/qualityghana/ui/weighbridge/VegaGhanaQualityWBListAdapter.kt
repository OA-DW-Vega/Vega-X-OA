package com.olam.warehouse.vegax.qualityghana.ui.weighbridge
...
import com.olam.warehouse.vegax.qualityghana.utils.PROCURE
import com.olam.warehouse.vegax.qualityghana.utils.WAREHOUSE
import kotlinx.android.synthetic.main.item_vega_ghana_quality_weigh_bridge_details.view.*

/**
 * Created by Baskaran Kannan on 9/25/2020.
 */
class VegaGhanaQualityWBListAdapter(private val onClick: (VegaQualityWBDetails?) -> Unit) :
    RecyclerView.Adapter<VegaGhanaQualityWBListAdapter.WeighBridgeViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WeighBridgeViewHolder {
        val v =
            LayoutInflater.from(parent.context)
                .inflate(R.layout.item_vega_ghana_quality_weigh_bridge_details, parent, false)
