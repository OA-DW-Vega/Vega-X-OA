package com.olam.warehouse.vegax.qualityghana.data.repo
...
import com.olam.warehouse.vegax.qualityghana.utils.prepareData
import com.olam.warehouse.vegax.qualityghana.utils.prepareWeighBridgeData
...
class VegaGhanaQualityRepositoryImpl(private val api: VegaGhanaQualityApi, private val dao: VegaQualityDao) :
    VegaGhanaQualityRepository {
