...
import com.olam.warehouse.vegax.qualityghana.databinding.FragmentVegaGhanaQualityWeighBridgeListBinding
...
class VegaGhanaQualityWBListFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance() = VegaGhanaQualityWBListFragment().putArgs {
        }
    }
