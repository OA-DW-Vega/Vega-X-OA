...
import com.olam.warehouse.vegax.qualityghana.di.injectGhanaQualityFeature
import com.olam.warehouse.vegax.qualityghana.ui.param.VegaGhanaQualityParameterFragment
import com.olam.warehouse.vegax.qualityghana.ui.weighbridge.VegaGhanaQualityWBListFragment
...
class VegaGhanaQualityActivity : HomeBaseActivity(), VegaGhanaQualityWBListFragment.OnWeighBridgeListener,
    VegaGhanaQualityParameterFragment.OnParamsListener,
    VegaGhanaQualityWeighmentTypeFragment.CallBack {
    ...
    private fun displayFragment(openFragment: String, bundle: Bundle?, canReplace: Boolean) {
        ...
        when (openFragment) {
            ...
            WEIGHBRIDGE_LIST -> {
                ...
                searchView?.visible()
                fragment = VegaGhanaQualityWBListFragment.newInstance()
            }
            PARAMS_LIST -> {
                search?.isVisible = false
                searchView?.gone()
            ...
            else -> fragment = VegaGhanaQualityWBListFragment.newInstance()
        }
