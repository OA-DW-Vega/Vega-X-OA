...
class PortIncomingBaleStatusActivity : HomeBaseActivity() {
    ...
    private fun showDamageTypeDialog() {
        ...
        when (baleStatus) {
            BaleStatus.CottonClean -> {
                llCottonClean!!.setBackgroundColor(ContextCompat.getColor(this, R.color.warm_grey))
                flCottonClean!!.visibility = View.VISIBLE
            }
            BaleStatus.CottonDirty -> {
                llCottonDirty!!.setBackgroundColor(ContextCompat.getColor(this, R.color.warm_grey))
                flCottonDirty!!.visibility = View.VISIBLE
            }
            BaleStatus.TieDamage -> {
                llTieDamage!!.setBackgroundColor(ContextCompat.getColor(this, R.color.warm_grey))
                flTieDamage!!.visibility = View.VISIBLE
            }
            BaleStatus.WetBale -> {
                llWetBale!!.setBackgroundColor(ContextCompat.getColor(this, R.color.warm_grey))
                flWetBale!!.visibility = View.VISIBLE
            }
            BaleStatus.NoBaleTag -> {
                llNoBaleTag!!.setBackgroundColor(ContextCompat.getColor(this, R.color.warm_grey))
