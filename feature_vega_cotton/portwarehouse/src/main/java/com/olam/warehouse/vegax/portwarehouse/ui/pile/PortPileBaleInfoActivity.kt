...
import com.olam.warehouse.vegax.portwarehouse.databinding.FragmentPortBaleListBinding
import com.olam.warehouse.vegax.portwarehouse.databinding.ItemPortBaleSummaryBinding
...
class PortPileBaleInfoActivity : HomeBaseActivity() {
    ...
    private lateinit var binding: FragmentPortBaleListBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        //  injectPortPileFeature()
        binding = FragmentPortBaleListBinding.inflate(layoutInflater)
    ...
    private fun setUpAdpater(listItem: ArrayList<PortPileBale>) {
        binding.rvBaleList.setUpAdapter(
            ...
            ItemPortBaleSummaryBinding::inflate,
            { it, pos, bindItem ->
