...
import com.olam.warehouse.vegax.portwarehouse.databinding.ItemDispatchCompleteBinding
...
class PortDispatchCompleteAdapter constructor(val mListener: OnViewContainerListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        val v =
            ItemDispatchCompleteBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ItemViewHolder(
        private val iv: ItemDispatchCompleteBinding,
        private val mListener: OnViewContainerListener
