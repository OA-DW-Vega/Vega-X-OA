...
import com.olam.warehouse.portwarehouse.utils.enums.SyncStatus
...
object PortWHUtil {
    ...
    fun getContainerBackgroundColor(value: Int): Int {
        val status = ContainerStatus.from(value)
        return when (status) {
            ContainerStatus.InProgress -> R.color.orange
            ContainerStatus.Resume -> R.color.blue_light
            ContainerStatus.OnHold -> R.color.red
            ContainerStatus.Completed -> R.color.green
