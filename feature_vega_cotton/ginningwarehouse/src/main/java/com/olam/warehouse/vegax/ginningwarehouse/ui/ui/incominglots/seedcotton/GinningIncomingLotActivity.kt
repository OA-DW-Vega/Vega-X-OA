...
import kotlinx.android.synthetic.main.activity_ginning_incoming_lot.*
...
class GinningIncomingLotActivity : HomeBaseActivity(), HomeBaseActivity.DialogSingleClick {
    ...
    private fun initUI() {
        ...
        rvIncomingLots.apply {
            layoutManager = lm
            addItemDecoration(DividerItemDecoration(rvIncomingLots.context, lm.orientation))
            adapter = mAdapter
        }
