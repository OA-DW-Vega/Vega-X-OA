package com.olam.warehouse.ginning.data.repo
...
class VegaGinningDispatchRepositoryImpl(private val api: GinningDispatchApi, private val daoVegaCotton: VegaCottonGinningDispatchDao) : GinningDispatchRepository {
