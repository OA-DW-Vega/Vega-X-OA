...
import com.olam.warehouse.vegax.ginningwarehouse.databinding.ActivityGinningIncomingMtnOfflineBinding
import com.olam.warehouse.vegax.ginningwarehouse.ui.ui.incominglots.incomingmtn.GinningIncomingMtnViewModel
import com.olam.warehouse.vegax.ginningwarehouse.ui.ui.incominglots.incomingmtn.GinningIncomingVerifyBaleActivity
...
class GinningIncomingMtnOfflineActivity : HomeBaseActivity() {
    ...
    private lateinit var binding: ActivityGinningIncomingMtnOfflineBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGinningIncomingMtnOfflineBinding.inflate(layoutInflater)
    ...
    private fun initUI() {
        ...
        if (isOnline()) {
            ...
            binding.btnSyncProceed.setBackgroundColor(getColorUtil(com.olam.warehouse.presentation.R.color.colorPrimaryOfi))
        } else {
            binding.btnSyncProceed.isEnabled = false
            binding.btnSyncProceed.setBackgroundColor(getColorUtil(R.color.grey))
        }
        ...
        vm.getOfflineMtnWithBales.observe(this, Observer { mtnBales ->
            mtnBales.forEach {
                it.mtn.baleCount =
                    it.bales.filter { mtnBale -> mtnBale.isOfflineData }.size.toString()
