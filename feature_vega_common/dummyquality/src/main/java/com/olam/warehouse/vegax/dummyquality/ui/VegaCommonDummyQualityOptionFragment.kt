...
class VegaCommonDummyQualityOptionFragment : BaseFragment() {

    private var callBack: CallBack? = null
    override val layoutResourceId = R.layout.fragment_dummy_quality_option
    private lateinit var binding: FragmentDummyQualityOptionBinding

    companion object {
        fun newInstance() = VegaCommonDummyQualityOptionFragment().putArgs {
        }
    }
