...
import com.olam.warehouse.vegax.processingsesame.databinding.ItemVegaSesameFgrnGradesBinding
import com.olam.warehouse.vegax.processingsesame.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaSesameFgrnGradesFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(model: VegaCoffeeFgrnItems, id: String, vegaStage: VegaProcessingStage) = VegaSesameFgrnGradesFragment().putArgs {
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCoffeeFgrnItemsGrades>) {
        ...
        binding.rvGrades.setUpAdapter(
            gradeList,
            R.layout.item_vega_sesame_fgrn_grades,
            ItemVegaSesameFgrnGradesBinding::inflate,
            { item, pos, bindItem ->
    ...
    private fun View.updateGradeSelection(
        ...
        pos: Int,
        bindItem: ItemVegaSesameFgrnGradesBinding
    ) {
