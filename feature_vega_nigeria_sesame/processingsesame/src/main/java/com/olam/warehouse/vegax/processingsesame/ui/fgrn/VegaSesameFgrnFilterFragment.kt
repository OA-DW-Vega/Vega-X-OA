...
import kotlinx.android.synthetic.main.item_vega_sesame_fgrn_inventory_filter.view.*
import java.util.*
...
class VegaSesameFgrnFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<SesameFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_sesame_fgrn_inventory_filter, { it, pos ->
