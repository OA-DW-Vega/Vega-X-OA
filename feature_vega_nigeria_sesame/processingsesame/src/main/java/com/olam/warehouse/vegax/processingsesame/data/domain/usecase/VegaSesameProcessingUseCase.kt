package com.olam.warehouse.vegax.processingsesame.data.domain.usecase
...
import com.olam.warehouse.vegax.processingsesame.data.domain.model.VegaSesameProcessingRminBomPost
import com.olam.warehouse.vegax.processingsesame.data.repo.VegaSesameProcessingRepository

class VegaSesameProcessingUseCase(val repository: VegaSesameProcessingRepository) {
    suspend fun getGrades() = repository.getGrades()
    suspend fun getStages() = repository.getStages()
    suspend fun getBom(bomPostReq: VegaSesameProcessingRminBomPost) =
    ...
    suspend fun postRminDetails(model: VegaSesameProcessingFgrnPost) = repository.postRminDetails(model)
    ...
    suspend fun postFgrnDetails(poReq: VegaSesameProcessingFgrnPost) = repository.postFgrnDetails(poReq)
    ...
    suspend fun postCreatePo(bomPostReq: VegaSesameProcessingCreatePoReq) = repository.postCreatePo(bomPostReq)
