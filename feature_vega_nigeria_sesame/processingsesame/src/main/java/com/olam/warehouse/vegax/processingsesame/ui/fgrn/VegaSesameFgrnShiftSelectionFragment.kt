...
import com.olam.warehouse.vegax.processingsesame.databinding.FragmentVegaSesameFgrnSiftSelectionBinding
...
class VegaSesameFgrnShiftSelectionFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_sesame_fgrn_sift_selection
    private lateinit var binding: FragmentVegaSesameFgrnSiftSelectionBinding
    ...
    companion object {
        fun newInstance(model: VegaCoffeeFgrnItems, vegaStage: VegaProcessingStage) = VegaSesameFgrnShiftSelectionFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaSesameFgrnSiftSelectionBinding.inflate(layoutInflater)
        return binding.root
    }
