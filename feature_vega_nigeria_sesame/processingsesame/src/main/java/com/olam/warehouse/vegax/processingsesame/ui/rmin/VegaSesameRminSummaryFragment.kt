...
import com.olam.warehouse.vegax.processingsesame.databinding.ItemSesameRminMaterialSummaryBinding
import com.olam.warehouse.vegax.processingsesame.databinding.ItemSesameSummaryLotBinding
...
class VegaSesameRminSummaryFragment : BaseFragment() {
    ...
    private fun initGradeList() {
        ...
        binding.rvMaterialList.setUpAdapter(
            grade,
            R.layout.item_sesame_rmin_material_summary,
            ItemSesameRminMaterialSummaryBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun setupAdapter() {
        ...
        binding.rvLotList.setUpAdapter(
            list,
            R.layout.item_sesame_summary_lot,
            ItemSesameSummaryLotBinding::inflate,
            { it, pos, bindItem ->
