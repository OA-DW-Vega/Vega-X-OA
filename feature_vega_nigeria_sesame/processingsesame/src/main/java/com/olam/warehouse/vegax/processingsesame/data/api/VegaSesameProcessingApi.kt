package com.olam.warehouse.vegax.processingsesame.data.api
...
interface VegaSesameProcessingApi {
    ...
    suspend fun fetchBomList(@Body bomPostReq: VegaSesameProcessingRminBomPost): GenericReqAndResp<VegaProcessingRminBom>


    @POST("x-processing/vega/processing/createProcessOrder")
    suspend fun postCreatePo(@Body bomPostReq: VegaSesameProcessingCreatePoReq): GenericReqAndResp<VegaProcessingRminPo>
    ...
    ): GenericReqAndResp<List<VegaSesameProcessingQualityDetails>>
    ...
    fun getQualityParams(
        ...
        @Query("charg") charge: String,
        @Query("material") material: String
    ): Call<GenericReqAndResp<List<VegaSesameProcessingQualityDetails>>>
    ...
    suspend fun getFgrnGrades(@Body poReq: VegaSesameProcessOrderDetailsPostReq): GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>>

    @POST("x-processing/vega/processing/processOrders")
    suspend fun getFgrnPoDetailsList(@Body vegaProcessingOrderReq: VegaSesameProcessingOrderReq): GenericReqAndResp<List<VegaFgrnProcessingOrder>>

    @POST("x-processing/vega/processing/processOrders")
    suspend fun fetchFgrnPoDetailsList(@Body vegaProcessingOrderReq: VegaSesameProcessingOrderReq): GenericReqAndResp<List<VegaCoffeeFgrnItems>>

    @POST("x-processing/vega/processing/rmin_fgrn")
    suspend fun postRminDetails(@Body bomPostReq: VegaSesameProcessingFgrnPost): GenericReqAndResp<List<VegaSesameProcessingRminResponse>>

    @POST("x-processing/vega/processing/rmin_fgrn")
    suspend fun postFgrnDetails(@Body bomPostReq: VegaSesameProcessingFgrnPost): GenericReqAndResp<List<VegaSesameProcessingFgrnResponse>>
