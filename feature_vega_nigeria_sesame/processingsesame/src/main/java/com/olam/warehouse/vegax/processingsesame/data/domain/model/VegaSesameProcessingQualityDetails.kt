...
@Parcelize
data class VegaSesameProcessingQualityDetails(
    var charg: String? = "",
    var materialNumber: String? = "",
    var qualityParameters: List<VegaSesameProcessingQualityParams> = emptyList()
) : Parcelable

@Parcelize
data class VegaSesameProcessingQualityParams(
