...
import com.olam.warehouse.vegax.processingsesame.data.domain.model.VegaSesameRMINShiftModel
import com.olam.warehouse.vegax.processingsesame.databinding.FragmentSesameRminShiftSelectionBinding
import com.olam.warehouse.vegax.processingsesame.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel

class VegaSesameRMINShiftSelectFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_sesame_rmin_shift_selection
    private lateinit var binding: FragmentSesameRminShiftSelectionBinding
    ...
    companion object {
        fun newInstance(fromSummary: Boolean, model: VegaCoffeeRminProcessing) =
            VegaSesameRMINShiftSelectFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentSesameRminShiftSelectionBinding.inflate(layoutInflater)
        initExtra()
        initUI()
    ...
    private fun updateShiftAndRemarks(miscellaneous: List<VegaCocoaMiscellaneous>) {
        ...
        jsonData.forEach{
            if(it.contains(JSON_SHIFT_DETAILS_LIST)){
                val shift = gson.fromJson(it, VegaSesameRMINShiftModel::class.java)
