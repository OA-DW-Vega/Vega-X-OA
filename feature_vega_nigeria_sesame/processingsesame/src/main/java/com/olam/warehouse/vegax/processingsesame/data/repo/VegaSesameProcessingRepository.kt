package com.olam.warehouse.vegax.processingsesame.data.repo
...
import com.olam.warehouse.vegax.processingsesame.data.domain.model.*

interface VegaSesameProcessingRepository {
    ...
    suspend fun getBom(bomPostReq: VegaSesameProcessingRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>>

    suspend fun getStocks(material: String): LiveData<Resource<GenericReqAndResp<List<VegaCoffeeRminLots>>>>
    suspend fun postCreatePo(bomPostReq: VegaSesameProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>>
    ...
    suspend fun postRminDetails(model: VegaSesameProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaSesameProcessingRminResponse>>>>
    ...
    suspend fun postFgrnDetails(poReq: VegaSesameProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaSesameProcessingFgrnResponse>>>>
...
class VegaSesameProcessingRepoImpl(
    private val api: VegaSesameProcessingApi,
    private val dao: VegaCoffeeRminDao,
    private val masterDao: MasterDao,
    private val vegaMtntDao: VegaMtntDao
) : VegaSesameProcessingRepository {
    ...
    override suspend fun getBom(bomPostReq: VegaSesameProcessingRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>> {
    ...
    override suspend fun postCreatePo(bomPostReq: VegaSesameProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>> {
    ...
    override suspend fun getPoGrades(
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>> =
                api.getFgrnGrades(VegaSesameProcessOrderDetailsPostReq(getCurrentKey(), getPlantDetails(), poNo, rmin))
        }.build().asLiveData()
    }
    ...
    override suspend fun postRminDetails(model: VegaSesameProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaSesameProcessingRminResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaSesameProcessingRminResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaSesameProcessingRminResponse>> =
    ...
    override suspend fun postFgrnDetails(poReq: VegaSesameProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaSesameProcessingFgrnResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaSesameProcessingFgrnResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaSesameProcessingFgrnResponse>> =
