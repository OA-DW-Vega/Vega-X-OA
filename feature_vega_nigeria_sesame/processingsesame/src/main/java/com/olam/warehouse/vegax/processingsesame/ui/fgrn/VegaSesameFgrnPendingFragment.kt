...
import kotlinx.android.synthetic.main.item_vega_sesame_fgrn_pending.view.*
...
class VegaSesameFgrnPendingFragment : BaseFragment() {
    ...
    private fun updateItems(pendingList: List<VegaCoffeeFgrnItems>) {
        binding.rvPendingPoList.setUp(pendingList as MutableList, R.layout.item_vega_sesame_fgrn_pending, { item, pos ->
