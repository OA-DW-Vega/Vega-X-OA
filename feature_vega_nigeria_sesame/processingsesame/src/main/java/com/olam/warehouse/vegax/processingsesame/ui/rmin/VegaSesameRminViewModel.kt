...
class VegaSesameRminViewModel(
    ...
    private var postRminSource: LiveData<Resource<GenericReqAndResp<List<VegaSesameProcessingRminResponse>>>> =
        MutableLiveData()
    private val _postRmin = MediatorLiveData<Resource<GenericReqAndResp<List<VegaSesameProcessingRminResponse>>>>()
    val postRmin: LiveData<Resource<GenericReqAndResp<List<VegaSesameProcessingRminResponse>>>> get() = _postRmin
    ...
    fun postRmin(poReq: VegaSesameProcessingFgrnPost) = viewModelScope.launch(dispatchers.main) {
