...
import com.olam.warehouse.vegax.processingsesame.databinding.FragmentSesameInventoryLotListBinding
import com.olam.warehouse.vegax.processingsesame.utils.*
import kotlinx.android.synthetic.main.item_sesame_inventory_lot.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel

class VegaSesameRMINLotListFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_sesame_inventory_lot_list
    private lateinit var binding: FragmentSesameInventoryLotListBinding
    ...
    private var listener: SesameAddLotsListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        listener = context as? SesameAddLotsListener
    }
    ...
    companion object {
        fun newInstance(
            ...
            VegaSesameRMINLotListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentSesameInventoryLotListBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    ...
    private fun setupAdapter(data: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvLots.setUp(data, R.layout.item_sesame_inventory_lot, { it, pos ->
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter =
            ArrayAdapter(requireContext(), R.layout.item_vega_sesame_processing_rmin_grade, wareHouseList)
        ...
        binding.spWareHouse.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onNothingSelected(parent: AdapterView<*>?) {/*nothing to select*/}
