...
import com.olam.warehouse.vegax.processingsesame.databinding.ItemSesameInventoryLotBinding
...
class VegaSesameRMINLotListFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_sesame_inventory_lot,
            ItemSesameInventoryLotBinding::inflate,
            { it, pos, bindItem ->
