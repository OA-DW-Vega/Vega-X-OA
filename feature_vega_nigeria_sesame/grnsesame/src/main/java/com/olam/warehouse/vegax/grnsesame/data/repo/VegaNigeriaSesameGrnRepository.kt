package com.olam.warehouse.vegax.grnsesame.data.repo
...
import com.olam.warehouse.vegax.grnsesame.utils.prepareWeighBridgeData

/**
 * Created by Keerthi Santhanam on 6/29/2020.
 */
interface VegaNigeriaSesameGrnRepository {
    ...
    suspend fun postGrn(grnPost: VegaSesameGrnPost): LiveData<Resource<GenericReqAndResp<VegaEcuadorGrnResponse>>>
    ...
    suspend fun getQualityParams(
        charge: String,
        material: String
    ): LiveData<Resource<GenericReqAndResp<List<VegaGRNSesameQuality>>>>
}

class VegaNigeriaSesameGrnRepositoryImpl(private val api: VegaNigeriaSesameGrnApi, private val dao: VegaEcuadorGrnDao) : VegaNigeriaSesameGrnRepository {
    ...
    override suspend fun getQualityParams(
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaGRNSesameQuality>>>() {

            override suspend fun createCall(): GenericReqAndResp<List<VegaGRNSesameQuality>> =
    ...
    override suspend fun postGrn(grnPost: VegaSesameGrnPost): LiveData<Resource<GenericReqAndResp<VegaEcuadorGrnResponse>>> {
