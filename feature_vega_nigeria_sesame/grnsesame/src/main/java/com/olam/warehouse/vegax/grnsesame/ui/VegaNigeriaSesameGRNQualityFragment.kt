...
import com.olam.warehouse.vegax.grnsesame.databinding.ItemVegaNigeriaSesameGrnQualityDetailsBinding
    ...
    private fun setUpAdapter(data: MutableList<VegaGRNSesameQuality>) {
        data.let {
            ...
            binding.rvQuality.setUpAdapter(
                ...
                ItemVegaNigeriaSesameGrnQualityDetailsBinding::inflate,
                { it, pos, bindItem ->
                    i++
                    if (i % 2 == 0) {
