package com.olam.warehouse.vegax.grnsesame.ui.offline
...
import com.olam.warehouse.vegax.grnsesame.databinding.FragmentVegaNigeriaSesameGrnOfflineBinding
import com.olam.warehouse.vegax.grnsesame.databinding.ItemVegaNigeriaSesameGrnOfflineBinding
 ...
 */
class VegaNigeriaSesameGrnOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_nigeria_sesame_grn_offline
    private val vm: VegaNigeriaSesameGrnViewModel by viewModel()
    private lateinit var binding: FragmentVegaNigeriaSesameGrnOfflineBinding
    private var grnList = arrayListOf<VegaGrnWeighBridgeId>()
    private var callBack: CallBack? = null

    companion object {
        fun newInstance() = VegaNigeriaSesameGrnOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaNigeriaSesameGrnOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("grnsesame/ui/offline/VegaNigeriaSesameGrnOfflineSummary")
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaGrnWeighBridgeId>) {
        ...
        binding.rvOfflineGrn.setUpAdapter(
            grnList,
            R.layout.item_vega_nigeria_sesame_grn_offline,
            ItemVegaNigeriaSesameGrnOfflineBinding::inflate,
            { it, pos, bindItem ->
