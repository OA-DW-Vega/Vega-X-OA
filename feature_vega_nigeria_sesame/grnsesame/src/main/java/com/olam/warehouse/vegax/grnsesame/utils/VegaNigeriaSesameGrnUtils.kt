package com.olam.warehouse.vegax.grnsesame.utils
...
import com.olam.warehouse.vegax.grnsesame.data.domain.usecase.model.VegaSesameGrnPostData
...
fun preparePostGrnData(wbDetails: VegaGrnWeighBridgeId, admixtureValue: String): VegaSesameGrnPostData {
    var grnPost = VegaSesameGrnPostData()
    ...
    grnPost.warehouseRecieptNum=wbDetails.challan
    return grnPost
}
