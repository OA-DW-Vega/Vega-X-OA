...
import com.olam.warehouse.vegax.mtntsesame.databinding.ItemNigeriaSesameMtntTruckLayoutBinding
...
class VegaNigeriaSesameMtntWeighbridgeTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUpAdapter(
            dispatch1,
            R.layout.item_nigeria_sesame_mtnt_truck_layout,
            ItemNigeriaSesameMtntTruckLayoutBinding::inflate,
            { it, pos, bindItem ->
