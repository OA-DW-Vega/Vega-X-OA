...
import com.olam.warehouse.vegax.mtntsesame.data.domain.model.VegaNigeriaSesameMtntDeliveryDetail
import com.olam.warehouse.vegax.mtntsesame.data.domain.model.VegaNigeriaSesameMtntDeliveryPost
import com.olam.warehouse.vegax.mtntsesame.databinding.FragmentNigeriaSesameDispatchMtntSummaryBinding
...
class VegaNigeriaSesameMtntSummaryFragment : BaseFragment(),
    VegaNigeriaSesameMtntLotRemoveListener {

    private var dispatchLotsList = mutableListOf<VegaCocoaDispatchLots>()
    override val layoutResourceId: Int = R.layout.fragment_nigeria_sesame_dispatch_mtnt_summary
    private lateinit var binding: FragmentNigeriaSesameDispatchMtntSummaryBinding
    ...
    companion object {
        fun newInstance(data: VegaCocoaDispatchWB) = VegaNigeriaSesameMtntSummaryFragment()
            .putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentNigeriaSesameDispatchMtntSummaryBinding.inflate(inflater)
        initExtra()
        initUi()
    ...
    private fun setUpAdapter(list: List<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUp(lots, R.layout.item_nigeria_sesame_lot_summary, { item, pos ->
    ...
    private fun postDelivery() {
        vegaCoffeeDeliveryPost = VegaNigeriaSesameMtntDeliveryPost(
            getCurrentKey(),
            getPlantDetails(),
            "",
    ...
    private fun prepareDeliveryList(): List<VegaNigeriaSesameMtntDeliveryDetail> {
        val list = ArrayList<VegaNigeriaSesameMtntDeliveryDetail>()
        val year: Int = Calendar.getInstance().get(Calendar.YEAR)
        for (item in dispatchLotsList) {
            val deliveryDetail = VegaNigeriaSesameMtntDeliveryDetail()
