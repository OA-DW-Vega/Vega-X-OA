package com.olam.warehouse.vegax.mtntsesame.data.repo
...
interface VegaNigeriaSesameMtntRepository {
    suspend fun getTrucks(): LiveData<Resource<GenericReqAndResp<List<VegaCocoaDispatchWB>>>>
    suspend fun getPurchaseOrder(receivingWerks: String): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntPurchaseOrder>>>>
    ...
    suspend fun postDeliveryDetail(vegaDeliveryPost: VegaNigeriaSesameMtntDeliveryPost): LiveData<Resource<GenericReqAndResp<VegaDeliveryPostResponse>>>
    suspend fun postWeighScaleDeliveryDetail(vegaDeliveryPost: VegaNigeriaSesameMtntMergedDeliveryPost): LiveData<Resource<GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse>>>
    ...
    suspend fun getPalletDetails(
        batchNumber: String,
        material: String
    ): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntWeighScalePallet>>>>
...
class VegaNigeriaSesameMtntRepositoryImpl(
    private val api: VegaNigeriaSesameMtntApi,
    private val dao: VegaCoffeeDispatchDao,
    private val masterDao: MasterDao
) : VegaNigeriaSesameMtntRepository {
    ...
    override suspend fun getPurchaseOrder(receivingWerks: String): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntPurchaseOrder>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaNigeriaSesameMtntPurchaseOrder>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaNigeriaSesameMtntPurchaseOrder>> =
    ...
    override suspend fun postDeliveryDetail(vegaDeliveryPost: VegaNigeriaSesameMtntDeliveryPost): LiveData<Resource<GenericReqAndResp<VegaDeliveryPostResponse>>> {
    ...
    override suspend fun postWeighScaleDeliveryDetail(vegaDeliveryPost: VegaNigeriaSesameMtntMergedDeliveryPost): LiveData<Resource<GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse>>() {

            override suspend fun createCall(): GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse> =
                api.postWeighScaleDeliveryDetailsAuto(vegaDeliveryPost)
        }.build().asLiveData()
    }
    override suspend fun postWs(vegaSesameDeliveryPost: VegaNigeriaSesameMtntMergedDeliveryPost): LiveData<Resource<GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse>>(){
            override suspend fun createCall(): GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse> =
    ...
    override suspend fun getPalletDetails(
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaNigeriaSesameMtntWeighScalePallet>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaNigeriaSesameMtntWeighScalePallet>> =
