...
import com.olam.warehouse.vegax.mtntsesame.databinding.FragmentNigeriaSesameMtntWeighbridgeAddLotLayoutBinding
import com.olam.warehouse.vegax.mtntsesame.ui.ItemRemoveListener
import com.olam.warehouse.vegax.mtntsesame.ui.VegaNigeriaSesameMtntLotAdapter
...
import com.olam.warehouse.vegax.mtntsesame.utils.LOT_LIST
import com.olam.warehouse.vegax.mtntsesame.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.mtntsesame.utils.WEIGHBRIDGE_SUMMARY
import com.olam.warehouse.vegax.mtntsesame.utils.getColor
import org.koin.androidx.viewmodel.ext.android.viewModel
import java.util.concurrent.TimeUnit

class VegaNigeriaSesameMtntWeighBridgeAddLotFragment : BaseFragment(), ItemRemoveListener {
    override val layoutResourceId = R.layout.fragment_nigeria_sesame_mtnt_weighbridge_add_lot_layout
    private lateinit var binding: FragmentNigeriaSesameMtntWeighbridgeAddLotLayoutBinding
    ...
    private lateinit var adapter: VegaNigeriaSesameMtntLotAdapter
    ...
    companion object {
        fun newInstance(model: VegaCocoaDispatchWB) =
            VegaNigeriaSesameMtntWeighBridgeAddLotFragment()
                .putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentNigeriaSesameMtntWeighbridgeAddLotLayoutBinding.inflate(layoutInflater)
        initExtra()
        initAdapter()
        initUI()
        return binding.root
    ...
    private fun initUI() {
        ...
        binding.clLotSummary.btnAddLot.setOnClickListener {
            callback.replaceFragment(
                LOT_LIST,
                VegaNigeriaSesameMtntLotListModel(
    ...
    private fun initAdapter() {
        adapter =
            VegaNigeriaSesameMtntLotAdapter(
                ArrayList(),
                true,
                true, this
            )
