...
import com.olam.warehouse.vegax.mtntsesame.databinding.NigeriaSesameCustomDialogLayoutBinding
import com.olam.warehouse.vegax.mtntsesame.databinding.NigeriaSesameFilterItemBinding

class VegaNigeriaSesameCustomSingleSelectDialog(
    ...
    private var listener: VegaNigeriaSesameSingleSelectListener
) :
    Dialog(activity),
    ...
    private lateinit var binding: NigeriaSesameCustomDialogLayoutBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        requestWindowFeature(Window.FEATURE_NO_TITLE)
        binding = NigeriaSesameCustomDialogLayoutBinding.inflate(layoutInflater)
    ...
    private fun setAdapter(
        ...
        listener: VegaNigeriaSesameSingleSelectListener
    ) {
        binding.recyclerView.setUpAdapter(
            item,
            R.layout.nigeria_sesame_filter_item,
            NigeriaSesameFilterItemBinding::inflate,
            { it, pos, bindItem ->
