...
import com.olam.warehouse.vegax.mtntsesame.databinding.FragmentNigeriaSesameMtntWsAddLotLayoutBinding
...
import kotlinx.android.synthetic.main.item_nigeria_sesame_weighscale_lot_card_layout.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import java.util.concurrent.TimeUnit

class VegaNigeriaSesameMtntWeighScaleAddLotFragment : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_nigeria_sesame_mtnt_ws_add_lot_layout
    private lateinit var binding: FragmentNigeriaSesameMtntWsAddLotLayoutBinding
    ...
    companion object {
        fun newInstance(model: VegaCocoaDispatchWB) =
            VegaNigeriaSesameMtntWeighScaleAddLotFragment()
                .putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentNigeriaSesameMtntWsAddLotLayoutBinding.inflate(layoutInflater)
        binding.clLotSummary.btAdd.isEnabled = false
        initExtra()
        initUI()
        return binding.root
    }
    ...
    private fun initUI() {
        ...
        binding.clLotSummary.btnAddLot.setOnClickListener {
            callback.replaceFragment(
                LOT_LIST,
                VegaNigeriaSesameMtntLotListModel(selectedList = vm.lotList, isMultipleAdd = true, material = getMaterialList())
            )
        }
    ...
    private fun enableAddLot(value: String) {
        when {
            value.isNotEmpty() -> {
                ...
                binding.clLotSummary.btAdd.isEnabled = true
            }
    ...
    private fun setUpMaterialAdapter() {
        binding.rvMaterialList.setUp(vm.materialModelList, R.layout.item_nigeria_sesame_material_layout, { it, pos ->
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        val lots = list
        binding.clLotSummary.rvList.setUp(lots, R.layout.item_nigeria_sesame_weighscale_lot_card_layout, { item, pos ->
