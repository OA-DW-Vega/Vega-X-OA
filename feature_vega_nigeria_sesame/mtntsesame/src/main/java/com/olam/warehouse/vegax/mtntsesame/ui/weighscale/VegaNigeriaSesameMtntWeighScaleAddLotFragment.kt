...
import com.olam.warehouse.vegax.mtntsesame.databinding.ItemNigeriaSesameWeighscaleLotCardLayoutBinding
...
class VegaNigeriaSesameMtntWeighScaleAddLotFragment : BaseFragment() {
    ...
    private fun setUpMaterialAdapter() {
        binding.rvMaterialList.setUpAdapter(vm.materialModelList,
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        ...
        binding.clLotSummary.rvList.setUpAdapter(
            lots,
            R.layout.item_nigeria_sesame_weighscale_lot_card_layout,
            ItemNigeriaSesameWeighscaleLotCardLayoutBinding::inflate,
            { item, pos, bindItem ->
