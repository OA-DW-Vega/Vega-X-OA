...
import com.olam.warehouse.vegax.mtntsesame.data.domain.model.VegaNigeriaSesameMtntWeighScalePallet
import com.olam.warehouse.vegax.mtntsesame.databinding.FragmentNigeriaSesameMtntWeighscaleAddPalletBinding
import com.olam.warehouse.vegax.mtntsesame.databinding.ItemVegaNigeriaSesameMtntAddBagBinding
...
class VegaNigeriaSesameMtntWeighScalePalletFragment : BaseFragment() {

    override val layoutResourceId: Int =
        R.layout.fragment_nigeria_sesame_mtnt_weighscale_add_pallet
    private lateinit var binding: FragmentNigeriaSesameMtntWeighscaleAddPalletBinding
    ...
    companion object {
        fun newInstance(item: VegaCocoaDispatchLots) = VegaNigeriaSesameMtntWeighScalePalletFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentNigeriaSesameMtntWeighscaleAddPalletBinding.inflate(inflater)
        initUI()
        return binding.root
    }
    ...
    private fun updatePalletUI(response: Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntWeighScalePallet>>>?) {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(), R.layout.item_vega_nigeria_sesame_mtnt_add_bag,
            ItemVegaNigeriaSesameMtntAddBagBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
