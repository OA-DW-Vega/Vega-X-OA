...
class VegaNigeriaSesameMtntViewModel(private val useCase: VegaNigeriaSesameDispatchUseCase, private val dispatchers: AppDispatchers) :
    BaseViewModel() {
    ...
    private var purchaseSource: LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntPurchaseOrder>>>> = MutableLiveData()
    private val _purchaseOrder = MediatorLiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntPurchaseOrder>>>>()
    val purchaseOrder: LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntPurchaseOrder>>>> get() = _purchaseOrder
    ...
    private var weighScaleDeliveryPostSource: LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntDeliveryDetail>>>> =
        MutableLiveData()
    private val _weighScaleDeliveryPost =
        MediatorLiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntDeliveryDetail>>>>()
    val weighScaleDeliveryPost: LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntDeliveryDetail>>>> get() = _weighScaleDeliveryPost

    private var wsPostSource: LiveData<Resource<GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse>>> =
        MutableLiveData()
    private val _wsdeliveryPost = MediatorLiveData<Resource<GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse>>>()
    val wsdeliveryPost: LiveData<Resource<GenericReqAndResp<VegaNigeriaSesameMergedDeliveryPostResponse>>> get() = _wsdeliveryPost
    ...
    private var palletResource: LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntWeighScalePallet>>>> =
        MutableLiveData()
    private val _pallet = MediatorLiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntWeighScalePallet>>>>()
    val pallet: LiveData<Resource<GenericReqAndResp<List<VegaNigeriaSesameMtntWeighScalePallet>>>> get() = _pallet
    ...
    fun postDeliveryDetail(vegaDeliveryPost: VegaNigeriaSesameMtntDeliveryPost) =
    ...
    fun postWeighScaleDeliveryDetails(vegaDeliveryPost: VegaNigeriaSesameMtntMergedDeliveryPost) =
        viewModelScope.launch(dispatchers.main) {
    ...
    fun postWeighScaleDeliveryDetails123(vegaSesameDeliveryPost: VegaNigeriaSesameMtntMergedDeliveryPost) {
       viewModelScope.launch (dispatchers.main){
          _wsdeliveryPost.removeSource(wsPostSource)
           withContext(dispatchers.io){
               wsPostSource = useCase.postWs(vegaSesameDeliveryPost)
           }
