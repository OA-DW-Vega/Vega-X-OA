 ...
 */
data class VegaPpqWarehouseModel(
...
data class VegaPpqModel(
    var inventories: List<VegaPpqWarehouseModel>,
...
data class SesamePpqStorageLoc(
    val inventory: List<SesamePpq>,
    val kor: String? = "",
...
data class VegaSesameInventoryStocks(
