...
import com.olam.warehouse.vegax.pilesesame.databinding.FragmentPileManagementSesameEditBinding
...
import kotlinx.android.synthetic.main.item_pile_management_sesame.view.*
...
class VegaSesamePileManagementEditFragment : BaseFragment(), VegaSingleSelectListener {

    override val layoutResourceId = R.layout.fragment_pile_management_sesame_edit
    private lateinit var binding: FragmentPileManagementSesameEditBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentPileManagementSesameEditBinding.inflate(layoutInflater)
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        val lots = list
        binding.rvLots.setUp(lots, R.layout.item_pile_management_sesame, { item, pos ->
