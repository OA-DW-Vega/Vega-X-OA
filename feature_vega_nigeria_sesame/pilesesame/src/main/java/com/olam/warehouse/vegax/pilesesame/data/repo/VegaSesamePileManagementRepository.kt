...
class VegaSesamePileManagementRepositoryImpl(
    ...
    override suspend fun getLotQuality(
        charge: String, material: String
    ): LiveData<Resource<GenericReqAndResp<List<VegaDispatchLotQuality>>>> {
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaDispatchLotQuality>>>() {
            ...
            override suspend fun createCall(): GenericReqAndResp<List<VegaDispatchLotQuality>> =
                api.getLotQuality(getCurrentKey(),charge,material)
    ...
    override suspend fun getQualityGradesListWithDesc(): LiveData<List<QualitativeParams>> =
        daoNic.getQualityGradeDescList()

    override suspend fun postWeightedAverage(vegaWeightedAvgPost: VegaNigeriaSesameWeightedAveragePost): LiveData<Resource<GenericReqAndResp<VegaNigeriaSesameWeightedAverageResponse>>> {
        return object :
            NetworkOnlyBoundResource<GenericReqAndResp<VegaNigeriaSesameWeightedAverageResponse>>() {
            override suspend fun createCall(): GenericReqAndResp<VegaNigeriaSesameWeightedAverageResponse> =
