...
import com.olam.warehouse.vegax.pilesesame.data.domain.model.SesameFilterList
import com.olam.warehouse.vegax.pilesesame.databinding.FragmentPileManagementFilterSesameBinding
import com.olam.warehouse.vegax.pilesesame.databinding.ItemVegaSesamePileFilterBinding
import com.olam.warehouse.vegax.pilesesame.utils.*
import java.util.*

class VegaSesamePileFilterFragment : BaseFragment() {

    private lateinit var binding: FragmentPileManagementFilterSesameBinding
    override val layoutResourceId = R.layout.fragment_pile_management_filter_sesame
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaSesamePileFilterFragment().putArgs {
    ...
    override fun onCreateView(
        ...
        binding = FragmentPileManagementFilterSesameBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<SesameFilterList>) {
        binding.rvWhLocation.setUpAdapter(
            listFliterWhLoc,
            R.layout.item_vega_sesame_pile_filter_,
            ItemVegaSesamePileFilterBinding::inflate,
            { it, pos, bindItem ->
