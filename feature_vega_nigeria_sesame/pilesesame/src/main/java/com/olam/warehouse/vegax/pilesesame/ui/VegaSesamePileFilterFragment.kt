...
import kotlinx.android.synthetic.main.item_vega_sesame_pile_filter_.*
import java.util.*
...
class VegaSesamePileFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<SesameFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_sesame_pile_filter_, { it, pos ->
