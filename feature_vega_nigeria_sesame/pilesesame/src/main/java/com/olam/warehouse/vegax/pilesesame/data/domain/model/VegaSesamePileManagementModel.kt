...
data class VegaSesamePilePostRequest(
    ...
    var qualityDetails: List<VegaQualityDetail> = emptyList(),
    var plant: Plant
...
data class VegaDispatchLotQuality(
    ...
    var qualityParameters: List<VegaLotQualityParams> = emptyList()
) : Parcelable


@Parcelize
data class VegaLotQualityParams(
...
data class VegaNigeriaSesameWeightedAverageDeliveryDetail(
    var batchNumber: String? = "",
    var materialCode: String? = "",
    var qualityDetails: List<VegaNigeriaSesameQualityDetails> = emptyList()
)

data class VegaNigeriaSesameWeightedAveragePost(
    var key: String? = "",
    var batchUpdateFlag: Boolean = false,
    var weightedAvgFlag: Boolean = false,
    var plant: Plant,
    var deliveryDetails: List<VegaNigeriaSesameWeightedAverageDeliveryDetail>,
)

@Parcelize
data class VegaNigeriaSesameWeightedAverageDetails(
    var atcod: String? = "",
    var atflv: String? = "",
    var atfor: String? = "",
    var atinn: String? = "",
...
data class VegaNigeriaSesameWeightedAverageResponse(
    var weightedAvg: List<VegaNigeriaSesameWeightedAverageDetails>,
    var imWerks: String? = ""
)
