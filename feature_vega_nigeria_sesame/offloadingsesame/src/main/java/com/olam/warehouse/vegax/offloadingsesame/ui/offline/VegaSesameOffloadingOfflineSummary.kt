package com.olam.warehouse.vegax.offloadingsesame.ui.offline
...
import com.olam.warehouse.vegax.offloadingsesame.databinding.ActivityVegaOffloadingSesameOfflineSummaryBinding
import com.olam.warehouse.vegax.offloadingsesame.databinding.ItemVagaOffloadingSesameOfflineSummaryBinding
import com.olam.warehouse.vegax.offloadingsesame.ui.VegaSesameOffloadingViewModel
import com.olam.warehouse.vegax.offloadingsesame.utils.OFFLOADING_SUMMARY_FRAG
 ...
 */
class VegaSesameOffloadingOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.activity_vega_offloading_sesame_offline_summary
    private val vm: VegaSesameOffloadingViewModel by viewModel()
    private lateinit var binding: ActivityVegaOffloadingSesameOfflineSummaryBinding
    ...
    companion object {
        fun newInstance() = VegaSesameOffloadingOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = ActivityVegaOffloadingSesameOfflineSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(offloadingItems1: ArrayList<VegaEcuaOffloadingWithLineItems>) {
        ...
        binding.rvReceivingOffline.setUpAdapter(
            offloadingItems,
            R.layout.item_vaga_offloading_sesame_offline_summary,
            ItemVagaOffloadingSesameOfflineSummaryBinding::inflate,
            { it, pos, bindItem ->
