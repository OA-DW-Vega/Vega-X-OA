package com.olam.warehouse.vegax.offloadingsesame.data.api
...
import com.olam.warehouse.vegax.offloadingsesame.data.domain.usecase.model.VegaSesameReceivingPostLineItem
 ...
 */
interface VegaSesameOffloadingApi {
...
suspend fun postReceivingDetail(@Body receivingData: VegaReceivingPost): GenericReqAndResp<VegaReceivingResponse>
    ...
    @POST("x-pre-processing/vega/wb/create-wbid")
    fun postReceivingItem(@Body receivingData: VegaSesameReceivingPostLineItem): Call<GenericReqAndResp<VegaReceivingResponse>>
    ...
    ): GenericReqAndResp<List<VegaSesameWeighScalePallet>>
