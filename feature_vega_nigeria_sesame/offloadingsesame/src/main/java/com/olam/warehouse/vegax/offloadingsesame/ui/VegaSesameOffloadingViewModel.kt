 ...
 */
class VegaSesameOffloadingViewModel(
    private val useCase: VegaSesameOffloadingUseCase,
    ...
    private var palletResource: LiveData<Resource<GenericReqAndResp<List<VegaSesameWeighScalePallet>>>> =
        MutableLiveData()
    private val _pallet = MediatorLiveData<Resource<GenericReqAndResp<List<VegaSesameWeighScalePallet>>>>()
    val pallet: LiveData<Resource<GenericReqAndResp<List<VegaSesameWeighScalePallet>>>> get() = _pallet
    ...
    private var offlineMtnrSource: LiveData<List<VegaCoffeeReceivingMtnrWithLots>> =
        mutableLiveDataOf()
    ...
    fun postOffloadingDetail(vegaOffloadingPost: VegaSesameOffloadingPostRequest) =
        viewModelScope.launch(dispatchers.main) {
