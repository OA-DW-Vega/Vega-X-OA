package com.olam.warehouse.vegax.qualitysesame.ui.lot
...
import com.olam.warehouse.vegax.qualitysesame.databinding.FragmentVegaNigeriaSesameWeighbridgeLotBinding
...
import kotlinx.android.synthetic.main.item_vega_nigeria_sesame_lot_card_layout.view.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper


class VegaNigeriaSesameQualityMtnrWBLotListFragment : BaseFragment() {

    private val vm: VegaNigeriaSesameQualityViewModel by viewModel()
    private lateinit var mListener: OnLotListener
    private lateinit var binding: FragmentVegaNigeriaSesameWeighbridgeLotBinding
    override val layoutResourceId = R.layout.fragment_vega_nigeria_sesame_weighbridge_lot
    ...
    companion object {
        fun newInstance() = VegaNigeriaSesameQualityMtnrWBLotListFragment().putArgs {
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaNigeriaSesameWeighbridgeLotBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun moveBagdetail(wbDetails: VegaCoffeeLot?) {
    }
    ...
    private fun setAdapter(mQualityLotList1: MutableList<VegaCoffeeLot>) {
        ...
        binding.rvLots.setUp(
            mQualityLotList1,
            R.layout.item_vega_nigeria_sesame_lot_card_layout,
            { it, pos ->
                tvScaleLotValue.text = it.batchNumber
                tvScaleWeightValue.text =
                    it.netWeight?.removeSpecialCharacters()?.toDouble()?.formatThreeDigits()
                        .plus(" ").plus(it.unitsOfMeasure)
