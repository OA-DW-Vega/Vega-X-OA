...
class VegaSesameMtnrQualityWBListFragment : BaseFragment() {

    private var mAdapter = VegaSesameMtnrWeighBridgeListAdapter { moveBagdetail(it) }
    ...
    companion object {
        fun newInstance() = VegaSesameMtnrQualityWBListFragment().putArgs {
        }
