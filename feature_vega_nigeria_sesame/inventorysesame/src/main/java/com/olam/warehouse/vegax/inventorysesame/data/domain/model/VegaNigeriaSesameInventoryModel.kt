package com.olam.warehouse.vegax.inventorysesame.data.domain.model
...
data class SesameStorageLoc(
    val inventory: List<SesameInventory>,
    val kor: String? = "",
