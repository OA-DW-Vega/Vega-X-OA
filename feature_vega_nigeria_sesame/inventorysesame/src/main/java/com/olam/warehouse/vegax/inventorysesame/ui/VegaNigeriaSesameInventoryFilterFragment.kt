...
import com.olam.warehouse.vegax.inventorysesame.data.domain.model.FilterList
import com.olam.warehouse.vegax.inventorysesame.databinding.FragmentVegaNigeriaSesameInventoryFilterBinding
import com.olam.warehouse.vegax.inventorysesame.utils.*
import kotlinx.android.synthetic.main.item_vega_nigeria_sesame_inventory_filter.view.*
 ...
 */
class VegaNigeriaSesameInventoryFilterFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_vega_nigeria_sesame_inventory_filter
    private lateinit var binding: FragmentVegaNigeriaSesameInventoryFilterBinding
    ...
    companion object {
        fun newInstance(bundle: Bundle, fullFilter: ArrayList<String>) = VegaNigeriaSesameInventoryFilterFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaNigeriaSesameInventoryFilterBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("inventorysesame/ui/VegaNigeriaSesameInventoryFilterFragment").title("Inventory Ecuador")
            .with(tracker)
        initUI()
    }
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUp(listFilterMaterial, R.layout.item_vega_nigeria_sesame_inventory_filter, { it, pos ->
    ...
    private fun setUpHumidityAdapter(listFilterHumidity: ArrayList<FilterList>) {
        binding.rvAdmixture.setUp(listFilterHumidity, R.layout.item_vega_nigeria_sesame_inventory_filter, { it, pos ->
    ...
    private fun setUpImpurityAdapter(listFilterImpurity: ArrayList<FilterList>) {
        binding.rvTotalImpurity.setUp(listFilterImpurity, R.layout.item_vega_nigeria_sesame_inventory_filter, { it, pos ->
    ...
    private fun setUpMouldAdapter(listFilterMould: ArrayList<FilterList>) {
        binding.rvMould.setUp(listFilterMould, R.layout.item_vega_nigeria_sesame_inventory_filter, { it, pos ->
