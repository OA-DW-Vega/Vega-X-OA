...
import com.olam.warehouse.vegax.inventorysesame.databinding.ItemVegaNigeriaSesameInventoryFilterBinding
...
class VegaNigeriaSesameInventoryFilterFragment : BaseFragment() {
    ...
    private fun setUpMaterialAdapter(listFilterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            listFilterMaterial,
            R.layout.item_vega_nigeria_sesame_inventory_filter,
            ItemVegaNigeriaSesameInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun setUpHumidityAdapter(listFilterHumidity: ArrayList<FilterList>) {
        binding.rvAdmixture.setUpAdapter(
            listFilterHumidity,
            R.layout.item_vega_nigeria_sesame_inventory_filter,
            ItemVegaNigeriaSesameInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
