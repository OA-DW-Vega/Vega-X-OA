...
import kotlinx.android.synthetic.main.item_vega_nigeria_sesame_inventory_child.view.*
import kotlinx.android.synthetic.main.item_vega_nigeria_sesame_inventory_parent.view.*
import kotlinx.android.synthetic.main.item_vega_nigeria_sesame_material_details.view.*
...
class VegaNigeriaSesameInventoryParentAdapter(
    ...
    override fun onBindViewHolder(holder: ParentViewHolder, position: Int) {
        ...
        holder.itemView.rv_child.adapter =
            VegaNigeriaSesameInventoryChildAdapter(items[position].storageLoc, listener, colorCode, materialList)
    }
