...
import com.olam.warehouse.vegax.inventorysesame.data.domain.model.SyncStatus
...
import com.olam.warehouse.vegax.inventorysesame.ui.dialog.VegaNigeriaSesameInventorySyncDetailsDailog
import com.olam.warehouse.vegax.inventorysesame.utils.INVENTORY_CODE
import com.olam.warehouse.vegax.inventorysesame.utils.INVENTORY_DETAILS
import com.olam.warehouse.vegax.inventorysesame.utils.INVENTORY_LOTS
 ...
 */
class VegaNigeriaSesameInventoryListFragment : BaseFragment(),
    VegaNigeriaSesameInventoryNavigateToDetailsListener {
    ...
    companion object {
        fun newInstance() = VegaNigeriaSesameInventoryListFragment().putArgs {
        }
    }
    ...
    private fun syncDetails() {
        val bottomDialog = VegaNigeriaSesameInventorySyncDetailsDailog.newInstance(syncStatusList)
    ...
    private fun setAdapter(data: List<VegaInventoryWarehouseModel>) {
        ...
        binding.rvInventory.adapter = VegaNigeriaSesameInventoryParentAdapter(data, materialList, this)
    }
