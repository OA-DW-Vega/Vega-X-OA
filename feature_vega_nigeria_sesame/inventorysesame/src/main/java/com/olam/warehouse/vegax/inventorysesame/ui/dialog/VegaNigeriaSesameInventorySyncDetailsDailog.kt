...
import kotlinx.android.synthetic.main.item_vega_nigeria_sesame_inventory_sync_details.view.*
import java.util.*
...
class VegaNigeriaSesameInventorySyncDetailsDailog : BottomSheetDialogFragment() {
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUp(syncStatusList, R.layout.item_vega_nigeria_sesame_inventory_sync_details, { it, pos ->
