package com.olam.warehouse.vegax.inventorysesame.ui.dialog
...
import com.olam.warehouse.vegax.inventorysesame.databinding.FragmentBottomSheetNigeriaSesameInventorySyncBinding
import com.olam.warehouse.vegax.inventorysesame.databinding.ItemVegaNigeriaSesameInventorySyncDetailsBinding
import com.olam.warehouse.vegax.inventorysesame.utils.SYNC_STATUS_DATA
import java.util.*

/**
 * Created by Keerthi Santhanam on 7/6/2020.
 */
class VegaNigeriaSesameInventorySyncDetailsDailog : BottomSheetDialogFragment() {

    private var syncStatusList = ArrayList<SyncStatus>()

    companion object {
        fun newInstance(syncStatusList: ArrayList<SyncStatus>) = VegaNigeriaSesameInventorySyncDetailsDailog().putArgs {
            putParcelableArrayList(SYNC_STATUS_DATA, syncStatusList)
        }
    }

    private lateinit var binding: FragmentBottomSheetNigeriaSesameInventorySyncBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBottomSheetNigeriaSesameInventorySyncBinding.inflate(layoutInflater)
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUpAdapter(
            syncStatusList,
            R.layout.item_vega_nigeria_sesame_inventory_sync_details,
            ItemVegaNigeriaSesameInventorySyncDetailsBinding::inflate,
            { it, pos, bindItem ->
