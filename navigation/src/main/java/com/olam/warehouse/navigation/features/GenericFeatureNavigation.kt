...
object VegaCottonGinningDispatchNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.ginning.ui.dispatch.GinningDispatchActivity"
...
object VegaCottonGinningIncomingLOTsNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.ginning.ui.incominglots.GinningSelectIncomingLotTypeActivity"
...
object VegaCottonGinningDryingNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.ginning.ui.drying.GinningDryingActivity"
...
object VegaCottonGinningPileNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.ginning.ui.pile.GinningPileManagementActivity"
...
object VegaCottonGinningInventoryNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.ginning.ui.inventory.GinningInventoryActivity"
...
object VegaCottonGinningInProgressNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.ginning.ui.ginninginprogress.GinningInprogressActivity"
...
object VegaCottonPortInventoryNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.portwarehouse.ui.inventory.InventoryActivity"
...
object VegaCottonPortPileNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.portwarehouse.ui.pile.PortPileManagementActivity"
...
object VegaCottonGinningBaleDetailNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.ginning.ui.inventory.GinningBaleDetailActivity"
...
object VegaCottonPortBaleDetailNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.portwarehouse.ui.inventory.BaleDetailActivity"
...
object VegaCottonGinningScanLotDetailsActivityNavigation : DynamicFeature<Intent> {
    ...
    private const val DPEC = "com.olam.warehouse.ginning.ui.scan.ScanLotDetailsActivity"
