...
import kotlinx.android.synthetic.main.item_vega_cocoa_lot_quality_lot_details.view.*
    ...
    private fun setUpAdapter(lotList: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvInspectiontLots.setUp(
            ...
            },
            {
                ...
                LotList.materialName = binding.rvInspectiontLots.tvMaterialName.text.toString()
