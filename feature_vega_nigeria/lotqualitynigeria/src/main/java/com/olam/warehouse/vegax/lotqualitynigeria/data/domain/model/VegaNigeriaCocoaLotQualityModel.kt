...
data class VegaLotQualityWarehouseModel(
...
data class VegaLotQualityModel(
    var inventories: List<VegaLotQualityWarehouseModel>,
...
data class CocoaLotQualityStorageLoc(
    val inventory: List<CocoaLotQuality>,
    val kor: String? = "",
