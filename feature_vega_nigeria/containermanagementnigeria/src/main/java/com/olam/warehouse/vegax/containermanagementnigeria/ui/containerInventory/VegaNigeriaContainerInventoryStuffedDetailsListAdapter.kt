...
import com.olam.warehouse.vegax.containermanagementnigeria.databinding.ItemVegaNigeriaContainerInventoryLotDetailsBinding
...
class VegaNigeriaContainerInventoryStuffedDetailsListAdapter(private val onClick: (ContainerLotDetails?) -> Unit) :
    ...
    inner class ContainerInventoryLotViewHolder(itemView: ItemVegaNigeriaContainerInventoryLotDetailsBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ContainerInventoryLotViewHolder {
        ...
        val v = ItemVegaNigeriaContainerInventoryLotDetailsBinding.inflate(
            LayoutInflater.from(parent.context),
            parent,
            false
        )
