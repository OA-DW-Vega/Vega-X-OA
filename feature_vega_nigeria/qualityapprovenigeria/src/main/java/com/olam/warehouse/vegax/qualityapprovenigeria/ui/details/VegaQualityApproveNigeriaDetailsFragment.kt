...
import com.olam.warehouse.vegax.qualityapprovenigeria.databinding.CutsomDialogQualtyApproveNigeriaLayoutBinding
...
//        val mDialogView = LayoutInflater.from(activity?.applicationContext).inflate(R.layout.cutsom_dialog_qualty_approve_nigeria_layout, null)
        val mDialogView =
            CutsomDialogQualtyApproveNigeriaLayoutBinding.inflate(LayoutInflater.from(activity?.applicationContext))
