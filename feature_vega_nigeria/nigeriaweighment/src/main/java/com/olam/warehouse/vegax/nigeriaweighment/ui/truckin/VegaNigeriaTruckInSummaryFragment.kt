...
import com.olam.warehouse.vegax.nigeriaweighment.databinding.FragmentVegaNigeriaTruckinSummaryBinding
...
import com.olam.warehouse.vegax.nigeriaweighment.utils.PROCURE
import com.olam.warehouse.vegax.nigeriaweighment.utils.RECEIVING_DATA
import com.olam.warehouse.vegax.nigeriaweighment.utils.getTmpId
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaNigeriaTruckInSummaryFragment: BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaNigeriaTruckinSummaryBinding
    override val layoutResourceId = R.layout.fragment_vega_nigeria_truckin_summary

    companion object {
        fun newInstance(receivingData: VegaReceiving) = VegaNigeriaTruckInSummaryFragment().putArgs {
            putParcelable(RECEIVING_DATA, receivingData)
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaNigeriaTruckinSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun initUI() {
        workFlowData = getCurrentWorkflowDetails(getPlantDetails().plantId, "5")
