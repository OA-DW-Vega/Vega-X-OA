...
import com.olam.warehouse.vegax.nigeriaweighment.databinding.FragmentVegaNigeriaTruckoutMtntSummaryBinding
...
class VegaNigeriaTruckOutMtntSummaryFragment: BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaNigeriaTruckoutMtntSummaryBinding
    override val layoutResourceId = R.layout.fragment_vega_nigeria_truckout_mtnt_summary

    companion object {
        fun newInstance(mtntData: VegaMtnt, mMtntList: ArrayList<VegaMtnt>, isRoundoff: Boolean) =
            VegaNigeriaTruckOutMtntSummaryFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaNigeriaTruckoutMtntSummaryBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun initUI() {
        ...
        binding.tvTruckGrossWeight.text =
            mtntData.grossWeight.plus(" ").plus(mtntData.unitsOfMeasure)
    ...
    private fun postReceiving() {
        ...
        if (AppUtils.isOnline()) {
            vm.postMtntData(VegaNigeriaMtntPost(getCurrentKey(), getPlantDetails(), mMtntList))
        } else {
            prepareSuccessData(
