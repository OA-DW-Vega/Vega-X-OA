...
import com.olam.warehouse.vegax.nigeriaweighment.databinding.FragmentVegaNigeriaTruckoutMtntAddWeightBinding
...
import com.olam.warehouse.vegax.nigeriaweighment.utils.MTNTDATA
import com.olam.warehouse.vegax.nigeriaweighment.utils.MTNT_POST_DATA
import com.olam.warehouse.vegax.nigeriaweighment.utils.TRUCKOUT_SUMMARYT_FRAG
...
class VegaNigeriaTruckOutMtntAddWeightFragment: BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaNigeriaTruckoutMtntAddWeightBinding

    override val layoutResourceId = R.layout.fragment_vega_nigeria_truckout_mtnt_add_weight

    companion object {
        fun newInstance(mtntData: VegaMtnt, mMtntList: ArrayList<VegaMtnt>) =
            VegaNigeriaTruckOutMtntAddWeightFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaNigeriaTruckoutMtntAddWeightBinding.inflate(layoutInflater)
        return binding.root
    }
