...
import com.olam.warehouse.vegax.nigeriaweighment.databinding.FragmentVegaNigeriaTruckoutWblistBinding
import com.olam.warehouse.vegax.nigeriaweighment.databinding.ItemVegaNigeriaTruckoutWbListBinding
...
class VegaNigeriaTruckOutWBListFragment : BaseFragment(){
    ...
    private lateinit var binding: FragmentVegaNigeriaTruckoutWblistBinding
    override val layoutResourceId = R.layout.fragment_vega_nigeria_truckout_wblist

    companion object {
        fun newInstance(receivingData: VegaQualityWBDetails) = VegaNigeriaTruckOutWBListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaNigeriaTruckoutWblistBinding.inflate(layoutInflater)
        return binding.root
    }
...
//                                        .filter { wb -> !wb.qcStatus.equals("") }
    ...
    private fun setUpAdapter(data: List<VegaQualityWBDetails>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_nigeria_truckout_wb_list,
            ItemVegaNigeriaTruckoutWbListBinding::inflate,
            { it, pos, bindItem ->
