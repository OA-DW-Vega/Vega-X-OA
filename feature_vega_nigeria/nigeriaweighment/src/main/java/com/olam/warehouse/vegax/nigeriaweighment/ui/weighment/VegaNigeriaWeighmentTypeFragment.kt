package com.olam.warehouse.vegax.nigeriaweighment.ui.weighment
...
import com.olam.warehouse.vegax.nigeriaweighment.databinding.FragmentVegaNigeriaWeighmentTypeBinding
import com.olam.warehouse.vegax.nigeriaweighment.utils.*
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaNigeriaWeighmentTypeFragment : BaseFragment() {

    private val mTAG = VegaNigeriaWeighmentTypeFragment::class.java.canonicalName
    private lateinit var binding: FragmentVegaNigeriaWeighmentTypeBinding
    private var callBack: CallBack? = null
    private var receivingData = VegaReceiving()
    private var receiving = VegaQualityWBDetails()
    ...
    override val layoutResourceId = R.layout.fragment_vega_nigeria_weighment_type

    companion object {
        fun newInstance() = VegaNigeriaWeighmentTypeFragment().putArgs {
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaNigeriaWeighmentTypeBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("nigeriaweighment/ui/weighment/VegaNigeriaWeighmentTypeFragment").title("Receiving").with(tracker)
        initUI()
    }
    ...
    private fun initUI() {
        ...
        binding.llLocalSales.setOnClickListener { moveToLocalSales() }
        binding.llLocalSales.gone()
    ...
    private fun moveToSupplier() {
        receiving = VegaQualityWBDetails()
        receiving.direction = mDirection.toString()
        receiving.weighBridgeType = PROCURE
        callBack?.replaceFragment(SUPPLIER, receiving.direction, receiving)
    }
