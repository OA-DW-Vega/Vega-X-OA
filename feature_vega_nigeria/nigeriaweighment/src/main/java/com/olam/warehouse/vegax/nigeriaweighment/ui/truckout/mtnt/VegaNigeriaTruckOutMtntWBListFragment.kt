package com.olam.warehouse.vegax.nigeriaweighment.ui.truckout.mtnt
...
import com.olam.warehouse.vegax.nigeriaweighment.databinding.FragmentVegaNigeriaTruckoutMtntWblistBinding
import com.olam.warehouse.vegax.nigeriaweighment.databinding.ItemVegaNigeriaTruckoutMtntWbListBinding
import com.olam.warehouse.vegax.nigeriaweighment.ui.VegaNigeriaMtntViewModel
import com.olam.warehouse.vegax.nigeriaweighment.utils.DIRECTIONOUT
import com.olam.warehouse.vegax.nigeriaweighment.utils.MTNT_DATA
import com.olam.warehouse.vegax.nigeriaweighment.utils.TRUCKOUT_MTNT_ADD_WEIGHT_FRAG
import com.olam.warehouse.vegax.nigeriaweighment.utils.getColor
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaNigeriaTruckOutMtntWBListFragment : BaseFragment(){
    ...
    private lateinit var binding: FragmentVegaNigeriaTruckoutMtntWblistBinding
    override val layoutResourceId = R.layout.fragment_vega_nigeria_truckout_mtnt_wblist

    companion object {
        fun newInstance(mtntData: VegaMtnt) = VegaNigeriaTruckOutMtntWBListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentVegaNigeriaTruckoutMtntWblistBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("receiving/ui/truckout/mtnt/VegaTruckOutMtntWBListFragment").title("Receiving")
            .with(tracker)
        initUI()
    }
    ...
    private fun setUpAdapter(data: List<VegaMtnt>?) {
        ...
        binding.rvWeighbridge.setUpAdapter(
            ...
            R.layout.item_vega_nigeria_truckout_mtnt_wb_list,
            ItemVegaNigeriaTruckoutMtntWbListBinding::inflate,
            { it, pos, bindItem ->
