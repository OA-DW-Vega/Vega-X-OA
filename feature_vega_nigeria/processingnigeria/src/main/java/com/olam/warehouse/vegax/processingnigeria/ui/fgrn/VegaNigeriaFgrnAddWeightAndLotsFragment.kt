...
import kotlinx.android.synthetic.main.item_vega_nigeria_fgrn_add_bag.view.*
...
//                binding.icAssignLotCard.tvStorageValue.gone()
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCoffeeFgrnGradesMatrialWeights>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_vega_nigeria_fgrn_add_bag, { it, pos ->
            if (pos % 2 == 0) {
