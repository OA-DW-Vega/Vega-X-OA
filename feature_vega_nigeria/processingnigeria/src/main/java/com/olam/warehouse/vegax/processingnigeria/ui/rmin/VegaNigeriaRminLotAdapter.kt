...
import kotlinx.android.synthetic.main.item_nigeria_lot_card_layout.view.*
...
class VegaNigeriaRminLotAdapter(
    ...
    class ScaleViewHolder(bind: ItemNigeriaLotCardLayoutBinding) : RecyclerView.ViewHolder(bind.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {

        val viewHolder =
            ItemNigeriaLotCardLayoutBinding.inflate(LayoutInflater.from(parent.context), parent, false)
