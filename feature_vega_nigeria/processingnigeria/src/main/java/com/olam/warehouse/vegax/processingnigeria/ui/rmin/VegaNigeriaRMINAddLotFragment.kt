...
class VegaNigeriaRMINAddLotFragment : BaseFragment(), NigeriaRminItemRemoveListener,
    ...
    companion object {
        fun newInstance(
            ...
            VegaNigeriaRMINAddLotFragment().putArgs {
    ...
    private fun clearAllValues() {
        if (model?.gradeListDetails.isNullOrEmpty()) {
            binding.cvCard.tvMaterialValue.text = model?.materialName
            currentMaterial = model?.materialCode.toString()
            currentMaterialName = model?.materialName.toString()
        } else {
            binding.cvCard.tvMaterialValue.text = gradeList[selectedItemPosition].materialName
    ...
    private fun updateAdapter(vegaCocoaDispatchLots: VegaCoffeeRminLots) {
        ...
        if (model?.gradeListDetails.isNullOrEmpty()) {
            ...
            vegaCocoaDispatchLots.fgrnIdMaterialCode =
                gradeList[selectedItemPosition].fgrnIdMaterialCode
        }
