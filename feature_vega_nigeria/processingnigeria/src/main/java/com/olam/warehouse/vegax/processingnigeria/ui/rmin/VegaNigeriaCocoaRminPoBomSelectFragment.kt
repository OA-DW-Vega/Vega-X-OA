...
import com.olam.warehouse.vegax.processingnigeria.databinding.FragmentPoBomSelectLayoutBinding
...
import com.olam.warehouse.vegax.processingnigeria.utils.ADDLOT
import com.olam.warehouse.vegax.processingnigeria.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.processingnigeria.utils.SUBSTAGES
import com.olam.warehouse.vegax.processingnigeria.utils.getColor
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaNigeriaCocoaRminPoBomSelectFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(title: String, isPo: Boolean, model: VegaCoffeeRminProcessing) =
            VegaNigeriaCocoaRminPoBomSelectFragment().putArgs {
    ...
    private fun updateBomList(boms: List<VegaProcessingRminBoms>?) {
        ...
        if (boms?.size == 1) {
            ...
            activity?.supportFragmentManager?.popBackStackImmediate()
            callBack?.replaceFragment(SUBSTAGES, false, model!!, isPoSelection)
