package com.olam.warehouse.vegax.processingnigeria.data.repo
...
interface VegaNigeriaProcessingRepository {
    suspend fun getGrades(): LiveData<List<VegaMaterial>>
    suspend fun getStages(): LiveData<List<VegaProcessingStage>>
    suspend fun getBom(bomPostReq: VegaNigeriaRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>>

    suspend fun getStocks(material: String): LiveData<Resource<GenericReqAndResp<List<VegaCoffeeRminLots>>>>
    suspend fun postCreatePo(bomPostReq: VegaNigeriaProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>>
    ...
    suspend fun getSubStages(
        material: String,
        werks: String
    ): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaProcessingSubStageDetails>>>>
    ...
    suspend fun postRminDetails(model: VegaNigeriaProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaProcessingRminResponse>>>>
    ...
    suspend fun postFgrnDetails(poReq: VegaNigeriaProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaProcessingFgrnResponse>>>>
...
class VegaNigeriaProcessingRepoImpl(
        private val api: VegaNigeriaProcessingApi,
        private val dao: VegaCoffeeRminDao,
        private val masterDao: MasterDao
) : VegaNigeriaProcessingRepository {

    val currentKey = PreferenceHelper.get(Constants.CURRENT_KEY, "")
    override suspend fun getGrades() = dao.getProducts()
    override suspend fun getStages() = dao.getProcessingStage()
    override suspend fun getBom(bomPostReq: VegaNigeriaRminBomPost): LiveData<Resource<GenericReqAndResp<VegaProcessingRminBom>>> {
    ...
    override suspend fun postCreatePo(bomPostReq: VegaNigeriaProcessingCreatePoReq): LiveData<Resource<GenericReqAndResp<VegaProcessingRminPo>>> {
    ...
    override suspend fun getPoGrades(
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaCoffeeFgrnItemsGrades>> =
                api.getFgrnGrades(VegaNigeriaProcessOrderDetailsPostReq(getCurrentKey(), getPlantDetails(), poNo, rmin))
        }.build().asLiveData()
    }
    ...
    override suspend fun postRminDetails(model: VegaNigeriaProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaProcessingRminResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaNigeriaProcessingRminResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaNigeriaProcessingRminResponse>> =
    ...
    override suspend fun postFgrnDetails(poReq: VegaNigeriaProcessingFgrnPost): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaProcessingFgrnResponse>>>> {
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaNigeriaProcessingFgrnResponse>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaNigeriaProcessingFgrnResponse>> =
    ...
    override suspend fun getSubStages(
        material: String,
        werks: String
    ): LiveData<Resource<GenericReqAndResp<List<VegaNigeriaProcessingSubStageDetails>>>> {
        return object :
            NetworkOnlyBoundResource<GenericReqAndResp<List<VegaNigeriaProcessingSubStageDetails>>>() {
            override suspend fun createCall(): GenericReqAndResp<List<VegaNigeriaProcessingSubStageDetails>> =
                api.getProcessingStageVersion(getCurrentKey(), material, werks)
        }.build().asLiveData()
    }
