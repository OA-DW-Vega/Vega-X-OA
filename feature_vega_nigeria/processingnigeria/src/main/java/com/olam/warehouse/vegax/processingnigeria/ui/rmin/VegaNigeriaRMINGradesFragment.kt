...
import com.olam.warehouse.vegax.processingnigeria.databinding.ItemVegaNigeriaFgrnGradesBinding
import com.olam.warehouse.vegax.processingnigeria.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaNigeriaRMINGradesFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(model: VegaCoffeeRminProcessing, id: String, isPo: Boolean) =
            VegaNigeriaRMINGradesFragment().putArgs {
                putParcelable(FRAG_ITEM, model)
                putBoolean(IS_PO, isPo)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("processingnigeria/ui/fgrn/VegaCoffeeRMINGradesFragment").title("Processing Coffee")
            .with(tracker)
    }
    ...
    private fun validateGrade() {
        when (gradeList.any { it.isGradeChecked!! }) {
            true -> {
                ...
                callBack?.replaceFragment(ADDLOT, false, fgrnItem, isPoSelection)
            }
    ...
    private fun updateAdapter(gradeList: MutableList<VegaCoffeeFgrnItemsGrades>) {
        ...
        binding.rvGrades.setUpAdapter(
            gradeList,
            R.layout.item_vega_nigeria_fgrn_grades,
            ItemVegaNigeriaFgrnGradesBinding::inflate,
            { item, pos, bindItem ->
    ...
    private fun View.updateGradeSelection(
        ...
        pos: Int,
        bindItem: ItemVegaNigeriaFgrnGradesBinding
    ) {
