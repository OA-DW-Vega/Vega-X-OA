...
import kotlinx.android.synthetic.main.item_vega_nigeria_fgrn_inventory_filter.*
import java.util.*
...
class VegaNigeriaFgrnFilterFragment : BaseFragment() {
    ...
    private fun setUpAdapter(listFliterWhLoc: ArrayList<NigeriaFilterList>) {
        binding.rvWhLocation.setUp(listFliterWhLoc, R.layout.item_vega_nigeria_fgrn_inventory_filter, { it, pos ->
