...
import com.olam.warehouse.vegax.processingnigeria.databinding.FragmentNigeriaRminShiftSelectionBinding
import com.olam.warehouse.vegax.processingnigeria.utils.*
import org.koin.androidx.viewmodel.ext.android.viewModel

class VegaNigeriaRMINShiftSelectFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_nigeria_rmin_shift_selection
    private lateinit var binding: FragmentNigeriaRminShiftSelectionBinding
    ...
    companion object {
        fun newInstance(fromSummary: Boolean, model: VegaCoffeeRminProcessing) =
            VegaNigeriaRMINShiftSelectFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentNigeriaRminShiftSelectionBinding.inflate(layoutInflater)
        initExtra()
        initUI()
...
//            remark.toString().isEmpty() -> showSnack(getString(R.string.choose_remarks))
    ...
    private fun updateCurrentShiftSelection(value: String) {
        when (value) {
            shiftList[0] -> binding.rbA.isChecked = true
            shiftList[1] -> binding.rbB.isChecked = true
            shiftList[2] -> binding.rbC.isChecked = true
        }
    }
...
//                    val shift = gson.fromJson(it, VegaNigeriaRMINRemarkModel::class.java)
