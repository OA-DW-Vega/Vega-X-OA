...
import com.olam.warehouse.vegax.processingnigeria.databinding.FragmentNigeriaInventoryLotListBinding
import com.olam.warehouse.vegax.processingnigeria.databinding.ItemNigeriaInventoryLotBinding
import com.olam.warehouse.vegax.processingnigeria.utils.MODEL_BUNDLE
import com.olam.warehouse.vegax.processingnigeria.utils.MULTIPLE_LOT
import com.olam.warehouse.vegax.processingnigeria.utils.getColor
import com.olam.warehouse.vegax.processingnigeria.utils.listOfField
import org.koin.androidx.viewmodel.ext.android.viewModel

class VegaNigeriaRMINLotListFragment : BaseFragment() {

    override val layoutResourceId = R.layout.fragment_nigeria_inventory_lot_list
    private lateinit var binding: FragmentNigeriaInventoryLotListBinding
    ...
    private var listener: NigeriaAddLotsListener? = null
    ...
    override fun onAttach(context: Context) {
        ...
        listener = context as? NigeriaAddLotsListener
    }
    ...
    companion object {
        fun newInstance(
            ...
            VegaNigeriaRMINLotListFragment().putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentNigeriaInventoryLotListBinding.inflate(layoutInflater)
        initExtra()
        initUI()
        return binding.root
    }
    ...
    private fun setupAdapter(data: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvLots.setUpAdapter(
            data,
            R.layout.item_nigeria_inventory_lot,
            ItemNigeriaInventoryLotBinding::inflate,
            { it, pos, bindItem ->
    ...
    private fun updateWareHouseSpinner() {
        val stageAdapter =
            ArrayAdapter(requireContext(), R.layout.item_vega_nigeria_processing_rmin_grade, wareHouseList)
