...
import kotlinx.android.synthetic.main.item_vega_nigeria_fgrn_lot.view.*
...
//                binding.tvBatchDefault.gone()
    ...
    private fun updateAdapter(stockList: MutableList<VegaCoffeeRminLots>) {
        ...
        binding.rvInventoryLot.setUp(stockList, R.layout.item_vega_nigeria_fgrn_lot, { it, pos ->
            ivDelete.gone()
