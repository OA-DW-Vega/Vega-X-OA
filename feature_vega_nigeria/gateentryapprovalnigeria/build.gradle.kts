...
android {
   ...
   buildFeatures.viewBinding = true
    namespace = "com.olam.warehouse.vegax.gateentryapprovalnigeria"
}
...
dependencies {
    ...
    implementation(project(mapOf("path" to ":feature_vega_nigeria:gateentrynigeria")))
    //implementation(LibraryDependency.PDFVIEWER)
}
