...
import com.olam.warehouse.vegax.pilemanagementnigeria.databinding.FragmentPileManagementNigeriaEditBinding
...
import kotlinx.android.synthetic.main.item_pile_management_nigeria.view.*
...
class VegaNigeriaPileManagementEditFragment : BaseFragment(), VegaSingleSelectListener {

    override val layoutResourceId = R.layout.fragment_pile_management_nigeria_edit
    private lateinit var binding: FragmentPileManagementNigeriaEditBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPileManagementNigeriaEditBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(list: ArrayList<VegaCocoaDispatchLots>) {
        val lots = list
        binding.rvLots.setUp(lots, R.layout.item_pile_management_nigeria, { item, pos ->
