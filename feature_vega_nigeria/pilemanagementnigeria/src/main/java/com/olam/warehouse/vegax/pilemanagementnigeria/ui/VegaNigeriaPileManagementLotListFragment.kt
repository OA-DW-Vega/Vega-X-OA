...
import kotlinx.android.synthetic.main.item_pile_management_lot_list_card_nigeria.view.*
...
//                    hideLoading()
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLots.setUp(data, R.layout.item_pile_management_lot_list_card_nigeria, { it, pos ->
