...
import kotlinx.android.synthetic.main.item_pile_management_summary_nigeria.view.*
...
class VegaNigeriaPileManagementSummaryFragment : BaseFragment() {
    ...
    private fun setupAdapter(data: MutableList<VegaCocoaDispatchLots>) {
        ...
        binding.rvLotList.setUp(data, R.layout.item_pile_management_summary_nigeria, { it, pos ->
