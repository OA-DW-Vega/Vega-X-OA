package com.olam.warehouse.vegax.inventorynigeria.ui.dialog
...
import com.olam.warehouse.vegax.inventorynigeria.databinding.FragmentBottomSheetNigeriaInventorySyncBinding
import com.olam.warehouse.vegax.inventorynigeria.databinding.ItemVegaNigeriaInventorySyncDetailsBinding
import com.olam.warehouse.vegax.inventorynigeria.utils.SYNC_STATUS_DATA
import java.util.*

/**
 * Created by Roshna Parambil on 9/3/2020.
 */
class VegaNigeriaInventorySyncDetailsDailog : BottomSheetDialogFragment() {

    private var syncStatusList = ArrayList<SyncStatus>()

    companion object {
        fun newInstance(syncStatusList: ArrayList<SyncStatus>) = VegaNigeriaInventorySyncDetailsDailog().putArgs {
            putParcelableArrayList(SYNC_STATUS_DATA, syncStatusList)
        }
    }

    private lateinit var binding: FragmentBottomSheetNigeriaInventorySyncBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBottomSheetNigeriaInventorySyncBinding.inflate(layoutInflater)
    ...
    private fun setUpAdapter(syncStatusList: java.util.ArrayList<SyncStatus>) {
        binding.rvSyncDetails.setUpAdapter(
            syncStatusList,
            R.layout.item_vega_nigeria_inventory_sync_details,
            ItemVegaNigeriaInventorySyncDetailsBinding::inflate,
            { it, pos, bindItem ->
