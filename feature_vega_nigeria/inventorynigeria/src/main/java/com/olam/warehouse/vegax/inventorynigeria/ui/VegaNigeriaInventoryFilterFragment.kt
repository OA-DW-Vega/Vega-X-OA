...
import com.olam.warehouse.vegax.inventorynigeria.databinding.ItemVegaNigeriaInventoryFilterBinding
import com.olam.warehouse.vegax.inventorynigeria.utils.FILTER_LOCATION
import com.olam.warehouse.vegax.inventorynigeria.utils.FILTER_MATERIAL
import com.olam.warehouse.vegax.inventorynigeria.utils.FULL_FILTER
...
//        bundle.putStringArrayList(FILTER_FAT, selectedFat)
    ...
    private fun setUpMaterialAdapter(listFliterMaterial: ArrayList<FilterList>) {
        binding.rvMaterial.setUpAdapter(
            listFliterMaterial,
            R.layout.item_vega_nigeria_inventory_filter,
            ItemVegaNigeriaInventoryFilterBinding::inflate,
            { it, pos, bindItem ->
