...
import com.olam.warehouse.vegax.inventorynigeria.databinding.ItemVegaNigeriaQualityDetailsBinding
...
class VegaNigeriaInventoryQualityFragment : BaseFragment() {
    ...
    private fun setUpAdapter(qualityParameters: List<QualityParams>) {
        binding.rvQuality.setUpAdapter(
            ...
            R.layout.item_vega_nigeria_quality_details,
            ItemVegaNigeriaQualityDetailsBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
