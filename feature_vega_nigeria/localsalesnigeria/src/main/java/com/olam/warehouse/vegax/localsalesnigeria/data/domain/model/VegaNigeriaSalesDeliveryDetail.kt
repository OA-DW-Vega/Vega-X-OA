...
data class VegaNigeriaSalesPostRequest(
    var batchNumber: String? = "",
    var delFlag: String? = "",
    var deliveryDetails: List<VegaNigeriaSalesDeliveryDetail>,
    var key: String? = "",
...
data class VegaNigeriaSalesDeliveryDetail(
    var batchNumber: String? = "",
    var bltxt: String? = "",
...
data class VegaNigeriaSalesPallet(
    var weighbridgeID: String? = "",
