...
import com.olam.warehouse.vegax.localsalesnigeria.databinding.ItemNigeriaSalesPalletBagInfoBinding
...
//        callBack?.replaceFragment(UPDATE_WEIGHT, binding.tvNetWtValue.text.toString())
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCoffeeSalesBagMaterial>) {
        ...
        binding.rvWeight.setUpAdapter(
            bagList1.asReversed(),
            R.layout.item_nigeria_sales_pallet_bag_info,
            ItemNigeriaSalesPalletBagInfoBinding::inflate,
            { it, pos, bindItem ->
                if (pos % 2 == 0) {
