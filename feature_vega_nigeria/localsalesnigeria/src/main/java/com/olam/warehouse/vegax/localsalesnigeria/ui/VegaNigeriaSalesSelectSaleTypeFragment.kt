...
import com.olam.warehouse.vegax.localsalesnigeria.databinding.FragmentNigeriaSalesTypesBinding
import com.olam.warehouse.vegax.localsalesnigeria.utils.SALES_PENDING
import com.olam.warehouse.vegax.localsalesnigeria.utils.SALES_TYPE_ANTICIPATED
import com.olam.warehouse.vegax.localsalesnigeria.utils.SALES_TYPE_WEIGHBRIDGE
import com.olam.warehouse.vegax.localsalesnigeria.utils.SALES_TYPE_WEIGHSCALE
import org.koin.androidx.viewmodel.ext.android.viewModel
import org.matomo.sdk.Tracker
import org.matomo.sdk.extra.TrackHelper

class VegaNigeriaSalesSelectSaleTypeFragment : BaseFragment() {
    override val layoutResourceId: Int = R.layout.fragment_nigeria_sales_types
    private var callBack: CallBack? = null
    private lateinit var binding: FragmentNigeriaSalesTypesBinding
    ...
    companion object {
        fun newInstance() = VegaNigeriaSalesSelectSaleTypeFragment().putArgs {
        }
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentNigeriaSalesTypesBinding.inflate(layoutInflater)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("localsalesNigeria/ui/VegaNigeriaSalesSelectSaleTypeFragment")
