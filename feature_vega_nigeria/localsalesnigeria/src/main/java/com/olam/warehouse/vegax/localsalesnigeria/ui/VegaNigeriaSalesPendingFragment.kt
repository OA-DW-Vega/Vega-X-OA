...
import kotlinx.android.synthetic.main.item_nigeria_sales_pending_list.view.*
...
class VegaNigeriaSalesPendingFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaCoffeePendingSalesOrderWithLots>?) {
        ...
        binding.rvLots.setUp(dispatch1, R.layout.item_nigeria_sales_pending_list, { it, pos ->
