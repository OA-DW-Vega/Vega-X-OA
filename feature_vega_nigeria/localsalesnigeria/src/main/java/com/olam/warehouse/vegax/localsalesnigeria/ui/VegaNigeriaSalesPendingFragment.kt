...
import com.olam.warehouse.vegax.localsalesnigeria.databinding.FragmentNigeriaSalesPendingListBinding
import com.olam.warehouse.vegax.localsalesnigeria.databinding.ItemNigeriaSalesPendingListBinding
import com.olam.warehouse.vegax.localsalesnigeria.utils.ADD_LOT
import com.olam.warehouse.vegax.localsalesnigeria.utils.SALES_TYPE_WEIGHSCALE
import com.olam.warehouse.vegax.localsalesnigeria.utils.SEARCH_HINT
 ...
 */
class VegaNigeriaSalesPendingFragment : BaseFragment() {

    override val layoutResourceId: Int = R.layout.fragment_nigeria_sales_pending_list
    private lateinit var binding: FragmentNigeriaSalesPendingListBinding
    ...
    companion object {
        fun newInstance(salesTypeWeighscale: String) = VegaNigeriaSalesPendingFragment().putArgs {
        }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentNigeriaSalesPendingListBinding.inflate(inflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("localsalesNigeria/ui/VegaNigeriaSalesPendingFragment")
    ...
    private fun setUpAdapter(data: List<VegaCoffeePendingSalesOrderWithLots>?) {
        ...
        binding.rvLots.setUpAdapter(
            dispatch1,
            R.layout.item_nigeria_sales_pending_list,
            ItemNigeriaSalesPendingListBinding::inflate,
            { it, pos, bindItem ->
