...
import kotlinx.android.synthetic.main.item_lot_nigeria_sales_summary.view.*
import kotlinx.android.synthetic.main.item_nigeria_sales_material_list.view.*
import kotlinx.android.synthetic.main.nigeria_custom_edit_text.view.*
...
//            showConformationDialog()
    ...
    private fun setUpAdapter(lineItems: MutableList<VegaCoffeeSalesLotWithbags>) {
        ...
        binding.rvLots.setUp(lineItems, R.layout.item_lot_nigeria_sales_summary, { it, pos ->
            val lot = it.salesLot
            ...
            when(lot.unitOfMeasure){
                ...
                "MT" -> {
                    ...
                    tvWeightToProcessValue.text = convertMtToKg(lot.editedWeight.toString()).plus(" ").plus("KG")
                }
            }
