package com.olam.warehouse.vegax.grnnigeria.ui.offline
...
import com.olam.warehouse.vegax.grnnigeria.databinding.FragmentVegaNigeriaGrnOfflineBinding
import com.olam.warehouse.vegax.grnnigeria.databinding.ItemVegaNigeriaGrnOfflineBinding
import com.olam.warehouse.vegax.grnnigeria.ui.VegaNigeriaGrnViewModel
import com.olam.warehouse.vegax.grnnigeria.utils.GRN_FRAG
 ...
 */
class VegaNigeriaGrnOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_nigeria_grn_offline
    private val vm: VegaNigeriaGrnViewModel by viewModel()
    private lateinit var binding: FragmentVegaNigeriaGrnOfflineBinding
    private var grnList = arrayListOf<VegaGrnWeighBridgeId>()
    private var callBack: CallBack? = null

    companion object {
        fun newInstance() = VegaNigeriaGrnOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaNigeriaGrnOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("grnnigeria/ui/offline/VegaNigeriaGrnOfflineSummary")
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaGrnWeighBridgeId>) {
        ...
        binding.rvOfflineGrn.setUpAdapter(
            grnList,
            R.layout.item_vega_nigeria_grn_offline,
            ItemVegaNigeriaGrnOfflineBinding::inflate,
            { it, pos, bindItem ->
