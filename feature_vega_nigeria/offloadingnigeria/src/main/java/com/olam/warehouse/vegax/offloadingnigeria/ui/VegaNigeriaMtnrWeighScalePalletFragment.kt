...
import kotlinx.android.synthetic.main.item_vega_nigeria_offload_add_bag.view.*
        ...
        binding.rvWeight.setUp(
            ...
            { it, pos ->
                if (pos % 2 == 0) {
                    ...
                    clBagHead.setBackgroundResource(R.drawable.shape_nigeria_offload_rect_light_grey1)
                }
