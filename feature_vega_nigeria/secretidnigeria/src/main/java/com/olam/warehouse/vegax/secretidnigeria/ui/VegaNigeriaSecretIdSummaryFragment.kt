...
class VegaNigeriaSecretIdSummaryFragment : BaseFragment() {
    ...
    private fun initUI() {
        ...
        binding.tvApproveParamsText.text = selectedText
        ...
        secretIdDetails.weighBridgeId.let { vm.getWbWeightDetails(it,wbType.toString()) }
    }
    ...
    private fun createLotCardBitMap() {
        ...
        DoAsync {
            lotList.forEachIndexed { index, item ->
                ...
                viewBinder.tvText.visible()
                viewBinder.tvTextValue.visible()
                viewBinder.tvLotValue.text = item.batchNumber
                viewBinder.tvTextValue.text = selectedText
