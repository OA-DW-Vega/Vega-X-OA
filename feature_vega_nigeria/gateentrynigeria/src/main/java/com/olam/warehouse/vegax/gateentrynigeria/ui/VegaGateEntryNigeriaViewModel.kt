 ...
 */
class VegaGateEntryNigeriaViewModel(
    private val useCase: VegaGateEntryNigeriaUseCase,
...
/*    private var gateEntryTruckResource: LiveData<Resource<GenericReqAndResp<List<VegaGateEntry>>>> = MutableLiveData()
    ...
    private var gateEntrySource: LiveData<Resource<GenericReqAndResp<VegaGateEntryNigeriaResponse>>> =
        MutableLiveData()
    private val _gateEntry = MediatorLiveData<Resource<GenericReqAndResp<VegaGateEntryNigeriaResponse>>>()
    val gateEntry: LiveData<Resource<GenericReqAndResp<VegaGateEntryNigeriaResponse>>> get() = _gateEntry
    ...
    fun postGateEntryData(gateEntryPost: VegaGateEntryNigeriaPost) = viewModelScope.launch(dispatchers.main) {
