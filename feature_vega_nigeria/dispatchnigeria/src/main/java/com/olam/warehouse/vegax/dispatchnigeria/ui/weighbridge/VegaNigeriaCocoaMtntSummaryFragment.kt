...
import com.olam.warehouse.vegax.dispatchnigeria.data.domain.model.VegaNigeriaCocoaMtntDeliveryDetail
import com.olam.warehouse.vegax.dispatchnigeria.data.domain.model.VegaNigeriaCocoaMtntDeliveryPost
import com.olam.warehouse.vegax.dispatchnigeria.databinding.FragmentNigeriaCocoaDispatchMtntSummaryBinding
...
import com.olam.warehouse.vegax.dispatchnigeria.utils.WEIGHBRIDGE
...
class VegaNigeriaCocoaMtntSummaryFragment : BaseFragment(),
    VegaNigeriaCocoaMtntLotRemoveListener {

    private var dispatchLotsList = mutableListOf<VegaCocoaDispatchLots>()
    override val layoutResourceId: Int = R.layout.fragment_nigeria_cocoa_dispatch_mtnt_summary
    private lateinit var binding: FragmentNigeriaCocoaDispatchMtntSummaryBinding
    ...
    companion object {
        fun newInstance(data: VegaCocoaDispatchWB) = VegaNigeriaCocoaMtntSummaryFragment()
            .putArgs {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = FragmentNigeriaCocoaDispatchMtntSummaryBinding.inflate(inflater)
        initExtra()
        initUi()
    ...
    private fun postDelivery() {
        vegaCoffeeDeliveryPost = VegaNigeriaCocoaMtntDeliveryPost(
            getCurrentKey(),
            getPlantDetails(),
            "",
    ...
    private fun prepareDeliveryList(): List<VegaNigeriaCocoaMtntDeliveryDetail> {
        val list = ArrayList<VegaNigeriaCocoaMtntDeliveryDetail>()
        val year: Int = Calendar.getInstance().get(Calendar.YEAR)
        for (item in dispatchLotsList) {
            val deliveryDetail = VegaNigeriaCocoaMtntDeliveryDetail()
