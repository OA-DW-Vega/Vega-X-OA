...
import kotlinx.android.synthetic.main.item_nigeria_cocoa_mtnt_truck_layout.view.*
...
class VegaNigeriaCocoaMtntWeighbridgeTruckListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUp(dispatch1, R.layout.item_nigeria_cocoa_mtnt_truck_layout, { it, pos ->
