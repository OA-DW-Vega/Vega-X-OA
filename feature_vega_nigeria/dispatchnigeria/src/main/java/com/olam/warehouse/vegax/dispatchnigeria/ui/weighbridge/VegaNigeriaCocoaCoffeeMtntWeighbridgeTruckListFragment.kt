...
import com.olam.warehouse.vegax.dispatchnigeria.databinding.FragmentNigeriaCocoaTruckListLayoutBinding
import com.olam.warehouse.vegax.dispatchnigeria.databinding.ItemNigeriaCocoaMtntTruckLayoutBinding
...
import com.olam.warehouse.vegax.dispatchnigeria.utils.DIRECTIONOUT
import com.olam.warehouse.vegax.dispatchnigeria.utils.WEIGHBRIDGE
import com.olam.warehouse.vegax.dispatchnigeria.utils.WEIGHBRIDGE_ADD_LOT
import com.olam.warehouse.vegax.dispatchnigeria.utils.getColor
import org.koin.androidx.viewmodel.ext.android.viewModel

class VegaNigeriaCocoaMtntWeighbridgeTruckListFragment : BaseFragment() {
    override val layoutResourceId: Int = R.layout.fragment_nigeria_cocoa_truck_list_layout
    private lateinit var binding: FragmentNigeriaCocoaTruckListLayoutBinding
    ...
    companion object {
        fun newInstance() = VegaNigeriaCocoaMtntWeighbridgeTruckListFragment()
            .putArgs {
            }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentNigeriaCocoaTruckListLayoutBinding.inflate(inflater)
    ...
    private fun setUpAdapter(data: List<VegaCocoaDispatchWB>?) {
        ...
        binding.rvLots.setUpAdapter(
            dispatch1,
            R.layout.item_nigeria_cocoa_mtnt_truck_layout,
            ItemNigeriaCocoaMtntTruckLayoutBinding::inflate,
            { it, pos, bindItem ->
