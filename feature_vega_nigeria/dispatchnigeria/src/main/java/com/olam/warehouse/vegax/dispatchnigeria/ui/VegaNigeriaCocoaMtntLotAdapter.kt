...
class VegaNigeriaCocoaMtntLotAdapter(
    var data: ArrayList<VegaCocoaDispatchLots>,
    var isEdit: Boolean = false,
    var isClose: Boolean = false,
    var listener: ItemRemoveListener
) :
    RecyclerView.Adapter<VegaNigeriaCocoaMtntLotAdapter.LotViewHolder>() {

    class LotViewHolder(bind: ItemNigeriaCocoaMtntLotSummaryBinding) :
    ...
    override fun onBindViewHolder(holder: LotViewHolder, position: Int) {
        ...
        holder.binding.ivClose.setImageDrawable(holder.itemView.context.getDrawable(if (isClose) R.drawable.ic_nigeriacoco_close_black else R.drawable.ic_nigeriacoco_edit_gray))
