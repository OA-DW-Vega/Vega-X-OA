...
import kotlinx.android.synthetic.main.item_vega_nigeria_cocoa_mtnt_add_bag.view.*
...
class VegaNigeriaCocoaMtntWeighScalePalletFragment : BaseFragment() {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_vega_nigeria_cocoa_mtnt_add_bag, { it, pos ->
            if (pos % 2 == 0) {
