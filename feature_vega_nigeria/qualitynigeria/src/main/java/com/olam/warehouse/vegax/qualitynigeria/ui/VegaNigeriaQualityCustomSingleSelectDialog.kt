...
import com.olam.warehouse.vegax.qualitynigeria.databinding.NigeriaQualityCustomDialogLayoutBinding
import com.olam.warehouse.vegax.qualitynigeria.databinding.NigeriaQualityFilterItemBinding

class VegaNigeriaQualityCustomSingleSelectDialog(
    private var title: String,
    private var isWh: Boolean,
    private var items: ArrayList<String>,
    private var activity: Context,
    private var listener: VegaNigeriaQualitySingleSelectListener
) :
    Dialog(activity),
    ...
    private lateinit var binding: NigeriaQualityCustomDialogLayoutBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        requestWindowFeature(Window.FEATURE_NO_TITLE)
        binding = NigeriaQualityCustomDialogLayoutBinding.inflate(layoutInflater)
    ...
    private fun setAdapter(
        ...
        listener: VegaNigeriaQualitySingleSelectListener
    ) {
        binding.recyclerView.setUpAdapter(
            item,
            R.layout.nigeria_quality_filter_item,
            NigeriaQualityFilterItemBinding::inflate,
            { it, pos, bindItem ->
