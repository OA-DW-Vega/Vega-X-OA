package com.olam.warehouse.vegax.qualitynigeria.data.repo
...
import com.olam.warehouse.vegax.qualitynigeria.utils.prepareData
import com.olam.warehouse.vegax.qualitynigeria.utils.prepareWeighBridgeData

/**
 * Created by Keerthi Santhanam on 6/21/2020.
 */
interface VegaNigeriaQualityRepository {
    ...
    suspend fun getPortPlantsId(role: String): LiveData<List<VegaCocoaMiscellaneous>>
    suspend fun getVegaMaterials(): LiveData<List<VegaMaterial>>
}

class VegaNigeriaQualityRepositoryImpl(private val api: VegaNigeriaQualityApi, private val dao: VegaQualityDao) : VegaNigeriaQualityRepository {
    ...
    override suspend fun getqcWeighBridgeList(selectedPlantId: String): LiveData<Resource<GenericReqAndResp<List<VegaQualityWBDetails>>>> {
        ...
        return object : NetworkOnlyBoundResource<GenericReqAndResp<List<VegaQualityWBDetails>>>() {
            ...
            override suspend fun createCall(): GenericReqAndResp<List<VegaQualityWBDetails>> =
                api.fetchQCWeighBridgeList(getCurrentKey(), "false", selectedPlantId)
    ...
    override suspend fun getPortPlantsId(role: String): LiveData<List<VegaCocoaMiscellaneous>> =
