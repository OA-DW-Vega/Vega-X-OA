package com.olam.warehouse.vegax.qualitynigeria.ui.offline
...
import com.olam.warehouse.vegax.qualitynigeria.databinding.FragmentVegaNigeriaQualityOfflineBinding
import com.olam.warehouse.vegax.qualitynigeria.databinding.ItemVegaNigeriaQtyOfflineBinding
 ...
 */
class VegaNigeriaQualityOfflineSummary : BaseFragment() {
    override val layoutResourceId = R.layout.fragment_vega_nigeria_quality_offline
    private val vm: VegaNigeriaQualityViewModel by viewModel()
    private lateinit var binding: FragmentVegaNigeriaQualityOfflineBinding
    private var qualityList = arrayListOf<VegaWeighBridgeWithQualityParams>()
    private var callBack: CallBack? = null

    companion object {
        fun newInstance() = VegaNigeriaQualityOfflineSummary().putArgs {
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaNigeriaQualityOfflineBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun setUpAdapter(qtyList: ArrayList<VegaWeighBridgeWithQualityParams>) {
        ...
        binding.rvOfflineQuality.setUpAdapter(
            qualityList,
            R.layout.item_vega_nigeria_qty_offline,
            ItemVegaNigeriaQtyOfflineBinding::inflate,
            { it, pos, bindItem ->
