...
import kotlinx.android.synthetic.main.item_vega_nigeria_export_sales_add_bag.view.*
...
/*    private fun updateConfigItems(configItems: List<VegaConfigDetails>?) {
    ...
    private fun setUpAdapter(bagList: ArrayList<VegaCocoaSweepingBagMaterial>) {
        ...
        binding.rvWeight.setUp(bagList1.asReversed(), R.layout.item_vega_nigeria_export_sales_add_bag, { it, pos ->
            if (pos % 2 == 0) {
