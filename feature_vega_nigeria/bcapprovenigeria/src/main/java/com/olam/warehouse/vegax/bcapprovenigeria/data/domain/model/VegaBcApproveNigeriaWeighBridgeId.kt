package com.olam.warehouse.vegax.bcapprovenigeria.data.domain.model
 ...
 */
/*@Parcelize
data class VegaQualityApproveNigeriaWeighBridgeId(
...
//VegaQualityApproveNigeriaWeighBridgeResponse
@Parcelize
data class VegaQualityApproveNigeriaWeighBridgeId(
    var charg: String? = "",
    var batchNumber: String? = "",
...
data class VegaNigeriaWeighmentModel(
    var data :List<VegaNigeriaWeighmentDetails>)

data class VegaNigeriaWeighmentDetails(
