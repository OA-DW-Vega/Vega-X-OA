...
import com.olam.warehouse.vegax.bcapprovenigeria.di.injectQualityApproveNigeriaFeature
import com.olam.warehouse.vegax.bcapprovenigeria.ui.quality.VegaBcApproveNigeriaFragment
import com.olam.warehouse.vegax.bcapprovenigeria.ui.weighbridge.VegaBcApproveNigeriaWeighbridgeListFragment
...
class VegaBcApproveNigeriaActivity : HomeBaseActivity(), OnFragmentBcApproveNigeriaInteractionListener,
    VegaBcApproveNigeriaFragment.OnParamsListener {
    ...
    private val mTAG = VegaBcApproveNigeriaActivity::class.java.canonicalName
    override val layoutResourceId: Int
        get() = R.layout.activity_vega_bc_approve_nigeria //To change initializer of created properties use File | Settings | File Templates.
    ...
    private fun initUi() {
        displayFragment(VegaBcApproveNigeriaWeighbridgeListFragment(), false)
    }
