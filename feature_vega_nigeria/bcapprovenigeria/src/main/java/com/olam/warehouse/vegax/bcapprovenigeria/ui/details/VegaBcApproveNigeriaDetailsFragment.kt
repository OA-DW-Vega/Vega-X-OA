package com.olam.warehouse.vegax.bcapprovenigeria.ui.details
...
import com.olam.warehouse.vegax.bcapprovenigeria.databinding.CutsomDialogBcApproveNigeriaLayoutBinding
import com.olam.warehouse.vegax.bcapprovenigeria.databinding.FragmentVegaBcApproveNigeriaDetailsBinding
...
import com.olam.warehouse.vegax.bcapprovenigeria.utils.preparePostGrnData
 ...
 */
class VegaBcApproveNigeriaDetailsFragment : BaseFragment() {
    ...
    private lateinit var binding: FragmentVegaBcApproveNigeriaDetailsBinding

    override val layoutResourceId = R.layout.fragment_vega_bc_approve_nigeria_details
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentVegaBcApproveNigeriaDetailsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        TrackHelper.track().screen("bcapproveNigeria/ui/details/VegaBcApproveNigeriaDetailsFragment").title("Vega_Nigeria/Approve").with(tracker)
        initUI()
    }
...
//        vm.grn.observe(viewLifecycleOwner, Observer { updateGrnUI(it) })
    ...
    private fun updateGrnUI(data: Resource<GenericReqAndResp<VegaBcApproveNigeriaGrnResponse>>) {
        data.let {
            when (it.status) {
                Resource.Status.SUCCESS -> {
                    hideLoading()
...
/*        binding.tvPaidWeight.text =
    ...
    private fun showConfirmDialog() {
        ...
        //val mDialogView = LayoutInflater.from(activity?.applicationContext).inflate(R.layout.cutsom_dialog_bc_approve_nigeria_layout, null)
        val mDialogView =
            CutsomDialogBcApproveNigeriaLayoutBinding.inflate(LayoutInflater.from(activity?.applicationContext))
...
//            wbDetails.storageLocationCode = binding.tvStorageLocation.text.toString()
    ...
    private fun showConfirmApproveDialog(data: GenericReqAndResp<VegaBcApproveNigeriaGrnResponse>?) {
