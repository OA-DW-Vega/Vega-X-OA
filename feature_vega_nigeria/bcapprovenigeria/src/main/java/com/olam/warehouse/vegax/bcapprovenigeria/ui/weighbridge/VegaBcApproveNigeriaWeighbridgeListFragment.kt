...
import com.olam.warehouse.vegax.bcapprovenigeria.databinding.ItemVegaWeighbridgeBcApproveNigeriaBinding
...
class VegaBcApproveNigeriaWeighbridgeListFragment : BaseFragment() {
    ...
    private fun setUpAdapter(data: List<VegaQualityApproveCameroonWeighBridge>?) {
        ...
        binding.rvWeighBridgeId.setUpAdapter(
            weighBridgeList1,
            R.layout.item_vega_weighbridge_bc_approve_nigeria,
            ItemVegaWeighbridgeBcApproveNigeriaBinding::inflate,
            { it, pos, bindItem ->
